...
$sql = "INSERT INTO marcel (filmes) VALUES ('$filmes')";
if(mysql_query($sql)) {
echo "<div align=center><br><font color='#000000' size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">Cadastrado com sucesso!!</font></div>";
}else{
