...
<div align="center">
 ...
 <table width="700" border="0">
    <tr>
      <td><p align="center" class="style20 style3"><span class="style21">
        <?
include "conexao.php";
...
if ($query)  
{
echo "<div align=center><font color='#000000' size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">Notícia deletada com sucesso!</font></div>";
}else{
echo "<div align=center><font color='#000000' size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">Não foi possível deletar a notícia.</font></div>";
}
?>
      </span></p>
      </td>
