...
while($n = mysql_fetch_array($sql))
   ...
   ?>
          <tr>
            <td width="81%" class="style3"><div align="left"><span class="style19"><?php echo $n["Id"]; ?> - <?php echo $n["titulo"]; ?></span></div></td>
            <td width="14%" class="style3"><div align="left"><span class="style19"><a href="admeditarnoticia.php?Id=<?php echo $n["Id"]; ?>">SELECIONAR</a></span></div></td>
            <td width="5%" class="style3"><div align="left"><a href="admeditarnoticia.php?Id=<?php echo $n["Id"]; ?>"><img src="editar.gif" border="0" /></a></div></td>
          </tr>
          <?
  }
  }
