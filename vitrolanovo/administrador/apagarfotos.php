...
while($n = mysql_fetch_array($sql))
   ...
   ?>
        <tr>
          <td width="13%"><font color="#000000"><img src="capaspm/<?php echo $n["foto"]; ?>" border="0"/></font></td>
          <td width="73%"><span class="style19"><font color="#000000"><?php echo $n["titulo"]; ?></font></span></td>
          <td width="10%"><span class="style19"><a href="admapagafoto.php?id=<?php echo $n["id"]; ?>"><font color="#000000">SELECIONAR</font></a></span></td>
          <td width="4%"><a href="admapagafoto.php?id=<?php echo $n["id"]; ?>"><img src="editar.gif" border="0" /></a></td>
        </tr>
        <?
  }
  }
