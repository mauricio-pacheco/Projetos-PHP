...
while($n = mysql_fetch_array($sql))
   ...
   ?>
        <tr>
          ...
          <td width="14%"><span class="style2"><a href="admexcluirgaleria.php?id=<?php echo $n["id"]; ?>&amp;foto=<?php echo $n["foto"]; ?>" onclick="return confirm('Tem certeza que deseja apagar a galeria <?php echo $n["titulo"]; ?> ?')"><font color="#000000">APAGAR</font></a></span></td>
