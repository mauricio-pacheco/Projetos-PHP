      ...
      <table width="100%" height="300" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td valign="top"><table width="100%" height="30" border="0">
            <tr>
              <td class="fontetitulo">&nbsp;Pesquisar</td>
            </tr>
          </table>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
...
$sql_select = "SELECT * FROM cw_pub WHERE titulo LIKE '%".$palavra."%' ORDER BY titulo ASC LIMIT $inicio, $qnt";
                          ...
                          <table width="100%" border="0">
                            <tr>
                              <td width="25%" align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td align="center"><a href="administrador/ups/publicacoes/<?php echo $arquivo.""; ?>" target="_blank"><img alt="<?php echo $titulo.""; ?>" title="<?php echo $titulo.""; ?>" src="imagens/down.png" border="0" /></a></td>
                                </tr>
                              </table>
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
