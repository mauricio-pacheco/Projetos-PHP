    ...
    <td width="996" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
       <td width="100%" valign="top"><table width="98%" height="30" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td class="fontetitulon"><?php $obra = $_GET["galeria"]; echo $obra; ?></td>
          </tr>
        </table>
                        ...
                        <table width="156" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr>
                            <td><table border="1" bordercolor="#FFFFFF" width="170" height="130" cellspacing="0" cellpadding="0">
                              <tr>
                                <td align="center" bordercolor="#EEEEEE" background="imagens/ddd.png"><a href='administrador/ups/fotosgaleria/g/<?php echo $foto.""; ?>' rel='lightbox['roadtrip="roadtrip"']' title='<?php echo $comentario.""; ?>'><img src="administrador/ups/fotosgaleria/p/<?php echo $fotomenor.""; ?>" width="160" height="120" border="0" /></a></td>
                              </tr>
                            </table></td>
                          </tr>
                          <tr>
