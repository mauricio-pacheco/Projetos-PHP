...
<table width="1000" border="0" background="imagens/fundogeral.png" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="996" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="23%" valign="top"><?php include("menulateral.php"); ?></td>
...
while($y = mysql_fetch_array($sql))
   ...
   ?>
        <table width="98%" height="30" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td class="fontetitulon"><?php echo $y["nome"]; ?></td>
          </tr>
        </table>
