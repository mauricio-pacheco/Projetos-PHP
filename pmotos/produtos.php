...
<table width="1000" border="0" height="600" background="imagens/fundogeral.png" align="center" cellpadding="0" cellspacing="0">
  <tr>
      ...
      <tr>
        ...
        <td width="77%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <table width="98%" height="30" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td class="fontetitulon">Produtos</td>
            </tr>
          </table>
...
$sql_select = "SELECT * FROM cw_produtos ORDER BY nome ASC LIMIT $inicio, $qnt";
...
// Exibe o primeiro link 'primeira p&aacute;gina', que n&atilde;o entra na contagem acima(3)
echo "<a href='produtos.php?p=1' target='_self' class=manchete_texto96>PRIMEIRA PÁGINA</a>&nbsp;&nbsp; ";
...
echo "| <a href='produtos.php?p=".$i."' target='_self' class=manchete_texto96>".$i."</a> ";
}
}
...
echo "&nbsp;&nbsp;<a href='produtos.php?p=".$pags."' target='_self' class=manchete_texto96>ÚLTIMA PÁGINA</a> ";
