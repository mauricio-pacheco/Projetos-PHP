...
$texto .=  "$nome, acabou de enviar uma mensagem pelo site Polaco Motos:\n\n\n<br><br>"; 
$texto .= "Nome: $nome\n\n<br><br>"; 
$texto .= "Cidade: $cidade\n\n<br><br>";  
$texto .= "Estado: $estado\n\n<br><br>";  
...
$mensagem = $texto;
$assunto = "CONTATO DO SITE POLACO MOTOS";
	
$assunto = "CONTATO DO SITE POLACO MOTOS";
$remetente = "$nome<$email2>";
$destinatario = "polacomotos2@hotmail.com";
...
$mail -> AddAddress("polacomotos2@hotmail.com");
