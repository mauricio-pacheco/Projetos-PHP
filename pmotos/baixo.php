<table width="100%" height="120" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td valign="top" background="imagens/tabelabaixa.png"><table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
      ...
      <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td class="fonterodape" align="center"><strong>&copy; Polaco Motos
              <?php   
...
$visita->imprime();
?>
          <br />Desenvolvimento: <a href="http://www.casadaweb.net" class="fonterodape" target="_blank"><font color="#FFFFFF">Casa da Web</font></a></td>
        </tr>
    </table>
      <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
