  ...
  <tr>
    ...
    <td width="996" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="77%" valign="top"><table width="98%" height="30" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td class="fontetitulon"><?php
						$idsub = $_GET["idsub"];
$iddep = $_GET["iddep"];
...
$sql_select = "SELECT * FROM cw_produtos WHERE departamento='$iddep' ORDER BY id DESC LIMIT $inicio, $qnt";
...
$sql_select_all = "SELECT * FROM cw_produtos WHERE departamento='$iddep'";
...
echo "<a href='sessoes.php?p=1&amp;iddep=$iddep' target='_self' class=manchete_texto96>PRIMEIRA PÁGINA</a>&nbsp;&nbsp; ";
...
echo "| <a href='sessoes.php?p=".$i."&amp;iddep=$iddep' target='_self' class=manchete_texto96>".$i."</a> ";
}
}
...
echo "&nbsp;&nbsp;<a href='sessoes.php?p=".$pags."&amp;iddep=$iddep' target='_self' class=manchete_texto96>ÚLTIMA PÁGINA</a> ";
