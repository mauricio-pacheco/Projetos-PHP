	...
	if ($PBwhere1=="customers") {
		...
		while ($pb= mysql_fetch_array($result)) {
				...
				if ($auth == "ok" || $auth == "readonly") {
					$html = "<table><tr><td bgcolor=\'#CCCCCC\'><b>$pb[custname] $pb[contact]</b></td></tr><tr><td><img src=\'arrow.gif\'>&nbsp;<a href=\'phonebook.php?nonavbar=$nonavbar&edit=$pb[id]\' class=\'bigsort\'>Editar</a></td></tr><tr><td><img src=\'arrow.gif\'>&nbsp;<a href=\'phonebook.php?nonavbar=$nonavbar&delete=$pb[id]\' class=\'bigsort\'>Deletar</td></tr></table>";
...
//		print "<tr><td colspan =12>$lang[pbresults] '$search' &nbsp;[$lang[phonebook1]]</td></tr>";
		...
		$result= mcq($sql,$db);
		while ($pb= mysql_fetch_array($result)) {
				$html = "<table><tr><td bgcolor=\'#CCCCCC\'><b>$pb[Firstname] $pb[Lastname]</b></td></tr><tr><td><img src=\'arrow.gif\'>&nbsp;<a href=\'phonebook.php?nonavbar=$nonavbar&edit=$pb[id]\' class=\'bigsort\'>Editar</a></td></tr><tr><td><img src=\'arrow.gif\'>&nbsp;<a href=\'phonebook.php?nonavbar=$nonavbar&delete=$pb[id]\' class=\'bigsort\'>Deletar</td></tr></table>";
				...
				$a .= "</td><td onmouseover=\"javascript:style.background='#CCCCCC';return overlib('" . $html . "', STICKY)\"  onmouseout=\"javascript:style.background='#F2F2F2';nd();\"><img src='arrow.gif'>&nbsp;<a class='topnav' style='cursor:pointer' >OPÇÕES</a></td></tr>";
