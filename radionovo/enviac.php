...
$texto =  "FORMULARIO DENUNCIA SITE LUZ E ALEGRIA\n\n\n<br><br>"; 
$texto .= "$denuncia\n\n<br><br>"; 


	
$mensagem = $texto;
$assunto = "FORMULARIO DENUNCIA SITE LUZ E ALEGRIA";
	
$assunto = "FORMULARIO DENUNCIA SITE LUZ E ALEGRIA";
$remetente = "$nome<$email2>";
$destinatario = "jornalismo@luzealegria.com.br";
...
$mail -> AddAddress("jornalismo@luzealegria.com.br");
...
echo "<script>alert('Denuncia Enviada com Sucesso!')</script>";
echo "<meta http-equiv='refresh' content='0;URL=denuncia.php'>";
