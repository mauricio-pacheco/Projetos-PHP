...
function adminMain() {
    ...
    OpenTable();
    echo "<center><b>"._LAST." 100 "._ARTICLES."</b></center><br>";
    $result6 = $db->sql_query("SELECT sid, aid, title, time, topic, informant, alanguage FROM ".$prefix."_stories $queryalang ORDER BY time DESC LIMIT 0,100");
    ...
    while ($row6 = $db->sql_fetchrow($result6)) {
		...
		echo "<tr><td align=\"right\"><b>$sid</b>"
		    ."</td><td align=\"right\" nowrap>(<a href=\"admin.php?op=RemoveStory&amp;sid=$sid\">APAGAR</a> - <a href=\"admin.php?op=FCKEditStory&amp;sid=$sid\">EDITAR</a>)"
