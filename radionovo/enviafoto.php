...
<LINK REL="StyleSheet" HREF="themes/Helius/style/style2.css" TYPE="text/css"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="br">
<head>
...
.style21 {color: #000000; font-size: 10px; font-family: Verdana, Arial, Helvetica, sans-serif; }
body {
...
<form name="form1" action="enviafoto2.php" method="post" enctype="multipart/form-data" onSubmit="return validar(this)">
                                    <table width="100%" border="0" align="left">
                                      <tr>
                                        <td width="685"><span class="style15">
                                          <input name="foto" type="file" class="texto" />
                                          <span class="style9">*</span> 
                                          <input type="submit" class="texto" value="ENVIAR FOTO PARA O SERVIDOR" />
                                        </span></td>
                                      </tr>
  </table>
