...
function Stats_Main() {
	...
	."[ <a href=\"modules.php?name=$module_name&op=Stats\">VISUALIZAR ESTATÍSTICAS DETALHADAS</a> ]<BR><BR>[ <a href=\"modules.php?name=Top\">VISUALIZAR ESTATÍSTICAS POR ÁREAS</a> ]</center>";
    CloseTable();
    echo "<br><br>";
