...
<div align="center">
  ...
  <p class="style1">AUDIOS LUZ E ALEGRIA</p>
  <p class="style1"><span class="style2"><a href="index.php">ENVIAR AUDIO</a> ------ <a href="deletaraudios.php">APAGAR AUDIO</a></span></p>
</div>
  <tr>
    <td><p align="left">
...
?><div align="left">
        <tr>
          <td width="86%"><span class="style19"><font color="#28638E"><a href="../audioenv/<?php echo $arquivo.""; ?>" target="_blank">&nbsp;&nbsp;<img src="fone.gif" border="0" /></a><?php echo $titulo.""; ?></font> - <font color="#0B7044">&nbsp;Arquivo postado em:</font> <?php echo $data.""; ?> - <?php echo $hora.""; ?> - </span></td>
          <td width="9%"><span class="style19"><a href="admexcluiraudio.php?id=<?php echo $id.""; ?>&amp;recua=<?php echo $arquivo.""; ?>" onClick="return confirm('Tem certeza que deseja apagar o audio <?php echo $titulo.""; ?> ?')"><font color="#000000">APAGAR</font></a></span></td>
          <td width="5%"><a href="admexcluirnaudio.php?id=<?php echo $id.""; ?>&amp;recua=<?php echo $arquivo.""; ?>" onClick="return confirm('Tem certeza que deseja apagar o audio <?php echo $titulo.""; ?> ?')"><img src="apagar.gif" border="0" /></a></td>
        </tr>
