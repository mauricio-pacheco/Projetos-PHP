...
$texto .=  "$nome, acabou de enviar uma mensagem pelo site Rodolfo Peron:\n\n\n<br><br>"; 
$texto .= "Nome: $nome\n\n<br><br>"; 
$texto .= "Cidade: $cidade\n\n<br><br>";  
$texto .= "Estado: $estado\n\n<br><br>";  
...
$mensagem = $texto;
$assunto = "CONTATO DO SITE RODOLFO PERON";
	
$assunto = "CONTATO DO SITE RODOLFO PERON";
$remetente = "$nome<$email2>";
$destinatario = "rodolfoperon@hotmail.com";
...
$mail -> Host = "mail.rodolfoperon.com.br"; //SERVIDOR SMTP
$mail -> Port = "25";
$mail -> SMTPAuth = true; // 'true' Para Autentica&ccedil;&atilde;o SMTP
$mail -> Username - "webmaster@rodolfoperon.com.br"; // Usu&aacute;rio para autenticar
$mail -> Password = "ro2012"; // Senha usada 
$mail -> From = "webmaster@rodolfoperon.com.br"; // Colocar Email para que a aut. n&atilde;o barre o a mensagem
$mail -> Fromname = "From: $nome<$e_mail> \n";
$mail -> AddAddress("rodolfoperon@hotmail.com");
