          ...
          <tr>
            <td width="69%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="98%" bgcolor="#111113" align="center"><img src="imagens/qualidade.png" /></td>
...
$sql_select = "SELECT * FROM cw_galeria WHERE local='qualidade' ORDER BY id DESC LIMIT $inicio, $qnt";
...
$sql_select_all = "SELECT * FROM cw_galeria WHERE local='qualidade'";
...
echo "<a href='qualidade.php?p=1' target='_self' class=fonterodape><b>PRIMEIRA PÁGINA</b></a>&nbsp;&nbsp; ";
...
echo "| <a href='qualidade.php?p=".$i."' target='_self' class=fonterodape>".$i."</a> ";
}
}
...
echo "&nbsp;&nbsp;<a href='qualidade.php?p=".$pags."' target='_self' class=fonterodape><b>ÚLTIMA PÁGINA</b></a> ";
