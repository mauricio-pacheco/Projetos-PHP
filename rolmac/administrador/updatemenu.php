...
$sql = "UPDATE cw_menus SET departamento = '$departamento' WHERE id = '$id'";
if(mysql_query($sql)) {
echo "<div align=center><br><img src=imagens/ok.png></div><br><div align=center class=manchete_texto>O DEPARTAMENTO FOI EDITADO COM SUCESSO!!</div>";
}else{
