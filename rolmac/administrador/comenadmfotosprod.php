          ...
          <table width="100%" border="0" align="center">
            <tr>
              <td width="11%" height="30" bgcolor="#076CA0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="98%">&nbsp;&nbsp;<font color="#FFFFFF" class="fontetabela2"><b>ADMINSITRAR IMAGENS DO PRODUTO</b></font></td>
                </tr>
              </table></td>
            </tr>
          </table>
                      ...
                      <tr>
                        ...
                        <td align="left" width="98%" valign="top" class="manchete_texto3"><table width="100%" border="0">
                          ...
                          <table width="100%" border="0">
                            <tr>
                              <td class="manchete_texto"><b>Preço:</b> <?php echo $n["valor"]; ?><br /><?php echo $n["descricao"]; ?></td>
                            </tr>
                          </table>
                          <table width="100%" border="0">
                            <tr>
