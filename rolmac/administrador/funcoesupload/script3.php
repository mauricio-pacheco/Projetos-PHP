...
$file = $_FILES['photoupload']['tmp_name'];
	...
	elseif (!$error && ($size[0] < 25) || ($size[1] < 25))
	{
		...
		$aux_tipo_imagem = $size['mime'];
            ...
            $diretorio = "../ups/fotosprodutos/";
            $diretorio_g = "../ups/fotosprodutos/g/";
            $diretorio_p = "../ups/fotosprodutos/p/";
	...
	else
	{
		...
		include "../conexao.php";
		$sql = "INSERT INTO cw_anexosprod (fotomaior, fotomenor, idnot) VALUES ('$ft_nome2','$tb_nome2','$idpuxado')";
		mysql_query($sql);
	}
