        ...
        <td width="76%" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <table width="100%" border="0" align="center">
            <tr>
              <td width="11%" height="30" bgcolor="#076CA0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="98%">&nbsp;&nbsp;<font color="#FFFFFF" class="fontetabela2"><b>ADMINISTRAR VIDEOS</b></font></td>
                </tr>
              </table></td>
            </tr>
          </table>
          ...
          <tr>
            ...
            <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td>
                  <form name="formbusca" method="post" action="buscavideo.php">
                    <label><span class="manchete_texto"><strong>Pesquisar Video:</strong></span>
                      <input name="palavra" type="text" value="Digite o Título do Video" onclick="this.value=''" class="manchete_texto" id="palavra" size="102" />
                    </label>
...
$sql_select = "SELECT * FROM cw_videos WHERE titulo LIKE '%".$palavra."%' ORDER BY id DESC LIMIT $inicio, $qnt";
// Executa o Query
...
?>
                  ...
                  <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td><a href="edivideos.php?id=<?php echo $id.""; ?>" class="manchete_texto4"><b>EDITAR VIDEO</b></a> - <a href="delvideos.php?id=<?php echo $id.""; ?>&amp;foto=<?php echo $foto.""; ?>" onclick="return confirm('Tem certeza que deseja apagar o video <?php echo $nomegaleria.""; ?> ?')" class="manchete_texto6"><b>APAGAR VIDEO</b></a></td>
                    </tr>
                  </table>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
...
$sql_select_all = "SELECT * FROM cw_videos WHERE titulo LIKE '%".$palavra."%'";
...
echo "<a class=manchete_texto href='buscavideo.php?p=1' target='_self'><b>PRIMEIRA P&Aacute;GINA</b></a>&nbsp;&nbsp;";
...
echo "| <a class=manchete_texto href='buscavideo.php?p=".$i."' target='_self'>".$i."</a> ";
}
}
...
echo "&nbsp;&nbsp;<a class=manchete_texto href='buscavideo.php?p=".$pags."' target='_self'><b>&Uacute;LTIMA P&Aacute;GINA</b></a> ";
?></div></td>
              </tr>
            </table></td>
          </tr>
