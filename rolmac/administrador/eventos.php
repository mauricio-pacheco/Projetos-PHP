          ...
          <table width="100%" border="0" align="center">
            <tr>
              <td width="11%" height="30" bgcolor="#076CA0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="98%">&nbsp;&nbsp;<font color="#FFFFFF" class="fontetabela2"><b>CADASTRAR GALERIA</b></font></td>
                </tr>
              </table></td>
            </tr>
          </table>
                    ...
                    <table width="100%" border="0" align="center">
                      <tr>
                        <td class="manchete_texto" align="left">Local da Galeria:  
                          <input name="local" type="radio" value="fotos" checked="checked" />
Fotos
<input type="radio" name="local" value="empresa" />
Empresa
<input type="radio" name="local" value="produtos" /> 
Produtos
<input type="radio" name="local" value="qualidade" />
Qualidade </td>
                      </tr>
                      <tr>
            ...
            ?>
                      ...
                      <tr>
                        <td class="manchete_texto" align="left"><span style="MARGIN: 0px">
                          <input name="submit" class="fontetabela" type="submit" style="FONT-SIZE: 10px" value="CADASTRAR GALERIA" />
                        </span></td>
                      </tr>
                    </table>
                  </form></td>
