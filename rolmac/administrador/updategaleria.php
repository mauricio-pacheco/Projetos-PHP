...
$sql = mysql_query("SELECT * FROM cw_galeria WHERE id='$id'");
...
while($t = mysql_fetch_array($sql))
   {
$arquivoapaga = "$t[foto]";
unlink("ups/galerias/$arquivoapaga");
}

$arquivo0 = isset($_FILES["foto"]) ? $_FILES["foto"] : FALSE;
$max_image_x0 = 158;
$max_image_y0 = 119;
$diretorio0 = 'ups/galerias/';
if($arquivo0)
{
...
$sql = "UPDATE cw_galeria SET local = '$local', nomegaleria = '$nomegaleria', dataevento = '$dataevento', comentario = '$comentario', foto = '$nome_foto0' WHERE id = '$id'";
if(mysql_query($sql)) {
echo "<div align=center><br><img src=imagens/ok.png></div><br><div align=center class=manchete_texto>O EVENTO FOI EDITADO COM SUCESSO!!</div>";
}else{
