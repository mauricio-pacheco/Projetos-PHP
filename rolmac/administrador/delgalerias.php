          ...
          <table width="100%" border="0" align="center">
            <tr>
              <td width="11%" height="30" bgcolor="#076CA0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="98%">&nbsp;&nbsp;<font color="#FFFFFF" class="fontetabela2"><b>APAGAR GALERIA</b></font></td>
                </tr>
              </table></td>
            </tr>
          </table>
...
$sql = "DELETE FROM cw_galeria WHERE id='$id'";
unlink("ups/galerias/$foto");
if(mysql_query($sql)) {
echo "<div align=center class=fontetabela><br>O EVENTO FOI APAGADO COM SUCESSO!!</div>";
echo "<script>alert('EVENTO APAGADO COM SUCESSO!')</script>";
echo "<script>location.href='admeventos.php'</script>";
}else{
echo "<div align=center><br><font color='#000000' >NÃO FOI POSSÍVEL APAGAR!</font></div>";
}

$sql3 = mysql_query("SELECT * FROM cw_fotos WHERE idgaleria='$id' ORDER BY id");
...
$sql2 = "DELETE FROM cw_fotos WHERE idgaleria='$id'";
mysql_query($sql2)
