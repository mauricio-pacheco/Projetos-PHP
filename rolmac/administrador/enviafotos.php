          ...
          <table width="100%" border="0" align="center">
            <tr>
              <td width="11%" height="30" bgcolor="#076CA0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="98%">&nbsp;&nbsp;<font color="#FFFFFF" class="fontetabela2"><b>ENVIAR IMAGENS A GALERIA</b></font></td>
                </tr>
              </table></td>
            </tr>
          </table>
                      ...
                      <tr>
                        ...
                        <td align="left" width="98%" valign="top" class="manchete_texto3"><table width="100%" border="0">
                          ...
                          <table width="100%" border="0">
                            <tr>
                              <td class="manchete_texto"><b>Data da Galeria:</b> <?php echo $n["dataevento"]; ?><br /><b>Data de Postagem:</b> <?php echo $n["data"]; ?> / <?php echo $n["hora"]; ?><br /><?php echo $n["comentario"]; ?></td>
                            </tr>
                          </table></td>
                      </tr>
                    </table></td>
