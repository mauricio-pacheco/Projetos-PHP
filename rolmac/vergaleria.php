          ...
          <tr>
            <td width="69%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="98%" bgcolor="#111113" align="center"><span class="heading" style="BACKGROUND: #E71C24"><span class="text" style="COLOR: #ffffff">
                  <?php
...
while($y = mysql_fetch_array($sql))
   {
   ?>
                </span></span><span class="manchete_textorp"><font color="#FFFFFF"><b><?php echo $y["nomegaleria"]; ?></b></font></span></td>
                <td width="1%"><img src="imagens/c2.png" width="11" height="26" /></td>
              </tr>
            </table></td>
            </tr>
        </table>
          <table width="99%" class="fonterodape" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                    ...
                    <table width="100%" border="0" align="center">
					 ...
					 if ($branca == $testeb)
					 {
                            ...
                            <td width="81%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td><b><?php echo $y["nomegaleria"]; ?></b></td>
                              </tr>
                            </table>
                              ...
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td>Data da Galeria: <?php echo $y["dataevento"]; ?></td>
                                </tr>
                              </table>
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                              ...
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td>Data de Publica&ccedil;&atilde;o: <?php echo $y["data"]; ?> --- ( <?php echo $y["hora"]; ?> Hs )</td>
                                </tr>
                              </table>
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                              ...
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td><b><?php echo $y["comentario"]; ?></b></td>
                                </tr>
                              </table></td>
                          </tr>
                        </table></td>
                      ...
                      <tr>
                        <td align="left"><img src="imagens/branco.gif" width="1" height="6" /></td>
                      </tr>
                      <tr>
...
$colunas="8"; //quantidade de colunas
$cont="1"; //contador

print"<table width=860>";
