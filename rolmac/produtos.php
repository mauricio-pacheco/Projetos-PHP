          ...
          <tr>
            <td width="69%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="98%" bgcolor="#111113" align="center"><img src="imagens/equipamentos.png" /></td>
          ...
          <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td><p class="manchete_textorp">Para mais informaçoes sobre maquinas  e equipamentos entre em contato&nbsp;nos telefones:<br />(55) 9901-0162 - Nei e  (55) 9633-6271 - Fabiano</p></td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                </tr>
...
$sql_select = "SELECT * FROM cw_galeria WHERE local='produtos' ORDER BY id DESC LIMIT $inicio, $qnt";
...
$sql_select_all = "SELECT * FROM cw_galeria WHERE local='produtos'";
...
echo "<a href='produtos.php?p=1' target='_self' class=fonterodape><b>PRIMEIRA PÁGINA</b></a>&nbsp;&nbsp; ";
...
echo "| <a href='produtos.php?p=".$i."' target='_self' class=fonterodape>".$i."</a> ";
}
}
...
echo "&nbsp;&nbsp;<a href='produtos.php?p=".$pags."' target='_self' class=fonterodape><b>ÚLTIMA PÁGINA</b></a> ";
