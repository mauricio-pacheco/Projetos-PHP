          ...
          <tr>
            <td width="69%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="98%" bgcolor="#111113" align="center"><img src="imagens/empresa.png" /></td>
          ...
          <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td><p class="manchete_textorp">A Rolmac Terraplenagem iniciou suas atividades em 2010 no mercado de  prestação de serviços para terraplenagem, aterro, desaterro, escavações e limpeza de grandes áreas. </p>
                    <p><span class="manchete_textorp"> Com atendimento personalizado, equipamentos de primeira linha, profissionais especializados e investimentos constantes, garantimos a satisfação do cliente e o alto nível dos serviços prestados.</span><br />
                    </p></td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
...
$sql_select = "SELECT * FROM cw_galeria WHERE local='empresa' ORDER BY id DESC LIMIT $inicio, $qnt";
                    ...
                    <table width="160" border="0" align="center" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        <td class="fonteadm" align="center"><table width="100%" border="0">
                          ...
                          <span class="fonterodape"><strong><a href="vergaleria.php?id=<?php echo $id.""; ?>" class="fonterodape"><?php echo $nomegaleria.""; ?></a></strong></span></td>
                      </tr>
                      <tr>
...
$sql_select_all = "SELECT * FROM cw_galeria WHERE local='empresa'";
...
echo "<a href='empresa.php?p=1' target='_self' class=fonterodape><b>PRIMEIRA PÁGINA</b></a>&nbsp;&nbsp; ";
...
echo "| <a href='empresa.php?p=".$i."' target='_self' class=fonterodape>".$i."</a> ";
}
}
...
echo "&nbsp;&nbsp;<a href='empresa.php?p=".$pags."' target='_self' class=fonterodape><b>ÚLTIMA PÁGINA</b></a> ";
