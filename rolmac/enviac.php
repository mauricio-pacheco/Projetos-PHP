...
$texto .=  "$nome, acabou de enviar uma mensagem pelo site Rolmac Terraplanagem:\n\n\n<br><br>"; 
$texto .= "Nome: $nome\n\n<br><br>"; 
$texto .= "Cidade: $cidade\n\n<br><br>";  
$texto .= "Estado: $estado\n\n<br><br>";  
...
$mensagem = $texto;
$assunto = "CONTATO DO SITE ROLMAC TERRAPLANAGEM";
	
$assunto = "CONTATO DO SITE ROLMAC TERRAPLANAGEM";
$remetente = "$nome<$email2>";
$destinatario = "rolmac@rolmacterraplanagem.com.br";
...
$mail -> Host = "mail.rolmacterraplanagem.com.br"; //SERVIDOR SMTP
$mail -> Port = "25";
$mail -> SMTPAuth = true; // 'true' Para Autentica&ccedil;&atilde;o SMTP
$mail -> Username - "webmaster@rolmacterraplanagem.com.br"; // Usu&aacute;rio para autenticar
$mail -> Password = "mac2012"; // Senha usada 
$mail -> From = "webmaster@rolmacterraplanagem.com.br"; // Colocar Email para que a aut. n&atilde;o barre o a mensagem
$mail -> Fromname = "From: $nome<$e_mail> \n";
$mail -> AddAddress("rolmac@rolmacterraplanagem.com.br");
//$mail -> AddAddress("nettmoda@yahoo.com");
