...
?>
              ...
              <table width="99%" border="0" align="center">
                <tr>
                  ...
                  <td width="21%" class="manchete_texto9"><strong><a href="detalhecompra.php?id=<?php echo $id.""; ?>&amp;idcliente=<?php echo $idcliente.""; ?>&amp;data=<?php echo $data.""; ?>&amp;hora=<?php echo $hora.""; ?>" class="manchete_texto9">DETALHES DA COMPRA</a></strong></td>
                </tr>
              </table>
