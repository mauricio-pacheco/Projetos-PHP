...
?>
  ...
  <tr>
    <td width="4%"><img src="imagens/ajuda.png"  /></td>
    <td width="19%" class="manchete_texto9"><a href="atendimento.php" class="manchete_texto9">Atendimento Online</a></td>
    <td width="35%" class="manchete_texto9">Bem vindo, <b><?php echo $y["cliente"]; ?></b></td>
    <td width="42%" class="manchete_texto9m"><a class="manchete_texto9m" href="altera.php?id=<?php echo $y["id"]; ?>&amp;usuario=<?php echo $y["usuario"]; ?>">ALTERAR DADOS PESSOAIS</a> | <a class="manchete_texto9m" href="minhascompras.php?id=<?php echo $y["id"]; ?>&amp;usuario=<?php echo $y["usuario"]; ?>&amp;cliente=<?php echo $y["cliente"]; ?>">MINHAS COMPRAS</a> | <a class="manchete_texto9m" href="sair.php">SAIR</a></td>
  </tr>
</table>
          ...
          <form action="autoriza.php" method="post" name="formlogin" onsubmit="return validarlogin(this)"><table width="98%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="323"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="7%"><img src="imagens/ajuda.png"  /></td>
                    <td width="47%" class="manchete_texto9"><a href="atendimento.php" class="manchete_texto9">Atendimento Online</a></td>
                    <td width="6%"><img src="imagens/login.png" /></td>
                    <td width="40%" class="manchete_texto9"s><a href="cadastro.php" class="manchete_texto9">Efetuar Cadastro</a></td>
                  </tr>
                </table></td>
                <td width="24" class="manchete_texto9"><img src="imagens/usuario.png"  /></td>
                <td width="134" class="manchete_texto9"><input style="font-size:11px; height:18px; width:120px; color:#FFF; background-color:#000000" name="usuario" type="text" onclick="this.value=''" class="manchete_texto9" value="usuário" /></td>
                <td width="23"><img src="imagens/chave.png"  /></td>
                <td width="125" class="manchete_texto9"><input type="password" style="font-size:11px; height:18px; width:120px; color:#FFF; background-color:#000000" class="manchete_texto9" onclick="this.value=''" value="******" name="senha" /></td>
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <table width="336" background="imagens/fundobusca.png" height="35" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="4%"></td>
                  <td width="36%"><input name="palavra" style="font-size:16px; height:30px; width:510px; color:#FFF; background-color:#164029" type="text" id="textfield2" onClick="this.value=''" value=" Digite o nome do produto desejado..." /></td>
                ...
                <td width="50%"><table width="90%" border="0" align="right" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td class="manchete_texto9">Itens na Cesta: <b><?php
include "administrador/conexao.php";
...
?>
 ...
 ?></b></td>
                      ...
                      <tr>
                        <td class="manchete_texto9"><a href="carrinho.php" class="manchete_texto9">Visualizar Minha Cesta</a></td>
                        </tr>
                    </table></td>
                  </tr>
                </table></td>
