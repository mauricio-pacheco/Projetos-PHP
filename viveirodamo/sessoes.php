...
$sql_select = "SELECT * FROM cw_subdepprod WHERE iddep='$iddep' ORDER BY nomesub ASC LIMIT $inicio, $qnt";
...
?>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td align="left"><a 
                        href="produto.php?idsub=<?php echo $id.""; ?>&iddep=<?php echo $iddep.""; ?>"><img 
                        alt="<?php echo $nome.""; ?>" 
                        src="imagens/caite.png" 
                        border="0" /></a></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td class="manchete_texto96" align="left"><a class="manchete_texto96" 
                        href="produto.php?idsub=<?php echo $id.""; ?>&iddep=<?php echo $iddep.""; ?>"><b><?php echo $nomesub.""; ?></b></a></td>
                      </tr>
...
$sql_select_all = "SELECT * FROM cw_subdepprod WHERE iddep='$iddep'";
