          ...
          <tr>
            <td><table width="100%" border="0">
              <tr>
                ...
                <td width="99%" align="left" background="barra11.jpg">&nbsp;&nbsp;&nbsp;<b>Apagar Galeria</b></td>
                </tr>
              </table>
              <table width="100%" border="0">
                <tr>
...
$sql = "DELETE FROM gestao_galeria WHERE id='$id'";
unlink("galerias/$foto");
if(mysql_query($sql)) {
echo "<div align=center><br><font color='#000000' >A GALERIA FOI APAGADA COM SUCESSO!!</font></div>";
echo "<script>alert('GALERIA APAGADA COM SUCESSO!')</script>";
...
$sql3 = mysql_query("SELECT * FROM gestao_fotos WHERE idgaleria='$id' ORDER BY id");
while($y = mysql_fetch_array($sql3))
{
$foto = $y["foto"];
$fotomenor = $y["fotomenor"];
unlink("ups/fotosgaleria/g/$foto");
unlink("ups/fotosgaleria/p/$fotomenor");
}

$sql2 = "DELETE FROM gestao_fotos WHERE idgaleria='$id'";
mysql_query($sql2)
