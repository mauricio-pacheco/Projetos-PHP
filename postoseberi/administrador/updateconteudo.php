...
$sql = "UPDATE gestao_conteudo SET titulo = '$titulo', setor = '$setor', texto1 = '$texto1', texto2 = '$texto2', texto3 = '$texto3', data = '$data', hora = '$hora' WHERE id = '$id'";
if(mysql_query($sql)) {
echo "<div align=center><br><img src=ok.png></div><div align=center><br>A PÁGINA FOI EDITADA COM SUCESSO!!</div>";
}else{
echo "<div align=center><br>NÃO FOI POSSÍVEL EDITAR A PÁGINA!</div>";
}
