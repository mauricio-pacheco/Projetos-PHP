          ...
          <tr>
            <td><table width="100%" border="0">
              <tr>
                ...
                <td width="99%" align="left" background="barra11.jpg">&nbsp;&nbsp;&nbsp;<b>Administrar Notícias</b></td>
                </tr>
              </table>
              <table width="100%" border="0">
                <tr>
                                        ...
                                        <tr>
                                          <td align="left" width="98%"><table width="100%" border="0">
                                            <tr>
                                              <td><table width="100%" border="0">
                                                <tr>
                                                  <td width="4%"><img src="jornal.png"></td>
                                                  <td width="96%"><font color="#000000"><b><?php echo $titulo.""; ?></b> -- <?php echo $data.""; ?> <?php echo $hora.""; ?></font></td>
                                                </tr>
                                              </table></td>
                                            </tr>
                                            <tr>
                                              <td>&nbsp;<a href="edinoticia.php?id=<?php echo $id.""; ?>" class="linkmenu"><font color="#0000ff"><b>EDITAR NOTÍCIA</b></font></a> - <a href="delnot.php?id=<?php echo $id.""; ?>" class="linkmenu" onClick="return confirm('Tem certeza que deseja apagar a notícia <?php echo $titulo.""; ?> ?')"><font color="#ff0000"><b>APAGAR NOTÍCIA</b></font></a></td>
                                            </tr>
                                          </table></td>
                                        </tr>
                                      </table>
...
echo "<a href='admnoticias.php?p=1' target='_self'><font size='1'>PRIMEIRA PÁGINA</font></a> <font color='#000000' size='1'>-</font> ";
...
echo "<a href='admnoticias.php?p=".$i."' target='_self'>".$i."</a> ";
}
}
...
echo " <font color='#000000' size='1'>-</font> <a href='admnoticias.php?p=".$pags."' target='_self'><font size='1'>ÚLTIMA PÁGINA</font></a> ";
?>
                                      </div></td>
                                  </tr>
                                </table></td>
