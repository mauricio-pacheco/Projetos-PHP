          ...
          <tr>
            <td><table width="100%" border="0">
              <tr>
                ...
                <td width="99%" align="left" background="barra11.jpg">&nbsp;&nbsp;&nbsp;<b>Administrar Galerias</b></td>
                </tr>
              </table>
              <table width="100%" border="0">
                <tr>
...
?>
                                  <table width="100%" border="0" align="center">
                                    <tr>
                                      ...
                                      <td align="left" width="98%"><font color="#000000"><b><?php echo $nomegaleria.""; ?></b> -- <?php echo $data.""; ?> <?php echo $hora.""; ?> <br /><br>
                                        <a href="edigalerias.php?id=<?php echo $id.""; ?>" class="linkmenu"><font color="#0000ff"><b>EDITAR GALERIA</b></font></a> - <a href="delgalerias.php?id=<?php echo $id.""; ?>&amp;foto=<?php echo $foto.""; ?>" class="linkmenu" onClick="return confirm('Tem certeza que deseja apagar a galeria <?php echo $nomegaleria.""; ?> ?')"><font color="#ff0000"><b>APAGAR GALERIA </b></font></a> <br><br> <a href="enviafotos.php?id=<?php echo $id.""; ?>" class="linkmenu"><font color="#008000"><b>ENVIAR IMAGENS A GALERIA</b></font></a> - <a href="comenadmfotos.php?id=<?php echo $id.""; ?>" class="linkmenu"><font color="#FF8000"><b>ADMINISTRAR IMAGENS DA GALERIA</b></font></a></td>
                                    </tr>
                                  </table>
                                  <div align="center"><br />
                                    <?php
...
echo "<a href='admgaleria.php?p=1' target='_self'><font size='1'>PRIMEIRA PÁGINA</font></a> <font color='#000000' size='1'>-</font> ";
...
echo "<a href='admgaleria.php?p=".$i."' target='_self'>".$i."</a> ";
}
}
...
echo " <font color='#000000' size='1'>-</font> <a href='admgaleria.php?p=".$pags."' target='_self'><font size='1'>ÚLTIMA PÁGINA</font></a> ";
?>
                                  </div></td>
                              </tr>
                            </table>
