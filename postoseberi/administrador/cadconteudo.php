          ...
          <tr>
            <td><table width="100%" border="0">
              <tr>
                ...
                <td width="99%" align="left" background="barra11.jpg">&nbsp;&nbsp;&nbsp;<b>Cadastrar Página</b></td>
                </tr>
              </table>
              <table width="100%" border="0">
                <tr>
...
$sql = "INSERT INTO gestao_conteudo (titulo, setor, texto1, texto2, texto3, data, hora) VALUES ('$titulo', '$setor', '$texto1', '$texto2', '$texto3', '$data', '$hora')";
if(mysql_query($sql)) {
echo "<div align=center><br><img src=ok.png></div><div align=center><br>O CADASTRO DA PÁGINA FOI EFETUADO COM SUCESSO!!</div>";
}else{
