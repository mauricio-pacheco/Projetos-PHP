          ...
          <tr>
            <td><table width="100%" border="0">
              <tr>
                ...
                <td width="99%" align="left" background="barra11.jpg">&nbsp;&nbsp;&nbsp;<b>Apagar Notícia</b></td>
                </tr>
              </table>
              <table width="100%" border="0">
                <tr>
...
$sql = "DELETE FROM gestao_noticias WHERE id='$id'";
if(mysql_query($sql)) {
echo "<div align=center><br>A NOTÍCIA FOI APAGADA COM SUCESSO!!</div>";
echo "<script>alert('NOTÍCIA APAGADA COM SUCESSO!')</script>";
echo "<script>location.href='admnot.php'</script>";
}else{
echo "<div align=center><br>NÃO FOI POSSÍVEL APAGAR A NOTÍCIA!</div>";
}
