          ...
          <tr>
            <td><table width="100%" border="0">
              <tr>
                ...
                <td width="99%" align="left" background="barra11.jpg">&nbsp;&nbsp;&nbsp;<b>Administrar Páginas</b></td>
                </tr>
              </table>
              <table width="100%" border="0">
                <tr>
...
$sql_select = "SELECT * FROM gestao_conteudo ORDER BY id DESC LIMIT $inicio, $qnt";
// Executa o Query
                                        ...
                                        <tr>
                                          <td align="left" width="98%"><table width="100%" border="0">
                                            <tr>
                                              <td><table width="100%" border="0">
                                                <tr>
                                                  <td width="4%"><img src="pagina.png"></td>
                                                  <td width="96%"><font color="#000000">&nbsp;<b><?php echo $titulo.""; ?></b> -- <?php echo $data.""; ?> <?php echo $hora.""; ?></font></td>
                                                </tr>
                                              </table></td>
                                            </tr>
                                            <tr>
                                              <td>&nbsp;<a href="ediconteudo.php?id=<?php echo $id.""; ?>&amp;setor=<?php echo $setor.""; ?>" class="linkmenu"><font color="#0000ff"><b>EDITAR PÁGINA</b></font></a> - <a href="delconteudo.php?id=<?php echo $id.""; ?>" class="linkmenu" onClick="return confirm('Tem certeza que deseja apagar a página <?php echo $titulo.""; ?> ?')"><font color="#ff0000"><b>APAGAR PÁGINA</b></font></a></td>
                                            </tr>
                                          </table></td>
                                        </tr>
                                      </table>
...
$sql_select_all = "SELECT * FROM gestao_conteudo";
...
echo "<a href='admpaginas.php?p=1' target='_self'><font size='1'>PRIMEIRA PÁGINA</font></a> <font color='#000000' size='1'>-</font> ";
...
echo "<a href='admpaginas.php?p=".$i."' target='_self'>".$i."</a> ";
}
}
...
echo " <font color='#000000' size='1'>-</font> <a href='admpaginas.php?p=".$pags."' target='_self'><font size='1'>ÚLTIMA PÁGINA</font></a> ";
?>
                                      </div></td>
                                  </tr>
                                </table></td>
