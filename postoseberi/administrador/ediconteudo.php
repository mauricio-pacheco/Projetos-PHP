          ...
          <tr>
            <td><table width="100%" border="0">
              <tr>
                ...
                <td width="99%" align="left" background="barra11.jpg">&nbsp;&nbsp;&nbsp;<b>Editar Página</b></td>
                </tr>
              </table>
              <table width="100%" border="0">
                <tr>
...
$id = $_GET['id'];
$sql = mysql_query("SELECT * FROM gestao_conteudo WHERE id='$id' ORDER BY id");
$contar = mysql_num_rows($sql); 

if ($contar < 1)  
   {echo "<div align=center><b>NÃO EXISTE PÁGINAS CADASTRADAS!</b></div>"; 
   }
else 
   {
   ...
   ?>
                                                              ...
                                                              <table width="100%" border="0" align="center">
                                                                <tr>
                                                                  <td><table width="100%" border="0">
                                                                    <tr>
                                                                      <td><form action="updateconteudo.php" method="post" name="form1" id="form1" onSubmit="return validar(this)">
                                                                        <table width="100%" border="0" align="center">
                                                                          <tr>
                                                                            <td class="rodape">&nbsp;
                  ...
                  name="titulo" value="<?php echo $n["titulo"]; ?>" />
                                                                          ...
                                                                          <tr>
                                                                            <td class="rodape"><label> &nbsp;Sessão:
                                                                                
                                                                              <select class=texto name="setor">
                                                                              <?php
...
$setor = $_GET['setor'];
   ...
   ?>
                                                                          ...
                                                                          <tr>
                                                                            <td class="rodape">&nbsp;Texto da Página:</td>
                                                                          </tr>
                                                                          <tr>
                                                                            <td class="rodape"><span class="fontetabela">
                                                                              <?php    
                //Step 2: Create Editor object.    
                $editor=new CuteEditor("texto2");
				$editor->Text="$n[texto2]";
               $editor->Height="1000";
				$editor->Width="712";
