          ...
          <tr>
            <td><table width="100%" border="0">
              <tr>
                ...
                <td width="99%" align="left" background="barra11.jpg">&nbsp;&nbsp;&nbsp;<b>Apagar Página</b></td>
                </tr>
              </table>
              <table width="100%" border="0">
                <tr>
...
$sql = "DELETE FROM gestao_conteudo WHERE id='$id'";
if(mysql_query($sql)) {
echo "<div align=center><br>A PÁGINA FOI APAGADA COM SUCESSO!!</div>";
echo "<script>alert('PÁGINA APAGADA COM SUCESSO!')</script>";
echo "<script>location.href='admpaginas.php'</script>";
}else{
echo "<div align=center><br>NÃO FOI POSSÍVEL APAGAR A PÁGINA!</div>";
}
