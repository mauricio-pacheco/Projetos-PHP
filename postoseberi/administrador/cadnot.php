...
$sql = "INSERT INTO gestao_noticias (titulo, legenda, texto, data, hora) VALUES ('$titulo','$legenda','$texto','$data','$hora')";
if(mysql_query($sql)) {
echo "<div align=center><br><img src=ok.png></div><div align=center><br>O CADASTRO DA NOTÍCIA FOI EFETUADO COM SUCESSO!!</div>";
}else{
