  ...
  <tr>
    <td bgcolor="#FFFFFF" valign="top">
      ...
      <tr>
        ...
        <td width="78%" valign="top"><span class="fontetabela">
          <?php
                ...
                <tr>
                  <td height="24" bordercolor="#A7D2EF" bgcolor="#004080"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      ...
                      <td width="90%" class="manchete_texto" align="center"><font color="#FFFFFF"><b><em><?php echo $y["pergunta"]; ?></em></b></font></td>
					...
					?>
                            ...
                            <td width="91%">&nbsp;<?php echo $y["op1"]; ?> --
                              ...
                              <table width="<?php echo intval($vop1); ?>%" border="0" height="2">
                                <tr>
                                  <td width="89%" bgcolor="#E67914" align="right"><img src="administrador/imagens/branco.gif" width="2" height="16" /></td>
                                </tr>
                              </table></td>
                          </tr>
                        </table>
