                ...
                <tr>
                  <td height="24" bordercolor="#A7D2EF" bgcolor="#004080"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      ...
                      <td width="90%" class="manchete_texto" align="center"><font color="#FFFFFF"><b><em>PEÇA SUA MÚSICA</em></b></font></td>
...
if (document.cadastro.artista.value=="") {
alert("O Campo Artista / Musica não está preenchido!")
cadastro.artista.focus();
return false
}

if (document.cadastro.quem.value=="") {
alert("O Campo Para Quem não está preenchido!")
cadastro.quem.focus();
return false
}
...
campo.value = campo.value + separador3;
                  ...
                  <form action="enviapeca.php" method="post" enctype="multipart/form-data" name="cadastro" id="cadastro" onSubmit="return validar(this)">
                    <table width="100%" border="0" align="center">
                      <tr>
                        <td width="50%"><table width="100%" border="0">
                          <tr>
                            <td class="fontebaixo2">Preencha o formul&aacute;rio abaixo para pedir sua música:</td>
                      ...
                      <tr>
                        <td><table width="100%" align="left" border="0">
                          <tbody>
                            <tr>
                              <td class="fontebaixo2">Artista / Música:</td>
                            </tr>
                            <tr>
                              <td class="fontebaixo2"><input class="texto" size="60" name="artista" />
* </td>
                            </tr>
                            <tr>
                              <td class="fontebaixo2">Para Quem:</td>
                            </tr>
                            <tr>
