...
$sql_select = "SELECT * FROM cw_noticias WHERE home='sim' ORDER BY id DESC LIMIT $inicio, $qnt";
...
$sql = mysql_query("SELECT * FROM cw_publicidades WHERE local='entre' AND status='0' ORDER BY rand()");
...
while($y = mysql_fetch_array($sql))
   ...
   ?>
      ...
      <?php
         ...
         <a href="<?php echo $y["link"]; ?>" target="_blank"><img alt="<?php echo $y["descricao"]; ?>" title="<?php echo $y["descricao"]; ?>" border="0" src="administrador/ups/publicidades/<?php echo $y["arquivo"]; ?>" width="530" /></a>
         <table width="100%" border="0" cellspacing="0" cellpadding="0">
           <tr>
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#026DA2" style="margin-bottom:4px">
                            <tr>
                              <td height="24" bordercolor="#A7D2EF" bgcolor="#004080"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td width="5%"><img src="imagens/antena.png" /></td>
                                  <td width="90%" class="manchete_texto" align="center"><font color="#FFFFFF"><strong><em>HORÓSCOPO</em></strong></font></td>
                                  <td width="5%" class="manchete_texto"><img src="imagens/antena2.png" /></td>
                                </tr>
                              </table></td>
                            </tr>
                          ...
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center"><iframe id='horoscopovirtual-gadget' name='hv-gadget' src='http://www.horoscopovirtual.com.br/gadget/horoscopo/?background=333333&color=ffffff' framespacing='0' frameborder='no' scrolling='no' width='300' height='300'></iframe></td>
  </tr>
  <tr>
    <td align="center"><img src="imagens/branco.gif" width="2" height="6"  alt=""/></td>
  </tr>
  <tr>
    <td align="center"><a href="https://www.facebook.com/dejair.decastro/photos_albums#!/pages/Cultura-FM-879-Palmitinho/439632096125289?fref=ts" target="_blank"><img border="0" src="facepag.jpg" width="532" height="137"  alt=""/></a></td>
  </tr>
</table>

                
                </td>
              <td width="30%" valign="top" align="center"><?php
