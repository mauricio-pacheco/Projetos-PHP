                      ...
                      <tr>
                        <td height="24"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr>
                            ...
                            <td width="95%" class="manchete_texto9">&nbsp;<a class="manchete_texto9" href="verevento.php?id=<?php echo $y["id"]; ?>"><font color="#004080"><?php echo $y["dataevento"]; ?></font></a></td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
                        <td width="100%" height="24"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr>
                            ...
                            <td width="95%" class="manchete_texto9">&nbsp;<font color="#004080"><a class="manchete_texto9" href="verevento.php?id=<?php echo $y["id"]; ?>"><?php echo $y["nomegaleria"]; ?></a></font></td>
                          </tr>
                        </table></td>
                      </tr>
                    </table></td>
