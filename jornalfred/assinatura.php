  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td width="82%" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td><img src="imagens/barraass.png" /></td>
        </tr>
        <tr>
            ...
            <tr>
              <td><br />
                <table width="99%" border="0" align="center">
                  <tr>
                    <td class="titulonoticia"><strong>Para informações sobre a assinatura do Jornal Frederiquense entre em contato com via telefone, e-mail ou MSN:</strong></td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    <td><table width="98%" border="0">
                      <tr>
                        <td width="6%"><img src="imagens/telefone.png" width="24" height="24" /></td>
                        <td width="94%">&nbsp;<strong>(55) 3744-2377</strong></td>
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                      ...
                      <tr>
                        <td><img src="imagens/cartaido.png" width="28" height="24" /></td>
                        <td>&nbsp;<a href="mailto:jornalfrederiquense@terra.com.br">jornalfrederiquense@terra.com.br</a></td>
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                      ...
                      <tr>
                        <td><img src="imagens/imsn.png" width="30" height="24" /></td>
                        <td>&nbsp;<a href="msnim:add?contact=jornalfrederiquense@hotmail.com">jornalfrederiquense@hotmail.com</a></td>
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
