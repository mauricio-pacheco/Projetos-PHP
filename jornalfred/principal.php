...
<div class="item_de_conteudo">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td><img src="imagens/barrault.png" /></td>
        </tr>
        <tr>
          <td bgcolor="#FFFFFF"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td><iframe marginwidth="0" marginheight="0" src="http://www.casadaweb.net/noticias/notrss.php" frameborder="0" width="538" scrolling="no" height="180"></iframe></td>
            </tr>
          </table></td>
        </tr>
        <tr>
                ...
                <tr>
                  ...
                  <table width="100%" border="0">
                    <tr>
					  ...
					  ?>
                      <td width="29%">
                                            <img src="administrador/imagensnot/<?php echo $y["foto"]; ?>" width="150" height="115" /></td><?php } ?>
                      <td width="71%" valign="top"><table width="100%" border="0">
                        <tr>
                          <td class="tituloita"><div align="justify"><i><?php echo $y["primeira"]; ?></i></div></td>
                        </tr>
                        <tr>
                          <td><table width="100%" border="0">
                            <tr>
                            ...
                            <table width="100%" border="0">
                            <tr>
                              <td width="46%"><?php echo $y["data"]; ?> - (<?php echo $y["hora"]; ?>)</td>
                              <td width="37%" class="titulosessao"><?php echo $y["sessao"]; ?></td>
                              <td width="17%"><a href="vernoticia.php?id=<?php echo $y["id"]; ?>" class="texto"><img src="imagens/leia.png" alt="Leia Mais..." title="Leia Mais..." border="0" /></a></td>
                              </tr>
                          </table></td>
                        </tr>
                      </table></td>
