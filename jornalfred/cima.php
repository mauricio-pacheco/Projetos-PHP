<table class="acessibilidade" width="100%" height="30" border="0">
  <tr>
    <td width="4%"><img src="imagens/calenda.png" width="24" height="24" /></td>
        <td width="80%" class="textume">&nbsp;<script language="JavaScript" type="text/javascript">
...
<td width="3%" class="textume"><img src="imagens/relogio.png" width="24" height="24" /></td>
    <td width="13%" class="textume"> <script language="JavaScript" type="text/javascript">
function horas(){
	var now = new Date();
