                ...
                <tr>
                  ...
                  <table width="100%" border="0">
                    <tr>
					  ...
					  {
					  ?>
                      <td width="29%"><img src="administrador/imagensnot/<?php echo $foto.""; ?>" width="150" height="115" /></td><?php } ?>
                      <td width="71%" valign="top"><table width="100%" border="0">
                        <tr>
                          <td class="tituloita"><div align="justify"><i><?php echo $primeira.""; ?></i></div></td>
                        </tr>
                        <tr>
                          <td><table width="100%" border="0">
                            <tr>
                            ...
                            <table width="100%" border="0">
                            <tr>
                              <td width="46%"><?php echo $data.""; ?> - (<?php echo $hora.""; ?>)</td>
                              <td width="37%" class="titulosessao"><?php echo $sessao.""; ?></td>
                              <td width="17%"><a href="vernoticia.php?id=<?php echo $id.""; ?>" class="texto"><img src="imagens/leia.png" alt="Leia Mais..." title="Leia Mais..." border="0" /></a></td>
                              </tr>
                          </table></td>
                        </tr>
                      </table></td>
