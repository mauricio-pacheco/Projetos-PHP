...
?>
  ...
  href="vernot.php?id=<?php echo $id.""; ?>"><img 
...
echo "<a href='vernots.php?p=1&amp;iddep=$iddep' target='_self' class=fonte><b>PRIMEIRA P&Aacute;GINA</b></a>&nbsp;&nbsp;";
...
echo "| <a href='vernots.php?p=".$i."&amp;iddep=$iddep' target='_self' class=fonte>".$i."</a> ";
}
}
...
echo "&nbsp;&nbsp;<a href='vernots.php?p=".$pags."&amp;iddep=$iddep' target='_self' class=fonte><b>&Uacute;LTIMA P&Aacute;GINA</b></a> ";
?></td>
        </tr>
    </table>
      <table width="856" border="0" align="center" cellpadding="0" cellspacing="0">
