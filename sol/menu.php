  ...
  <tr>
    ...
    <td width="35%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
     <FORM style="MARGIN: 0px" name="form_busca" action="buscanormal.php" 
                  method=post> <tr>
        <td width="37%"><input name="textfield" type="text" id="textfield" size="30" /></td>
        <td width="63%"><input type="image" src="imagens/buscar.png" name="button" id="button" value="BUSCAR" /></td>
      </tr></FORM>
    </table></td>
  </tr>
</table>
