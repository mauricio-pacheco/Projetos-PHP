        ...
        <td width="78%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td width="97%" class="manchete_texto9m">&nbsp;<strong><em><strong><em><span class="manchete_textoalto"><i><strong>
              Imoveis para Locação</strong></i></span></em></strong></em></strong></td>
          </tr>
        </table>
...
$sql_select = "SELECT * FROM cw_produtos WHERE tipo='Locação' ORDER BY id DESC LIMIT $inicio, $qnt";
...
$sql_select_all = "SELECT * FROM cw_produtos WHERE tipo='Locação'";
