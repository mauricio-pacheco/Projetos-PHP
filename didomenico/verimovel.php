...
while($y = mysql_fetch_array($sql))
   ...
   ?>
          ...
          <tr>
            ...
            <td width="97%" class="manchete_texto9m">&nbsp;<strong><em><b><?php echo $y["nome"]; ?></b></em></strong></td>
          </tr>
        </table>
                  ...
                  <td align="left" class="manchete_texto9"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <table width="99%" border="0" align="right" cellpadding="0" cellspacing="0">
					 ...
					 if ($branca == $testeb)
					 {
					  					  ?>
                          <?php } else { ?>
                          <img src="administrador/ups/produtos/<?php echo $y["foto"]; ?>" />
                          <?php } ?></td>
                        <td width="83%" valign="top"><?php
include "administrador/conexao.php";
...
?></td>
                ...
                <tr>
                  <td align="left" class="manchete_texto"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td><span class="manchete_textoalto"><i>
                        <strong>
                        <?php 	
...
<?php if ($y["tipo"]=='Venda') { ?><font color="#EC1D25"><?php } else { ?><font color="#0364FF"><?php } ?><?php echo $y["tipo"]; ?></font></td>
                      </tr>
                    </table>
                     <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                    ...
                    <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td><?php if ($y["valor"]=='') { } else { ?>
                          Valor: <font color="#009900">R$</font> <?php echo $y["valor"]; ?>
                          <?php } ?></td>
                      </tr>
                  </table>
                    <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td><?php if ($y["valorpx"]=='' and $y["valorp"]=='') { } else { ?>
                          ou em <?php echo $y["valorpx"]; ?> X de <font color="#009900">R$</font> <?php echo $y["valorp"]; ?>
                          <?php } ?></td>
                      </tr>
                    </table>
                    <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td><?php if ($y["valor"]!='' and $y["valorpx"]!='' and $y["valorp"]!='') { } else { ?>
                ...
                <tr>
                  <td align="left" width="14%"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td><div align="justify"><span class="manchete_texto">
                        <?php
...
return false
		...
		return true;
                    ...
                    <form action="emailproduto.php" method="post" name="cadastro" id="cadastro" onSubmit="return validar(this)">
                      <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td><strong>MAIS INFORMAÇÕES SOBRE O IMÓVEL:</strong></td>
                        </tr>
                      </table>
                      <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                      ...
                      <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td><span class="fontetabela">Nome:
                            <input name="nome" type="text" class="manchete_texto9" id="nome" style="width:330px"  />
                          *</span></td>
                        </tr>
                      </table>
                      <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                      ...
                      <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td><span class="fontetabela">Telefone:
                            <input name="fone" type="text" class="manchete_texto9" id="fone" style="width:150px" />
                          *</span></td>
                        </tr>
                      </table>
                      <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                      ...
                      <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td><span class="fontetabela">E-mail:
                            <input name="email2" type="text" class="manchete_texto9" id="email" style="width:300px" />
                          *</span></td>
                        </tr>
                      </table>
                      <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                      ...
                      <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td><span class="fontetabela">Digite abaixo as informações que deseja sobre o imóvel:</span></td>
                        </tr>
                      </table>
                      <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                      ...
                      <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td><span class="fontetabela">
                            <textarea name="descricao" cols="60" rows="10" class="manchete_texto9" id="descricao"></textarea>
                          </span></td>
                        </tr>
                      </table>
                      <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                      ...
                      <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          <td><span class="fontetabela">
                            <input name="button2" type="submit" value="ENVIAR DADOS" class="manchete_texto9" id="button2"  />
