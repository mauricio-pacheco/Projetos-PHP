...
?>
              <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#026DA2" style="margin-bottom:4px">
                <tr>
                  <td height="24" bordercolor="#A7D2EF" bgcolor="#F9F9F9"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td width="92%" class="manchete_texto9">&nbsp;<a class="manchete_texto9" href="sessao.php?iddep=<?php echo $y["id"]; ?>"><b><?php echo strtoupper($y["nome"]); ?></b></a></td>
                    </tr>
                  </table></td>
                </tr>
              </table>
