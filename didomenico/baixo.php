<table width="980" height="30" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="491" class="manchete_textocasab">&copy; Di Domenico - Corretor de Im&oacute;veis. Frederico Westphalen/RS. Todos os direitos reservados.</td>
    <td width="326" align="center"><span class="manchete_textocasab"><span class="manchete_texto989">
      <?php
