        ...
        <td width="78%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td width="97%" class="manchete_texto9m">&nbsp;<strong><em><strong><em><span class="manchete_textoalto"><i><strong>
              Imoveis para Venda</strong></i></span></em></strong></em></strong></td>
          </tr>
        </table>
...
$sql_select = "SELECT * FROM cw_produtos WHERE tipo='Venda' ORDER BY id DESC LIMIT $inicio, $qnt";
...
?>
                    <table border="0" class="boxSombra">
                      <tr>
                        <td align="center"><a 
                        href="verimovel.php?id=<?php echo $id.""; ?>"><img 
...
$sql_select_all = "SELECT * FROM cw_produtos WHERE tipo='Venda'";
...
echo "<a href='vendas.php?p=1' target='_self' class=manchete_texto9><b>PRIMEIRA PÁGINA</b></a>&nbsp;&nbsp; ";
...
echo "| <a href='vendas.php?p=".$i."' target='_self' class=manchete_texto9>".$i."</a> ";
}
}
...
echo "&nbsp;&nbsp;<a href='vendas.php?p=".$pags."' target='_self' class=manchete_texto9><b>ÚLTIMA PÁGINA</b></a> ";
