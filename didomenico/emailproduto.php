      ...
      <tr>
        ...
        <td width="78%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td width="97%" class="manchete_texto9m">&nbsp;<strong><em>Informações</em></strong></td>
          </tr>
        </table>
...
$texto =  "<font face=tahoma size=2>$nome, acabou de enviar uma mensagem via Informa&ccedil;&otilde;es do Im&oacute;vel do site Di Domenico Im&oacute;veis:\n\n\n<br><br>"; 
$texto .= "Im&oacute;vel Escolhido: <b>$produto</b>\n\n<br><br>"; 
$texto .= "Nome: $nome\n\n<br><br>";  
$texto .= "Fone: $fone\n\n<br><br>"; 
$texto .= "E-mail: $email2\n\n<br><br>";  
$texto .= "Informa&ccedil;&atilde;o: $descricao\n\n<br><br>"; 
$texto .= "Link do Im&oacute;vel no Site:\n\n<br>"; 
$texto .= "<a href=http://www.casadaweb.net/didomenico/verimovel.php?id=$id>http://www.casadaweb.net/didomenico/verimovel.php?id=$id</a>\n\n<br></font>"; 


	
$mensagem = $texto;
$assunto = utf8_decode("INFORMAÇÃO DO IMÓVEL DO SITE DI DOMENICO IMÓVEIS");
$remetente = "$nome<$email2>";
$destinatario = "claudiodidomenico@brturbo.com.br";
...
$mail -> Host = "mail.casadaweb.net"; //SERVIDOR SMTP
$mail -> Port = "25";
$mail -> SMTPAuth = true; // 'true' Para Autentica&ccedil;&atilde;o SMTP
$mail -> Username - "comercial@casadaweb.net"; // Usu&aacute;rio para autenticar
$mail -> Password = "m85022525"; // Senha usada 
$mail -> From = "comercial@casadaweb.net"; // Colocar Email para que a aut. n&atilde;o barre o a mensagem
$mail -> Fromname = "From: $nome<$e_mail> \n";
$mail -> AddAddress("claudiodidomenico@brturbo.com.br");
