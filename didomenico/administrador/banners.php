        ...
        <td width="76%" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <table width="100%" border="0" align="center">
            <tr>
              <td width="11%" height="30" bgcolor="#076CA0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="98%">&nbsp;&nbsp;<font color="#FFFFFF" class="fontetabela2"><b>CADASTRAR BANNER AFILIADOS</b></font></td>
                </tr>
              </table></td>
            </tr>
          </table>
          ...
          <tr>
            <td><table width="100%" border="0" align="center">
              <tr>
                <td>
                  <form action="cadbanner.php" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return validar(this)">
                    <table width="100%" border="0" align="center">
                      <tr>
                        <td class="manchete_texto" align="left">Dados do Banner:</td>
                      </tr>
                      <tr>
                        <td class="manchete_texto" align="left"><textarea name="banner" cols="90" rows="8" class="manchete_texto" id="textarea"></textarea></td>
                      </tr>
                      <tr>
                        <td class="manchete_texto" align="left"><span style="MARGIN: 0px">
                          <input name="submit" class="fontetabela" type="submit" style="FONT-SIZE: 10px" value="CADASTRAR BANNER" />
                        </span></td>
                      </tr>
                    </table>
                  </form></td>
