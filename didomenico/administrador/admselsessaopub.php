          ...
          <table width="100%" border="0" align="center">
            <tr>
              <td width="11%" height="30" bgcolor="#076CA0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="98%">&nbsp;&nbsp;<font color="#FFFFFF" class="fontetabela2"><b>ADMINSITRAR PUBLICAÇÃO - SELECIONE A SUB-SESSÃO</b></font></td>
                </tr>
              </table></td>
            </tr>
          </table>
                  ...
                  <table width="100%" border="0" align="center">
                    <tr>
                      ...
                      <td align="left" width="98%" valign="top"><font color="#000000"><?php echo $subsessao.""; ?><br />
                        <a href="admpublicacao.php?idsessao=<?php echo $idsessao.""; ?>&amp;idsubsessao=<?php echo $id.""; ?>" class="manchete_texto4"><b>SELECIONAR SUB-SESSÃO</b></a></td>
                    </tr>
                  </table>
                  <div align="center">
				  <?php
...
$sql_select_all = "SELECT * FROM cw_subsessoes WHERE idsessao='$idsessaonovo'";
...
echo "<a href='selsessaopub.php?p=1&amp;id=$idsessaonovo' target='_self' class=manchete_texto><b>PRIMEIRA P&Aacute;GINA</b></a>&nbsp;&nbsp;";
...
echo " <a href='selsessaopub.php?p=".$i."&amp;id=$idsessaonovo' target='_self' class=manchete_texto>".$i."</a> |";
}
}
...
echo "&nbsp;&nbsp;<a href='selsessaopub.php?p=".$pags."&amp;id=$idsessaonovo' target='_self' class=manchete_texto><b>&Uacute;LTIMA P&Aacute;GINA</b></a> ";
?></div></td>
              </tr>
            </table></td>
          </tr>
