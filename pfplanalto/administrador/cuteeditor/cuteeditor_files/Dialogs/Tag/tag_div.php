						...
						<table cellpadding="0" cellspacing="0" style="padding-bottom:10">
							<tr>
								<td><?php echo GetString("BorderColor") ; ?>:<br />
									...
									<img alt="" id="bordercolor_Preview" src="../Images/colorpicker.gif" style="margin-bottom:-2px"/>
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td><?php echo GetString("Shade") ; ?>:<br />
								    ...
								    <img alt="" id="inp_shade_Preview" src="../Images/colorpicker.gif" style="margin-bottom:-2px"/>
								</td>
							</tr>
						</table>
					</td>
