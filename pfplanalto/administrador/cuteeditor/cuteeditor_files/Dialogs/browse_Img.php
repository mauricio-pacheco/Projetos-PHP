...
$str_openfolderEvent="onclick=\"parent.SetUpload_FolderPath('".$current_Path.$folpath.$file."');location.href='browse_Img.php?".$setting."&loc=".$folpath.$file."&Theme=".$Theme."&GP=".$current_Path."';\"";
...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <script type="text/javascript">
      var folderpath = "browse_Img.php?<?php echo $setting ; ?>&GP=<?php echo $current_Path ; ?>&Theme=<?php echo $Theme; ?>";
      ...
      for (i=0;i<arrloc.length-2;i++) {
			...
			str="browse_Img.php?<?php echo $setting ; ?>&GP=<?php echo $current_Path ; ?>&Theme=<?php echo $Theme; ?>&loc=" + str + "&u=y";
			location.href = str;
