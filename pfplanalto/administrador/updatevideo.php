...
$sql = mysql_query("SELECT * FROM cw_videos WHERE id='$id'");
...
while($t = mysql_fetch_array($sql))
   {
$arquivoapaga = "$t[foto]";
unlink("ups/videos/$arquivoapaga");
}

$arquivo0 = isset($_FILES["foto"]) ? $_FILES["foto"] : FALSE;
$max_image_x0 = 140;
$max_image_y0 = 105;
$diretorio0 = 'ups/galeriavideo/';
if($arquivo0)
{
...
$sql = "UPDATE cw_videos SET titulo = '$titulo', video = '$video', comentario = '$comentario', data = '$data', hora = '$hora', foto='$nome_foto0' WHERE id = '$id'";
if(mysql_query($sql)) {
echo "<div align=center><br><img src=imagens/ok.png></div><br><div align=center class=manchete_texto>O VIDEO FOI EDITADO COM SUCESSO!!</div>";
}else{
