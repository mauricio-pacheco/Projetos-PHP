          ...
          <table width="100%" border="0" align="center">
            <tr>
              <td width="11%" height="30" bgcolor="#076CA0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="98%">&nbsp;&nbsp;<font color="#FFFFFF" class="fontetabela2"><b>ADMINISTRAR EDIÇÕES</b></font></td>
                </tr>
              </table></td>
            </tr>
          </table>
...
$sql_select = "SELECT * FROM cw_edicoes ORDER BY id DESC LIMIT $inicio, $qnt";
// Executa o Query
...
?>
                  <table width="100%" border="0" align="center">
                    <tr>
                      <td width="2%"><img src="ups/capasedicoes/<?php echo $foto.""; ?>" /></td>
                      <td align="left" width="98%" valign="top"><font color="#000000"><?php echo $edicao.""; ?><br />                        
                        <a href="enviajornal.php?id=<?php echo $id.""; ?>&amp;pasta=<?php echo $pasta.""; ?>" class="manchete_texto4"><b>CADASTRAR JORNAL DIGITAL</b></a> - <a href="deledicao.php?id=<?php echo $id.""; ?>&amp;pasta=<?php echo $pasta.""; ?>&amp;foto=<?php echo $foto.""; ?>" onclick="return confirm('Tem certeza que deseja apagar a edição <?php echo $edicao.""; ?> ?')" class="manchete_texto6"><b>APAGAR EDIÇÃO</b></a></td>
                    </tr>
                  </table>
                  <div align="center">
				  <?php
...
$sql_select_all = "SELECT * FROM cw_edicoes";
...
echo "<a href='admedicoes.php?p=1' target='_self' class=manchete_texto><b>PRIMEIRA P&Aacute;GINA</b></a>&nbsp;&nbsp; ";
...
echo "| <a href='admedicoes.php?p=".$i."' target='_self' class=manchete_texto>".$i."</a> ";
}
}
...
echo "&nbsp;&nbsp;<a href='admedicoes.php?p=".$pags."' target='_self' class=manchete_texto><b>&Uacute;LTIMA P&Aacute;GINA</b></a> ";
?></div></td>
              </tr>
            </table></td>
          </tr>
