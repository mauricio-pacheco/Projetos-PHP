...
return false
                                ...
                                <form action="cadpublicacao.php" method="post" name="form1" enctype="multipart/form-data" onSubmit="return validar(this)"><table width="100%" border="0" align="center">
             <tr>
             ...
             <tr>
               <td class="manchete_texto" align="left">&nbsp;Arquivo da Publicação:<span class="style15">
                 ...
                 <span class="fonteadm">
                 <input name="idsessao" type="hidden" value="<?php echo $idsessao; ?>" />
                 <input name="idsubsessao" type="hidden" value="<?php echo $idsubsessao; ?>" />
                 </span></span></td>
             </tr>
             <tr>
               <td align="left"><p style="MARGIN: 0px"> <span class="manchete_texto">
                 <input name="submit" type="submit" style="FONT-SIZE: 10px" value="CADASTRAR PUBLICAÇÃO" />
                 </span></p></td>
             </tr>
           </table></form></td>
          </tr>
