          ...
          <table width="100%" border="0" align="center">
            <tr>
              <td width="11%" height="30" bgcolor="#076CA0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="98%">&nbsp;&nbsp;<font color="#FFFFFF" class="fontetabela2"><b>APAGAR ENQUETE</b></font></td>
                </tr>
              </table></td>
            </tr>
          </table>
...
$sql = "DELETE FROM cw_enquetes WHERE id='$id'";

if(mysql_query($sql)) {
echo "<div align=center><br><img src=imagens/ok.png></div><div align=center class=fontetabela><br>A ENQUETE FOI APAGADA COM SUCESSO!!</div>";
echo "<script>alert('ENQUETE APAGADA COM SUCESSO!')</script>";
echo "<script>location.href='admenquetes.php'</script>";
}else{
echo "<div align=center><br><font color='#000000' >NÃO FOI POSSÍVEL APAGAR!</font></div>";
}

$sql = "DELETE FROM cw_enquetes WHERE id='$id'";
unlink("ups/fotosenquetes/$foto1");
unlink("ups/fotosenquetes/$foto2");
unlink("ups/fotosenquetes/$foto3");
unlink("ups/fotosenquetes/$foto4");
unlink("ups/fotosenquetes/$foto5");
unlink("ups/fotosenquetes/$foto6");
unlink("ups/fotosenquetes/$foto7");
unlink("ups/fotosenquetes/$foto8");
unlink("ups/fotosenquetes/$foto9");
unlink("ups/fotosenquetes/$foto10");
