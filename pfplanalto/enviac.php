...
$texto .=  "$nome, acabou de enviar uma mensagem pelo site Jari Planalto:\n\n\n<br><br>"; 
$texto .= "Nome: $nome\n\n<br><br>"; 
$texto .= "Cidade: $cidade\n\n<br><br>";  
$texto .= "Estado: $estado\n\n<br><br>";  
...
$mensagem = $texto;
$assunto = "CONTATO DO SITE JARI PLANALTO";
	
$assunto = "CONTATO DO SITE JARI PLANALTO";
$remetente = "$nome<$email2>";
$destinatario = "contato@planalto.rs.gov.br";
...
$mail -> Host = "mail.planalto.rs.gov.br"; //SERVIDOR SMTP
$mail -> Port = "25";
$mail -> SMTPAuth = true; // 'true' Para Autentica&ccedil;&atilde;o SMTP
$mail -> Username - "webmaster@planalto.rs.gov.br"; // Usu&aacute;rio para autenticar
$mail -> Password = "pl2012"; // Senha usada 
$mail -> From = "webmaster@planalto.rs.gov.br"; // Colocar Email para que a aut. n&atilde;o barre o a mensagem
$mail -> Fromname = "From: $nome<$e_mail> \n";
$mail -> AddAddress("contato@planalto.rs.gov.br");
