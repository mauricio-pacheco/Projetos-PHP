...
<table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="98%"><?php include("menu.php"); ?></td>
        ...
        <td width="723" valign="top" bgcolor="#FFFFFF"><table width="99%" align="center" border="0" cellspacing="0" cellpadding="0">
          <tr>
...
while($y = mysql_fetch_array($sql))
   ...
   ?>
          ...
          <tr>
            <td class="manchete_texto"><strong><em><b><?php echo $y["nome"]; ?></b></em></strong></td>
          </tr>
        </table>
...
?></td>
                ...
                <tr>
                  <td align="left" class="manchete_texto"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td><span class="manchete_textoalto"><i> <strong>
                        <?php 	
...
return false
		...
		return true;
          ...
          <td width="7" bgcolor="#F0F0F0"><img src="imagens/branco.gif" width="6" height="1" /></td>
