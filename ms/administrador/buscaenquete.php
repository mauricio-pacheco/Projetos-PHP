        ...
        <td width="76%" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <table width="100%" border="0" align="center">
            <tr>
              <td width="11%" height="30" bgcolor="#076CA0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="98%">&nbsp;&nbsp;<font color="#FFFFFF" class="fontetabela2"><b>ADMINISTRAR ENQUETES</b></font></td>
                </tr>
              </table></td>
            </tr>
          </table>
          ...
          <tr>
            <td><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td><form action="buscaenquete.php" method="post" name="formbusca" id="formbusca">
                  <label><span class="manchete_texto"><strong>Pesquisar Enquete:</strong></span>
                    <input name="palavra" type="text" value="Digite o Título da Enquete" onclick="this.value=''" class="manchete_texto" id="palavra" size="96" />
                  </label>
...
$sql_select = "SELECT * FROM cw_enquetes WHERE pergunta LIKE '%".$palavra."%' ORDER BY id DESC LIMIT $inicio, $qnt";
// Executa o Query
...
?>
                      <table width="100%" border="0" align="center">
                        <tr>
                          <td width="2%"><img src="imagens/pergunta.png" /></td>
                          <td align="left" width="98%">&nbsp;<span class="fonteadm"><font color="#000000"><?php echo $pergunta.""; ?></span> &nbsp; <a href="edienquete.php?id=<?php echo $id.""; ?>"  class="manchete_texto4"><b>EDITAR ENQUETE</b></a> - <a href="delenquete.php?id=<?php echo $id.""; ?>" onclick="return confirm('Tem certeza que deseja apagar a enquete <?php echo $titulo.""; ?> ?')" class="manchete_texto6"><b>APAGAR ENQUETE</b></a></td>
                        </tr>
                      </table>
                      <div align="center"><br />
                        <?php
...
$sql_select_all = "SELECT * FROM cw_enquetes WHERE pergunta LIKE '%".$palavra."%'";
...
echo "<a href='buscaenquete.php?p=1' target='_self' class=manchete_texto><b>PRIMEIRA P&Aacute;GINA</b></a>&nbsp;&nbsp;";
...
echo "| <a href='buscaenquete.php?p=".$i."' target='_self' class=manchete_texto>".$i."</a> ";
}
}
...
echo "&nbsp;&nbsp;<a href='buscaenquete.php?p=".$pags."' target='_self' class=manchete_texto><b>&Uacute;LTIMA P&Aacute;GINA</b></a> ";
?>
                      </div></td>
                  </tr>
                </table></td>
