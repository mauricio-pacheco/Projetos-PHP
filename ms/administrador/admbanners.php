          ...
          <table width="100%" border="0" align="center">
            <tr>
              <td width="11%" height="30" bgcolor="#076CA0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="98%">&nbsp;&nbsp;<font color="#FFFFFF" class="fontetabela2"><b>ADMINISTRAR BANNERS DE AFILIADOS</b></font></td>
                </tr>
              </table></td>
            </tr>
          </table>
...
$sql_select = "SELECT * FROM banner LIMIT $inicio, $qnt";
// Executa o Query
...
?>
                  <table width="100%" border="0" align="center">
                    <tr>
                      <td align="left" width="98%" valign="top"><?php echo $banner.""; ?><br />
                        <a href="edibanner.php?id=<?php echo $id.""; ?>" class="manchete_texto4"><b>EDITAR BANNER</b></a> - <a href="delbanner.php?id=<?php echo $id.""; ?>" onclick="return confirm('Tem certeza que deseja apagar o banner <?php echo $nome.""; ?> ?')" class="manchete_texto6"><b>APAGAR BANNER</b></a></td>
                    </tr>
                  </table>
                  <div align="center">
				  <?php
...
$sql_select_all = "SELECT * FROM banner";
...
echo "<a href='admbanners.php?p=1' target='_self' class=manchete_texto><b>PRIMEIRA P&Aacute;GINA</b></a>&nbsp;&nbsp;";
...
echo "&nbsp;&nbsp;<a href='admbanners.php?p=".$pags."' target='_self' class=manchete_texto><b>&Uacute;LTIMA P&Aacute;GINA</b></a> ";
?></div></td>
              </tr>
            </table></td>
          </tr>
