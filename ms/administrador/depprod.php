          ...
          <table width="100%" border="0" align="center">
            <tr>
              <td width="11%" height="30" bgcolor="#076CA0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="98%">&nbsp;&nbsp;<font color="#FFFFFF" class="fontetabela2"><b>CADASTRAR DEPARTAMENTO DOS PRODUTOS</b></font></td>
                </tr>
              </table></td>
            </tr>
          </table>
...
alert("O Campo Departamento não está preenchido!")
form1.nome.focus();
return false
}
                  ...
                  <form action="caddepprod.php" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return validar(this)">
                    <table width="100%" border="0" align="center">
                      <tr>
