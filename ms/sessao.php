...
$iddep = $_GET["iddep"];
   ...
   { echo $z["nome"];  }
	...
	?></strong></i></em></strong></em></strong></td>
          </tr>
        </table>
...
echo "<a href='sessao.php?p=1&amp;iddep=$iddep' target='_self' class=manchete_texto9><b>PRIMEIRA PÁGINA</b></a>&nbsp;&nbsp; ";
...
echo "| <a href='produto.php?p=".$i."&amp;iddep=$iddep' target='_self' class=manchete_texto9>".$i."</a> ";
}
}
...
echo "&nbsp;&nbsp;<a href='produto.php?p=".$pags."&amp;iddep=$iddep' target='_self' class=manchete_texto9><b>ÚLTIMA PÁGINA</b></a> ";
