...
<table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="98%"><?php include("menu.php"); ?></td>
        ...
        <td width="700" valign="top" bgcolor="#FFFFFF"><table width="99%" align="center" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td class="manchete_texto">Empresa</td>
          </tr>
        </table>
  ...
  <tr>
    <td><img src="imagens/branco.gif" width="2" height="4" /></td>
          ...
          <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td align="left" class="manchete_texto"> <br />A mais de 4 anos no mercado, com atualmnete com 5 colcabores, empresa seria, com profisionais qualificados, assistencia tecnica especializada, em toda linhade impressoras, computadores, notebooks.... produtos com maxima qualidade, todos com garantia. aguardamos seu contato.</td>
            </tr>
          </table>
          <table width="99%" align="center" border="0" cellspacing="0" cellpadding="0">
            <tr>
