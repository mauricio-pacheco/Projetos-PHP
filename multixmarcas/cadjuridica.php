        ...
        <td valign="top"><table width="992" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="761" valign="top"><table height="30" background="imagens/funtotabelamaior.png" bgcolor="#535353" width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td class="fontetabela5" align="right"><strong>Cadastro Pessoa Jurídica</strong>&nbsp;&nbsp;</td>
              </tr>
            </table>
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
...
loadXMLDoc("cidades.php?ID="+valor);
                        ...
                        <form action="cadcliente2.php" method="post" enctype="multipart/form-data" name="cadastro" onsubmit="return validar(this)">
                          <table width="100%" border="0" align="center" class="manchete_texto9">
                            <tr>
                              <td width="18%"><b>Usuário:</b></td>
                              <td width="82%"><input name="usuario" class="manchete_texto96" size="30" />
                            ...
                            <tr>
                              ...
                              <td>&nbsp;</td>
                                                       ...
                                                       <tr>
                                                         <td>Nome P/ Contato:</td>
                                                         <td><input name="cliente" class="manchete_texto96" size="56" />
*</td>
                                                       </tr>
                                                       <tr>
                              <td>Raz&atilde;o Social:</td>
                              <td><input name="razaosocial" class="manchete_texto96" size="70" />
                                *</td>
                            </tr>
                             <tr>
                              <td>E-mail:</td>
                            ...
                            <tr>
                              <td>Nome Fantasia:</td>
                              <td><input name="nomefantasia" class="manchete_texto96" size="70" />
                                *</td>
                            </tr>
                            <tr>
		  ...
		  ?>
                            ...
                            <tr>
                              <td>CEP:</td>
                              <td><input name="cep" class="manchete_texto96" onkeypress="Mascara('cep', window.event.keyCode, 'document.cadastro.cep');" size="14" maxlength="9"/>
                                *</td>
                            </tr>
                            <tr>
                              <td>CNPJ:</td>
                            ...
                            <tr>
                              <td>Insc. Est:</td>
                              <td><input name="ie" class="manchete_texto96" size="32" /></td>
                            </tr>
                            <tr>
                              <td>Telefone:</td>
