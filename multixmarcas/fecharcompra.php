...
return false
		...
		return true;
			  ...
			  $valortransporte = $_GET['prazotransporte'];
	  ...
	  if($valorcompra>150 and $formaenvio=='PAC') {
		  $valorfrete = 0;
	  } else {
	
	  }
			  
			  $valortotalc = $valorcompra;
              ...
              while($y = mysql_fetch_array($sql))
   {
             ...
             <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td align="center"><img src="imagens/b2.png" width="752" height="39" /></td>
                    </tr>
                  </table>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
  ...
  ?>
                ...
                <tr>
                  ...
                  <td align="center" class="manchete_texto9"><div align="center" class="manchete_texto9"> R$ <?php echo $valorfrete;
	  ?></div></td>
                  </tr>
                <tr>
                ...
                <tr>
                  <td><div align="right" class="manchete_texto9"><strong>PRAZO DO TRANSPORTE:</strong>&nbsp; </div></td>
                  <td align="center" class="manchete_texto9"><div align="center" class="manchete_texto9"> <?php echo $valortransporte; ?> dia(s)</div></td>
                  </tr>
                  
                  <tr>
                  <td><div align="right" class="manchete_texto9"><strong>PRAZO DE PRODUÇÃO:</strong>&nbsp; </div></td>
                  <td align="center" class="manchete_texto9"><div align="center" class="manchete_texto9"> 3 dia(s)</div></td>
                  </tr>
                  
                <tr>
                  <td><div align="right" class="manchete_texto9"><strong>PRAZO TOTAL DE ENTREGA:</strong>&nbsp; </div></td>
                ...
                <tr>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td align="center"><img src="imagens/branco.gif" width="1" height="4" /></td>
                      </tr>
                      <tr>
