...
while($y = mysql_fetch_array($sql))
   {
?>
          <a href="arquivos.php"><a class="manchete_texto9m" href="arquivos.php?idcliente=<?php echo $y["id"]; ?>&amp;usuario=<?php echo $y["usuario"]; ?>&amp;cliente=<?php echo $y["cliente"]; ?>"><img src="imagens/botaoanexar.png" border="0" /></a>
          <?php }  ?>
          </td>
        </tr>
    </table>
