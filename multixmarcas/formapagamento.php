        ...
        <td valign="top"><table width="992" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="761" valign="top"><table height="30" background="imagens/funtotabelamaior.png" bgcolor="#535353" width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td align="center"><img src="imagens/b4.png" width="752" height="39" /></td>
                    </tr>
                  </table>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
...
$sql2 = "INSERT INTO cw_produtoscomprados (carrinho, produto, preco, qtd, idcliente, peso, cod, data, hora) VALUES ('$carrinhoc', '$produtoc', '$precoc', '$qtdc', '$idcliente', '$pesoc', '$codc', '$data', '$hora')";
mysql_query($sql2);
...
action="https://pagseguro.uol.com.br/checkout/checkout.jhtml" target="_blank">
  <input type="hidden" name="email_cobranca"
  value="atendimento@multixshop.com.br" />
