...
$prossiga = '<a href=fecharcompra.php><img border=0 src=imagens/prossegue.png /></a>';
} else {
 ...
 <tr>
  ...
  <tr>
      ...
      <tr>
        ...
        <td align="center" class="manchete_texto9"><div align="center" class="manchete_texto9">
      <?php echo $nome_servico; ?></div></td>
        <td>&nbsp;</td>
      </tr>
      
      
      <tr>
        <td colspan="3"><div align="right" class="manchete_texto9"><strong>PRAZO DE ENTREGA:</strong>&nbsp; </div></td>
        <td align="center" class="manchete_texto9"><div align="center" class="manchete_texto9">
...
?>&nbsp;Kg</td>
     ...
     <tr>
      ...
      <div align="right"></div></td>
      <td><div align="center" class="manchete_texto9">
      <b>R$</b> <b><?=  $somatorio = $soma_carrinho + $total;    number_format($somatorio,2,",","."); ?></b></div></td>
      <td>&nbsp;</td>
    </tr>
    ...
    <td><img src="imagens/branco.gif" width="1" height="8" /></td>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <input type="text" class="manchete_texto9" name="cep" onkeypress="Mascara('cep', window.event.keyCode, 'document.cadastro.cep');" size="14" maxlength="9"/>
          </strong>Formato Ex: (98400-000) </td>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="65%">&nbsp;</td>
          <td width="33%"><?php echo $prossiga; ?></td>
          <td width="2%">&nbsp;</td>
        </tr>
      </table>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
