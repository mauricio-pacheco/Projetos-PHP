...
echo "<a href='sessoes.php?p=1&amp;idsub=$idsub&iddep=$iddep' target='_self' class=manchete_texto96>PRIMEIRA PÁGINA</a>&nbsp;&nbsp; ";
...
echo "| <a href='sessoes.php?p=".$i."&amp;idsub=$idsub&iddep=$iddep' target='_self' class=manchete_texto96>".$i."</a> ";
}
}
...
echo "&nbsp;&nbsp;<a href='sessoes.php?p=".$pags."&amp;idsub=$idsub&iddep=$iddep' target='_self' class=manchete_texto96>ÚLTIMA PÁGINA</a> ";
