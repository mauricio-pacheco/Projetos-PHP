...
while($y = mysql_fetch_array($sql))
   {
   ?>
                <strong><?php echo $y["nome"]; ?></strong>&nbsp;&nbsp;</td>
              </tr>
            </table>
                  ...
                  <td valign="top"><table width="100%" border="0" align="center" class="manchete_texto9">
                    ...
                    <tr>
					 ...
					 if ($branca == $testeb)
					 {
					  					  ?>
                              <?php } else { ?>
                              <img src="administrador/ups/produtos/<?php echo $y["foto"]; ?>" width="300" height="225"/>
                              <?php } ?></td>
   ...
   { echo $z["nomesub"];  }
	...
	?>
                        ...
                        <td><img src="imagens/branco.gif" width="1" height="2" /></td>
                           ...
                           <tr>
                        <td><a 
                        href="carrinho.php?cod=<?php echo $y["id"]; ?>&amp;acao=incluir"><img alt="Adicionar <?php echo $y["nome"]; ?> ao carrinho de compras" title="Adicionar <?php echo $y["nome"]; ?> ao carrinho de compras" src="imagens/carrote.jpg" border="0" /></a></td>
                      </tr>
                      <tr>
                        <td><img src="imagens/branco.gif" width="1" height="2" /></td>
                      </tr>
		...
		return true;
                        ...
                        <form action="emailproduto.php" method="post" name="cadastro" id="cadastro" onsubmit="return validar(this)">
                          ...
                          <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                              <td><span class="manchete_texto96">Nome:
                                <input name="nome" type="text" class="manchete_texto96" id="nome" style="width:330px"  />
                                *</span></td>
                            </tr>
                          </table>
                          <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                          ...
                          <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                              <td><span class="manchete_texto96">E-mail:
                                <input name="email2" type="text" class="manchete_texto96" id="email" style="width:300px" />
                                *</span></td>
                            </tr>
                          </table>
                          <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                          ...
                          <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                              <td><span class="manchete_texto96">
                                <textarea name="descricao" cols="60" rows="10" class="manchete_texto96" id="descricao"></textarea>
                              </span></td>
                            </tr>
                          </table>
                          <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                          ...
                          <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                              <td><span class="manchete_texto96">
                                <input name="button2" type="submit" value="ENVIAR DADOS" class="manchete_texto96" id="button2"  />
