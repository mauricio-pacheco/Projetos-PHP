          ...
          <table width="100%" border="0" align="center">
            <tr>
              <td width="11%" height="30" bgcolor="#076CA0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="98%">&nbsp;&nbsp;<font color="#FFFFFF" class="fontetabela2"><b>ADMINISTRAR SUB-SESSÕES - SELECIONE A SESSÃO</b></font></td>
                </tr>
              </table></td>
            </tr>
          </table>
                  ...
                  <table width="100%" border="0" align="center">
                    <tr>
                      ...
                      <td align="left" width="98%" valign="top"><font color="#000000"><?php echo $nome.""; ?><br />
                        <a href="selsessao.php?id=<?php echo $id.""; ?>" class="manchete_texto4"><b>SELECIONAR SESSÃO</b></a></td>
                    </tr>
                  </table>
                  <div align="center">
				  <?php
...
echo "<a href='admsubsessoes.php?p=1' target='_self' class=manchete_texto><b>PRIMEIRA P&Aacute;GINA</b></a>&nbsp;&nbsp;";
...
echo "| <a href='admsubsessoes.php?p=".$i."' target='_self' class=manchete_texto>".$i."</a> ";
}
}
...
echo "&nbsp;&nbsp;<a href='admsubsessoes.php?p=".$pags."' target='_self' class=manchete_texto><b>&Uacute;LTIMA P&Aacute;GINA</b></a> ";
?></div></td>
              </tr>
            </table></td>
          </tr>
