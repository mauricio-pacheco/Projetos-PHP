          ...
          <table width="100%" border="0" align="center">
            <tr>
              <td width="11%" height="30" bgcolor="#076CA0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="98%">&nbsp;&nbsp;<font color="#FFFFFF" class="fontetabela2"><b>EDITAR SESSÃO</b></font></td>
                </tr>
              </table></td>
            </tr>
          </table>
...
return false
                  ...
                  <form action="updatesessao.php" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return validar(this)">
                    <?php

include "conexao.php";

$id = $_GET['id'];
$sql = mysql_query("SELECT * FROM cw_sessoes WHERE id='$id' ORDER BY id");
$contar = mysql_num_rows($sql); 

if ($contar < 1)  
   {echo "<div align=center><b>N&Atilde;O EXISTE MENU CADASTRADO!</b></div>"; 
   }
else 
   {
while($n = mysql_fetch_array($sql))
   ...
   ?>
                    <table width="100%" border="0" align="center">
                      <tr>
                        <td class="manchete_texto" align="left">T&iacute;tulo da Sessão: <span class="style15">
                          <input name="nome" type="text"  value="<?php echo $n["nome"]; ?>" class="fontetabela" size="60" />
                      ...
                      <tr>
                        <td class="manchete_texto" align="left"><span style="MARGIN: 0px">
                          <input name="submit" class="fontetabela" type="submit" style="FONT-SIZE: 10px" value="EDITAR SESSÃO" />
                        </span></td>
                      </tr>
                    </table>
