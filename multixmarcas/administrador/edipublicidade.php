          ...
          <table width="100%" border="0" align="center">
            <tr>
              <td width="11%" height="30" bgcolor="#076CA0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="98%">&nbsp;&nbsp;<font color="#FFFFFF" class="fontetabela2"><b>EDITAR BANNER</b></font></td>
                </tr>
              </table></td>
            </tr>
          </table>
                    ...
                    <table width="99%" border="0" align="center">
                      <tr>
                        ...
                        <?php if ($n["local"]=='cabecalho') { echo 'checked=checked'; } else { }?> />
                          Cabeçalho ( <em>992 px de largura X 300 px de altura</em> )
<span class="style15"><span class="rodape">
...
Imagem ( .gif, .jpg e .png )</td>
                      ...
                      <tr>
                        <td class="manchete_texto" align="left"><?php
						  if ($n["tipo"]=='imagem') {
						  						  ?>
                          <img src="ups/publicidades/<?php echo $n["arquivo"]; ?>" width="500" height="150" />
                          <?php
						  } else {
						  ?>
...
//-->
                      ...
                      <tr>
                        <td class="manchete_texto" align="left">Arquivo do Banner:
...
<input type="hidden" name="arquivo" value="<?php echo $n["arquivo"]; ?>" /></td>
                      ...
                      <tr>
                        <td class="manchete_texto" align="left">Descri&ccedil;&atilde;o do Banner:</td>
                      </tr>
                      <tr>
