          ...
          <table width="100%" border="0" align="center">
            <tr>
              <td width="11%" height="30" bgcolor="#076CA0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="98%">&nbsp;&nbsp;<font color="#FFFFFF" class="fontetabela2"><b>ADMINISTRAR SESSÕES</b></font></td>
                </tr>
              </table></td>
            </tr>
          </table>
...
$sql_select = "SELECT * FROM cw_sessoes ORDER BY id ASC LIMIT $inicio, $qnt";
// Executa o Query
...
?>
                  <table width="100%" border="0" align="center">
                    <tr>
                      <td width="2%"><img src="imagens/sessao.png" /></td>
                      <td align="left" width="98%" valign="top"><font color="#000000"><?php echo $nome.""; ?><br />
                        <a href="edisessao.php?id=<?php echo $id.""; ?>" class="manchete_texto4"><b>EDITAR SESSÃO</b></a> - <a href="delsessao.php?id=<?php echo $id.""; ?>" onclick="return confirm('Tem certeza que deseja apagar a sessão <?php echo $nome.""; ?> ?')" class="manchete_texto6"><b>APAGAR SESSÃO</b></a></td>
                    </tr>
                  </table>
                  <div align="center">
				  <?php
...
$sql_select_all = "SELECT * FROM cw_sessoes";
...
echo "<a href='admsessoes.php?p=1' target='_self' class=manchete_texto><b>PRIMEIRA P&Aacute;GINA</b></a>&nbsp;&nbsp;";
...
echo "| <a href='admsessoes.php?p=".$i."' target='_self' class=manchete_texto>".$i."</a> ";
}
}
...
echo "&nbsp;&nbsp;<a href='admsessoes.php?p=".$pags."' target='_self' class=manchete_texto><b>&Uacute;LTIMA P&Aacute;GINA</b></a> ";
?></div></td>
              </tr>
            </table></td>
          </tr>
