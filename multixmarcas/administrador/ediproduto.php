...
loadXMLDoc("subdeps.php?id="+valor);
   ...
   { echo $z["nomesub"];    }
             ...
             <tr>
               <td class="manchete_texto" align="left"><span class="fontetabela">&nbsp;Gabarito:
                 <input type="file" name="arquivo" class="fontetabela" />
                 &nbsp;(caso n&atilde;o deseje editaro gabarito deixe   em branco)
                 <input type="hidden" name="arquivo" value="<?php echo $n["arquivo"]; ?>" />
                 <a href="ups/publicacoes/<?php echo $n["arquivo"]; ?>" target="_blank" class="manchete_texto"><strong>BAIXAR GABARITO</strong></a></span></td>
             </tr>
             <tr>
               <td class="manchete_texto" align="left">Peso: <span class="fontetabela">
               <input class="fontetabela" name="peso" value="<?php echo $n["peso"]; ?>" size="12" />
               </span>Kg ( Peso total do pacote em Quilos, caso seja menos de 1Kg, ex.: 300g, coloque 0.300 ) <span class="fontetabela">*</span></td>
             </tr>
             <tr>
