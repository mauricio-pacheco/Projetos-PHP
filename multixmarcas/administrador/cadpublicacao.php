...
$sql = "INSERT INTO cw_pub (titulo, idsessao, idsubsessao, data, hora, arquivo) VALUES ('$titulo', '$idsessao', '$idsubsessao', '$data', '$hora', '$arquivo_nome')";
if(mysql_query($sql)) {
echo "<div align=center><br><img src=imagens/ok.png></div><div align=center class=manchete_texto><br>A PUBLICAÇÃO FOI CADASTRADA COM SUCESSO!!</div>";
}else{
