          ...
          <table width="100%" border="0" align="center">
            <tr>
              <td width="11%" height="30" bgcolor="#076CA0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="98%">&nbsp;&nbsp;<font color="#FFFFFF" class="fontetabela2"><b>APAGAR BANNER</b></font></td>
                </tr>
              </table></td>
            </tr>
          </table>
...
$sql = "DELETE FROM cw_publicidades WHERE id='$id'";
unlink("ups/publicidades/$arquivo");
if(mysql_query($sql)) {
echo "<div align=center class=manchete_texto><br>O BANNER FOI APAGADO COM SUCESSO!!</div>";
echo "<script>alert('BANNER APAGADO COM SUCESSO!')</script>";
echo "<script>location.href='admpubs.php'</script>";
}else{
