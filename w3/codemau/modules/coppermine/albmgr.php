...
?>
        <form name="album_menu" method="post" action="<?php echo $CPG_URL;
?>&file=delete&what=albmgr" onSubmit="return CheckAlbumForm(this);">
    ...
    echo <<<EOT
        <tr>
            <td>
                ...
                <select onChange="if(this.options[this.selectedIndex].value) window.location.href='$CPG_URL&file=albmgr&cat='+this.options[this.selectedIndex].value;"  name="cat" disabled="true" class="listbox">
EOT;
...
?>
                ...
                <tr>
                                        <td><a href="javascript:Moveup_Option();"><img src="<?php echo $CPG_M_DIR;
?>/images/move_up.gif" width="26" height="21" border="0"></a><a href="javascript:Movedown_Option();"><img src="<?php echo $CPG_M_DIR;
?>/images/move_down.gif" width="26" height="21" border="0"></a>
                                        </td>
                                        ...
                                        <td align="center" style="width: 1px;"><img src="<?php echo $CPG_M_DIR;
?>/images/spacer.gif" width="1" alt=""><br>
                                        </td>
