...
$lang_translation_info = array('lang_name_english' => 'English', // the name of your language in English, e.g. 'Greek' or 'Spanish'
    ...
    'trans_name' => 'Scott Gahres', // the name of the translator - can be a nickname
    'trans_email' => 'webmaster@coppermine.findhere.org', // translator's email address (optional)
    'trans_website' => 'http://coppermine.findhere.org/', // translator's website (optional)
...
// File theme.php
// ------------------------------------------------------------------------- //
$lang_main_menu = array('alb_list_title' => 'Go to the album list',
...
$lang_user_admin_menu = array('albmgr_lnk' => 'Create / order my albums',
    'modifyalb_lnk' => 'Modify my albums',
    'my_prof_lnk' => 'My profile',
    );

$lang_cat_list = array('category' => 'Category',
    'albums' => 'Albums',
    'pictures' => 'Pictures',
    );

$lang_album_list = array('album_on_page' => '%d albums on %d page(s)'
    );
...
$lang_rate_pic = array('rate_this_pic' => 'Rate this picture ',
...
if (defined('ALBMGR_PHP')) $lang_albmgr_php = array('alb_need_name' => 'Albums need to have a name !',
        ...
        'no_category' => '* Nenhuma Categoria Cadastrada *',
        'delete' => 'Delete',
        'new' => 'New',
...
// File db_input.php
// ------------------------------------------------------------------------- //
if (defined('DB_INPUT_PHP')) $lang_db_input_php =
    array('empty_name_or_com' => 'You need to type your name and a comment',
...
if (defined('MODIFYALB_PHP')) $lang_modifyalb_php = array('upd_alb_n' => 'Update album %s',
        ...
        'no_cat' => '* Nenhuma Categoria Cadastrada *',
...
// File ratepic.php
// ------------------------------------------------------------------------- //
if (defined('RATEPIC_PHP')) $lang_rate_pic_php = array('already_rated' => 'Sorry but you have already rated this picture',
