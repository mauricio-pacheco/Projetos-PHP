...
$index = 0;
if (file_exists("$CPG_M_DIR/include/help-$currentlang.inc.php")) {
    include_once("$CPG_M_DIR/include/help-$currentlang.inc.php");
} else {
    include_once("$CPG_M_DIR/include/help-english.inc.php");
}
$TMPCONFIG = $CONFIG;
require_once("header.php");
$CONFIG = $TMPCONFIG;
define('META_LNK','&cat=0');
print'<link rel="stylesheet" href="modules/' . $name . '/docs/styles.css" type="text/css">';
...
<!-- END my_gal_link -->
<!-- BEGIN admin_mode_link_title -->
<p class="doc_title" align="left">' . GTDOC_ADMINMODE_TITLE . ' </p>
<!-- END admin_mode_link_title -->
<!-- BEGIN site_admin_mode_link_desc -->
<p class="doc_desc" align="left">' . GTDOC_SITEADM_ADMINMODE_DESC . '</p>
<!-- END site_admin_mode_link_desc -->
<!-- BEGIN ad_mode_link_desc -->
<p class="doc_desc" align="left">' . GTDOC_ADM_ADMINMODE_DESC . '</p>
<!-- END ad_mode_link_desc -->
<!-- BEGIN user_admin_mode_link_desc -->
<p class="doc_desc" align="left">' . GTDOC_USER_ADMINMODE_DESC . '</p>
<!-- END user_admin_mode_link_desc -->
<!-- BEGIN upload_title -->
...
<p class="doc_title" align="left">' . GTDOC_DDIR_TITLE . '</p>
<p class="doc_desc" align="left">' . GTDOC_DDIR_DESC . '</p>
<p class="doc_title" align="left">' . GTDOC_CHMOD_TITLE . '</p>
<p class="doc_desc" align="left">' . GTDOC_CHMOD_DESC . '</p>
...
<p class="doc_title" align="left">' . GTDOC_ADEBUG_TITLE . '</p>
<p class="doc_desc" align="left">' . GTDOC_ADEBUG_DESC . '</p>
<p class="doc_title" align="left">' . GTDOC_UPDATE_ALERT_TITLE . '</p>
<p class="doc_desc" align="left">' . GTDOC_UPDATE_ALERT_DESC . '</p>
<!-- END doc_debug -->
<!-- END doc_config_desc -->
';
