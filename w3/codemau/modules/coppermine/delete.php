...
<tr><td><b>F</b></td><td>:</td><td><?php echo $lang_delete_php['fs_pic'] ?></td><td width="20">&nbsp;</td><td><img src="<?php echo $CPG_M_DIR;
    ?>/images/green.gif" border="0" width="12" height="12" align="absmiddle"></td><td>:</td><td><?php echo $lang_delete_php['del_success'] ?></td></tr>
<tr><td><b>N</b></td><td>:</td><td><?php echo $lang_delete_php['ns_pic'] ?></td><td width="20">&nbsp;</td><td><img src="<?php echo $CPG_M_DIR;
...
switch ($what) {
    ...
    case 'albmgr':
        ...
        echo "<div class=\"admin_menu_thumb\"><a href=\"" . $CPG_URL . "&file=albmgr&cat=3\"  class=\"adm_menu\">$lang_continue</a></div>\n";
        echo "</td></tr>";
        endtable();
        pagefooter();
        break;
