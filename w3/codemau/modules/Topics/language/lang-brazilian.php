...
define("_ACTIVETOPICS","<img src='tses.jpg'>");
define("_CLICK2LIST","Listar todas as notícias desta Sessão");
define("_TOTNEWS","Total de notícias");
define("_TOTREADS","Total de visualizações");
define("_MORE","Mais...");
define("_NONEWSYET","...ainda não há nenhuma notícia sobre este Sessão...");
