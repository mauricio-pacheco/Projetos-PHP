...
function topicsmanager() {
    ...
    GraphicAdmin();
    OpenTable();
    echo "<center><font class=\"title\"><b>Gerenciador de Cotações Agrícolas</b></font></center>";
    CloseTable();
    echo "<br>";
  
    echo "<br><a name=\"Add\">";
    OpenTable();
    echo "<iframe marginwidth='0' marginheight='0' src='cotacoes/enviando.php' frameborder='0' width='756' scrolling='no' height='300'></iframe>";
    CloseTable();
    include("footer.php");
}
