...
function select_month() {
    ...
    include("header.php");
    OpenTable();
    echo "<center><img src='tarq.jpg'></center>\n";
	CloseTable();
	OpenTable();
	...
	if ($month != $thismonth) {
	    $year = $getdate[1];
	    echo "<img src='calendario.gif'>&nbsp;<a href=\"modules.php?name=$module_name&amp;sa=show_month&amp;year=$year&amp;month=$getdate[2]&amp;month_l=$month\">$month, $year</a><br>";
	    $thismonth = $month;
	}
    }
    echo "</ul>"
	...
	."<input type=\"submit\" value=\"Pesquisar Notícia\">"
	."</form><br><br>"	
...
function show_month($year, $month, $month_l) {
    ...
    echo "<table border=\"0\" width=\"100%\"><tr>"
		."<td bgcolor=\"#FCDBB6\" align=\"left\"><b>"._ARTICLES."</b></td>"
		."<td bgcolor=\"#FCDBB6\" align=\"center\"><b>"._COMMENTS."</b></td>"
		."<td bgcolor=\"#FCDBB6\" align=\"center\"><b>"._READS."</b></td>"
		."<td bgcolor=\"#FCDBB6\" align=\"center\"><b>"._USCORE."</b></td>"
		."<td bgcolor=\"#FCDBB6\" align=\"center\"><b>"._DATE."</b></td>"
		."<td bgcolor=\"#FCDBB6\" align=\"center\"><b>"._ACTIONS."</b></td></tr>";
    ...
    while ($row = $db->sql_fetchrow($result)) {
		...
		if ($multilingual == 1) {
		    ...
		    $lang_img = "<img src='folha.gif'>";
		}
		if ($articlecomm == 0) {
		    $comments = 0;
		}
		echo "<tr>"
		    ."<td bgcolor=\"#ffffff\" align=\"left\">$lang_img $title</td>"
		    ."<td bgcolor=\"#ffffff\" align=\"center\">$comments</td>"
		    ."<td bgcolor=\"#ffffff\" align=\"center\">$counter</td>"
		    ."<td bgcolor=\"#ffffff\" align=\"center\">$rated</td>"
		    ."<td bgcolor=\"#ffffff\" align=\"center\">$time[0]</td>"
		    ."<td bgcolor=\"#ffffff\" align=\"center\">$actions</td></tr>";
    }
    echo "</table>"
	...
	if ($month != $thismonth) {
	    $year = $getdate[1];
	    echo "<img src='calendario.gif'>&nbsp;<a href=\"modules.php?name=$module_name&amp;sa=show_month&amp;year=$year&amp;month=$getdate[2]&amp;month_l=$month\">$month, $year</a>";
	    $thismonth = $month;
	}
    }
...
function show_all($min) {
	...
	."<input type=\"submit\" value=\"PESQUISAR NOTÍCIA\">"
	."</form>"
	."<br>[ <a href=\"modules.php?name=$module_name\">"._ARCHIVESINDEX."</a> ]</center>";
    CloseTable();
    include("footer.php");
}
...
# $Log: index.php,v $
# Revision 1.2  2004/12/08 00:30:55  chatserv
