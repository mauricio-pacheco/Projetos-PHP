...
function menu($mainlink) {
    ...
    OpenTable();
    $ThemeSel = get_theme();
    if (file_exists("themes/$ThemeSel/images/link-logo.jpg")) {
	echo "<br><center><a href=\"modules.php?name=$module_name\"><img src=\"themes/$ThemeSel/images/link-logo.jpg\" border=\"0\" alt=\"\"></a><br><br>";
    } else {
	echo "<br><center><a href=\"modules.php?name=$module_name\"><img src=\"modules/$module_name/images/link-logo.jpg\" border=\"0\" alt=\"\"></a><br><br>";
    }
...
function viewlinkcomments($lid, $ttitle) {
	...
	$useravgrating = $useravgrating + $rating2;
	    ...
	    ."<font class=\"content\">";
	    if (is_admin($admin)) {
		echo "<a href=\"admin.php?op=LinksModLink&amp;lid=$lid\"><img src=\"modules/$module_name/images/editicon.gif\" border=\"0\" alt=\""._EDITTHISLINK."\"></a>";
	    }
...
# $Log: index.php,v $
# Revision 1.2  2004/12/08 00:37:29  chatserv
