...
echo "<br><font class=\"content\">"._AREYOUSURE."</font><br><br>"
	...
	."<option value=\"FCKPreviewAgain\" selected>"._PREVIEWSTORY."</option>"
...
#	."<textarea wrap=\"virtual\" cols=\"50\" rows=\"12\" name=\"bodytext\"></textarea><br>"
	...
	."<select name=\"op\">"
	.""
	."<option readonly value=\"FCKPostAdminStory\">"._POSTSTORY."</option>"
	."</select>"
	."<input type=\"submit\" value=\""._OK."\">";
    CloseTable();
    echo "<br>";
...
echo "<br>";
    ...
    echo ": 00<br><br>"
	."<select name=\"op\">"
	."<option value=\"FCKPreviewAdminStory\" selected>"._PREVIEWSTORY."</option>"
