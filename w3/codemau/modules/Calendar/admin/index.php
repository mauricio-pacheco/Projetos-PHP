...
.""; 
themepreview($subject, $story); 
echo "<br><br><img src='http://www.codemau.org.br/loadeventos/$aid'></td></tr></table></td></tr></table><hr noshade size=\"1\" width=\"99%\"><br><br>"; 
echo "<br><font size=\"3\">" 
."<form onSubmit=\"return verify();\" action=\"admin.php\" method=\"post\" NAME=\"calendar\">" 
."" 
.""; 
...
$start_Array = explode(":",$startTime); 
$end_Array = explode(":",$endTime); 
echo "<br><b>Folder do Evento</b> (tamanho max: 500 Kb)<br>";
	echo "<input type=\"file\" name=\"foto1\" size=\"50\" value=\"$foto1\">";
	echo "<br>";
echo " 
<br><br> 
"._CALEVENTDATETEXT.": "; 
...
mysql_query("update ".$prefix."_events set title='$subject', hometext='$hometext', aid='$aid', topic='$topic', informant='$author', eventDate='$year-$month-$day', endDate='$endyear-$endmonth-$endday', startTime='$startTime', endTime='$endTime', alldayevent='$alldayevent', barcolor='$barcolor' where eid=$eid"); 
Header("Location: modules.php?op=modload&name=$module_name&file=index"); 
} 
} 
