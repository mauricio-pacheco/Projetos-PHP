...
<tr>
	...
	<td width="100%" height="24" align="center" valign="middle" background="themes/Helius/forums/images/top_center.gif"><a class="cattitle" href="{searchresults.U_TOPIC}">{searchresults.TOPIC_TITLE}</a></td>
