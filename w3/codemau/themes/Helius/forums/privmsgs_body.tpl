  ...
  <tr> 
	...
	<td align="right"> 
	  ...
	  <table width="190" cellspacing="1" cellpadding="2" border="0" class="forumline">
		<tr> 
		  <td colspan="3" width="190" class="row1" nowrap="nowrap"><span class="gensmall">{BOX_SIZE_STATUS}</span></td>
		</tr>
		<tr> 
		  <td colspan="3" width="190" class="row2" nowrap="nowrap"><img src="themes/Helius/forums/images/vote_lcap.gif" width="4" height="12" border="0" /><img src="themes/Helius/forums/images/voting_bar.gif" width="{INBOX_LIMIT_IMG_WIDTH}" height="12" alt="{INBOX_LIMIT_PERCENT}" /><img src="themes/Helius/forums/images/vote_rcap.gif" width="10" height="12" border="0" alt="" /></td>
		</tr>
		<tr> 
...
<tr>
	...
	<td width="100%" height="24" align="center" valign="middle" background="themes/Helius/forums/images/top_center.gif"><span class="cattitle">{BOX_NAME}</span></td>
...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	...
	<!-- BEGIN listrow -->
	<tr> 
	  <td class="row4" width="5%" align="center" valign="middle"><img src="{listrow.PRIVMSG_FOLDER_IMG}" width="19" height="18" alt="{listrow.L_PRIVMSG_FOLDER_ALT}" title="{listrow.L_PRIVMSG_FOLDER_ALT}" /></td>
	  <td width="55%" valign="middle" class="row1" onmouseover="this.style.backgroundColor='#F8F9FA';" onmouseout="this.style.backgroundColor='#EDEFF2';" onclick="window.location.href='{listrow.U_READ}'"><span class="topictitle">&nbsp;<a href="{listrow.U_READ}" class="topictitle">{listrow.SUBJECT}</a></span></td>
	  <td width="20%" valign="middle" align="center" class="row2" onmouseover="this.style.backgroundColor='#EBEEF3';" onmouseout="this.style.backgroundColor='#DDE2EC';" onclick="window.location.href='{listrow.U_FROM_USER_PROFILE}'"><span class="name">&nbsp;<a href="{listrow.U_FROM_USER_PROFILE}" class="name">{listrow.FROM}</a></span></td>
	  <td width="15%" align="center" valign="middle" class="row3"><span class="postdetails">{listrow.DATE}</span></td>
	  <td width="5%" align="center" valign="middle" class="row2"><span class="postdetails"> 
	...
	<tr> 
	  <td class="row4" colspan="5" height="26" align="right"> {S_HIDDEN_FIELDS} 
...
<tr>
	<td width="100%" height="5" background="centro.gif"><img src="themes/Helius/forums/images/spacer.gif" width="1" height="1" border="0" alt="" /></td>
	</tr>
</table>
