...
<table width="100%" border="0"  align="center" cellspacing="0" cellpadding="0">
      <tr> 
        <td width="60%" height="110" align="center"> 
          <div align="center"> <SCRIPT src="carregador.js"></SCRIPT><SCRIPT language=javascript>
     carregaFlash("cima.swf","976","120"); // Depois só descrever o caminho, largura, altura do SWF.
    </SCRIPT></div></td>
      </tr>
    </table>
<table class="bodyline" background="b1.gif" width="975" align="center" cellspacing="0" cellpadding="0" border="0"> 
	<tr> 
		<td align="center" valign="top">
   <table width="100%" border="0" align="center" background="fundado.jpg" height="38">
  <tr>
    <td width="1%"><img src="calenda.gif" /></td>
    <td width="49%"><font color="#252525">
...
setTimeout("horas()",1000);
    ...
    <td width="1%"><div align="center"><img src="lupaco.gif" /></div></td>
    <form action="modules.php?op=modload&amp;name=Recherches&amp;file=index" method="post">
      <td width="30%">
        <div align="left">
          <input type="text" size="34" class="texto" name="query"  />
          <input type="submit" class="texto" value="Busca no Site" />
          </div></td>
    </form>
    <td width="4%" align="right"><img src="rel.gif" /></td>
    <td width="20%" align="right"><span id="clock">
