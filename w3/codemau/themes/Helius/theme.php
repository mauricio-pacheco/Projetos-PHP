...
/* Check if this impression is the last one and print the banner */ 
   ...
   if (($imptotal <= $impmade) AND ($imptotal != 0)) { 
    ...
    echo "<body onclick=checkExpand() bgcolor=\"#FFFFFF\" text=\"#000000\" leftmargin=\"10\" topmargin=\"0\" marginwidth=\"10\" marginheight=\"10\" onunload=clearTimeout(window.tm)>";
    ...
    $tmpl_file = "themes/Helius/header.php";
