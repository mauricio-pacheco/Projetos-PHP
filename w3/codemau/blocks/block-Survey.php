...
if ($pollID == 0 || $pollID == "") {
   ...
   if ($ip == $ips) {
    ...
    $content .= "<br><font class=\"content\"><a href=\"modules.php?name=Surveys&amp;op=results&amp;pollID=$pollID&amp;mode=$cookie[4]&amp;order=$cookie[5]&amp;thold=$cookie[6]\"><img src='result.gif' border=0 /><br><b>"._RESULTS."</b></a><br><br><a href=\"modules.php?name=Surveys\"><img src='int.gif' border=0 /><br><b>Enquetes</b></a><br>";
