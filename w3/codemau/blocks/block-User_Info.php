...
if (is_user($user)) {
    $content .= "<div align='center'><img src=\"images/blocks/group-4.gif\" height=\"14\" width=\"17\"> "._BWEL.", <b>$uname</b>.<br>\n<img src='fluor.gif'>\n</div>";
    ...
    $content .= "<div align='center'><img src=\"images/blocks/group-4.gif\" height=\"14\" width=\"17\"> "._BWEL.", <b>$anonymous</b>\n<img src='fluor.gif'>\n</div>";
    $content .= ""._NICKNAME." <input type=\"text\" name=\"username\" size=\"14\" maxlength=\"25\"><br>";
    ...
    $content .= "<input type=\"submit\" value=\""._LOGIN."\">\n (<a href=\"modules.php?name=Your_Account&amp;op=new_user\">"._BREG."</a>)<div align='center'>------------------------------------<br></div>";
}
$content .= "<img src=\"images/blocks/group-2.gif\"> <b><u>"._BMEMP.":</u></b><br>\n";
$content .= "<img src=\"images/blocks/ur-moderator.gif\"> "._BLATEST.": <A HREF=\"modules.php?name=Your_Account&amp;op=userinfo&amp;username=$lastuser\"><b>$lastuser</b></a><br>\n";
$content .= "<img src=\"images/blocks/ur-author.gif\"> "._BTD.": <b>$userCount</b><br>\n";
$content .= "<img src=\"images/blocks/ur-admin.gif\"> "._BYD.": <b>$userCount2</b><br>\n";
$content .= "<img src=\"images/blocks/ur-guest.gif\"> "._BOVER.": <b>$numrows</b><br>\n<div align='center'>------------------------------------<br></div>\n";
$content .= "<img src=\"images/blocks/group-3.gif\"> <b><u>"._BVISIT.":</u></b>\n<br>\n";
$content .= "<img src=\"images/blocks/ur-anony.gif\"> "._BVIS.": <b>$guest_online_num</b><br>\n";
$content .= "<img src=\"images/blocks/ur-member.gif\"> "._BMEM.": <b>$member_online_num</b><br>\n";
$content .= "<img src=\"images/blocks/ur-registered.gif\"> "._BTT.": <b>$who_online_num</b><br>\n";
if ($member_online_num > 0) {
    $content .= "<div align='center'>------------------------------------<br></div>\n<img src=\"images/blocks/group-1.gif\"> <b><u>"._BON.":</u></b><br>$who_online_now";
}
$content .= "</form>";
