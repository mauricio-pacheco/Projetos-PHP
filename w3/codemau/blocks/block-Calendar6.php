...
$content .= "<MARQUEE behavior= \"scroll\" align= \"center\" direction= \"up\" height=\"140\" scrollamount= \"1\" scrolldelay= \"80\" onmouseover='this.stop()' onmouseout='this.start()'>";
...
$content .= "<br><center><img src=agricolas.jpg></center><br>";
$content .= "<MARQUEE behavior= \"scroll\" align= \"center\" direction= \"up\" height=\"280\" scrollamount= \"1\" scrolldelay= \"80\" onmouseover='this.stop()' onmouseout='this.start()'>";
$cotado = mysql_query("SELECT * FROM agricolas ORDER BY nome ASC");
 while(list($id, $nome, $vencimento, $preco, $data, $hora) = mysql_fetch_row($cotado)) 
        {
 
 $content .= "<img src=\"grana.jpg\" border=0> $nome - R$ $preco<br>"; 
 $content .= "<img src=\"reloko.gif\" border=0>  $data - $hora<br>"; 
 $content .= "<font color=#008000>OBS:</font> $vencimento<br><br>"; 
