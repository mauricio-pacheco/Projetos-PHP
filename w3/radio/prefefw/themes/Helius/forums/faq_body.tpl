...
<tr>
	...
	<td width="100%" height="24" align="center" valign="middle" background="themes/Helius/forums/images/top_center.gif"><span class="cattitle">{L_FAQ_TITLE}</span></td>
...
<tr>
	<td width="50" align="right" valign="bottom"><img src="themes/Helius/forums/images/direito.gif"/></td>
	<td width="100%" height="24" align="center" valign="middle" background="themes/Helius/forums/images/top_center.gif"><span class="cattitle">{faq_block.BLOCK_TITLE}</span></td>
	<td width="50" align="left" valign="bottom"><img src="themes/Helius/forums/images/esquerdo.gif"/></td>
</tr>
</table>
<table class="forumline" width="100%" cellspacing="1" cellpadding="3" border="0" align="center">
...
<tr>
	<td class="spacerow" height="1"><img src="themes/Helius/forums/images/spacer.gif" alt="" width="1" height="1" /></td>
</tr>
<!-- END faq_row -->
</table>
