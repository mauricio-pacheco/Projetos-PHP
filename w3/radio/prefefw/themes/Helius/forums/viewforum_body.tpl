...
<tr>
	...
	<td width="100%" height="24" align="center" valign="middle" background="themes/Helius/forums/images/top_center.gif"><a class="cattitle" href="{U_VIEW_FORUM}">{FORUM_NAME}</a></td>
