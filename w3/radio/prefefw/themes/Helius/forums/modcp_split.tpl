...
<tr>
	...
	<td width="100%" height="24" align="center" valign="middle" background="themes/Helius/forums/images/top_center.gif"><span class="cattitle">{L_SPLIT_TOPIC}</span></td>
	<td width="50" align="left" valign="bottom"><img src="themes/Helius/forums/images/esquerdo.gif"/></td>
</tr>
</table>
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
<tr> 
	<th colspan="3" align="center"><span class="gensmall2">{L_SPLIT_TOPIC_EXPLAIN}</span></td>
</tr>
<tr> 
	...
	<tr> 
	<td class="row4" colspan="3" height="28"> 
	...
	<tr> 
	  ...
	  <td width="100%" valign="top" class="{postrow.ROW_CLASS}"> 
		<table width="100%" cellspacing="0" cellpadding="3" border="0">
		  <tr> 
			<td valign="middle"><img src="themes/Helius/forums/images/icon_minipost.gif" alt="{L_POST}"><span class="postdetails">{L_POSTED}: 
