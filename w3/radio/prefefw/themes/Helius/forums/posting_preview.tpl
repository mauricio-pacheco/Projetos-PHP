...
<tr>
	...
	<td width="100%" height="24" align="center" valign="middle" background="themes/Helius/forums/images/top_center.gif"><span class="cattitle">{L_PREVIEW}</span></td>
...
<tr>
	...
	<tr height="26">
		<td align="left" valign="middle" nowrap="nowrap"><img src="themes/Helius/forums/images/icon_minipost.gif" alt="{L_POST}" /><span class="genmed">{L_POSTED}: {POST_DATE}</span></td>
	</tr></table></td>
</tr>
<tr>
	...
	<tr>
		...
		<tr>
			...
			<tr>
				<td align="left" valign="top"><img src="themes/Helius/forums/images/spacer.gif" width="150" height="100" border="0" alt="" /></td>
			</tr>
			</table><br /><br /></td>
...
<tr>
	<td width="100%" height="5" background="themes/Helius/forums/images/center.gif"><img src="themes/Helius/forums/images/spacer.gif" width="1" height="1" border="0" alt="" /></td>
	</tr>
</table>
