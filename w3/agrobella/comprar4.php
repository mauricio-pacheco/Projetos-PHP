...
campo.value = campo.value + separador3;
                                             ...
                                             <div align="center"><img src="pet4.jpg"><br><br></div>
...
<span class="tahoma10preto"><strong>CODOBEL</strong> - Ração farelada para codornas em produção, linha comercial disponível em embalagens de 5kg e 25kg.</span>
<table width="100%" border="0"><tr>
<td width="9%"><input type="checkbox" name="racao1" value="CODOBEL - Ração farelada para codornas em produção, linha comercial disponível em embalagens de 5kg e 25kg. ( 5 Kg )" id="check2" onClick="checkText(event, 'campo1')" />
<span class="tahoma10preto">5Kg</span></td>
<td width="60%"><span class="tahoma10preto">Quantidade:</span><strong><span class="tahoma10preto">
<input class="formularioDir"  size="6" name="quantidade1" value="1" id="campo1" disabled/></span></strong></td></tr>
<tr><td><input type="checkbox" name="racao2" value="CODOBEL - Ração farelada para codornas em produção, linha comercial disponível em embalagens de 5kg e 25kg. ( 25 Kg )" id="check3" onClick="checkText(event, 'campo2')" />
<span class="tahoma10preto">25Kg</span></td><td><span class="tahoma10preto">Quantidade:</span><strong><span class="tahoma10preto">
<input class="formularioDir"  size="6" name="quantidade2" value="1" id="campo2" disabled/></span></strong></td></tr></table><br /></td>
                              </tr>
                              <tr>
                                <td 
                            style="FONT-SIZE: 9px; FONT-FAMILY: Verdana, Arial, Helvetica, sans-serif" 
