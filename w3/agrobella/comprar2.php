...
campo.value = campo.value + separador3;
                                          ...
                                          <div align="center"><img src="pet3.jpg"><br><br></div>
...
function checkText(e, text){
    ...
    document.getElementById(text).disabled = !element.checked;
                                ...
                                </script><img src=caixote.gif>&nbsp;<span class="tahoma10preto"><strong>PEIXEBEL</strong> Extrusada</span>
<table width="100%" border="0"><tr>
<td width="9%"><input type="checkbox" name="racao" value="PEIXEBEL EXTRUSADA( 15 Kg )" id="check2" onClick="checkText(event, 'campo')" />
<span class="tahoma10preto">15Kg</span></td>
...
<img src=caixote.gif>&nbsp;<span class="tahoma10preto"><strong>PEIXEBEL</strong> Crescimento</span>
<table width="100%" border="0"><tr>
<td width="9%"><input type="checkbox" name="racao2" value="PEIXEBEL CRESCIMENTO( 25 Kg )" id="check2" onClick="checkText(event, 'campo2')" />
