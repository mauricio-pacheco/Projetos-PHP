                            ...
                            <TD class=tahoma10cinza666666><table width="100%" border="0">
                              <tr>
                                <td width="48%" class="tahoma10preto"><table width="100%" border="0">
                                    <tr>
                                      <td width="13%"><img src="funji2.jpg" width="133" height="46" /></td>
                                      <td width="87%"><div align="center">Fungicidas Mertin</div></td>
                                    </tr>
                                    <tr>
                                      <td>&nbsp;</td>
                                      <td>&nbsp;</td>
                              ...
                              <tr>
                                <td width="48%" class="tahoma10preto"><p><strong>MODO DE AÇÃO</strong><br />
                                  Fungicida Organo-Estanico Não Sistêmico
                                      </p>
                                    <p><strong>CULTURA</strong><br />
                                      Feijão, Alho, Cebola, Arroz, Batata, Cenoura<br />
                                    </p>
                                  <p><strong>ALVO</strong><br />
                                    Antracnose, Ferrugem, Manchas Parda e Angular, Mancha Purpura, Ferrugem, Brusone, Helmitosporiose, Pinta Preta e Requeima, Queima das Folhas<br />
                                    </p>
                                  <p><strong>DOSE</strong><br />
                                    800 ML a 1 LT / Há, 25 ML / 100 LT, 750 ML / Há, 50 ML / 100 LT, 50 ML / 100 LT,</p>
                                  <p><strong>OBSERVAÇÃO</strong><br />
                                    Intervalo de Segurança: 21 Dias<br />
                                    </p>
