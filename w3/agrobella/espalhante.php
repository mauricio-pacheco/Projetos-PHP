                ...
                <TD vAlign=top width=80% bgColor=#ffffff>
                  ...
                  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
                    ...
                    <TR>
                      ...
                      height=32><img src="espalha.png"></TD>
                    </TR>
                    <TR>
                      <TD colSpan=2>
                            ...
                            <TD class=tahoma10cinza666666><table width="100%" border="0">
                              <tr>
                                <td width="48%" class="tahoma10preto"><table width="100%" border="0">
                                    <tr>
                                      <td width="13%"><img src="astuto.jpg" width="108" height="40" /></td>
                                      <td width="87%"><div align="center">Espalhante Adesivo Agral</div></td>
                                    </tr>
                                    <tr>
                                      <td>&nbsp;</td>
                                      <td>&nbsp;</td>
                                ...
                                <td width="48%" class="tahoma10preto"><p><strong>MODO DE AÇÃO</strong><br />
                                  Espalhante Adesivo
                                    ...
                                    <p><strong>CULTURA</strong><br />
                                      Pode ser adicionado a qualquer Herbicida, Fungicida, Inseticida ou Fertilizante Foliar<br />
                                    </p>
