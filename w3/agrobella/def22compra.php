...
campo.value = campo.value + separador3;
                                           ...
                                           <div align="center"><img src="def22.jpg"><br><br></div>
...
function checkText(e, text){
    ...
    document.getElementById(text).disabled = !element.checked;
                                ...
                                <img src=caixote.gif>&nbsp;
<span class="tahoma10preto"><strong>Cropstar SC</strong></span>
<table width="100%" border="0"><tr>
<td width="9%"><input type="checkbox" name="racao" value="Cropstar SC ( 1 Lt )" id="check2" onClick="checkText(event, 'campo')" />
...
<tr>
<td width="9%"><input type="checkbox" name="racao2" value="Cropstar SC ( 5 Lts )" id="check2" onClick="checkText(event, 'campo2')" />
<span class="tahoma10preto">5 Lts</span></td>
<td width="60%"><span class="tahoma10preto">Quantidade:</span><strong><span class="tahoma10preto">
<input class="formularioDir"  size="6" name="quantidade2" value="1" id="campo" disabled/></span></strong></td></tr>
