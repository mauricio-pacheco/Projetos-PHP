...
campo.value = campo.value + separador3;
                                           ...
                                           <div align="center"><img src="chemi1.jpg"><br><br></div>
...
function checkText(e, text){
    ...
    document.getElementById(text).disabled = !element.checked;
                                ...
                                <img src=caixote.gif>&nbsp;
<span class="tahoma10preto"><strong>Glifos</strong></span>
<table width="100%" border="0"><tr>
<td width="9%"><input type="checkbox" name="racao" value="Glifos ( 1 Lt )" id="check2" onClick="checkText(event, 'campo')" />
...
<tr>
<td width="9%"><input type="checkbox" name="racao2" value="Glifos ( 5 Lts )" id="check2" onClick="checkText(event, 'campo2')" />
...
<tr>
<td width="9%"><input type="checkbox" name="racao3" value="Glifos ( 20 Lts )" id="check2" onClick="checkText(event, 'campo3')" />
