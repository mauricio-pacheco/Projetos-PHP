...
$sql = "INSERT INTO noticias (titulo, descricao, data, hora) VALUES ('$titulo', '$descricao', '$data', '$hora')";
if(mysql_query($sql)) {
echo "<div align=center><br><br><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">A sua notícia foi enviada com sucesso!!</font></div>";
}else{
echo "<div align=center><br><br><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">Não foi possivel enviar sua notícia!</font></div>";
}
