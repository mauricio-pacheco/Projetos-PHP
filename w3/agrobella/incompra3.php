...
campo.value = campo.value + separador3;
                                           ...
                                           <div align="center"><img src="inset3.jpg"><br><br></div>
...
function checkText(e, text){
    ...
    document.getElementById(text).disabled = !element.checked;
                                ...
                                <img src=caixote.gif>&nbsp;
<span class="tahoma10preto"><strong>KARATE ZEON</strong></span>
<table width="100%" border="0"><tr>
<td width="9%"><input type="checkbox" name="racao" value="KARATE ZEON ( 0,25 Lts )" id="check2" onClick="checkText(event, 'campo')" />
...
<tr>
<td width="9%"><input type="checkbox" name="racao2" value="KARATE ZEON ( 1 Lt )" id="check2" onClick="checkText(event, 'campo2')" />
