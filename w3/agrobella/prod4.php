                            ...
                            <TD class=tahoma10cinza666666><table width="100%" border="0">
                              <tr>
                                <td width="48%" class="tahoma10preto"><table width="100%" border="0">
                                    <tr>
                                      <td width="13%"><img src="prod4.jpg" width="136" height="50" /></td>
                                      <td width="87%"><div align="center">Herbicidas Gramocil</div></td>
                                    </tr>
                                    <tr>
                                      <td>&nbsp;</td>
                                      <td>&nbsp;</td>
                              ...
                              <tr>
                                <td width="48%" class="tahoma10preto"><p><strong>MODO DE AÇÃO</strong><br />
                                  Contato / Dessecação<br />
                                  </p>
                                    <p><strong>CULTURA</strong><br />
                                      Diversas<br />
                                    </p>
                                  <p><strong>ALVO</strong><br />
                                    Plantas Daninhas, Folhas Largas e Gramineas Anuais em Pós Emergência<br />
                                    </p>
