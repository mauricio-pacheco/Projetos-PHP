                ...
                <TD vAlign=top width=80% bgColor=#ffffff>
                  ...
                  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
                    ...
                    <TR>
                      ...
                      height=32><img src="codornas.png"></TD>
                    </TR>
                    <TR>
                      <TD colSpan=2>
                          ...
                          <TR>
                            <TD class=tahoma10cinza666666><table width="100%" border="0">
                                ...
                                <td width="48%" class="tahoma10preto"><table width="100%" border="0"><tr>
                                    <td><img src="pet4.jpg"></td>
                                    <td>Rações para Codornas</td>
                                  </tr>
                                </table>
                                  </td>
                                </tr><tr>
                                <td width="48%" class="tahoma10preto"><p><strong>CODOBEL</strong><br>
                                    Ração farelada para codornas em produção, linha comercial disponível em embalagens de 5kg e 25kg.<br>
                                    Modo de Usar: Fornecer a livre acesso durante o ciclo de produção.<br>
                                    Proteína  20%<br>
                                    Energia metabolizavel 2,72%<br>
                                    Metionina 0,55%<br>
                                  </p>
