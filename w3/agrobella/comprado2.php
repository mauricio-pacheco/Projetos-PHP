...
$racao6 = utf8_decode($_POST["racao6"]);
$quantidade6 = utf8_decode($_POST['quantidade6']);
$racao7 = utf8_decode($_POST["racao7"]);
$quantidade7 = utf8_decode($_POST['quantidade7']);
$racao8 = utf8_decode($_POST["racao8"]);
$quantidade8 = utf8_decode($_POST['quantidade8']);
$racao9 = utf8_decode($_POST["racao9"]);
$quantidade9 = utf8_decode($_POST['quantidade9']);
$racao10 = utf8_decode($_POST["racao10"]);
$quantidade10 = utf8_decode($_POST['quantidade10']);
$racao11 = utf8_decode($_POST["racao11"]);
$quantidade11 = utf8_decode($_POST['quantidade11']);
$racao12 = utf8_decode($_POST["racao12"]);
$quantidade12 = utf8_decode($_POST['quantidade12']);
$racao13 = utf8_decode($_POST["racao13"]);
$quantidade13 = utf8_decode($_POST['quantidade13']);
$racao14 = utf8_decode($_POST["racao14"]);
$quantidade14 = utf8_decode($_POST['quantidade14']);
$racao15 = utf8_decode($_POST["racao15"]);
$quantidade15 = utf8_decode($_POST['quantidade15']);
...
$mensagem .= "<b>Nome do Produto:</b> \t$racao6<BR>";
$mensagem .= "<b>Quantidade:</b> \t$quantidade6<BR><br>";
$mensagem .= "<b>Nome do Produto:</b> \t$racao7<BR>";
$mensagem .= "<b>Quantidade:</b> \t$quantidade7<BR><br>";
$mensagem .= "<b>Nome do Produto:</b> \t$racao8<BR>";
$mensagem .= "<b>Quantidade:</b> \t$quantidade8<BR><br>";
$mensagem .= "<b>Nome do Produto:</b> \t$racao9<BR>";
$mensagem .= "<b>Quantidade:</b> \t$quantidade9<BR><br>";
$mensagem .= "<b>Nome do Produto:</b> \t$racao10<BR>";
$mensagem .= "<b>Quantidade:</b> \t$quantidade10<BR><br>";
$mensagem .= "<b>Nome do Produto:</b> \t$racao11<BR>";
$mensagem .= "<b>Quantidade:</b> \t$quantidade11<BR><br>";
$mensagem .= "<b>Nome do Produto:</b> \t$racao12<BR>";
$mensagem .= "<b>Quantidade:</b> \t$quantidade12<BR><br>";
$mensagem .= "<b>Nome do Produto:</b> \t$racao13<BR>";
$mensagem .= "<b>Quantidade:</b> \t$quantidade13<BR><br>";
$mensagem .= "<b>Nome do Produto:</b> \t$racao14<BR>";
$mensagem .= "<b>Quantidade:</b> \t$quantidade14<BR><br>";
$mensagem .= "<b>Nome do Produto:</b> \t$racao15<BR>";
$mensagem .= "<b>Quantidade:</b> \t$quantidade15<BR><br>";
