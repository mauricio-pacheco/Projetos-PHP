                ...
                <TD vAlign=top width=80% bgColor=#ffffff>
                  ...
                  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
                    ...
                    <TR>
                      ...
                      height=32><img src="nutri.png"></TD>
                    </TR>
                    <TR>
                      <TD colSpan=2>
                          ...
                          <TR>
                            <TD class=tahoma10cinza666666><table width="100%" border="0">
                                ...
                                <td width="48%" class="tahoma10preto"><table width="100%" border="0"><tr>
                                    <td align="center"><img src="nutribel.gif"><br><br></td>
                                  </tr>
                                </table>
                                  </td>
                                </tr><tr>
                                <td width="48%" class="tahoma10preto"><p align="justify"><span style="font-weight: bold">NUTRIBEL MILK</span></p>
                                  <p align="justify"><span style="font-weight: bold">NUTRIBELl PLUS</span></p>
                                  <p align="justify"><span style="font-weight: bold">NUTRIBEL INICIAL 20 Kg</span></p>
                                  <p align="justify"><span style="font-weight: bold">NUTRIBEL CRESC. TERM.</span></p>
                                  <p align="justify"><span style="font-weight: bold">NUTRIBEL GESTAÇÃO</span></p>
                                  <p align="justify"><span style="font-weight: bold">NUTRIBEL LACTAÇÃO</span></p>
