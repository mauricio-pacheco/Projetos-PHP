...
campo.value = campo.value + separador3;
                                           ...
                                           <div align="center"><img src="mon4.jpg"><br><br></div>
...
function checkText(e, text){
    ...
    document.getElementById(text).disabled = !element.checked;
                                ...
                                <img src=caixote.gif>&nbsp;
<span class="tahoma10preto"><strong>Roundup Transorb</strong></span>
<table width="100%" border="0"><tr>
<td width="9%"><input type="checkbox" name="racao" value="Roundup Transorb ( 1 Lt )" id="check2" onClick="checkText(event, 'campo')" />
...
<tr>
<td width="9%"><input type="checkbox" name="racao2" value="Roundup Transorb ( 5 Lts )" id="check2" onClick="checkText(event, 'campo2')" />
<span class="tahoma10preto">5 Lts</span></td>
<td width="60%"><span class="tahoma10preto">Quantidade:</span><strong><span class="tahoma10preto">
<input class="formularioDir"  size="6" name="quantidade2" value="1" id="campo2" disabled/></span></strong></td></tr>
<tr>
<td width="9%"><input type="checkbox" name="racao3" value="Roundup Transorb ( 20 Lts )" id="check2" onClick="checkText(event, 'campo3')" />
<span class="tahoma10preto">20 Lts</span></td>
<td width="60%"><span class="tahoma10preto">Quantidade:</span><strong><span class="tahoma10preto">
