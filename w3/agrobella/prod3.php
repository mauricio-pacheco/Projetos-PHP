                ...
                <TD vAlign=top width=80% bgColor=#ffffff>
                  ...
                  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
                    ...
                    <TR>
                      ...
                      height=32><img src="herbs.png"></TD>
                    </TR>
                    <TR>
                      <TD colSpan=2>
                            ...
                            <TD class=tahoma10cinza666666><table width="100%" border="0">
                              <tr>
                                <td width="48%" class="tahoma10preto"><table width="100%" border="0">
                                    <tr>
                                      <td width="13%"><img src="prod3.jpg" width="144" height="48" /></td>
                                      <td width="87%"><div align="center">Herbicidas Fusilade</div></td>
                                    </tr>
                                    <tr>
                                      <td>&nbsp;</td>
                                      <td>&nbsp;</td>
                                ...
                                <td width="48%" class="tahoma10preto"><p><strong>MODO DE AÇÃO</strong><br />
                                  Pós Emergente<br />
                                    ...
                                    <p><strong>CULTURA</strong><br />
                                      Soja, Feijão, Batata, Cenoura, Alface, Cebola<br />
                                    </p>
                                  <p><strong>ALVO</strong><br />
                                    Gramineas até 2 Perfilios, Folhas Estreitas, Azevem até dois Perfilios<br />
                                    </p>
                                  <p><strong>DOSE</strong><br />
                                    0,5 a 1,0 Lt / Há, 1,0 La/Há</p>
                                  <p><strong>OBSERVAÇÃO</strong><br />
                                    Usar 0,1 % de Agral por volume de calda<br />
                                    </p>
