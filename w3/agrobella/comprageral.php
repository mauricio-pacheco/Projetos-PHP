...
campo.value = campo.value + separador3;
                              ...
                              <tr>
                                <td 
                            style="FONT-SIZE: 9px; FONT-FAMILY: Verdana, Arial, Helvetica, sans-serif" 
                            bgcolor="#ffffff" colspan="2"><span class="style3">Dados do Produto:</span></td>
                              </tr>
                              <tr class="back">
                                <td 
                            style="FONT-SIZE: 9px; FONT-FAMILY: Verdana, Arial, Helvetica, sans-serif"><div align="right"><span class="tahoma10preto"><font color="#000000">Produto: </font></span></div></td>
                                <td 
                            style="FONT-SIZE: 9px; FONT-FAMILY: Verdana, Arial, Helvetica, sans-serif"><span class="tahoma10preto"><strong>
                                  <?
	  $nome = $_GET['nome'];
	   ?>
                                 <select 
                              class="formularioDir"  name="nomedoproduto"><?php echo "$nome" ?></select>
                                  *</strong></span></td>
                              </tr>
                              <tr class="back">
                                <td 
                            style="FONT-SIZE: 9px; FONT-FAMILY: Verdana, Arial, Helvetica, sans-serif"><div align="right"><span class="tahoma10preto"><font 
                              color="#000000">Quantidade:</font></span></div></td>
                                <td 
                            style="FONT-SIZE: 9px; FONT-FAMILY: Verdana, Arial, Helvetica, sans-serif"><strong> <span class="tahoma10preto">
                                  <input 
                              class="formularioDir"  size="8" name="quantidade" />
                                  *</span></strong></td>
                              </tr>
                              <tr>
                                <td 
                            ...
                            bgcolor="#ffffff" colspan="2"><div class="back" align="center">
                              ...
                              <tr class="back">
                                <td 
                            style="FONT-SIZE: 9px; FONT-FAMILY: Verdana, Arial, Helvetica, sans-serif" 
                            width="28%"><div align="right"><span class="tahoma10preto"><font color="#000000">Nome 
                            ...
                            style="FONT-SIZE: 9px; FONT-FAMILY: Verdana, Arial, Helvetica, sans-serif"><strong> <span class="tahoma10preto">
                              ...
                              <tr class="back">
                                <td 
                            style="FONT-SIZE: 9px; FONT-FAMILY: Verdana, Arial, Helvetica, sans-serif"><div align="right"><span class="tahoma10preto"><font color="#000000">Telefone 
