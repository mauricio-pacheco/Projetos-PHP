...
campo.value = campo.value + separador3;
                                           ...
                                           <div align="center"><img src="iha3.jpg"><br><br></div>
...
function checkText(e, text){
    ...
    document.getElementById(text).disabled = !element.checked;
                                ...
                                <img src=caixote.gif>&nbsp;
<span class="tahoma10preto"><strong>Cercobin 700 PM</strong></span>
<table width="100%" border="0"><tr>
<td width="9%"><input type="checkbox" name="racao" value="Cercobin 700 PM ( 1 Kg )" id="check2" onClick="checkText(event, 'campo')" />
