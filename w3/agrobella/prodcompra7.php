...
campo.value = campo.value + separador3;
                                           ...
                                           <div align="center"><img src="prod7.jpg"><br><br></div>
...
function checkText(e, text){
    ...
    document.getElementById(text).disabled = !element.checked;
                                ...
                                <img src=caixote.gif>&nbsp;
<span class="tahoma10preto"><strong>ROBUST</strong></span>
<table width="100%" border="0"><tr>
<td width="9%"><input type="checkbox" name="racao" value="ROBUST ( 0,5 Lt )" id="check2" onClick="checkText(event, 'campo')" />
<span class="tahoma10preto">0,5 Lt</span></td>
...
<tr>
<td width="9%"><input type="checkbox" name="racao2" value="ROBUST ( 1 Lt )" id="check2" onClick="checkText(event, 'campo2')" />
...
<tr>
<td width="9%"><input type="checkbox" name="racao3" value="ROBUST ( 5 Lts )" id="check2" onClick="checkText(event, 'campo3')" />
