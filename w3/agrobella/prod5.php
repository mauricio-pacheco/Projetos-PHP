                            ...
                            <TD class=tahoma10cinza666666><table width="100%" border="0">
                              <tr>
                                <td width="48%" class="tahoma10preto"><table width="100%" border="0">
                                    <tr>
                                      <td width="13%"><img src="prod5.jpg" width="140" height="47" /></td>
                                      <td width="87%"><div align="center">Herbicidas Gramoxone</div></td>
                                    </tr>
                                    <tr>
                                      <td>&nbsp;</td>
                                      <td>&nbsp;</td>
                              ...
                              <tr>
                                <td width="48%" class="tahoma10preto"><p><strong>MODO DE AÇÃO</strong><br />
                                  Dessecação / Contato<br />
                                  </p>
                                    <p><strong>CULTURA</strong><br />
                                      Diversas<br />
                                    </p>
                                  <p><strong>ALVO</strong><br />
                                    Plantas Daninhas, Folhas Estreitas, e Folhas Largas, Dissecação de Culturas<br />
                                    </p>
