...
campo.value = campo.value + separador3;
                                           ...
                                           <div align="center"><img src="semente3.jpg"><br><br></div>
...
function checkText(e, text){
    ...
    document.getElementById(text).disabled = !element.checked;
                                ...
                                <img src=caixote.gif>&nbsp;
<span class="tahoma10preto"><strong>CRUISER</strong></span>
<table width="100%" border="0"><tr>
<td width="9%"><input type="checkbox" name="racao" value="CRUISER ( 250 Ml )" id="check2" onClick="checkText(event, 'campo')" />
<span class="tahoma10preto">250 Ml</span></td>
...
<tr>
<td width="9%"><input type="checkbox" name="racao2" value="CRUISER ( 1 Lt )" id="check2" onClick="checkText(event, 'campo2')" />
