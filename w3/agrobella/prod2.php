                            ...
                            <TD class=tahoma10cinza666666><table width="100%" border="0">
                              <tr>
                                <td width="48%" class="tahoma10preto"><table width="100%" border="0">
                                    <tr>
                                      <td width="13%"><img src="prod2.jpg" width="139" height="39" /></td>
                                      <td width="87%"><div align="center">Herbicidas FusiFlex</div></td>
                                    </tr>
                                    <tr>
                                      <td>&nbsp;</td>
                                      <td>&nbsp;</td>
                              ...
                              <tr>
                                <td width="48%" class="tahoma10preto"><p><strong>MODO DE AÇÃO</strong><br />
                                  ...
                                  <p><strong>ALVO</strong><br />
                                    Fls Largas, 2 a 4 folhas, Fls Estreita Até 1 Perfilho<br />
                                    </p>
                                  <p><strong>DOSE</strong><br />
                                    1,6 a 2,0 Lt / Há</p>
                                  <p><strong>OBSERVAÇÃO</strong><br />
Intervalo de Segurança 30 dias após a Aplicação<br />
                                  </p>
