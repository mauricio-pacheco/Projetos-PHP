...
campo.value = campo.value + separador3;
                                           ...
                                           <div align="center"><img src="inset2.jpg"><br><br></div>
...
function checkText(e, text){
    ...
    document.getElementById(text).disabled = !element.checked;
                                ...
                                <img src=caixote.gif>&nbsp;
<span class="tahoma10preto"><strong>ENGEO PLENO</strong></span>
<table width="100%" border="0"><tr>
<td width="9%"><input type="checkbox" name="racao" value="ENGEO PLENO ( 0,25 Lts )" id="check2" onClick="checkText(event, 'campo')" />
<span class="tahoma10preto">0,25 Lts</span></td>
...
<tr>
<td width="9%"><input type="checkbox" name="racao2" value="ENGEO PLENO ( 1 Lt )" id="check2" onClick="checkText(event, 'campo2')" />
...
<tr>
<td width="9%"><input type="checkbox" name="racao3" value="ENGEO PLENO ( 5 Lts )" id="check2" onClick="checkText(event, 'campo3')" />
