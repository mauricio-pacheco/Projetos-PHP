...
campo.value = campo.value + separador3;
                                           ...
                                           <div align="center"><img src="out9.jpg"><br><br></div>
...
function checkText(e, text){
    ...
    document.getElementById(text).disabled = !element.checked;
                                ...
                                <img src=caixote.gif>&nbsp;
<span class="tahoma10preto"><strong>Orthene 750 BR</strong></span>
<table width="100%" border="0"><tr>
<td width="9%"><input type="checkbox" name="racao" value="Orthene 750 BR ( 1 Pacote )" id="check2" onClick="checkText(event, 'campo')" />
<span class="tahoma10preto">1 Pacote</span></td>
