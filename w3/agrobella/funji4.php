                ...
                <TD vAlign=top width=80% bgColor=#ffffff>
                  ...
                  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
                    ...
                    <TR>
                      ...
                      height=32><img src="fungicidada.png"></TD>
                    </TR>
                    <TR>
                      <TD colSpan=2>
                        ...
                        border=0>
                          ...
                          <TR>
                            <TD class=tahoma10cinza666666><table width="100%" border="0">
                              <tr>
                                <td width="48%" class="tahoma10preto"><table width="100%" border="0">
                                    <tr>
                                      <td width="13%"><img src="funji4.jpg" width="137" height="64" /></td>
                                      <td width="87%"><div align="center">Fungicidas Score</div></td>
                                    </tr>
                                    <tr>
                                      <td>&nbsp;</td>
                                      <td>&nbsp;</td>
                              ...
                              <tr>
                                <td width="48%" class="tahoma10preto"><p><strong>MODO DE AÇÃO</strong><br />
                                  Fungicida Sistêmico Trazol
                                      </p>
                                    <p><strong>CULTURA</strong><br />
                                      Abóbrinha, Alface, Alho, Cebola, Beterraba, Batata, Cenoura, Amendoim, Citros, Couve Flor, Ervilha, Manda, Maracujá, Melancia, Melão, Pepino, Morango, Pimentão, Tomate, Uva<br />
                                    </p>
                                  <p><strong>ALVO</strong><br />
                                    Óldio, Septoriose, Mancha Purpura, Mancha de Cercospora, Pinta Preta, Queima das Folhas, Mancha, Verrugose, Podridão, Mancha de Altenária, Antracnose, Crestamento, Óldio Mancha de Mycosphaerella.Cercospora, Pinta Preta, Septoriose, Antracnose, Óldio, Mancha das Folhas<br />
                                    </p>
                                  <p><strong>DOSE</strong><br />
                                    20 ML / 100 LT, 60 ML / 100 LT, 40 ML / 100 LT, 60 ML / 100 LT, 20 ML / 100 LT, 20 ML / 100 LT, 50 ML / 100 LT, 30 ML / 100 LT, 40 ML / 100 LT, 50 ML / 100 LT, 12 ML / 100 LT,</p>
                                  <p><strong>OBSERVAÇÃO</strong><br />
                                    14 Dias, 14 Dias, 07 Dias, 15 Dias, 30 Dias, 14 Dias, 14 Dias, 03 Dias, 07 Dias, 14 Dias, 21 Dias, <br />
                                    </p>
