                ...
                <TD vAlign=top width=80% bgColor=#ffffff>
                  ...
                  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
                    ...
                    <TR>
                      ...
                      height=32><img src="tratamento.png"></TD>
                    </TR>
                    <TR>
                      <TD colSpan=2>
                            ...
                            <TD class=tahoma10cinza666666><table width="100%" border="0">
                              <tr>
                                <td width="48%" class="tahoma10preto"><table width="100%" border="0">
                                    <tr>
                                      <td width="13%"><img src="semente3.jpg" width="140" height="47" /></td>
                                      <td width="87%"><div align="center">Inseticidas Cruiser</div></td>
                                    </tr>
                                    <tr>
                                      <td>&nbsp;</td>
                                      <td>&nbsp;</td>
                              ...
                              <tr>
                                <td width="48%" class="tahoma10preto"><p><strong>MODO DE AÇÃO</strong><br />
                                  Inseticida Sistêmico, Melhor Ação em Pragas Sugadoras
                                      </p>
                                    <p><strong>CULTURA</strong><br />
                                      Feijão, Milho, Soja, Trigo<br />
                                    </p>
                                  <p><strong>ALVO</strong><br />
                                    Mosca Branca, Vaquinha Veramar, Cigarrinha Verde, Cigarrinha, Pulgão, Percevejo, Lagarta Elaso, Lagarta Elasmo, Tamanduá, Pulgão, Percevejo<br />
                                    </p>
                                  <p><strong>DOSE</strong><br />
                                    3 ML / KG, 6 ML / KG, 0,5  a 2 ML / KG, 0,5 a 1,5 ML / KG, </p>
