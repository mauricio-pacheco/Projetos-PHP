                            ...
                            <TD class=tahoma10cinza666666><table width="100%" border="0">
                              <tr>
                                <td width="48%" class="tahoma10preto"><table width="100%" border="0">
                                    <tr>
                                      <td width="13%"><img src="inset5.jpg" width="141" height="45" /></td>
                                      <td width="87%"><div align="center">Inseticidas Vertimec</div></td>
                                    </tr>
                                    <tr>
                                      <td>&nbsp;</td>
                                      <td>&nbsp;</td>
                              ...
                              <tr>
                                <td width="48%" class="tahoma10preto"><p><strong>MODO DE AÇÃO</strong><br />
                                  Acarida Biológico<br />
                                  </p>
                                    <p><strong>CULTURA</strong><br />
                                      Batata, Citros, Uva, Figo, Feijão, Mamão, Melancia, Pimentão, Melão, Morango, Tomate, Pepino, Pêssego, Vagem<br />
                                    </p>
                                  <p><strong>ALVO</strong><br />
                                    Ácaros, Mosca Minadora, Traças, Brocas<br />
                                    </p>
                                  <p><strong>DOSE</strong><br />
                                    75 a 100 ML  / 100 LT</p>
                                  <p><strong>OBSERVAÇÃO</strong><br />
                                    Intervalo de Segurança: 28 Dias<br />
                                    </p>
