                            ...
                            <TD class=tahoma10cinza666666><table width="100%" border="0">
                              <tr>
                                <td width="48%" class="tahoma10preto"><table width="100%" border="0">
                                    <tr>
                                      <td width="13%"><img src="funji1.jpg" width="134" height="51" /></td>
                                      <td width="87%"><div align="center">Fungicidas Amistar</div></td>
                                    </tr>
                                    <tr>
                                      <td>&nbsp;</td>
                                      <td>&nbsp;</td>
                              ...
                              <tr>
                                <td width="48%" class="tahoma10preto"><p><strong>MODO DE AÇÃO</strong><br />
                                  Sistêmico-Estrobirulina, Preventivo, Curativo, Anti Esporulante. Aconselha-se Aplicar de Controle<br />
                                  </p>
                                    <p><strong>CULTURA</strong><br />
                                      Feijão, Tomate, Batata, Cebola, Beterraba, Amendoim, Morango, Pimentão, Pêssego, Figo, Uva, Melão, Melancia<br />
                                    </p>
                                  <p><strong>ALVO</strong><br />
                                    Antracnose, Ferrugem, Manchas, Pinta Preta, Septoriose, Mancha Purpura, Mancha de Cercospora, Castanha e Preta, Mildio, Antracnose, Ferrugem , Mildio, Óidio<br />
                                    </p>
                                  <p><strong>DOSE</strong><br />
                                    100 a 120 GR / Há, 10 a 15 GR / 100 LT, 15 GR / 100 LT,  15 GR / 100 LT,  15 GR / 100 LT,  15 e 20 GR / 100 LT,  24 GR / 100 LT,  16 GR / 100 LT, </p>
                                  <p><strong>OBSERVAÇÃO</strong><br />
                                    Intervalo de Segurança: 07 Dias<br />
                                    </p>
