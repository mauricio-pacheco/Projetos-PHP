...
campo.value = campo.value + separador3;
                                           ...
                                           <div align="center"><img src="mon3.jpg"><br><br></div>
...
function checkText(e, text){
    ...
    document.getElementById(text).disabled = !element.checked;
                                ...
                                <img src=caixote.gif>&nbsp;
<span class="tahoma10preto"><strong>Roundup WG</strong></span>
<table width="100%" border="0"><tr>
<td width="9%"><input type="checkbox" name="racao" value="Roundup WG ( 1 Kg )" id="check2" onClick="checkText(event, 'campo')" />
<span class="tahoma10preto">1 Kg</span></td>
...
<tr>
<td width="9%"><input type="checkbox" name="racao2" value="Roundup WG ( 5 Kg )" id="check2" onClick="checkText(event, 'campo2')" />
<span class="tahoma10preto">5 Kg</span></td>
<td width="60%"><span class="tahoma10preto">Quantidade:</span><strong><span class="tahoma10preto">
