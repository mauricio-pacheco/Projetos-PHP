...
campo.value = campo.value + separador3;
                                          ...
                                          <div align="center"><img src="pet5.jpg"><br><br></div>
...
<span class="tahoma10preto"><strong>CUNITTI</strong> - Ração peletizada para coelhos, linha comercial disponível em embalagens de 5kg e 25kg.</span>
<table width="100%" border="0"><tr>
<td width="9%"><input type="checkbox" name="racao"  value="CUNITTI - Ração peletizada para coelhos, linha comercial disponível em embalagens de 5kg e 25kg. ( 25 Kg )" id="check" onClick="checkText(event, 'campo')" />
...
<span class="tahoma10preto"><strong>CUNIBEL</strong> - Ração peletizada para coelhos, linha comercial disponível em embalagens de 5kg e 25kg.</span>
<table width="100%" border="0"><tr>
<td width="9%"><input type="checkbox" name="racao2" value="CUNIBEL - Ração peletizada para coelhos, linha comercial disponível em embalagens de 5kg e 25kg. ( 5 Kg )" id="check2" onClick="checkText(event, 'campo2')" />
...
<tr><td><input type="checkbox" name="racao3" value="CUNIBEL - Ração peletizada para coelhos, linha comercial disponível em embalagens de 5kg e 25kg. ( 25 Kg )" id="check3" onClick="checkText(event, 'campo3')" />
<span class="tahoma10preto">25Kg</span></td><td><span class="tahoma10preto">Quantidade:</span><strong><span class="tahoma10preto">
<input class="formularioDir"  size="6" name="quantidade3" value="1" id="campo3" disabled/></span></strong></td></tr></table><br /></td>
                              </tr>
                              <tr>
                                <td 
                            style="FONT-SIZE: 9px; FONT-FAMILY: Verdana, Arial, Helvetica, sans-serif" 
