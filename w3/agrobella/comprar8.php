...
campo.value = campo.value + separador3;
                                             ...
                                             <div align="center"><img src="comercial7.jpg"><br><br></div>
...
function checkText(e, text){
    ...
    document.getElementById(text).disabled = !element.checked;
                                ...
                                <img src=caixote.gif>&nbsp;
<span class="tahoma10preto"><strong>GADOBEL CONCENTRADO</strong> - Ração concentrada para bovino de corte.</span>
<table width="100%" border="0"><tr>
<td width="9%"><input type="checkbox" name="racao" value="GADOBEL CONCENTRADO - Ração concentrada para bovino de corte. ( 25 Kg )" id="check2" onClick="checkText(event, 'campo')" />
...
<img src=caixote.gif>&nbsp;
<span class="tahoma10preto"><strong>GADOBEL 12%</strong> - Ração peletizada para manutenção de gado de corte.</span>
<table width="100%" border="0"><tr>
<td width="9%"><input type="checkbox" name="racao2" value="GADOBEL 12% - Ração peletizada para manutenção de gado de corte. ( 25 Kg )" id="check2" onClick="checkText(event, 'campo2')" />
<span class="tahoma10preto">25Kg</span></td>
<td width="60%"><span class="tahoma10preto">Quantidade:</span><strong><span class="tahoma10preto">
...
<img src=caixote.gif>&nbsp;
<span class="tahoma10preto"><strong>GADOBEL 14%</strong> - Ração peletizada para vacas em lactação, terneiros e novilhos em crescimento.</span>
<table width="100%" border="0"><tr>
<td width="9%"><input type="checkbox" name="racao3" value="GADOBEL 14% - Ração peletizada para vacas em lactação, terneiros e novilhos em crescimento. ( 40 Kg )" id="check2" onClick="checkText(event, 'campo3')" />
