...
campo.value = campo.value + separador3;
                                           ...
                                           <div align="center"><img src="so2.jpg"><br><br></div>
...
function checkText(e, text){
    ...
    document.getElementById(text).disabled = !element.checked;
                                ...
                                <img src=caixote.gif>&nbsp;
<span class="tahoma10preto"><strong>Sem. de Sorgo AG 2501C</strong></span>
<table width="100%" border="0"><tr>
<td width="9%"><input type="checkbox" name="racao" value="Sem. de Sorgo AG 2501C ( 20 Kg )" id="check2" onClick="checkText(event, 'campo')" />
<span class="tahoma10preto">20 Kg</span></td>
