...
campo.value = campo.value + separador3;
                                          ...
                                          <div align="center"><img src="pet2.jpg"><br><br></div>
...
<table width="100%" border="0"><tr>
<td width="9%"><input type="checkbox" name="racao2" value="BELLINO - Ração para cães adultos. ( 8 Kg )" id="check2" onClick="checkText(event, 'campo2')" />
...
<tr><td><input type="checkbox" name="racao3" value="BELLINO - Ração para cães adultos. ( 25 Kg )" id="check3" onClick="checkText(event, 'campo3')" />
