                            ...
                            <TD class=tahoma10cinza666666><table width="100%" border="0">
                              <tr>
                                <td width="48%" class="tahoma10preto"><table width="100%" border="0">
                                    <tr>
                                      <td width="13%"><img src="semente1.jpg" width="133" height="45" /></td>
                                      <td width="87%"><div align="center">Fungicidas Maxim XL</div></td>
                                    </tr>
                                    <tr>
                                      <td>&nbsp;</td>
                                      <td>&nbsp;</td>
                              ...
                              <tr>
                                <td width="48%" class="tahoma10preto"><p><strong>MODO DE AÇÃO</strong><br />
                                  ...
                                  <p><strong>ALVO</strong><br />
                                    Tombamento, Tombamento, Antracnose, Manchas, Queima das Hastes<br />
                                    </p>
                                  <p><strong>DOSE</strong><br />
                                    150 ML / 100 KG, 100 ML / 100 KG<br />
                                    </p>
