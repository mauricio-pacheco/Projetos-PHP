                            ...
                            <TD class=tahoma10cinza666666><table width="100%" border="0">
                              <tr>
                                <td width="48%" class="tahoma10preto"><table width="100%" border="0">
                                    <tr>
                                      <td width="13%"><img src="inset2.jpg" width="137" height="56" /></td>
                                      <td width="87%"><div align="center">Inseticidas Engeo Pleno</div></td>
                                    </tr>
                                    <tr>
                                      <td>&nbsp;</td>
                                      <td>&nbsp;</td>
                              ...
                              <tr>
                                <td width="48%" class="tahoma10preto"><p><strong>MODO DE AÇÃO</strong><br />
                                  Contato, Ingestão e Sistêmico<br />
                                  </p>
                                    <p><strong>CULTURA</strong><br />
                                      Soja, Trigo, Milho<br />
                                    </p>
                                  <p><strong>ALVO</strong><br />
                                    Pulgões, Percevejos, Lagartas<br />
                                    </p>
                                  <p><strong>DOSE</strong><br />
                                    40 a 50 ML / Há, 150 ML / Há, 80 a 100 ML / Há<br />
                                    </p>
