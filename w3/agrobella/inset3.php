                ...
                <TD vAlign=top width=80% bgColor=#ffffff>
                  ...
                  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
                    ...
                    <TR>
                      ...
                      height=32><img src="inseto.png"></TD>
                    </TR>
                    <TR>
                      <TD colSpan=2>
                            ...
                            <TD class=tahoma10cinza666666><table width="100%" border="0">
                              <tr>
                                <td width="48%" class="tahoma10preto"><table width="100%" border="0">
                                    <tr>
                                      <td width="13%"><img src="inset3.jpg" width="138" height="54" /></td>
                                      <td width="87%"><div align="center">Inseticidas Karate Zeon</div></td>
                                    </tr>
                                    <tr>
                                      <td>&nbsp;</td>
                                      <td>&nbsp;</td>
                              ...
                              <tr>
                                <td width="48%" class="tahoma10preto"><p><strong>MODO DE AÇÃO</strong><br />
                                  Contato e Ingestão<br />
                                  </p>
                                    <p><strong>CULTURA</strong><br />
                                      Feijão, Fumo, Milho, Soja, Trigo, Tomate, Algodão, Citros, Amendoin, Cebola, Couve, Batata<br />
                                    </p>
                                  <p><strong>ALVO</strong><br />
                                    Lagarta da Soja, Lagarta Militar, Lagarta do Trigo, Vaquinha Verde e Amarela, Pulgão, Percevejo, Bicudo, Mosca Branca<br />
                                    </p>
                                  <p><strong>DOSE</strong><br />
                                    150 ML / Há, 70 a 100 ML/ Há, 250 ML / Há, 300 ML / Há, 600 ML / Há</p>
