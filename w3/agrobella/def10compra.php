...
campo.value = campo.value + separador3;
                                           ...
                                           <div align="center"><img src="def10.jpg"><br><br></div>
...
function checkText(e, text){
    ...
    document.getElementById(text).disabled = !element.checked;
                                ...
                                <img src=caixote.gif>&nbsp;
<span class="tahoma10preto"><strong>Captan</strong></span>
<table width="100%" border="0"><tr>
<td width="9%"><input type="checkbox" name="racao" value="Captan ( 1 Lt )" id="check2" onClick="checkText(event, 'campo')" />
...
<tr>
<td width="9%"><input type="checkbox" name="racao2" value="Captan ( 5 Lts )" id="check2" onClick="checkText(event, 'campo2')" />
