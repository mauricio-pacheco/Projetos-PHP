...
campo.value = campo.value + separador3;
                                             ...
                                             <div align="center"><img src="comercial5.jpg"><br><br></div>
...
function checkText(e, text){
    ...
    document.getElementById(text).disabled = !element.checked;
                                ...
                                <img src=caixote.gif>&nbsp;
<span class="tahoma10preto"><strong>PAPITABEL</strong> - Ração pré-inicial para leitões.</span>
<table width="100%" border="0"><tr>
<td width="9%"><input type="checkbox" name="racao" value="PAPITABEL - Ração pré-inicial para leitões. ( 25 Kg )" id="check2" onClick="checkText(event, 'campo')" />
...
<img src=caixote.gif>&nbsp;
<span class="tahoma10preto"><strong>NINOBEL</strong> - Ração pré-inicial para leitões.</span>
<table width="100%" border="0"><tr>
<td width="9%"><input type="checkbox" name="racao2" value="NINOBEL - Ração pré-inicial para leitões. ( 25 Kg )" id="check2" onClick="checkText(event, 'campo2')" />
<span class="tahoma10preto">25Kg</span></td>
<td width="60%"><span class="tahoma10preto">Quantidade:</span><strong><span class="tahoma10preto">
...
<img src=caixote.gif>&nbsp;
<span class="tahoma10preto"><strong>NENEBEL</strong> - Ração inicial para leitões farelada e peletizada.</span>
<table width="100%" border="0"><tr>
<td width="9%"><input type="checkbox" name="racao3" value="NENEBEL - Ração inicial para leitões farelada e peletizada. ( 25 Kg )" id="check2" onClick="checkText(event, 'campo3')" />
<span class="tahoma10preto">25Kg</span></td>
<td width="60%"><span class="tahoma10preto">Quantidade:</span><strong><span class="tahoma10preto">
...
<img src=caixote.gif>&nbsp;
<span class="tahoma10preto"><strong>BAMBIBEL</strong> - Ração inicial pra leitões peletizada.</span>
<table width="100%" border="0"><tr>
<td width="9%"><input type="checkbox" name="racao4" value="BAMBIBEL - Ração inicial pra leitões peletizada. ( 25 Kg )" id="check2" onClick="checkText(event, 'campo4')" />
<span class="tahoma10preto">25Kg</span></td>
<td width="60%"><span class="tahoma10preto">Quantidade:</span><strong><span class="tahoma10preto">
...
<img src=caixote.gif>&nbsp;
<span class="tahoma10preto"><strong>SUIBEL CRESCIMENTO I</strong> - Ração de crescimento para suínos peletizada.</span>
<table width="100%" border="0"><tr>
<td width="9%"><input type="checkbox" name="racao5" value="SUIBEL CRESCIMENTO I - Ração de crescimento para suínos peletizada. ( 25 Kg )" id="check2" onClick="checkText(event, 'campo5')" />
<span class="tahoma10preto">25Kg</span></td>
<td width="60%"><span class="tahoma10preto">Quantidade:</span><strong><span class="tahoma10preto">
