...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
  ...
  <TR>
    <TD>
                ...
                <TD vAlign=top width=80% bgColor=#ffffff>
                  ...
                  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
                    ...
                    <TR>
                      ...
                      height=32><img src="agricola.png"></TD>
                    </TR>
                    <TR>
                      <TD colSpan=2>
                        ...
                        border=0>
                          <TBODY>
                          <TR>
                            <TD class=tahoma10cinza666666><table width="100%" border="0">
                                <tr>
                                <td width="48%" class="tahoma10preto"><table width="100%" border="0"><tr>
                                    <td align="center"><img src="so2.jpg"><br><br></td>
                                  </tr>
                                </table>
                                  </td>
                                </tr><tr>
                                <td width="48%" class="tahoma10preto"><p align="justify"><span style="font-weight: bold">AG 2501C</span></p>
                                  <p align="justify">O sorgo <STRONG>AG 2501 C</STRONG> produz em 40 dias uma pastagem de superior   qualidade e de alto valor nutritivo. Tem perfilamento vigoroso, rebrota rápida e   alta produção de massa verde, possibilitando dois pastejos antes da formação do   pasto com capim na renovação de pastagem ou três no sistema de integração   agricultura - pecuária. Outro benefício é a grande produção de palhada de alta   durabilidade para o Sistema de Plantio Direto. O <STRONG>AG 2501 C</STRONG> tem   alta produtividade, facilidade de manejo e flexibilidade. <BR>
                                    <BR>
                                    Nota: O   pastejo deverá ocorrer somente quando as plantas atingirem altura superior a 60   centímetros, para eliminar a possibilidade da formação de ácido cianídrico no   rúmen do animal, o que provoca intoxicação.</p>
     ...
     </TD></TR></TBODY></TABLE><TABLE height=60 cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TBODY>
        <TR>
                  ...
                  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
                    ...
                    <TR>
                      <TD vAlign=bottom height=25>
                        ...
                        href="index.php">Empresa</A> <span class="style1">|</span> <A class=tahoma10preto
                        href="pet2.php">Linha Pet</A> 
                        <span class="style1">|</span> <A class=tahoma10preto 
                        href="pet.php">Linha Comercial</A> 
                      <span class="style1">|</span> <A class=tahoma10preto
                        href="index.php">Localização</A> <span class="style1">|</span> <A class=tahoma10preto 
                        href="index.php">Novidades</A> <span class="style1">|</span> <A class=tahoma10preto 
                        href="index.php">Contatos</A></DIV></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE></TD>
