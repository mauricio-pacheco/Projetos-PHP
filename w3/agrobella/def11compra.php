...
campo.value = campo.value + separador3;
                                           ...
                                           <div align="center"><img src="def11.jpg"><br><br></div>
...
function checkText(e, text){
    ...
    document.getElementById(text).disabled = !element.checked;
                                ...
                                <img src=caixote.gif>&nbsp;
<span class="tahoma10preto"><strong>Orius 250 CE</strong></span>
<table width="100%" border="0"><tr>
<td width="9%"><input type="checkbox" name="racao" value="Orius 250 CE ( 1 Lt )" id="check2" onClick="checkText(event, 'campo')" />
