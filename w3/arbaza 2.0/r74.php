        ...
        <td><table width="98%" border="0" align="center">
          ...
          <table width="60%" border="0">
            ...
            <tr>
              ...
              <td><font size="2">Lentilha ARBAZA com Paio</font></td>
            </tr>
            <tr>
              <td width="2%">&nbsp;</td>
              <td width="98%">&nbsp;</td>
          ...
          <tr>
            <td><p>Ingredientes:</p>
              <p>500g de LENTILHA ARBAZA;<br>
                ...
                1 piment&atilde;o verde;<br>
                2 colheres (sopa) de &oacute;leo.<br>
              </p>
              <p>Preparo:</p>
              <p># Cozinhe as LENTILHAS ARBAZA em &aacute;gua fervente e reserve.<br>
                # Fa&ccedil;a um molho, refogando a cebola no &oacute;leo at&eacute; dourar. Junte o piment&atilde;o e os tomates,  acrescente o sal e a pimenta e ponha  3 paios picados.<br>
                # Quando os paios estiverem cozidos, junte a LENTILHA ARBAZA, deixando no fogo durante alguns minutos para apurar e tomar gosto.<br>
                # Sirva com arroz.</p>
              <p><br>
              </p></td>
          </tr>
