    ...
    <TD id=meio><table width="100%" border="0" align="center">
        ...
        <td><table width="98%" border="0" align="center">
          ...
          <table width="60%" border="0">
            ...
            <tr>
              ...
              <td><font size="2">Feij&atilde;o Branco ao Molho Agridoce</font></td>
            </tr>
            <tr>
              <td width="2%">&nbsp;</td>
              <td width="98%">&nbsp;</td>
      ...
      <tr>
        <td><table width="100%" border="0" align="center">
          <tr>
            <td><p>Ingredientes:</p>
              <p>&frac14; de x&iacute;cara de azeite;<br>
                1 cebola m&eacute;dia picada;<br>
                4 dentes de alho picados;<br>
                4 tomates cortados em pedacinhos;<br>
                &frac14; de x&iacute;cara de melado;<br>
                1 colher (ch&aacute;) de molho de pimenta vermelha;<br>
                500g de FEIJ&Atilde;O BRANCO OU CARIOCA ARBAZA, cozido e escorrido;<br>
                Sal a gosto.<br>
              </p>
              <p>Preparo:</p>
              <p># Numa panela com o azeite, frite a cebola e o alho at&eacute; dourar. Adicione o tomate, o melado e o molho de pimenta. Cozinhe at&eacute; ficar uma mistura &uacute;mida e soltar do fundo da panela.<br>
                # Junte o FEIJ&Atilde;O BRANCO OU CARIOCA ARBAZA, tempere e mexa somente para misturar. Sirva bem quente.</p>
              <p><br>
              </p>
              </td>
          </tr>
