    ...
    <TD id=meio><table width="100%" border="0" align="center">
        ...
        <td><table width="98%" border="0" align="center">
          ...
          <table width="60%" border="0">
            ...
            <tr>
              ...
              <td><font size="2">Sopa de Feij&atilde;o com Macarr&atilde;o</font></td>
            </tr>
            <tr>
              <td width="2%">&nbsp;</td>
              <td width="98%">&nbsp;</td>
      ...
      <tr>
        <td><table width="100%" border="0" align="center">
          <tr>
            <td><p>Ingredientes:</p>
              <p>2 x&iacute;caras de FEIJ&Atilde;O BRANCO ARBAZA, ou sobras de feij&atilde;o preto;<br>
                Sal em quantia suficiente;<br>
                2 dentes de alho;<br>
                2 colheres (sopa)  de azeite ou banha;<br>
                &frac12; cebola m&eacute;dia;<br>
                1 colher (sopa) de farinha de trigo;<br>
                2 cenouras;<br>
                4 batatinhas;<br>
                1 chuchu;<br>
                Tempero verde;<br>
                Macarr&atilde;o para sopa a gosto.<br>
              </p>
              <p>Preparo:</p>
              <p># Cozinhe o feij&atilde;o, tempere com sal,  a cebola, o alho e a farinha previamente fritos na gordura, ou aproveite as sobras de feij&atilde;o cozido.<br>
                # Passe na peneira ou no liq&uuml;idificador.<br>
                # Acrescente  os legumes picados e &aacute;gua na quantidade desejada, mas cuide para o caldo n&atilde;o ficar muito ralo.<br>
                # Quando os legumes estiverem cozidos, acrescente a massa. <br>
                # Sirva com p&atilde;o e queijo ralado.<br>
              </p>
              <p><br>
              </p></td>
          </tr>
