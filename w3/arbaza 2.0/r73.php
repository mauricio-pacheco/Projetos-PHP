    ...
    <TD id=meio><table width="100%" border="0" align="center">
        ...
        <td><table width="98%" border="0" align="center">
          ...
          <table width="60%" border="0">
            ...
            <tr>
              ...
              <td><font size="2">Lentilha ARBAZA com lingui&ccedil;a defumada</font></td>
            </tr>
            <tr>
              <td width="2%">&nbsp;</td>
              <td width="98%">&nbsp;</td>
      ...
      <tr>
        <td><table width="100%" border="0" align="center">
          <tr>
            <td><p>Ingredientes:</p>
              <p>500g de LENTILHA ARBAZA;<br>
                400g de ling&uuml;i&ccedil;a defumada;<br>
                4 dentes alho amassados e fritos;<br>
                1 cebola grande picada e frita;<br>
                1 tomate sem pele picado;<br>
                Tempero verde picado;<br>
                1 folha de louro;<br>
                1 talo de sals&atilde;o branco raspado e fatiado (opcional);<br>
                Sal a gosto;<br>
                &Aacute;gua para cobrir as LENTILHAS ARBAZA.<br>
              </p>
              <p>Preparo:</p>
              <p># Lave a LENTILHA ARBAZA e deixe de molho por  algumas horas.<br>
                # Desengordure a ling&uuml;i&ccedil;a, coloque todos os ingredientes numa panela e deixe cozinhar por 40 minutos aproximadamente.<br>
                # Verifique se a LENTILHA ARBAZA est&aacute; cozida e bom apetite.</p>
              <p><br>
              </p></td>
          </tr>
          <tr>
