    ...
    <TD id=meio><table width="100%" border="0" align="center">
        ...
        <td><table width="98%" border="0" align="center">
          ...
          <table width="60%" border="0">
            ...
            <tr>
              ...
              <td><font size="2">Pipoca ARBAZA com Coberturas de A&ccedil;ucar-de-Cana</font></td>
            </tr>
            <tr>
              <td width="2%">&nbsp;</td>
              <td width="98%">&nbsp;</td>
      ...
      <tr>
        <td><table width="100%" border="0" align="center">
          <tr>
            <td><p>Ingredientes:</p>
              <p>250g de PIPOCA ARBAZA; </p>
              <p>&Oacute;leo; </p>
              <p>200g de a&ccedil;&uacute;car-de-cana.<br>
              </p>
              <p>Preparo: </p>
              <p># Estoure a PIPOCA ARBAZA com o &oacute;leo.<br>
                # Ponha o a&ccedil;&uacute;car-de-cana em uma panela com aproximadamente uma colher (de sopa) de &aacute;gua e deixe derreter at&eacute; formar uma calda . Despeje por cima da PIPOCA ARBAZA.</p>
              <p><br>
              </p></td>
          </tr>
          <tr>
