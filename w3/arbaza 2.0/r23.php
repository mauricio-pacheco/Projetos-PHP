    ...
    <TD id=meio><table width="100%" border="0" align="center">
      ...
      <tr>
        <td><table width="100%" border="0" align="center">
          <tr>
            <td><p>Ingredientes:</p>
              <p>250 g de FEIJ&Atilde;O CARIOCA ARBAZA;<br>
                1 alho-por&oacute; (s&oacute; a parte verde);<br>
                1 talo de aipo;<br>
                Tomilho;<br>
                Louro;<br>
                Sal;<br>
              ...
              <p>Preparo:</p>
              <p># Deixe o FEIJ&Atilde;O CARIOCA ARBAZA de molho.<br>
                # Fa&ccedil;a um buqu&ecirc; com o alho-por&oacute;, o aipo, o tomilho e o louro.<br>
                # Leve o FEIJ&Atilde;O CARIOCA ARBAZA para cozinhar com sal e o buqu&ecirc; de temperos.<br>
                # Quando o FEIJ&Atilde;O CARIOCA ARBAZA estiver al dente acrescente a manteiga derretida e cozinhe at&eacute; engrossar o caldo.</p>
              <p>
              </p>
              </td>
          </tr>
