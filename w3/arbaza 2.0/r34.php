    ...
    <TD id=meio><table width="100%" border="0" align="center">
        ...
        <td><table width="98%" border="0" align="center">
          ...
          <table width="60%" border="0">
            ...
            <tr>
              ...
              <td><font size="2">Salada de Feij&atilde;o Rajado com Salsicha</font></td>
            </tr>
            <tr>
              <td width="2%">&nbsp;</td>
              <td width="98%">&nbsp;</td>
      ...
      <tr>
        <td><table width="100%" border="0" align="center">
          <tr>
            <td><p>Ingredientes:</p>
              <p>2 x&iacute;caras de FEIJ&Atilde;O RAJADO ARBAZA cozido;<br>
                3 ovos cozidos duros;<br>
                1 cebola ralada; <br>
                &frac12; x&iacute;cara de sals&atilde;o picado;<br>
                &frac12; x&iacute;cara de maionese;<br>
                2 colheres (de sopa) de vinagre;<br>
                100g de salsicha cortada em rodelinhas.<br>
              </p>
              <p>Preparo:</p>
              <p># Pique 2 ovos duros e corte 1 em rodelas. Misture todos os ingredientes. Leve &agrave; geladeira. Para servir, enfeite com as rodelas de ovo e de salsicha.<br>
              </p>
              <p>
              </p>
              </td>
