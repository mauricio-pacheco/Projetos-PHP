    ...
    <TD id=meio><table width="100%" border="0" align="center">
        ...
        <td><table width="98%" border="0" align="center">
          ...
          <table width="60%" border="0">
            ...
            <tr>
              ...
              <td><font size="2">Lentilha ARBAZA &agrave; moda casa</font></td>
            </tr>
            <tr>
              <td width="2%">&nbsp;</td>
              <td width="98%">&nbsp;</td>
      ...
      <tr>
        <td><table width="100%" border="0" align="center">
          <tr>
            <td><p>Ingredientes:</p>
              <p>1 kg de LENTILHAS ARBAZA;<br>
                250g de presunto;<br>
                250g de toucinho defumado;<br>
                250g de cenoura;<br>
                500g de batatas;<br>
                250g de nabo (opcional);<br>
                1 colher (sopa) de &oacute;leo;<br>
                2 cebolas;<br>
                2 tomates sem pele e sem sementes;<br>
                1 folha de louro;<br>
                4 dentes de alho;<br>
                1 ma&ccedil;o de cheiro verde;<br>
                Sal e pimenta a gosto.<br>
              </p>
              <p>Preparo:</p>
              <p># Deixe as LENTILHAS ARBAZA de molho.<br>
                #  Lave, escalde e deixe as carnes de molho.<br>
                # Coloque as carnes e os temperos para cozinhar num caldeir&atilde;o com &aacute;gua. Depois, separe o caldo da carne e cozinhe nele as LENTILHAS ARBAZA. <br>
                # Junte os nabos, as batatas e as cenouras. Acrescente a isso um refogado de alho, cebola e tomates. As carnes dever&atilde;o ser acrescentadas &agrave; LENTILHA ARBAZA, cuidando para que n&atilde;o cozinhe demais.<br>
              </p>
              <p><br>
              </p></td>
          </tr>
