    ...
    <TD id=meio><table width="100%" border="0" align="center">
        ...
        <td><table width="98%" border="0" align="center">
          ...
          <table width="60%" border="0">
            ...
            <tr>
              ...
              <td><font size="2">Lentilha com Linguicinha</font></td>
            </tr>
            <tr>
              <td width="2%">&nbsp;</td>
              <td width="98%">&nbsp;</td>
      ...
      <tr>
        <td><table width="100%" border="0" align="center">
          <tr>
            <td><p>Ingredientes:</p>
              <p>&frac12; kg de LENTILHA ARBAZA;<br>
                100g de bacon picadinho;<br>
                250g (aproximadamente) de ling&uuml;icinha de carne de porco;<br>
                2 batatas m&eacute;dias cortadas em cubinhos;<br>
                1 cebola m&eacute;dia picada;<br>
                3 dentes de alho esmagados;<br>
                1 caldo de galinha;<br>
                Pimenta-do-reino, sal, salsinha.<br>
              </p>
              <p>Preparo:</p>
              <p># Cozinhe a LENTILHA ARBAZA por  20 minutos, ou at&eacute; ficar macia, e acrescente as batatas.<br>
                #  Frite o bacon e as ling&uuml;i&ccedil;as. No &oacute;leo que sobrou, refogue a cebola, o alho e o caldo de galinha, juntando tudo com a LENTILHA ARBAZA. Tempere com sal e pimenta a gosto e, na hora de servir, acrescente a salsinha.</p>
              <p><br>
              </p></td>
          </tr>
          <tr>
