    ...
    <TD id=meio><table width="100%" border="0" align="center">
        ...
        <td><table width="98%" border="0" align="center">
          ...
          <table width="60%" border="0">
            ...
            <tr>
              ...
              <td><font size="2">Ca&ccedil;arola de Feij&atilde;o Vermelho ARBAZA</font></td>
            </tr>
            <tr>
              <td width="2%">&nbsp;</td>
              <td width="98%">&nbsp;</td>
      ...
      <tr>
        <td><table width="100%" border="0" align="center">
          <tr>
            <td><p>Ingredientes:</p>
              <p>250g de FEIJ&Atilde;O VERMELHO ARBAZA;<br>
                1 litro de &aacute;gua;<br>
                1 cebola;<br>
                2 colheres (sopa) de manteiga;<br>
                4 dentes de alho;<br>
                2 cenouras m&eacute;dias;<br>
                &frac12; x&iacute;cara de ervilha;<br>
                1 colher (ch&aacute;) sal temperado;<br>
                Pimenta-do-reino;<br>
              ...
              <p>Preparo:</p>
              <p># Cozinhe o FEIJ&Atilde;O VERMELHO ARBAZA na panela de press&atilde;o por 20 minutos.<br>
                # Numa ca&ccedil;arola de ferro, frite a cebola e o alho sem deixar queimar. Junte as cenouras picadas e frite tamb&eacute;m. Finalmente, acrescente as ervilhas e temperos, junte ao FEIJ&Atilde;O VERMELHO ARBAZA, e cozinhe por 10 minutos. Ao servir, acrescente o queijo ralado.<br>
              </p>
              <p>
              </p>
              </td>
