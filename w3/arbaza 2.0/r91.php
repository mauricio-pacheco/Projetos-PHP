    ...
    <TD id=meio><table width="100%" border="0" align="center">
        ...
        <td><table width="98%" border="0" align="center">
          ...
          <table width="60%" border="0">
            ...
            <tr>
              ...
              <td><font size="2">Pipoca ARBAZA com Caldo de Galinha</font></td>
            </tr>
            <tr>
              <td width="2%">&nbsp;</td>
              <td width="98%">&nbsp;</td>
      ...
      <tr>
        <td><table width="100%" border="0" align="center">
          <tr>
            <td><p>Ingredientes:</p>
              <p>250g de PIPOCA ARBAZA;<br>
                1 cubo de caldo de galinha; <br>
                Sal a gosto;<br>
                &Oacute;leo. <br>
              </p>
              <p>Preparo:</p>
              <p># Coloque na panela o &oacute;leo, a PIPOCA ARBAZA e o caldo de galinha amassado, com a panela ainda fora do fogo.<br>
                # Em fogo alto mexa a PIPOCA ARBAZA at&eacute; que o caldo de galinha esteja derretido e bem misturado com os gr&atilde;os. Abaixe um pouco o fogo e espere at&eacute; que estoure tudo. Se quiser acrescente sal.</p>
              <p><br>
              </p></td>
          </tr>
          <tr>
