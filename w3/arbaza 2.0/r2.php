    ...
    <TD id=meio><table width="100%" border="0" align="center">
        ...
        <td><table width="98%" border="0" align="center">
          ...
          <table width="60%" border="0">
            ...
            <tr>
              ...
              <td><font size="2">Caldinho de Feij&atilde;o ARBAZA</font></td>
            </tr>
            <tr>
              <td width="2%">&nbsp;</td>
              <td width="98%">&nbsp;</td>
      ...
      <tr>
        <td><table width="100%" border="0" align="center">
          <tr>
            <td><p>Ingredientes:</p>
              <p>2 litros de FEIJ&Atilde;O ARBAZA cozido, batido no liq&uuml;idificador;<br>
                4 tomates sem pele e sem sementes;<br>
                2 cebolas m&eacute;dias;<br>
                4 pimentas de cheiro (opcional);<br>
                3 pimentas malaguetas;<br>
                2 colheres (sopa) de manteiga.<br>
              </p>
              <p>Preparo:</p>
              <p># Passe no liq&uuml;idificador as cebolas, os tomates e as pimentas.<br>
                # Aque&ccedil;a a manteiga em uma panela e refogue os temperos batidos. Assim que a fervura levantar, junte o feij&atilde;o batido.<br>
                # Quando bater o feij&atilde;o cozido, coloque no liq&uuml;idificador mais caldo do que gr&atilde;os, para evitar a necessidade de acrescentar &aacute;gua posteriormente.<br>
                # Se o caldo ficar muito grosso, acrescente, aos poucos, &aacute;gua fervendo.</p>
              <p>
              </p></td>
          </tr>
          <tr>
