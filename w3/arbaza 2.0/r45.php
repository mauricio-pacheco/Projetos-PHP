    ...
    <TD id=meio><table width="100%" border="0" align="center">
        ...
        <td><table width="98%" border="0" align="center">
          ...
          <table width="60%" border="0">
            ...
            <tr>
              ...
              <td><font size="2">Salada de Feij&atilde;o e Salsicha</font></td>
            </tr>
            <tr>
              <td width="2%">&nbsp;</td>
              <td width="98%">&nbsp;</td>
      ...
      <tr>
        <td><table width="100%" border="0" align="center">
          <tr>
            <td><p>Ingredientes:</p>
              <p>2 x&iacute;caras de FEIJ&Atilde;O VERMELHO ARBAZA;<br>
                250g de salsichas frescas aquecidas e cortadas ou salsicha em lata cortada;<br>
                4 fatias de queijo prato cortadas em tiras finas;<br>
                &frac12; kg de vagem cozida;<br>
                1 piment&atilde;o verde bem picado;<br>
                1 cebola bem picada;<br>
                1 x&iacute;cara de maionese;<br>
                2 colheres (de sopa) de suco de lim&atilde;o;<br>
                1 colher de (ch&aacute;) de mostarda;<br>
                Sal a gosto.<br>
              </p>
              <p>Preparo:</p>
              <p># Misture todos os ingredientes numa vasilha grande e coloque na geladeira at&eacute; o momento de servir.</p>
              <p><br>
              </p>
              </td>
          </tr>
