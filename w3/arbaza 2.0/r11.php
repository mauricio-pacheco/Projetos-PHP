    ...
    <TD id=meio><table width="100%" border="0" align="center">
        ...
        <td><table width="98%" border="0" align="center">
          ...
          <table width="60%" border="0">
            ...
            <tr>
              ...
              <td><font size="2">Sopa de Feij&atilde;o ARBAZA com Arroz</font></td>
            </tr>
            <tr>
              <td width="2%">&nbsp;</td>
              <td width="98%">&nbsp;</td>
      ...
      <tr>
        <td><table width="100%" border="0" align="center">
          <tr>
            <td><p>Ingredientes:</p>
              <p>400g de FEIJ&Atilde;O PRETO ARBAZA;<br>
                2 batatas descascadas e cortadas ao meio;<br>
                A parte branca de um aipo (opcional);<br>
                Sal e pimenta;<br>
                100g de toucinho picado;<br>
                1 x&iacute;cara de arroz bem limpo, mas n&atilde;o lavado;<br>
                Manteiga;<br>
                50g de queijo parmes&atilde;o ralado.<br>
              </p>
              <p>Preparo:</p>
              <p># Cozinhe o FEIJ&Atilde;O PRETO ARBAZA em panela de press&atilde;o por 35 minutos. Junte a batata, o aipo, tempere com sal e pimenta. <br>
                # &Agrave; parte, frite o  toucinho, escorra o &oacute;leo e junte ao FEIJ&Atilde;O PRETO ARBAZA.<br>
                # Antes que a batata cozinhe, junte o arroz  e a manteiga; se o caldo ficar muito grosso acrescente um pouco de &aacute;gua fervente.<br>
                # Sirva bem quente e polvilhe com o queijo ralado.<br>
              </p>
              <p>
              </p></td>
          </tr>
