    ...
    <TD id=meio><table width="100%" border="0" align="center">
        ...
        <td><table width="98%" border="0" align="center">
          ...
          <table width="60%" border="0">
            ...
            <tr>
              ...
              <td><font size="2">Pipoca ARBAZA com Cobertura de Chocolate</font></td>
            </tr>
            <tr>
              <td width="2%">&nbsp;</td>
              <td width="98%">&nbsp;</td>
      ...
      <tr>
        <td><table width="100%" border="0" align="center">
          <tr>
            <td><p>Ingredientes:</p>
              <p>250 g de PIPOCA ARBAZA;</p>
              <p>&Oacute;leo para estourar.<br>
              </p>
              <p>Para a cobertura: </p>
              <p>150g de chocolate em p&oacute;;</p>
              <p>50g de a&ccedil;&uacute;car;</p>
              <p>1 colher (de sopa) de &aacute;gua.<br>
              </p>
              <p>Preparo:</p>
              <p># Estoure a PIPOCA ARBAZA com o &oacute;leo normalmente. <br>
                # Misture o chocolate em p&oacute;, o a&ccedil;&uacute;car e a &aacute;gua. Deixe em fogo baixo at&eacute; derreter. Ap&oacute;s derretido n&atilde;o pare de mexer. Deixe em ponto de bala. (Quando desprender do fundo da panela). Despeje por cima da PIPOCA ARBAZA.</p>
              <p><br>
              </p></td>
          </tr>
          <tr>
