    ...
    <TD id=meio><table width="100%" border="0" align="center">
        ...
        <td><table width="98%" border="0" align="center">
          ...
          <table width="60%" border="0">
            ...
            <tr>
              ...
              <td><font size="2">Sopa de Lentilhas ARBAZA com Acelga</font></td>
            </tr>
            <tr>
              <td width="2%">&nbsp;</td>
              <td width="98%">&nbsp;</td>
      ...
      <tr>
        <td><table width="100%" border="0" align="center">
          <tr>
            <td><p>Ingredientes:</p>
              <p>1 x&iacute;cara de LENTILHAS ARBAZA;<br>
                1 ma&ccedil;o de acelga;<br>
                2 batatas grandes cortadas finas;<br>
                1 colher (sopa) de &oacute;leo;<br>
                2 cebolas grandes cortadas em fatias;<br>
                2 dentes de alho socados com sal;<br>
                Coentro (opcional);<br>
                2 colheres (sopa) de farinha de trigo;<br>
                1 &frac12; litros de &aacute;gua;<br>
                Suco de 1 laranja azeda;<br>
                1 colher (sopa) &aacute;gua.<br>
              </p>
              <p>Preparo:</p>
              <p># Lave as LENTILHAS ARBAZA e coloque na &aacute;gua para cozinhar. Quando as LENTILHAS ARBAZA estiverem quase moles, junte a acelga cortada e as batatas. Frite no &oacute;leo a cebola picada e o alho socado, at&eacute; dourar. A&iacute;, despeje tudo no caldo e deixe cozinhar at&eacute; que as LENTILHAS ARBAZA fiquem bem macias.<br>
                # Por fim, engrosse o caldo com 2 colheres rasas ( sopa) de farinha de trigo, dissolvidas no suco de uma laranja azeda e 1 colher (sopa) &aacute;gua fria.</p>
              <p><br>
              </p></td>
          </tr>
          <tr>
