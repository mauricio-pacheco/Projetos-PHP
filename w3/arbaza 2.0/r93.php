        ...
        <td><table width="98%" border="0" align="center">
          ...
          <table width="60%" border="0">
            ...
            <tr>
              ...
              <td><font size="2">Pipoca ARBAZA com Bacon</font></td>
            </tr>
            <tr>
              <td width="2%">&nbsp;</td>
              <td width="98%">&nbsp;</td>
        ...
        <td><table width="100%" border="0" align="center">
          <tr>
            <td><p>Ingredientes:</p>
              ...
              <p>Bacon em tirinhas;</p>
              <p>Sal a gosto.<br>
              </p>
              <p>Preparo:</p>
              <p># Frite o bacon na panela onde ser&aacute; feita a PIPOCA ARBAZA. Retire o excesso de gordura que ficou na panela e coloque a PIPOCA ARBAZA para estourar  junto com o bacon frito. Ponha sal a gosto.</p>
              <p><br>
              </p></td>
          </tr>
          <tr>
