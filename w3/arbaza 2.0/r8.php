    ...
    <TD id=meio><table width="100%" border="0" align="center">
        ...
        <td><table width="98%" border="0" align="center">
          ...
          <table width="60%" border="0">
            ...
            <tr>
              ...
              <td><font size="2">Feijoada Completa</font></td>
            </tr>
            <tr>
              <td width="2%">&nbsp;</td>
              <td width="98%">&nbsp;</td>
      ...
      <tr>
        <td><table width="100%" border="0" align="center">
          <tr>
            <td><p>Ingredientes:</p>
              <p>2 &frac12; kg de FEIJ&Atilde;O PRETO ARBAZA;<br>
                6 orelhas de porco;<br>
                10 p&eacute;s de porco;<br>
                &frac12; kg de salame em peda&ccedil;os m&eacute;dios;<br>
                1 feixe de tempero verde;<br>
                2 cebolas;<br>
                4 piment&otilde;es vermelhos;<br>
                150g de toucinho;<br>
                &frac12; kg de costela defumada.<br>
              </p>
              <p>Preparo:</p>
              <p># Cozinhe as carnes separadas sem sal. Cozinhe o FEIJ&Atilde;O PRETO ARBAZA e soque.<br>
                # Frite a cebola, os temperos e os piment&otilde;es. Acrescente a costela, o toucinho, o salame e frite novamente.<br>
                # Misture as carnes ao FEIJ&Atilde;O PRETO ARBAZA e v&aacute; colocando, aos poucos, a &aacute;gua onde foram cozidas as carnes, a fim de controlar para que a feijoada n&atilde;o fique muito salgada.<br>
                # D&aacute; para 10 ou 12 pessoas.<br>
              </p>
              <p>OBS: Para acompanhar a feijoada servir: </p>
              <p>- couve refogada;</p>
              <p>- farofa;</p>
              <p>- laranja fatiada.<br>
              </p>
              <p>
              </p></td>
          </tr>
