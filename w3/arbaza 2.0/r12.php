        ...
        <td><table width="98%" border="0" align="center">
          ...
          <table width="60%" border="0">
            ...
            <tr>
              ...
              <td><font size="2">Sopa de Feij&atilde;o Preto ARBAZA</font></td>
            </tr>
            <tr>
              <td width="2%">&nbsp;</td>
              <td width="98%">&nbsp;</td>
          ...
          <tr>
            <td><p>Ingredientes:</p>
              <p>2 x&iacute;caras de FEIJ&Atilde;O PRETO ARBAZA ;<br>
                3 ling&uuml;i&ccedil;as cortadas em rodelas;<br>
                Massa para sopa;<br>
                2 batatas picadas;<br>
                Verduras a gosto;<br>
                Tempero verde;<br>
                Sal e pimenta.<br>
              </p>
              <p>Preparo:</p>
              <p># Bata no liq&uuml;idificador o FEIJ&Atilde;O PRETO ARBAZA previamente cozido com sal e pimenta.<br>
                #  Leve ao fogo com as rodelas de ling&uuml;i&ccedil;a, as batatas e outras verduras que tiver dispon&iacute;vel.<br>
                #  Quando as verduras estiverem cozidas, acrescente a massa de sopa. Antes de servir acrescente os temperos verdes.<br>
              </p>
              <p>
              </p></td>
          </tr>
