    ...
    <TD id=meio><table width="100%" border="0" align="center">
        ...
        <td><table width="98%" border="0" align="center">
          ...
          <table width="60%" border="0">
            ...
            <tr>
              ...
              <td><font size="2">Feij&atilde;o Rajado ARBAZA com Bacon</font></td>
            </tr>
            <tr>
              <td width="2%">&nbsp;</td>
              <td width="98%">&nbsp;</td>
      ...
      <tr>
        <td><table width="100%" border="0" align="center">
          <tr>
            <td><p>Ingredientes:</p>
              <p>&frac12; kg de FEIJ&Atilde;O RAJADO ARBAZA ;<br>
                250g de bacon cortado em quadradinhos; <br>
                1 cebola picada;<br>
                1 piment&atilde;o verde picado;<br>
                1 colher (de sopa) de farinha de trigo;<br>
                Sal e pimenta a gosto;<br>
                2 colheres (de ch&aacute;) de mostarda;<br>
                2 colheres (de sopa) de a&ccedil;&uacute;car mascavo;<br>
                1 caixinha pequena de pur&ecirc; de tomate.<br>
              </p>
              <p>Preparo:</p>
              <p># Cozinhe o FEIJ&Atilde;O RAJADO ARBAZA. Escorra. Frite o bacon numa frigideira grande at&eacute; que fique durinho. Retire o bacon e escorra. Adicione a cebola e o piment&atilde;o verde &agrave; gordura na frigideira e deixe fritar por cerca de 5 minutos. Acrescente a farinha, os temperos e o a&ccedil;&uacute;car mascavo. <br>
                # Junte o pur&ecirc; de tomate e deixe cozinhar durante aproximadamente 10 minutos. Junte o FEIJ&Atilde;O e aque&ccedil;a. Salpique com o bacon.<br>
              </p>
              <p>
              </p>
              </td>
