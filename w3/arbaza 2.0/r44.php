    ...
    <TD id=meio><table width="100%" border="0" align="center">
        ...
        <td><table width="98%" border="0" align="center">
          ...
          <table width="60%" border="0">
            ...
            <tr>
              ...
              <td><font size="2">Salada de Feij&atilde;o Vermelho ARBAZA</font></td>
            </tr>
            <tr>
              <td width="2%">&nbsp;</td>
              <td width="98%">&nbsp;</td>
      ...
      <tr>
        <td><table width="100%" border="0" align="center">
          <tr>
            <td><p>Ingredientes:</p>
              <p>2 x&iacute;caras de FEIJ&Atilde;O VERMELHO ARBAZA cozido e sem o caldo;<br>
                2 cebolas m&eacute;dias picadas;<br>
                2 tomates m&eacute;dios picados;<br>
                1 molho de tempero verde picado;<br>
                1 piment&atilde;o verde picado;<br>
                Vinagre, azeite de oliva, sal e pimenta;<br>
                2 dentes de alho picados;<br>
                2 ovos cozidos (opcional)- para enfeitar.<br>
              </p>
              <p>Preparo:</p>
              <p># Misture os ingredientes ao FEIJ&Atilde;O VERMELHO ARBAZA ainda quente, tempere a gosto e, se quiser, enfeite com rodelas de ovos.</p>
              <p><br>
              </p>
              </td>
          </tr>
