                ...
                <TD vAlign=center align=middle height=109><table width="100%" border="0">
                  <tr>
                    <td><p align="center" class="style6"><br>
                      <span class="style7">Seu formul&aacute;rio foi enviado com sucesso!</span></p>
...
$mens .= "..:: FORMULÁRIO DE CONTATO DO SITE GRAFIMAR ::..";
$mens .= "<BR><BR>";
$mens .= "Nome: ";
$mens .= "$nome";
$mens .= "<br><br>";
...
$headers .= "From: \"Formulario Contato Site Grafimar\"\r\n";
