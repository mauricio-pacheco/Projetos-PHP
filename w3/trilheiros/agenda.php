              ...
              <TR>
                <TD>
                  ...
                  border=0 align=center cellPadding=0 cellSpacing=0 bgcolor="#282828">
                    ...
                    <tr>
                      <td><div align="center"><img src="home_arquivos/agenda.jpg" width="200" height="30" /></div></td>
                    </tr>
                    <tr>
                          <td>
...
$sql_select = "SELECT * FROM agenda LIMIT $inicio, $qnt";
// Executa o Query
...
<table width="100%" border="0" align="center">
                            ...
                            <tr >
                              <td width="26%"><table width="100%" border="0">
                                <tr>
                                  <td><span class="style22"><a href="verevento.php?id=<?php echo $id.""; ?>"><img src="home_arquivos/caxeta.gif" width="14" height="14" border="0" />&nbsp;<?php echo $assunto.""; ?> </a><span class="style23">-</span><font color="#FEDC00"> Data do Evento: </font><?php echo $dataevento.""; ?></span></td>
                                </tr>
                                <tr>
                                  <td><span class="style20"><font color='#D29B36' arial,="Arial," helvetica,="Helvetica," sans-serif\="sans-serif\""><b>Local:</b></font><span class="style22">&nbsp;<?php echo $local.""; ?></span></span></td>
                                </tr>
                              </table></td>
                              </tr>
                                           </table>
