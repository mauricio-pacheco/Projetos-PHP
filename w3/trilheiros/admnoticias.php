...
alert("O Campo Título da Notícia não está preenchido!")
form1.assunto.focus();
return false
}

if (document.form1.local.value=="") {
alert("O Campo Fonte não está preenchido!")
form1.local.focus();
return false
}
...
</SCRIPT><form name="form1" action="cadnoticia.php" method="post" enctype="multipart/form-data" onSubmit="return validar(this)">
                                    <table width="91%" border="0">
                                      <tr>
                                        <td width="107"><span class="style15"><span class="style9">T&iacute;tulo da Not&iacute;cia: </span></span></td>
                                        <td width="454"><span class="style15">
                                          <input name="assunto" type="text" class="caixacontato" size="60" />
                                          <span class="style9">*</span> </span></td>
                                      </tr>
                                      <tr>
                                        <td width="107"><span class="style15"><span class="style9">Fonte: </span></span></td>
                                        <td width="454"><span class="style15">
                                          <input name="local" type="text" class="caixacontato" size="60" />
                                          <span class="style9">*</span> </span></td>
                                      </tr>
                                        <tr>
                                        <td width="107"><span class="style15"><span class="style9">Enviar imagem para o servidor: </span></span></td>
                                        <td width="454"><iframe marginwidth="0" marginheight="0" src="enviafoto.php" frameborder="0" width="520" scrolling="no" height="24"></iframe>&nbsp;</td>
                                      </tr>
                                    </table>
