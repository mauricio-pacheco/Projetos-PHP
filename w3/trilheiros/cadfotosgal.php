                        ...
                        <table width="98%" border="0">
                          <tr>
                            <td><div align="center">
                              ...
                              <p><span class="style19">Cadastrar Foto</span></p>
                              <table width="98%" border="0">
                                <tr>
...
if($arquivo)
{
    ...
    if(is_uploaded_file($arquivo['tmp_name']))
    {
        if(verifica_image($arquivo))
        {
            ...
            $nome_foto  = ('imagem_' . time() . '.' . verifica_extensao_image($arquivo));// nome Ãºnico para foto
...
$sql = "INSERT INTO fotos (galeria, comentario, foto, data, hora) VALUES ('$galeria', '$comentario', '$nome_foto', '$data', '$hora')";
if(mysql_query($sql)) {
echo "<div align=center><br><font color='#ffffff' size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">A sua foto foi cadastrada com sucesso!!</font><br><br><font color='#ffffff' size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\"><a href='admfotosenviar.php'>ENVIAR MAIS FOTOS!</a></font></div>";
}else{
echo "<div align=center><br><font color='#ffffff' size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">Não foi possivel efetuar o seu cadastro da foto!</font></div>";
}
