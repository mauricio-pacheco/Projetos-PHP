              ...
              <TR>
                <TD>
                  ...
                  border=0 align=center cellPadding=0 cellSpacing=0 bgcolor="#282828">
                    ...
                    <tr>
                      <td><div align="center"><img src="home_arquivos/noticias.jpg" width="200" height="30" /></div></td>
                    </tr>
                    <tr>
                          <td>
...
$sql_select = "SELECT * FROM noticias LIMIT $inicio, $qnt";
// Executa o Query
...
<table width="100%" border="0" align="center">
                            ...
                            <tr >
                              <td width="26%"><table width="100%" border="0">
                                <tr>
                                  <td><span class="style22"><a href="vernoticia.php?id=<?php echo $id.""; ?>"><img src="home_arquivos/not.gif" width="14" height="14" border="0"/>&nbsp;<?php echo $assunto.""; ?> </a><span class="style23">-</span></span><span class="style20"><font color="#FEDC00"> </font></span><span class="style22"><?php echo $data.""; ?> - <?php echo $hora.""; ?></span></td>
                                </tr>
                              </table></td>
                              </tr>
                                           </table>
...
echo "<a href='fotos.php?p=1' target='_self'>PRIMEIRA P&Aacute;GINA</a> <font color='#ffffff' size='1'>-</font> ";
...
echo " <font color='#ffffff' size='1'>-</font> <a href='fotos.php?p=".$pags."' target='_self'>&Uacute;LTIMA P&Aacute;GINA</a> ";
?></span></td>
                        </tr>
