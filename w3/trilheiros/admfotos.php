                        ...
                        <table width="98%" border="0">
                          <tr>
                            <td><div align="center">
                              ...
                              <p><span class="style19">Cadastrar Galerias</span></p>
...
</SCRIPT><form name="form1" action="cadfotos.php" method="post" enctype="multipart/form-data" onSubmit="return validar(this)">
                                    <table width="80%" border="0">
                                      <tr>
                                        <td width="160"><span class="style15"><span class="style9">Título da Galeria: </span></span></td>
                                        <td width="401"><span class="style15">
                                          <input name="nomegaleria" type="text" class="caixacontato" size="60" />
                                          <span class="style9">*</span> </span></td>
                                      </tr>
                                      <tr>
                                        <td><span class="style15"><span class="style9">Foto da Capa da Galeria: </span></span></td>
