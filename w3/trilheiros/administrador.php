...
return false
                            ...
                            <span class="style15"><img src="home_arquivos/logotrilha.jpg" width="121" height="120" /></span></p>
                        <form name="form1" action="auth.php" method="post" onSubmit="return validar(this)">
                          <p><span class="style17">* Campos Obrigat&oacute;rios</span></p>
                          <table width="24%" border="0">
                            <tr>
                              <td width="47"><span class="style15"><span class="style9">Usuário: </span></span></td>
                              <td width="243"><span class="style15">
                                <input name="usuario" type="text" class="caixacontato" size="16" />
                                <span class="style9">                              *</span></span></td>
                            </tr>
                            <tr>
                              <td><span class="style15"><span class="style9">Senha:</span></span></td>
                          ...
                          <p align="center" class="style15"><span class="style15">
                            <input type="submit" class="texto" value="Entrar" />&nbsp;&nbsp; <input class="texto" type="reset" value="Limpar" />
                            </span> </p>
                          </form>
                        </div></TD>
