                        ...
                        <table width="98%" border="0">
                          <tr>
                            <td><div align="center">
                              ...
                              <p><span class="style19">Apagar  Integrantes</span></p>
                              <table width="98%" border="0">
                                <tr>
...
$sql = mysql_query("SELECT * FROM integrantes ORDER BY id");
$contar = mysql_num_rows($sql); 

if ($contar < 1)  //Mostra se hÃ¡ algum registro na tabela, caso nÃ£o houver, ele mostrarÃ¡ a mensagem abaixo
   {echo "<div align=center><font color='#ffffff' size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\"><b>N�o existe integrantes cadastrados!</b></font></div>"; 
   }
...
while($n = mysql_fetch_array($sql))
   {
   ?>
                                          <font color="#FFFF00"><?php echo $n["nome"]; ?></font> - <a href="admintegrantedeletar2.php?id=<?php echo $n["id"]; ?>&foto=<?php echo $n["foto"]; ?>" onClick="return confirm('Tem certeza que deseja apagar o integrante <?php echo $n["nome"]; ?> ?')"><font color="#FFFFFF">Apagar</font> <img src="home_arquivos/apagar.gif" border="0"></a><br />
                                          <br />
                                          <?
  }
  }
