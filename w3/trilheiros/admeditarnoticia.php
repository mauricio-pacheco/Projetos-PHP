                        ...
                        <table width="98%" border="0">
                          <tr>
                            <td><div align="center">
                              ...
                              <p><span class="style19">Editar Not&iacute;cia</span></p>
...
if ($contar < 1)  //Mostra se hÃ¡ algum registro na tabela, caso nÃ£o houver, ele mostrarÃ¡ a mensagem abaixo
   {echo "<div align=center><font color='#ffffff' size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\"><b>Não existe notícias cadastradas!</b></font></div>"; 
   }
...
while($n = mysql_fetch_array($sql))
   {
   ?><form name="form1" action="admupdatenoticia.php" method="post" enctype="multipart/form-data" onSubmit="return validar(this)">
