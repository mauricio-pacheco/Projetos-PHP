...
function Inibe() {
  document.cadastro.foto2.disabled = true;
}

function Exibe() {
  document.cadastro.foto2.disabled = false;
}
...
-->
    ...
    <tr class="back">
      ...
      <td 
        ...
        <span class="style9"><input type="radio" name="foto" onClick="Exibe()">
        Enviar nova foto
        <input type="radio" name="foto" onClick="Inibe()" value="<?php echo $n["foto"]; ?>" checked> 
        Deixar mesma foto        </span></td>
    </tr>
    <tr class="back">
      <td 
