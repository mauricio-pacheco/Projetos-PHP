                        ...
                        <table width="98%" border="0">
                          <tr>
                            <td><div align="center">
                              ...
                              <p><span class="style19">Cadastrar Galeria</span></p>
                              <table width="98%" border="0">
                                <tr>
...
$sql = "INSERT INTO galeria (foto, nomegaleria, comentario, data, hora) VALUES ('$nome_foto', '$nomegaleria', '$comentario', '$data', '$hora')";
if(mysql_query($sql)) {
echo "<div align=center><br><font color='#ffffff' size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">A sua galeria foi cadastrada com sucesso!!</font></div>";
}else{
echo "<div align=center><br><font color='#ffffff' size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">Não foi possivel efetuar o seu cadastro da galeria!</font></div>";
}
