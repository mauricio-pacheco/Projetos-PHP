                        ...
                        <table width="98%" border="0">
                          <tr>
                            <td><div align="center">
                              ...
                              <p><span class="style19">Anexar Fotos nas Galerias Fotos</span></p>
                              <p><span class="style19">Selecione a Galeria para a enviar as Fotos</span></p>
                              <table width="98%" border="0">
                                <tr>
...
?>
                                    <font color="#FFFF00"><img src="capas/<?php echo $foto.""; ?>" border="0" width="100" height="75"></font> &nbsp;                                         <font color="#FFFF00"><?php echo $nomegaleria.""; ?></font> - <a href="admanexafoto.php?id=<?php echo $id.""; ?>&amp;nomegaleria=<?php echo $nomegaleria.""; ?>"><font color="#FFFFFF">ANEXAR FOTOS A GALERIA</font> <img src="home_arquivos/editar.gif" border="0"></a><br />
                                          <br />
                                          <?php
...
echo "<a href='admfotosenviar.php?p=1' target='_self' class=manchete_texto4>PRIMEIRA P&Aacute;GINA</a> <font color='#ffffff' size='1'>-</font> ";
...
echo "<a href='admfotosenviar.php?p=".$i."' target='_self'>".$i."</a> ";
}
}
...
echo " <font color='#ffffff' size='1'>-</font> <a href='admfotosenviar.php?p=".$pags."' target='_self'>&Uacute;LTIMA P&Aacute;GINA</a> ";
?>
                                  </p>
