...
$sql = "UPDATE galeria SET nomegaleria = '$nomegaleria', comentario = '$comentario', foto = '$nome_foto0' WHERE id = '$id'";
if(mysql_query($sql)) {
echo "<br><div align=center class=manchete_texto>A GALERIA FOI EDITADA COM SUCESSO!!</div>";
}else{
