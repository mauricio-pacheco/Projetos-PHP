                        ...
                        <table width="98%" border="0">
                          <tr>
                            <td><div align="center">
                              ...
                              <p><span class="style19">Apagar Eventos</span></p>
                              <table width="98%" border="0">
                                <tr>
...
?>
                                    <font color="#FFFF00"><?php echo $assunto.""; ?></font> - <a href="admexcluiragenda.php?id=<?php echo $id.""; ?>&amp;foto=<?php echo $foto.""; ?>&amp;fotomaior=<?php echo $fotomaior.""; ?>" onClick="return confirm('Tem certeza que deseja apagar o evento <?php echo $assunto.""; ?> ?')"><font color="#FFFFFF">APAGAR AGENDA</font> <img src="home_arquivos/apagar.gif" border="0"></a><br />
                                          <br />
                                          <?php
...
echo "<a href='admagendadeletar.php?p=1' target='_self' class=manchete_texto4>PRIMEIRA P&Aacute;GINA</a> <font color='#ffffff' size='1'>-</font> ";
...
echo "<a href='admagendadeletar.php?p=".$i."' target='_self'>".$i."</a> ";
}
}
...
echo " <font color='#ffffff' size='1'>-</font> <a href='admagendadeletar.php?p=".$pags."' target='_self'>&Uacute;LTIMA P&Aacute;GINA</a> ";
?>
                                  </p>
