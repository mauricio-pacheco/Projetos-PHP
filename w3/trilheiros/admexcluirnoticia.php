...
<meta HTTP-EQUIV="refresh" CONTENT="1;URL=admnoticiadeletar.php">
<STYLE type=text/css>
.style5 {
	font-size: 9px
}
                        ...
                        <table width="98%" border="0">
                          <tr>
                            <td><div align="center">
                              ...
                              <p><span class="style19">Apagar Not&iacute;cia</span></p>
                              <table width="98%" border="0">
                                <tr>
...
if ($query)  
{
echo "<div align=center><font color='#ffffff' size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">Notícia deletada com sucesso!</font></div>";
}else{
echo "<div align=center><font color='#ffffff' size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">Não foi possível deletar a notícia.</font></div>";
}
?></p>
