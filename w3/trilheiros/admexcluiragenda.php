...
<meta HTTP-EQUIV="refresh" CONTENT="1;URL=admagendadeletar.php">
<STYLE type=text/css>
.style5 {
	font-size: 9px
}
                        ...
                        <table width="98%" border="0">
                          <tr>
                            <td><div align="center">
                              ...
                              <p><span class="style19">Apagar Evento</span></p>
                              <table width="98%" border="0">
                                <tr>
...
$foto = $_GET['foto'];
$fotomaior = $_GET['fotomaior'];

unlink("fotosagenda/$foto");
unlink("fotosagendamaior/$fotomaior");


$query = mysql_query("DELETE FROM agenda WHERE id='$id'");
if ($query)  
{
echo "<div align=center><font color='#ffffff' size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">Evento deletado com sucesso!</font></div>";
}else{
echo "<div align=center><font color='#ffffff' size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">Não foi possível deletar o evento.</font></div>";
}
?></p>
