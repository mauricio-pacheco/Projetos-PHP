                        ...
                        <table width="98%" border="0">
                          <tr>
                            <td><div align="center">
                              ...
                              <p><span class="style19">Editar  Not&iacute;cias</span></p>
                              <table width="98%" border="0">
                                <tr>
...
?>
                                    <font color="#FFFF00"><?php echo $assunto.""; ?></font> - <a href="admeditarnoticia.php?id=<?php echo $id.""; ?>"><font color="#FFFFFF">EDITAR NOT&Iacute;CIA</font> <img src="home_arquivos/editar.gif" border="0"></a><br />
                                          <br />
                                          <?php
...
echo "<a href='admnoticiaeditar.php?p=1' target='_self' class=manchete_texto4>PRIMEIRA P&Aacute;GINA</a> <font color='#ffffff' size='1'>-</font> ";
...
echo "<a href='admnoticiaeditar.php?p=".$i."' target='_self'>".$i."</a> ";
}
}
...
echo " <font color='#ffffff' size='1'>-</font> <a href='admnoticiaeditar.php?p=".$pags."' target='_self'>&Uacute;LTIMA P&Aacute;GINA</a> ";
?>
                                  </p>
