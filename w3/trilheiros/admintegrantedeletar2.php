...
<meta HTTP-EQUIV="refresh" CONTENT="1;URL=admintegrantedeletar.php">
<STYLE type=text/css>
.style5 {
	font-size: 9px
}
...
$query = mysql_query("DELETE FROM integrantes WHERE id='$id'");
unlink("integrantes/$foto");
if ($query)  
{
echo "<div align=center><font color='#ffffff' size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">Integrante deletado com sucesso!</font></div>";
}else{
echo "<div align=center><font color='#ffffff' size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">Não foi possível deletar o integrante.</font></div>";
}
?></p>
