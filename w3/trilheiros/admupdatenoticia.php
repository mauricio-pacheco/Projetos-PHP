...
$sql = "UPDATE noticias SET assunto = '$assunto', local = '$local', texto = '$texto', data = '$data', hora = '$hora' WHERE id = '$id'";
if(mysql_query($sql)) {
echo "<div align=center><br><br><font color='#ffffff' size=\"3\" face=\"Verdana, Arial, Helvetica, sans-serif\">O sua notícia foi editada com sucesso!!</font></div>";
}else{
echo "<div align=center><br><br><font color='#ffffff' size=\"3\" face=\"Verdana, Arial, Helvetica, sans-serif\">Não foi possivel editar a notícia!</font></div>";
}
