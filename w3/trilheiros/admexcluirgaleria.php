...
<meta HTTP-EQUIV="refresh" CONTENT="1;URL=admdeletargaleria.php">
<STYLE type=text/css>
.style5 {
	font-size: 9px
}
                        ...
                        <table width="98%" border="0">
                          <tr>
                            <td><div align="center">
                              ...
                              <p><span class="style19">Apagar Galeria</span></p>
                              <table width="98%" border="0">
                                <tr>
...
if ($query)  
{
echo "<div align=center><font color='#ffffff' size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">Galeria deletada com sucesso!</font></div>";
}else{
echo "<div align=center><font color='#ffffff' size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">NÃ£o foi possÃ­vel deletar a galeria.</font></div>";
}


$sql3 = mysql_query("SELECT * FROM fotos WHERE galeria='$id' ORDER BY id");
while($y = mysql_fetch_array($sql3))
{
$foto = $y["foto"];
$fotomenor = $y["fotomenor"];
unlink("fotosgaleria/g/$foto");
unlink("fotosgaleria/p/$fotomenor");
}

$sql2 = "DELETE FROM fotos WHERE galeria='$id'";
mysql_query($sql2)
