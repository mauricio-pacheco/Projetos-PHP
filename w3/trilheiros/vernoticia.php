...
while($n = mysql_fetch_array($sql))
   ...
   ?>
                        ...
                        <tr>
                          <td><span class="style22">Data da Not&iacute;cia: <?php echo $n["data"]; ?> - <?php echo $n["hora"]; ?></span></td>
                        </tr>
                        <tr>
                          <td><span class="style20"><font color='#D29B36' arial,="Arial," helvetica,="Helvetica," sans-serif\="sans-serif\""><b>Fonte:</b></font> <font color='#CDCDCD' arial,="Arial," helvetica,="Helvetica," sans-serif\="sans-serif\""><?php echo $n["local"]; ?></font></span></td>
                        </tr>
                        <tr>
                          <td>&nbsp;</td>
                        </tr>
