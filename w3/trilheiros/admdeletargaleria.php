                        ...
                        <table width="98%" border="0">
                          <tr>
                            <td><div align="center">
                              ...
                              <p><span class="style19">Apagar Galerias</span></p>
                              <table width="98%" border="0">
                                <tr>
                                  <td><p align="left" class="style19">
                                     <?php
include "conexao.php";
...
?>
                                    ...
                                    <font color="#FFFF00"><img src="capas/<?php echo $foto.""; ?>" border="0" width="100" height="75"></font> &nbsp;                                         <font color="#FFFF00"><?php echo $nomegaleria.""; ?></font> - <a href="editargaleria.php?id=<?php echo $id.""; ?>&amp;nomegaleria=<?php echo $nomegaleria.""; ?>"><font color="#FFFFFF">EDITAR GALERIA</font> <img src="home_arquivos/editar.gif" border="0"></a> - <a href="admexcluirgaleria.php?id=<?php echo $id.""; ?>&foto=<?php echo $foto.""; ?>" onClick="return confirm('Tem certeza que deseja apagar a galeria <?php echo $nomegaleria.""; ?> ?')"><font color="#FFFFFF">APAGAR GALERIA</font> <img src="home_arquivos/apagar.gif" border="0"></a><br />
                                          <br />
                                          <?php
...
echo "<a href='admdeletargaleria.php?p=1' target='_self' class=manchete_texto4>PRIMEIRA P&Aacute;GINA</a> <font color='#ffffff' size='1'>-</font> ";
...
echo "<a href='admdeletargaleria.php?p=".$i."' target='_self'>".$i."</a> ";
}
}
// Exibe a p&aacute;gina atual, sem link, apenas o n&uacute;mero
echo "<font color=#FFFF00 size=1>";
echo $p." ";
echo "</font>";
...
echo " <font color='#ffffff' size='1'>-</font> <a href='admdeletargaleria.php?p=".$pags."' target='_self'>&Uacute;LTIMA P&Aacute;GINA</a> ";
?>
                                  </p>
                                    <p align="center" class="style19">&nbsp;</p></td>
                                </tr>
                              </table>
                              </div></td>
                          </tr>
