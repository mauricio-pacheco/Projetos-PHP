...
{
    var tabChildren, tabEnabled, boundingBox_mc, border_mc, __get__height, __get__width, __tabIndex, depth, createObject, createClassObject, loadExternal, __get__numChildren, destroyObject, createClassChildAtDepth, doLater, __get__tabIndex;
    function View()
    {
        super();
    } // End of the function
