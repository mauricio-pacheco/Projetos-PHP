...
<table width="100%" border="0">
                ...
                <table width="100%" border="0">
                 ...
                 <table width="100%" border="0">
                  <tr>
                    <td align="center"><a href="http://www.construtoramilani.com.br/delhi/" target=_blank><img alt="Acesse Agora o Site do Residencial Nova Délhi" title="Acesse Agora o Site do Residencial Nova Délhi" src="imagens/bannerdelhi.png" border="0" ></a></td>
                  </tr>
                </table>
                <table width="100%" border="0">
                  <tr>
