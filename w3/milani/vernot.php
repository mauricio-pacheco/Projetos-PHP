...
";
   ...
   ?></td>
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%" border="0">
                      <tr>
                        <td><table width="100%" border="0">
                          <tr>
                            <td width="2%"><img src="imagens/calenda.jpg" width="23" height="22"></td>
                            <td width="98%" class="manchete_texto" align="left">&nbsp;Notícia Publicada em <?php echo $n["data"]; ?> (<?php echo $n["hora"]; ?>)&nbsp;</td>
                          </tr>
                        </table></td>
                      </tr>
                    </table>
                    ...
                    <table width="100%" border="0">
                      <tr>
                        <td align="left"><?php echo $n["legenda"]; ?></td>
                      </tr>
                    </table>
                    <table width="100%" border="0">
                      <tr>
