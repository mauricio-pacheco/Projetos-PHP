     ...
     <?php include("cabecalho2.php"); ?>
      ...
      align=center>
          <TBODY>
            ...
            <TR>
              <TD background="imagens/fundotabela.jpg" vAlign=top width=200><?php include("esquerdo2.php"); ?> <TD style="PADDING-LEFT: 8px; PADDING-RIGHT: 8px" id=main_td 
                ...
                <CENTER>
                  <DIV style="Z-INDEX: 666" id=flash1>
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%" border="0">
                      <tr>
                        <td><img src="imagens/barranoticias.png"></td>
                      </tr>
                    </table>
...
$sql = mysql_query("SELECT * FROM gestao_noticias ORDER BY id DESC LIMIT 3");
$contar = mysql_num_rows($sql); 

if ($contar < 1)  
   {echo "<div align=center class=manchete_texto>Não existe notícias cadastradas!</div>"; 
   }
else 
   {
while($y = mysql_fetch_array($sql))
   ...
   ?>
                                      <table width="100%" border="0">
                                      <tr>
                                        <td width="98%"><font class="manchete_texto">-&nbsp;</font><a class="manchete_texto5" href="vernot.php?id=<?php echo $y["id"]; ?>"><?php echo $y["titulo"]; ?></a><a href="index.php" class="manchete_texto5"></a> <font class="manchete_texto">--</font> <font class="manchete_texto4"><?php echo $y["data"]; ?></font></td>
                                      </tr>
                                    </table>
                                      <?php
  }
 ...
 ?>
                                      <table width="100%" border="0">
                                        <tr>
                                          <td width="98%" align="right"><a href="noticias.php" class="manchete_texto4">VISUALIZAR TODAS AS NOT&Iacute;CIAS</a></td>
                                        </tr>
                                      </table></td>
                                  </tr>
                                </table></td>
...
$sql_select = "SELECT * FROM gestao_obras WHERE sessao='Lançamentos' ORDER BY rand() LIMIT $inicio, $qnt";
...
?>
                            ...
                            <table width="100%" border="0">
                              <tr>
                                <td class="pontilhada" align="center"><a href="obra.php?id=<?php echo $id.""; ?>"><img src="administrador/galeriadeobras/<?php echo $foto.""; ?>" border="1" alt="VISUALIZAR EMPREENDIMENTO"></a></td>
                              </tr>
                              <tr>
...
$sql_select_all = "SELECT * FROM gestao_obras WHERE sessao='Lançamentos'";
...
?>
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%" border="0">
                      <tr>
                        <td align="center"><a href="lancamentos.php"><img src="imagens/tabua1.jpg" border="0"></a></td>
                      </tr>
                    </table>
                    <table cellpadding="0" cellspacing="0" width="100%" border="0">
                      <tr>
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%" border="0">
                      <tr>
                        <td><img src="imagens/barraexec.png"></td>
                      </tr>
                    </table>
                    <table bgcolor="#FAFAFA" width="100%" border="0">
                      <tr>
...
$sql_select = "SELECT * FROM gestao_obras WHERE sessao='Em Execução' ORDER BY rand() LIMIT $inicio, $qnt";
...
?>
                              <table width="100%" border="0">
                                ...
                                <tr>
                                  <td class="manchete_texto"><div align="left">&nbsp;<b><?php echo $nome.""; ?></b></div></td>
                                </tr>
                                <tr>
                                  <td class="manchete_texto"><div align="left">&nbsp;<?php echo $tipo.""; ?></div></td>
                                </tr>
                                <tr>
                                  <td class="manchete_texto"><div align="left">&nbsp;<?php echo $cidade.""; ?> - <?php echo $uf.""; ?></div></td>
                                </tr>
                                <tr>
                                  <td class="manchete_texto3"><div align="left">&nbsp;<?php echo $valor.""; ?></div></td>
                                </tr>
                                <tr>
                                  <td align="right"><a href="obra.php?id=<?php echo $id.""; ?>"><img src="imagens/fundotab.jpg" alt="mais detalhes..." border="0" style="cursor:hand;" title="mais detalhes..."></a></td>
                                </tr>
...
// Faz uma nova sele&ccedil;&atilde;o no banco de dados, desta vez sem LIMIT, 
// para pegarmos o n&uacute;mero total de registros
$sql_select_all = "SELECT * FROM gestao_obras WHERE sessao='Em Execução'";
// Executa o query da sele&ccedil;&atilde;o acimas
$sql_query_all = mysql_query($sql_select_all);
// Gera uma vari&aacute;vel com o n&uacute;mero total de registros no banco de dados
$total_registros = mysql_num_rows($sql_query_all);
...
?></td>
                     ...
                     <table cellpadding="0" cellspacing="0" width="100%" border="0">
                      <tr>
                        <td align="center"><a href="emexecucao.php"><img src="imagens/tabua2.jpg" border="0"></a></td>
                      </tr>
                    </table>
                    <table cellpadding="0" cellspacing="0" width="100%" border="0">
                      <tr>
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%" border="0">
                      <tr>
                        <td><img src="imagens/barraobras.png"></td>
                      </tr>
                    </table>
...
$sql_select = "SELECT * FROM gestao_obras WHERE sessao='Obras Realizadas' ORDER BY rand() LIMIT $inicio, $qnt";
...
// Faz uma nova sele&ccedil;&atilde;o no banco de dados, desta vez sem LIMIT, 
// para pegarmos o n&uacute;mero total de registros
$sql_select_all = "SELECT * FROM gestao_obras WHERE sessao='Obras Realizadas'";
// Executa o query da sele&ccedil;&atilde;o acimas
$sql_query_all = mysql_query($sql_select_all);
// Gera uma vari&aacute;vel com o n&uacute;mero total de registros no banco de dados
$total_registros = mysql_num_rows($sql_query_all);
...
?></td>
                     ...
                     <table cellpadding="0" cellspacing="0" width="100%" border="0">
                      <tr>
                        <td align="center"><a href="realizadas.php"><img src="imagens/tabua3.jpg" border="0"></a></td>
                      </tr>
                    </table>
                    <table cellpadding="0" cellspacing="0" width="100%" border="0">
                      <tr>
