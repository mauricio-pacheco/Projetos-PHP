...
<FORM style="MARGIN: 0px" name="form_busca" action="buscanormal.php" 
   ...
   <table width="100%" border="0">
                 ...
                 <table width="100%" border="0">
                  <tr>
                    <td align="center" bgcolor="#EFEFEF"><a href="http://www.novadelhiresidence.com.br" target=_blank><img alt="Acesse Agora o Site do Residencial Nova Délhi" title="Acesse Agora o Site do Residencial Nova Délhi" src="imagens/bannerdelhi.png" border="0" ></a></td>
                  </tr>
                </table>
  <table width="100%" border="0">
    <tr>
...
<table width="100%" border="0">
                ...
                <table width="100%" border="0">
                 ...
                 <table width="100%" border="0">
                  <tr>
                    <td align="center"><a href="avenda.php"><img src="imagens/vend.jpg" alt="Empreendimentos à Venda" border="0" style= "cursor:Hand" title="Empreendimentos à Venda"></a></td>
                  </tr>
                </table>
                  <table width="100%" border="0">
                  <tr>
