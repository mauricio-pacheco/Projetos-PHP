...
TransMenu.dingbatOn = "/arrowchild-on.gif";            // path to the active sub menu dingbat
TransMenu.dingbatOff = "/arrowchild-off.gif";          // path to the inactive sub menu dingbat
