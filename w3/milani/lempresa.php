    ...
    <script type="text/javascript">
      ...
      function initialize() {
        if (GBrowserIsCompatible()) {
          ...
          map.setCenter(new GLatLng(-27.359023, -53.396999), 18);
		...
		// Aratiba
		var latlng = new GLatLng(-27.359023, -53.396999);
                    ...
                    <table background="imagens/barra1.jpg" height="40" width="100%" border="0">
                      <tr>
                        <td class="manchete_texto"><b>
                          Construtora Milani - Localiza&ccedil;&atilde;o</b></td>
                      </tr>
                    </table>
                    ...
                    <table bgcolor="#FAFAFA" width="100%" border="0">
                      <tr>
                        <td valign="top"><table width="100%" border="0" align="center">
                          <tr>
                            <td width="2%" class="manchete_texto"><div align="justify"><STRONG>ALCIDES S. MILANI CONSTRU&Ccedil;&Otilde;ES LTDA.</STRONG><BR>
                              Rua Herm&iacute;nia R. Milani,   43 - Centro - Cep: 98400-000 - Frederico Westphalen/RS<BR>
                            </div></td>
                            </tr>
                        </table></td>
                      </tr>
