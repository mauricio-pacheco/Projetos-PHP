...
$sql_select = "SELECT * FROM gestao_obras WHERE nome LIKE '%".$palavra."%' AND sessao='$sessaonova' ORDER BY id DESC LIMIT $inicio, $qnt";
...
$cont="1"; //contador
?><b>Busca Normal</b> - Sua Busca Retornou <font class="manchete_texto3"><b><?php echo "$total"; ?></b></font> Resultados</td>
                      </tr>
                    </table>
                  ...
                  <table cellpadding="0" cellspacing="0" width="100%" border="0">
                      <tr>
                        <td><img src="imagens/barraenc.png"></td>
                      </tr>
                    </table>
...
?>                         
                            ...
                            <table width="100%" border="0">
                              <tr>
                                <td class="pontilhada" align="center"><a href="obra.php?id=<?php echo $id.""; ?>"><img src="administrador/galeriadeobras/<?php echo $foto.""; ?>" border="1" alt="VISUALIZAR PRODUTO"></a></td>
                              </tr>
                              <tr>
...
$sql_select_all = "SELECT * FROM gestao_obras WHERE nome LIKE '%".$palavra."%' AND sessao='$sessaonova'";
