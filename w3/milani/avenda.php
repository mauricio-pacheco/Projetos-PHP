                ...
                <CENTER>
                  <DIV style="Z-INDEX: 666" id=flash1>
                    <table background="imagens/barra1.jpg" height="40" width="100%" border="0">
                      <tr>
                        <td class="manchete_texto"><b>Empreendimentos &agrave; Venda</b></td>
                      </tr>
                    </table>
                  ...
                  <table cellpadding="0" cellspacing="0" width="100%" border="0">
                      <tr>
                        <td><img src="imagens/barravenda.png"></td>
                      </tr>
                    </table>
...
$sql_select = "SELECT * FROM gestao_obras WHERE vendas='Sim' ORDER BY id DESC LIMIT $inicio, $qnt";
...
echo "<a href='avenda.php?p=1&id=$id' target='_self' class=manchete_texto4>PRIMEIRA PÁGINA</a> <font color='#000000' size='1'>-</font> ";
...
echo "<a href='avenda.php?p=".$i."&id=$id' target='_self' class=manchete_texto4>".$i."</a> ";
}
}
...
echo " <font color='#000000' size='1'>-</font> <a href='avenda.php?p=".$pags."&id=$id' target='_self' class=manchete_texto4>ÚLTIMA PÁGINA</a> ";
