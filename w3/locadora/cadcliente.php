...
$sql = "INSERT INTO clientes (nomecliente, email, cidade, estado, endereco, numero, bairro, telefone) VALUES ('$nomecliente', '$email', '$cidade', '$estado', '$endereco', '$numero', '$bairro', '$telefone')";
if(mysql_query($sql)) {
echo "<div align=center><br><font color='#000000' size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">O cliente foi cadastrado com sucesso!!</font></div>";
}else{
echo "<div align=center><br><font color='#000000' size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">N&atilde;o foi possivel efetuar o seu cadastro do cliente!</font></div>";
}
 
?>
              </p>
                <p align="center" class="style19"><a href="cadastrarcliente.php">CADASTRAR OUTRO CLIENTE</a><br><br></p></td>
            </tr>
            <tr>
              <td><HR align=center width="99%" color=#cccccc SIZE=1></td>
            </tr>
