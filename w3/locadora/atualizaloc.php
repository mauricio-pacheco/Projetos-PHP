      ...
      <table width="100%" border="0">
        <tr>
          ...
          <td width="81%" valign=top><table width="100%" border="0">
            <tr>
              <td>&nbsp;<font face="Verdana">Concluir Loca&ccedil;&atilde;o</font></td>
            </tr>
            <tr>
...
$codigo = $_GET["codigo"];
$codigofilme = $_GET["codigofilme"];


$sql = "UPDATE locacoes SET status = 's' WHERE codigo = '$codigo'";

if(mysql_query($sql)) {
echo "<div align=center><br><font color='#000000' size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">A sua locação foi concluida com sucesso!</font></div>";
}else{
echo "<div align=center><br><font color='#000000' size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">N&atilde;o foi possivel concluir a locação!</font></div>";
}

$sql = "UPDATE filmes SET estoque = 'Disponível' WHERE codigo = '$codigofilme'";
...
?>
                ...
                <p align="center" class="style19"><a href="exclocacao.php">CONCLUIR OUTRA LOCAÇÃO</a><br><br></p></td>
            </tr>
            <tr>
              <td><HR align=center width="99%" color=#cccccc SIZE=1></td>
            </tr>
