...
return false
		...
		return true;
            ...
            <tr>
              <td><div align="center"><font face="Verdana">Selecione o Filme para editar:</font></div></td>
            </tr>
            <tr>
              <td><HR align=center width="99%" color=#cccccc SIZE=1></td>
            </tr>
...
if(!empty($HTTP_POST_VARS["palavra"])) {
 ...
 ?>
                                      <table><tr><td><a href="editafilme.php?codigo=<?php echo $r["codigo"]; ?>"><img src='capas/<?php echo $r["foto"]; ?>' width="75" height="110" border='0'></a></td><td>&nbsp;&nbsp;<font face='Verdana' size='2'><a href="editafilme.php?codigo=<?php echo $r["codigo"]; ?>"><?php echo $r["nomefilme"]; ?></a></font></td></tr></table><br>
                                    <? }
