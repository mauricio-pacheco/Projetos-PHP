          ...
          <td width="81%" valign=top><table width="100%" border="0">
            ...
            <tr>
              <td><table width="98%" border="0" align="center">
                <form method="post" ENCTYPE="multipart/form-data" action="pesquisarclienteexcluido.php" name="cadastro" onSubmit="return validar(this)"><tr>
...
if(!empty($HTTP_POST_VARS["palavra"])) {
      ...
      $qr = "SELECT * FROM clientes WHERE nomecliente LIKE '%".$palavra."%'";
 ...
 ?>
                <table width="98%" border="0" align="center">
                  <tr>
                    ...
                    <td width="74%">&nbsp;<font face="Verdana" size="2"><?php echo $r["nomecliente"]; ?></font></td>
                    <td width="15%"><div align="center"><font face="Verdana" size="2"><a href="excluicliente.php?codigo=<?php echo $r["codigo"]; ?>" onClick="return confirm('Tem certeza que deseja excluir o cliente <?php echo $r["nomecliente"]; ?> ?')">APAGAR</a></font></div></td>
                    <td width="4%"><div align="center"><a href="excluicliente.php?codigo=<?php echo $r["codigo"]; ?>" onClick="return confirm('Tem certeza que deseja excluir o cliente <?php echo $r["nomecliente"]; ?> ?')"><img src="lixo.gif" width="19" height="24" border="0"></a></div></td>
                  </tr>
                </table>
                <? }
