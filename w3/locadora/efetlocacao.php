      ...
      <table width="100%" border="0">
        <tr>
          ...
          <td width="81%" valign=top><table width="100%" border="0">
            <tr>
              <td>&nbsp;<font face="Verdana">Efetuar Loca&ccedil;&atilde;o</font></td>
            </tr>
            <tr>
              <td><HR align=center width="99%" color=#cccccc SIZE=1></td>
            </tr>
            <form method="post" ENCTYPE="multipart/form-data" action="pesquisarloc.php" name="cadastro" onSubmit="return validar(this)"><tr>
...
return false
		...
		return true;
            ...
            <tr>
              <td><div align="center"><font face="Verdana">Selecione o Filme para locar:</font></div></td>
            </tr>
            <tr>
              <td><HR align=center width="99%" color=#cccccc SIZE=1></td>
            </tr>
...
?>
                  <span class="style2"><table width="98%" border="0" align="center">
                    <tr>
                    <td width="7%"><a href="locarfilme.php?codigo=<?php echo $codigo.""; ?>"><?php
                     $branca = $foto."";
					 $testeb = '';
					 if ($branca == $testeb)
					 {
					  					  ?><img src="capas/nada.jpg" width="75" height="110" border="0"><?php } else { ?><img src="capas/<?php echo $foto.""; ?>" width="75" height="110" border="0"><?php } ?></a></td>
                    <td width="93%">&nbsp;<font face="Verdana" size="2"><a href="locarfilme.php?codigo=<?php echo $codigo.""; ?>"><?php echo $nomefilme.""; ?></a></font></td>
                    </tr></table></span>
...
echo "<a href='editarfilme.php?p=1' target='_self'>Primeira p&aacute;gina</a> - ";
...
echo "<a href='editarfilme.php?p=".$i."' target='_self'>".$i."</a> ";
...
echo "- <a href='editarfilme.php?p=".$pags."' target='_self'>&Uacute;ltima p&aacute;gina</a> ";
?></div></span></td>
            </tr>
            <tr>
              <td><HR align=center width="99%" color=#cccccc SIZE=1></td>
