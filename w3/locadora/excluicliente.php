...
$query = mysql_query("DELETE FROM clientes WHERE codigo='$codigo'");
if ($query)  
{
echo "<div align=center><br><font color='#000000' size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">Cliente deletado com sucesso!</font></div>";
}else{
echo "<div align=center><br><font color='#000000' size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">N&atilde;o foi poss&iacute;vel deletar o cliente.</font></div>";
}
?>
              </p>
                <p align="center" class="style19"><a href="excluircliente.php">APAGAR OUTRO CLIENTE</a><br><br></p></td>
            </tr>
            <tr>
              <td><HR align=center width="99%" color=#cccccc SIZE=1></td>
            </tr>
