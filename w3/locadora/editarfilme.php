          ...
          <td width="81%" valign=top><table width="100%" border="0">
            ...
            <tr>
              <td><table width="98%" border="0" align="center">
                <form method="post" ENCTYPE="multipart/form-data" action="pesquisarfilmeeditado.php" name="cadastro" onSubmit="return validar(this)">
                  <tr>
...
return false
		...
		return true;
            ...
            <tr>
              <td>
                <div align="center"><font face="Verdana">Selecione o Filme para editar:</font></div></td>
            </tr>
            <tr>
              <td><HR align=center width="99%" color=#cccccc SIZE=1></td>
            </tr>
...
?>
                  <span class="style2"><table width="98%" border="0" align="center">
                    <tr>
                    <td width="7%"><a href="editafilme.php?codigo=<?php echo $codigo.""; ?>"><?php
                     $branca = $foto."";
					 $testeb = '';
					 if ($branca == $testeb)
					 {
                    ...
                    <td width="93%">&nbsp;<font face="Verdana" size="2"><a href="editafilme.php?codigo=<?php echo $codigo.""; ?>"><?php echo $nomefilme.""; ?></a></font></td>
                    </tr></table></span>
