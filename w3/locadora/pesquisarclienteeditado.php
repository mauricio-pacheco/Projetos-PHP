          ...
          <td width="81%" valign=top><table width="100%" border="0">
            ...
            <tr>
              <td><table width="98%" border="0" align="center">
                <form method="post" ENCTYPE="multipart/form-data" action="pesquisarclienteeditado.php" name="cadastro" onSubmit="return validar(this)"><tr>
 ...
 ?>
                <table width="98%" border="0" align="center">
                  <tr>
                    ...
                    <td width="93%">&nbsp;<font face="Verdana" size="2"><a href="editacliente.php?codigo=<?php echo $r["codigo"]; ?>"><?php echo $r["nomecliente"]; ?></a></font></td>
                  </tr>
                </table>
                                    <? }
