...
if(!empty($HTTP_POST_VARS["palavra"])) {
      ...
      $qr = "SELECT * FROM filmes WHERE nomefilme LIKE '%".$palavra."%'";
        ...
        echo "<div align=\"center\"><font face='Verdana'>Sua busca retornou <font color\"#2C9955\">' $total ' </font> resultados.</font></div><br>";
 ...
 ?>
                  ...
                  <div align="left">
                    <table>
                      <tr>
                        <td><span class="style2"><a href="locarfilme2.php?codigo=<?php echo $r["codigo"]; ?>"><img src='capas/<?php echo $r["foto"]; ?>' width="75" height="110" border='0'></a></span></td>
                            <td><span class="style2">&nbsp;&nbsp;<font face='Verdana' size='2'><a href="locarfilme2.php?codigo=<?php echo $r["codigo"]; ?>"><?php echo $r["nomefilme"]; ?></a></font></span></td>
                          </tr>
                    </table>
