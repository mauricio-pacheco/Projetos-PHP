      ...
      <table width="100%" border="0">
        <tr>
          ...
          <td width="81%" valign=top><table width="100%" border="0">
            <tr>
              <td>&nbsp;<span class="style2">Excluir Loca&ccedil;&atilde;o</span></td>
            </tr>
            <tr>
...
$query = mysql_query("DELETE FROM locacoes WHERE codigo='$codigo'");
if ($query)  
{
echo "<div align=center><br><font color='#000000' size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">Locação apagada com sucesso!</font></div>";
}else{
echo "<div align=center><br><font color='#000000' size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">N&atilde;o foi poss&iacute;vel apagar a locação.</font></div>";
}
?>
              </p>
                <p align="center" class="style2"><a href="exclocacao.php">APAGAR OUTRA LOCAÇÃO</a><br><br></p></td>
            </tr>
            <tr>
              <td><HR align=center width="99%" color=#cccccc SIZE=1></td>
            </tr>
