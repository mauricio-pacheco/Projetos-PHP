      ...
      <table width="100%" border="0">
        <tr>
          ...
          <td width="81%" valign=top><table width="100%" border="0">
            <tr>
              <td>&nbsp;<font face="Verdana">Excluir Filme</font></td>
            </tr>
            <tr>
            ...
            <tr>
              <td><table width="98%" border="0" align="center">
                <form method="post" ENCTYPE="multipart/form-data" action="pesquisarfilmeexcluido.php" name="cadastro" onSubmit="return validar(this)">
                  <tr>
...
return false
		...
		return true;
            ...
            <tr>
              <td><div align="center"><font face="Verdana">Selecione o Filme para excluir:</font></div></td>
            </tr>
            <tr>
              <td><HR align=center width="99%" color=#cccccc SIZE=1></td>
            </tr>
...
$sql_select = "SELECT * FROM filmes ORDER BY codigo DESC LIMIT $inicio, $qnt";
...
?>
                  <span class="style2"><table width="98%" border="0" align="center">
                    ...
                    <td width="13%"><?php
					 ...
					 if ($branca == $testeb)
					 {
					  					  ?><img src="capas/nada.jpg" width="75" height="110" border="0"><?php } else { ?><img src="capas/<?php echo $foto.""; ?>" width="75" height="110" border="0"><?php } ?></td>
                    <td width="68%">&nbsp;<font face="Verdana" size="2"><?php echo $nomefilme.""; ?></font></td>
                    <td width="15%"><div align="center"><font face="Verdana" size="2"><a href="excluifilme.php?codigo=<?php echo $codigo.""; ?>" onClick="return confirm('Tem certeza que deseja excluir o filme <?php echo $nomefilme.""; ?> ?')">APAGAR</a></font></div></td>
                    <td width="4%"><div align="center"><a href="excluifilme.php?codigo=<?php echo $codigo.""; ?>" onClick="return confirm('Tem certeza que deseja excluir o filme <?php echo $nomefilme.""; ?> ?')"><img src="lixo.gif" width="19" height="24" border="0"></a></div></td>
                    </tr></table>
                  </span>
...
$sql_select_all = "SELECT * FROM filmes ORDER BY codigo DESC";
...
echo "<a href='excluirfilme.php?p=1' target='_self'>Primeira p&aacute;gina</a> - ";
...
echo "<a href='excluirfilme.php?p=".$i."' target='_self'>".$i."</a> ";
...
echo "- <a href='excluirfilme.php?p=".$pags."' target='_self'>&Uacute;ltima p&aacute;gina</a> ";
?></div></span></td>
            </tr>
            <tr>
              <td><HR align=center width="99%" color=#cccccc SIZE=1></td>
