      ...
      <table width="100%" border="0">
        <tr>
          ...
          <td width="81%" valign=top><table width="100%" border="0">
            <tr>
              <td>&nbsp;<font face="Verdana">Editar Filme</font></td>
            </tr>
            <tr>
...
</SCRIPT><form method="post" ENCTYPE="multipart/form-data" action="updatefilme.php" name="cadastro" onSubmit="return validar(this)">
<?php
...
<table align=center width="90%">
  ...
  <tr>
                ...
                <td width="77%"><input name="nomefilme" type="text" value="<?php echo $n["nomefilme"]; ?>" size=75  style=font-size:11px;font-family:tahoma>
<font size="1" face="Verdana" >*</FONT></td>
                  ...
                  <td><FONT face=tahoma  style=font-size:11px><b>Diretor:</b></td><td><FONT face=tahoma  style=font-size:11px><input name="diretor" type="text" size=40 value="<?php echo $n["diretor"]; ?>"  style=font-size:11px;font-family:tahoma>&nbsp;</td>
                </tr><tr>
                    <td><FONT face=tahoma  style=font-size:11px><b>Elenco:</b></td><td><input name="elenco" type="text" size=50 value="<?php echo $n["elenco"]; ?>" style=font-size:11px;font-family:tahoma></td></tr><tr><tr>
                  <td><FONT face=tahoma  style=font-size:11px><b>Preço da Loca&ccedil;&atilde;o:</b></td><td><FONT face=tahoma  style=font-size:11px>&nbsp;R$ <input name="preco" type="text" size=15 value="<?php echo $n["preco"]; ?>" style=font-size:11px;font-family:tahoma>
                  *</td>
                  ...
                  <font color="#003366" style=font-size:10px>&nbsp;(tamanho ideal: largura 185px, altura indiferente)</font></td>
                      ...
                      <td><FONT face=tahoma  style=font-size:11px><b>Sinopse:</b></td><td><textarea name="sinopse" rows=15 cols=75 style=font-size:11px;font-family:tahoma><?php echo $n["sinopse"]; ?></textarea></td></tr><tr><td><FONT face=tahoma  style=font-size:11px><b>Estoque:</b></td><td><select name="estoque" style=font-size:11px;font-family:tahoma><option value="Disponível" >Disponível<option value="Não disponível" >Não disponível</select></td></tr><tr><td colspan=2 align=center height=15></td></tr><tr><td align=center></td><td align=center>&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" NAME="Enter" style=font-size:11px;font-family:tahoma value=" Editar Filme "> <input type="reset" value="Limpar formulario" style=font-size:11px;font-family:tahoma></td></table>
              <?
  }
  }
 ?></form></td>
