      ...
      <table width="100%" border="0">
        <tr>
          ...
          <td width="81%" valign=top><table width="100%" border="0">
            <tr>
              <td>&nbsp;<font face="Verdana">Cadastrar Cliente</font></td>
            </tr>
            <tr>
...
return false
...
</SCRIPT><form method="post" ENCTYPE="multipart/form-data" action="cadcliente.php" name="cadastro" onSubmit="return validar(this)"><table align=center width="90%">
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
                ...
                <td width="77%"><input name="nomecliente" type="text" value="" size=75  style=font-size:11px;font-family:tahoma>
<font size="1" face="Verdana">*</FONT></td>
              </tr><tr>
                  <td><FONT face=tahoma  style=font-size:11px><b>E-mail:</b></td><td><FONT face=tahoma  style=font-size:11px><input name="email" type="text" size=40 value="" style=font-size:11px;font-family:tahoma>&nbsp; <font size="1" face="Verdana">*</FONT></td>
                </tr>
                <tr>
                    <td><FONT face=tahoma  style=font-size:11px><b>Cidade:</b></td>
                    <td><input name="cidade" type="text" size=46 value="" style=font-size:11px;font-family:tahoma></td></tr><tr>
                    <tr>
                ...
                <tr>
                    <td><FONT face=tahoma  style=font-size:11px><b>Endere&ccedil;o:</b></td><td><input name="endereco" type="text" size=50 value="" style=font-size:11px;font-family:tahoma></td></tr><tr>
                  <td><FONT face=tahoma  style=font-size:11px><b>N&uacute;mero:</b></td><td><input name="numero" type="text" size=15 value="" style=font-size:11px;font-family:tahoma></td>
                    </tr><tr>
                      <td><FONT face=tahoma  style=font-size:11px><b>Bairro:</b></td><td><input name="bairro" type="text" size=24 value="" style=font-size:11px;font-family:tahoma></td></tr><tr>
                      <td><FONT face=tahoma  style=font-size:11px><b>Telefone:</b></td><td><input name="telefone" type="text" size=30 value="" style=font-size:11px;font-family:tahoma>
                        <font size="1" face="Verdana">*</FONT></td>
                      </tr><tr><td colspan=2 align=center height=15></td></tr><tr><td align=center></td><td align=center>&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" NAME="Enter" style=font-size:11px;font-family:tahoma value=" Cadastrar Cliente "> <input type="reset" value="Limpar formulario" style=font-size:11px;font-family:tahoma></td></table>
              </form></td>
            </tr>
            <tr>
              <td><HR align=center width="99%" color=#cccccc SIZE=1></td>
