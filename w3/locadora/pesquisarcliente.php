...
if(!empty($HTTP_POST_VARS["palavra"])) {
 ...
 ?>
                                      <table><tr><td><img src='clientes.jpg' border='0'></td><td>&nbsp;&nbsp;<font face='Verdana' size='2'><a href="perfil.php?codigo=<?php echo $r["codigo"]; ?>"><?php echo $r["nomecliente"]; ?></a></font></td></tr></table><br>
                                    <? }
