          ...
          <td width="81%" valign=top><table width="100%" border="0">
            ...
            <tr>
              <td><table width="98%" border="0" align="center">
                <form method="post" ENCTYPE="multipart/form-data" action="pesquisarclienteeditado.php" name="cadastro" onSubmit="return validar(this)">
                  <tr>
...
return false
		...
		return true;
            ...
            <tr>
              <td><div align="center"><font face="Verdana">Selecione o Cliente para editar:</font></div></td>
            </tr>
            <tr>
              <td><HR align=center width="99%" color=#cccccc SIZE=1></td>
            </tr>
...
?>
                  <span class="style2"><table width="98%" border="0" align="center">
                    ...
                    <td width="93%">&nbsp;<font face="Verdana" size="2"><a href="editacliente.php?codigo=<?php echo $codigo.""; ?>"><?php echo $nomecliente.""; ?></a></font></td>
                    </tr></table></span>
...
echo "<a href='editarcliente.php?p=1' target='_self'>Primeira p&aacute;gina</a> - ";
...
echo "<a href='editarcliente.php?p=".$i."' target='_self'>".$i."</a> ";
...
echo "- <a href='editarcliente.php?p=".$pags."' target='_self'>&Uacute;ltima p&aacute;gina</a> ";
?></div></span></td>
            </tr>
            <tr>
              <td><HR align=center width="99%" color=#cccccc SIZE=1></td>
