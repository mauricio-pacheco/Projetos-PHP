...
$sql = "UPDATE filmes SET foto = '$nome_foto', nomefilme = '$nomefilme', genero = '$genero', diretor = '$diretor', elenco = '$elenco', preco = '$preco', sinopse = '$sinopse', estoque = '$estoque' WHERE codigo = '$codigo'";
if(mysql_query($sql)) {
echo "<div align=center><br><font color='#000000' size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">O seu filme foi editado com sucesso!!</font></div>";
}else{
echo "<div align=center><br><font color='#000000' size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">N&atilde;o foi possivel efetuar o cadastro do filme!</font></div>";
}
 
?>
              </p>
                <p align="center" class="style19"><a href="editarfilme.php">EDITAR OUTRO FILME</a><br><br></p></td>
            </tr>
            <tr>
              <td><HR align=center width="99%" color=#cccccc SIZE=1></td>
            </tr>
