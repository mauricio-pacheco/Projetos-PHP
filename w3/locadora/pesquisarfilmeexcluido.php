          ...
          <td width="81%" valign=top><table width="100%" border="0">
            ...
            <tr>
              <td><table width="98%" border="0" align="center">
                <form method="post" ENCTYPE="multipart/form-data" action="pesquisarfilmeexcluido.php" name="cadastro" onSubmit="return validar(this)"><tr>
...
if(!empty($HTTP_POST_VARS["palavra"])) {
 ...
 ?>
                <table width="98%" border="0" align="center">
                  <tr>
                    <td width="13%"><img src="capas/<?php echo $r["foto"]; ?>" width="75" height="110" border="0"></td>
                    <td width="68%">&nbsp;<font face="Verdana" size="2"><?php echo $r["nomefilme"]; ?></font></td>
                    <td width="15%"><div align="center"><font face="Verdana" size="2"><a href="excluifilme.php?codigo=<?php echo $r["codigo"]; ?>" onClick="return confirm('Tem certeza que deseja excluir o filme <?php echo $r["nomefilme"]; ?> ?')">APAGAR</a></font></div></td>
                    <td width="4%"><div align="center"><a href="excluifilme.php?codigo=<?php echo $r["codigo"]; ?>" onClick="return confirm('Tem certeza que deseja excluir o filme <?php echo $r["nomefilme"]; ?> ?')"><img src="lixo.gif" width="19" height="24" border="0"></a></div></td>
                  </tr>
                </table>
<br>
                                    <? }
