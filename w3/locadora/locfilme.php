...
$codigofilme = $_POST["codigofilme"];
$nomefilme = $_POST["nomefilme"];
$preco = $_POST["preco"];

$sql = "INSERT INTO locacoes (nomecliente, datasaida, dataentrega, codigofilme, nomefilme, preco) VALUES ('$nomecliente', '$datasaida', '$dataentrega', '$codigofilme', '$nomefilme', '$preco')";
...
$sql = "UPDATE filmes SET estoque = 'Não disponível' WHERE codigo = '$codigofilme'";
if(mysql_query($sql)) {
echo "<div align=center><br><font color='#000000' size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">A locação foi efetuada com sucesso!!</font></div>";
}else{
echo "<div align=center><br><font color='#000000' size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">N&atilde;o foi possivel efetuar a locação!</font></div>";
} 
?>
                </p>
                <p align="center" class="style19"><a href="efetlocacao.php">LOCAR OUTRO FILME</a></p>
