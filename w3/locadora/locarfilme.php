...
<p align="center"><?php
					 ...
					 if ($branca == $testeb)
					 {
					  					  ?><img src="capas/nada.jpg"><?php } else { ?>
  <img src="capas/<?php echo $n["foto"]; ?>">
  <?php } ?>
</p>
                  ...
                  <td><FONT face=Verdana size=2>R$ <?php echo $n["preco"]; ?>
                    <input type="hidden" name="preco" value="<?php echo $n["preco"]; ?>" id="hiddenField3">
					 ...
					 if ($causa == $teste)
					 {
                        ...
                        <tr>
                          <td><font face="Verdana" size="2"><a href="javascript:history.go(-1)"><img src="setavol.gif" border="0"></a></font></td>
                          <td><font face="Verdana" size="2"><a href="javascript:history.go(-1)">VOLTAR</a></font></td>
                        </tr>
                      </table></td>
                      </table>
              <?
