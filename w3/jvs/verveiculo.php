...
while($y = mysql_fetch_array($sql))
   ...
   ?>
	  ...
	  <p>&nbsp;</p>
	  <p><a href="reservas.php?id=<?php echo $y["id"]; ?>"><img src="botao1.jpg" width="200" height="40" border="0"></a></p>
	  <p>&nbsp;</p></td>
  </tr>
  <tr>
    <td align="center"><?php echo $y["nome"]; ?><br><br>      
    <b>Lugares:</b> <?php echo $y["lugares"]; ?> - <b>Categoria:</b> <?php echo $y["categoria"]; ?> <br><br> 
    <b>Bancada:</b> <?php echo $y["bancada"]; ?> - <b>Ar Condicionado:</b> <?php echo $y["condicionado"]; ?> - <b>Modelo:</b> <?php echo $y["modelo"]; ?><br><br><b>Descrição</b><br><?php echo $y["descricao"]; ?> <BR><br><?php } ?>
