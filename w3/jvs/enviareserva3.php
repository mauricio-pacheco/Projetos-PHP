...
$mens .= "..:: FORMULÁRIO DA AGENDA DE VIAGENS DO SITE JVS TRANSPORTE E TURISMO ::..";
$mens .= "<BR><BR>";
$mens .= "<font color=#008000>DESCRIÇÃO DO PEDIDO:</font><br><br> ";
$mens .= "Roteiro: ";
$mens .= "$roteiro";
$mens .= "<br><br>";
$mens .= "Data de Saída: ";
$mens .= "$data";
$mens .= "<br><br>";
$mens .= "Data de Retorno: ";
$mens .= "$dataretorno";
$mens .= "<br><br>";
$mens .= "Descrição: ";
$mens .= "$descricao";
$mens .= "<br><br>";
$mens .= "<font color=#0066CC>DESCRIÇÃO DO PEDIDO:</font><br><br> ";
$mens .= "$reserva";
$mens .= "<br>";
$mens .= "<br>";
...
$headers .= "From: \"AGENDA DO SITE -  JVS Transporte e Turismo\"\r\n";
