                  ...
                  <table width="100%" border="0" align="center">
                    <tr>
                      <td width="7%" valign="top" align="center"><table width="100%" border="0">
                        <tr>
                          <td width="1%"><a href="verfotos.php?id=<?php echo $id.""; ?>"><img src="administrador/galerias/<?php echo $foto.""; ?>" border="1" alt="VISUALIZAR GALERIA"></a></td>
                          <td width="99%" align="left" valign="top"><a href="verfotos.php?id=<?php echo $id.""; ?>"><b><font size="2"><?php echo $nomegaleria.""; ?></font></b></a><br>
                            Data de Publicação:<br><font color="#005CA2"><?php echo $data.""; ?> - ( <?php echo $hora.""; ?> Hs )</font>
...
echo "<a href='fotos.php?p=1' target='_self'><font size='2' face=Tahoma>PRIMEIRA PÁGINA</font></a> <font size='2' face=Tahoma>-</font> ";
...
echo "<a href='fotos.php?p=".$i."' target='_self'><font size='2' face=Tahoma>".$i."</font></a> ";
}
}
...
echo " <font size='2' face=Tahoma>-</font> <a href='fotos.php?p=".$pags."' target='_self'><font size='2' face=Tahoma>ÚLTIMA PÁGINA</font></a> ";
