...
while($y = mysql_fetch_array($sql))
   ...
   ?>
	  ...
	  <p><span class="spip">
	   <FORM action="enviareserva.php" method=post name=cadastro > <textarea class="login" name="reserva" rows="12" cols="80"></textarea>
	  </span></p>
	  <p>&nbsp;</p>
	  <p><font 
  ...
  <tr>
    ...
    <b>Lugares:</b> <?php echo $y["lugares"]; ?> <span class="rodape">
