...
$sql_select = "SELECT * FROM cadastro WHERE tipo = 'Veículos Viagens' ORDER BY id DESC LIMIT $inicio, $qnt";
// Executa o Query
                      ...
                      <td width="7%" valign="top" align="center"><table width="100%" border="0">
                        <tr>
                          ...
                          <td width="99%" align="left" valign="top"><b><?php echo $nome.""; ?></b><br>
                            Ano Fabricação:&nbsp;<font color="#005CA2"><?php echo $anofab.""; ?></font><br><a href="verveiculo.php?id=<?php echo $id.""; ?>"><img src="detalhe.jpg" border="0"></a>
