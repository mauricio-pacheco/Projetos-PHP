                  ...
                  <table width="100%" border="0" align="center">
                    <tr>
                      <td width="7%" valign="top" align="center"><table width="100%" border="0">
                        <tr>
                          <td width="1%"><a href="veragenda.php?id=<?php echo $id.""; ?>"><img src="administrador/agenda/<?php echo $foto.""; ?>" border="1" alt="VISUALIZAR ROTEIRO"></a></td>
                           <td width="99%" align="left" valign="top"><b><?php echo $roteiro.""; ?></b><br>
                            Data de Saída:&nbsp;<font color="#008000"><?php echo $data.""; ?></font> <br> Data de Retorno:&nbsp;<font color="#005CA2"><?php echo $dataretorno.""; ?></font><br><a href="veragenda.php?id=<?php echo $id.""; ?>"><img src="detalhe.jpg" border="0"></a></td>
                        </tr>
                      </table></td>
                    </tr>
                  </table>
...
echo "<a href='servicos.php?p=1' target='_self'><font size='2' face=Tahoma>PRIMEIRA PÁGINA</font></a> <font size='2' face=Tahoma>-</font> ";
...
echo "<a href='servicos.php?p=".$i."' target='_self'><font size='2' face=Tahoma>".$i."</font></a> ";
}
}
...
echo " <font size='2' face=Tahoma>-</font> <a href='servicos.php?p=".$pags."' target='_self'><font size='2' face=Tahoma>ÚLTIMA PÁGINA</font></a> ";
