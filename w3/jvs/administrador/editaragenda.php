...
$sql = "UPDATE agenda SET data = '$data', dataretorno = '$dataretorno', roteiro = '$roteiro', descricao = '$descricao', foto = '$nome_foto0' WHERE id = '$id'";
if(mysql_query($sql)) {
echo "<div align=center class=tahomafonte>A AGENDA FOI EDITADA COM SUCESSO!!</div>";
}else{
