...
$sql = "INSERT INTO agenda (data, dataretorno, roteiro, descricao, foto) VALUES ('$data', '$dataretorno', '$roteiro', '$descricao', '$nome_foto')";


if(mysql_query($sql)) {
echo "<script>alert('O CADASTRO FOI EFETUADO COM SUCESSO COM SUCESSO!')</script>";
echo "<script>location.href='admagenda.php'</script>";
}else{
