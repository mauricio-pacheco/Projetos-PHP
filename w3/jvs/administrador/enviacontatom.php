...
$email     = "jvstransportes@yahoo.com.br";
$nome      = $_POST["nome"];  
$cidade    = $_POST["cidade"]; 
$estado    = $_POST["estado"]; 
$cep       = $_POST["cep"]; 
...
$mens .= "..:: FORMULÁRIO DE CONTATO DO SITE JVS TRANSPORTE E TURISMO ::..";
$mens .= "<BR><BR>";
$mens .= "Nome: ";
$mens .= "$nome";
$mens .= "<br><br>";
...
$headers .= "From: \"Formulario Contato Site JVS Transporte e Turismo\"\r\n";
