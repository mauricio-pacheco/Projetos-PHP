      ...
      <table width="94%" border="0" align="center">
        <tr>
          ...
          <td align="left" width="98%"><font color="#000000"><?php echo $nomegaleria.""; ?> -- <?php echo $data.""; ?> <?php echo $hora.""; ?> <br />
            <a href="apagafoto.php?id=<?php echo $id.""; ?>" class="linkmenu"><font color="#0000ff">SELECIONAR GALERIA</font></a></td>
        </tr>
      </table>
      <div align="center"><br />
        <?php
...
echo "<a href='admfotos.php?p=1' target='_self'><font size='2' face=Tahoma>PRIMEIRA P&Aacute;GINA</font></a> - ";
...
echo "<a href='admfotos.php?p=".$i."' target='_self'><font size='2' face=Tahoma>".$i."</font></a> ";
}
}
...
echo " <font size='2' face=Tahoma>-</font> <a href='admfotos.php?p=".$pags."' target='_self'><font size='2' face=Tahoma>&Uacute;LTIMA P&Aacute;GINA</font></a> ";
?>
      </div></td>
  </tr>
</table>
