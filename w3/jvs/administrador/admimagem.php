...
while($n = mysql_fetch_array($sql))
   ...
   ?>
      <table width="100%" border="0" align="center">
        <tr>
          <td align="center"><img src="veiculointro/<?php echo $n["foto"]; ?>" /></td>
        </tr>
        <tr>
          <td align="center" width="98%"><font color="#000000"><?php echo $n["nome"]; ?></td>
        </tr>
      </table>
      <br />
      <?php
...
$id = $_GET['id'];
$sql = mysql_query("SELECT * FROM fotosveiculos WHERE idveiculo='$id' ORDER BY id");
$contar = mysql_num_rows($sql); 
...
while($n = mysql_fetch_array($sql))
   ...
   ?>
      ...
      <table width="100%" border="0" align="center">
        <tr>
          <td width="2%"><img src="veiculosmenor/<?php echo $n["fotomenor"]; ?>" /></td>
          <td align="left" width="98%"><a href="delfotovei.php?id=<?php echo $n["id"]; ?>&amp;idveiculo=<?php echo $n["idveiculo"]; ?>&amp;fotomenor=<?php echo $n["fotomenor"]; ?>&amp;foto=<?php echo $n["foto"]; ?>" class="linkmenu" onClick="return confirm('Tem certeza que deseja apagar a foto ?')"><font color="#0000ff">APAGARFOTO</font></a></td>
        </tr>
      </table>
      <?php } ?>
      <?php
