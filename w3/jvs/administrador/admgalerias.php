        ...
        <tr>
          <td align="left" width="98%"><table width="100%" border="0">
            <tr>
              ...
              <td width="94%"><?php echo $nomegaleria.""; ?><br />
                <a href="edigaleria.php?id=<?php echo $id.""; ?>"><font color="#0000ff">EDITAR GALERIA</font></a> - <a href="delgaleria.php?id=<?php echo $id.""; ?>&amp;foto=<?php echo $foto.""; ?>" onClick="return confirm('Tem certeza que deseja apagar a galeria <?php echo $nomegaleria.""; ?> ?')"><font color="#ff0000">APAGAR GALERIA</font></a></td>
            </tr>
          </table></td>
        </tr>
      </table>
...
echo "<a href='admgalerias.php?p=1' target='_self'><font size='2' face=Tahoma>PRIMEIRA P&Aacute;GINA</font></a> - ";
...
echo "<a href='admgalerias.php?p=".$i."' target='_self'><font size='2' face=Tahoma>".$i."</font></a> ";
}
}
...
echo " - <a href='admgalerias.php?p=".$pags."' target='_self'><font size='2' face=Tahoma>&Uacute;LTIMA P&Aacute;GINA</font></a> ";
?>
      </div></td>
  </tr>
</table>
