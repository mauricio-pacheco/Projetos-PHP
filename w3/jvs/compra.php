...
while($y = mysql_fetch_array($sql))
   ...
   ?>
	  ...
	  <p>&nbsp;</p>
	  <p>DESCREVA OS DETALHES DE SUA COMPRA:</p>
	  <p><span class="spip">
	   <FORM action="enviareserva2.php" method=post name=cadastro > <textarea class="login" name="reserva" rows="12" cols="80"></textarea>
	  </span></p>
	  <p>&nbsp;</p>
	  <p><font 
  ...
  <tr>
    <td align="center"><?php echo $y["nome"]; ?><span class="rodape">
      <input type="hidden" name="nome" value="<?php echo $y["nome"]; ?>" />
    </span><br><br>      
    <b>Pre&ccedil;o:</b> <font color="#009900">R$</font> <?php echo $y["preco"]; ?><span class="rodape">
    <input type="hidden" name="lugares2" value="<?php echo $y["preco"]; ?>" />
    </span> - <b>Lugares:</b> <?php echo $y["lugares"]; ?> <span class="rodape">
    <input type="hidden" name="lugares" value="<?php echo $y["lugares"]; ?>" />
    </span>- <b>Categoria:</b> <?php echo $y["categoria"]; ?> <span class="rodape">
    <input type="hidden" name="categoria" value="<?php echo $y["categoria"]; ?>" />
    </span><br><br> 
    <b>Bancada:</b> <?php echo $y["bancada"]; ?> <span class="rodape">
    <input type="hidden" name="bancada" value="<?php echo $y["bancada"]; ?>" />
    </span>- <b>Ar Condicionado:</b> <?php echo $y["condicionado"]; ?> <span class="rodape">
    <input type="hidden" name="condicionado" value="<?php echo $y["condicionado"]; ?>" />
    </span>- <b>Modelo:</b> <?php echo $y["modelo"]; ?><span class="rodape">
    <input type="hidden" name="modelo" value="<?php echo $y["modelo"]; ?>" />
    </span><br><br><b>Descrição</b><br><?php echo $y["descricao"]; ?> <span class="rodape">
