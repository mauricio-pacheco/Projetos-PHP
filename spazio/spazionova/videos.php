      ...
      <td bgcolor="#272523"><table width="723" border="0" align="center">
          <tr>
            <td bgcolor="#000000"><table width="100%" border="0" align="center">
              <tr>
                <td><div align="center"><img src="txvideos.jpg" width="440" height="46"></div></td>
              </tr>
              <tr>
...
$sql_select = "SELECT * FROM videos ORDER BY id DESC LIMIT $inicio, $qnt";
// Executa o Query
                                  ...
                                  <td width="26%"><table width="100%" border="0">
                                      <tr>
                                        <td><table width="100%" border="0">
                                          <tr>
                                            <td><?php echo $link.""; ?></td>
                                            <td><?php echo $nome.""; ?><br><br><?php echo $descricao.""; ?></td>
                                          </tr>
                                        </table></td>
                                      </tr>
                                      <tr>
                                        <td class="style22"><img src="../imagens/lendario.png" border="0"/>&nbsp;Data da Postagem: &nbsp;<?php echo $data.""; ?> - <?php echo $hora.""; ?></td>
                                      </tr>
                                  </table></td>
                                </tr>
                              </table>                            </td>
...
$sql_select_all = "SELECT * FROM videos ORDER BY id DESC";
...
echo "<a href='videos.php?p=1' target='_self'><font size='1'>Primeira p&aacute;gina</font></a> <font color='#ffffff' size='1'>-</font> ";
...
echo "<a href='videos.php?p=".$i."' target='_self'>".$i."</a> ";
}
}
...
echo " <font color='#ffffff' size='1'>-</font> <a href='videos.php?p=".$pags."' target='_self'><font size='1'>&Uacute;ltima p&aacute;gina</font></a> ";
?>
                      </span><br><br></p></td>
                  </tr>
                </table> 
