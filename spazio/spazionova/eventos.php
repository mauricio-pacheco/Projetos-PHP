...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#000000"><tr><td><img src="eventos2.jpg"></td></tr></table>
...
?>
        <table width="100%" border="0" align="center">
          <tr onMouseOver="this.style.backgroundColor='#EF2F72'; this.style.color='#252525'; this.style.cursor='pointer'" onClick="window.location='verevento.php?id=<?php echo $id.""; ?>';" onMouseOut="this.style.backgroundColor='#000000'; this.style.color='#000000';">
            <td width="18%" align="center"><img src="../folders/<?php echo $folder.""; ?>" border="1"/></td>
            <td width="82%" bgcolor="#000000"><table width="100%" border="0">
                <tr>
                  <td><span class="style22"><?php echo $assunto." <br /> "; ?></span></td>
                </tr>
                <tr>
...
$sql_select_all = "SELECT * FROM agenda ORDER BY id DESC";
...
echo "<span align=center><a href='eventos.php?p=1' target='_self'><font size='1'>Primeira p&aacute;gina</font></a> <font color='#ffffff' size='1'>-</font> ";
...
echo "<a href='eventos.php?p=".$i."' target='_self'>".$i."</a> ";
}
}
...
echo " <font color='#ffffff' size='1'>-</font> <a href='eventos.php?p=".$pags."' target='_self'><font size='1'>&Uacute;ltima p&aacute;gina</font></a></span><br><br> ";
?>
        </span></div></td>
  </tr>
</table>
