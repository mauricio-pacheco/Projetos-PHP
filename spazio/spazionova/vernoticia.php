      ...
      <td bgcolor="#272523"><table width="723" border="0" align="center">
          <tr>
            <td bgcolor="#000000"><table width="100%" border="0" align="center">
              <tr>
                <td><div align="center"><img src="ult.jpg" width="440" height="46"></div></td>
              </tr>
              <tr>
...
while($n = mysql_fetch_array($sql))
   ...
   ?>
                          <tr>
                            <td><span class="style19"> <img src="../imagens/new.png"> <?php echo $n["assunto"]; ?></span></td>
                          </tr>
                          <tr>
                            <td><span class="style22"><img src="../imagens/lendario.png" width="20" height="16"> Data da Postagem: <?php echo $n["data"]; ?> - <?php echo $n["hora"]; ?></span></td>
                          </tr>
                          <tr>
                            <td>&nbsp;</td>
                          </tr>
