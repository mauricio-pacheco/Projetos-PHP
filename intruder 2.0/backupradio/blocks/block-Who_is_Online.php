...
$who_online = "<center><font class=\"content\">"._CURRENTLY.":<br><br><big> <font class=\"link1\">$guest_online_num</font> "._GUESTS."<br> <font class=\"link1\">$member_online_num</font> "._MEMBERS."</big><br>";
...
if (is_user($user)) {
    ...
    $content .= "<a href=\"http://www.mandrywebdesign.net/jornaladelar/modules.php?name=Statistics\">Estatísticas</a></font>";
} else {
