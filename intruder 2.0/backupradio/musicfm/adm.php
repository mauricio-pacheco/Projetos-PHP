...
$sql = mysql_query("SELECT * FROM musicafm ORDER BY codigo");
...
while($n = mysql_fetch_array($sql))
   ...
   ?>
   <title></title>
<body bgcolor="#C4F0FF" text="#000000" link="#000000" vlink="#000000" alink="#000000">
...
<p> <font size="2" face="Verdana, Arial, Helvetica, sans-serif">
  <? $sql = mysql_query("Select * from musicafm");
