...
<tr>
	...
	<td width="500" background="themes/Helius/forums/images/bg2.gif"><div align="center"><span class="cattitle">{L_GROUP_MEMBERSHIP_DETAILS}</span></div></td>
...
<tr>
	...
	<td width="100%" align="center" valign="middle" background="themes/Helius/forums/images/top_center.gif"><span class="cattitle">{L_JOIN_A_GROUP}</span></td>
