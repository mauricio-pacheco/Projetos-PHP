...
<tr>
	...
	<td width="500" background="themes/Helius/forums/images/bg2.gif"><div align="center"><span class="cattitle">&nbsp;<a href="{catrow.U_VIEWCAT}" class="cattitle">{catrow.CAT_DESC}</a>&nbsp;</span></div></td>
...
<tr>
	<td width="6" background="themes/Helius/forums/images/cubo.gif" align="right">&nbsp;</td>
	<td width="500" background="themes/Helius/forums/images/bg2.gif"><div align="center"><span class="cattitle">&nbsp;<a href="{U_VIEWONLINE}" class="cattitle">{L_WHO_IS_ONLINE}</a>&nbsp;</span></div></td>
	<td width="6" background="themes/Helius/forums/images/cubo.gif" align="left">&nbsp;</td>
</tr>
