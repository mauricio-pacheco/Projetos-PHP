...
<tr>
	...
	<td width="500" background="themes/Helius/forums/images/bg2.gif"><div align="center"><span class="cattitle">{L_SEARCH_USERNAME}</span></div></td>
	<td width="6" background="themes/Helius/forums/images/cubo.gif" align="left">&nbsp;</td>
</tr>
</table>			<table width="100%" class="forumline" cellpadding="4" cellspacing="1" border="0">
			<tr> 
