...
<tr>
	...
	<td width="500" background="themes/Helius/forums/images/bg2.gif"><div align="center"><span class="cattitle">{postrow.POST_SUBJECT}</span></div></td>
	<td width="6" background="themes/Helius/forums/images/cubo.gif" align="left">&nbsp;</td>
</tr>
</table><table border="0" cellpadding="0" cellspacing="1" width="100%" class="forumline">
<tr>
...
<tr>
	<td width="6" background="themes/Helius/forums/images/cubo.gif" align="right">&nbsp;</td>
	<td width="500" background="themes/Helius/forums/images/bg2.gif"><div align="center"><a class="cattitle" href="{U_VIEW_TOPIC}">{TOPIC_TITLE}</a></div></td>
	<td width="6" background="themes/Helius/forums/images/cubo.gif" align="left">&nbsp;</td>
</tr>
</table><table class="forumline" width="100%" cellspacing="1" cellpadding="" border="0">
<tr>
...
</table><table border="0" cellspacing="0" cellpadding="5" width="100%">
<tr>
