...
<tr>
	...
	<td width="500" background="themes/Helius/forums/images/bg2.gif"><div align="center"><span class="cattitle">{L_PREVIEW}</span></div></td>
...
<tr>
	<td class="th" align="center" valign="middle">{POST_SUBJECT}</td>
</tr>
<tr>
