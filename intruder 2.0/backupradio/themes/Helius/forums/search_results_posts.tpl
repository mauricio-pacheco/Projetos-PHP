...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 <tr>
   <td align="center"><span class="cattitle">{L_SEARCH_MATCHES}</span></td>
 </tr>
</table>
...
<tr>
	...
	<td width="500" background="themes/Helius/forums/images/bg2.gif"><div align="center"><a class="cattitle" href="{searchresults.U_TOPIC}">{searchresults.TOPIC_TITLE}</a></div></td>
