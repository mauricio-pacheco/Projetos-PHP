        ...
        <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td><table width="99%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><img src="imagens/galeriafotos.png" /></td>
               </tr>
            </table></td>
          </tr>
        </table></td>
...
$sql_select = "SELECT * FROM cw_galeria WHERE local='galeria' ORDER BY id DESC LIMIT $inicio, $qnt";
...
?>
              ...
              <tr>
                <td><table border="1" bordercolor="#009036" width="310" height="130" cellspacing="0" cellpadding="0">
                  <tr>
                    <td align="center" bordercolor="#008D35" background="imagens/ddd.png"><a href="vergaleria.php?id=<?php echo $id.""; ?>"><img title="<?php echo $nomegaleria.""; ?>" alt="<?php echo $nomegaleria.""; ?>" src="administrador/ups/galerias/<?php echo $foto.""; ?>" border="0" width="300" height="120"  /></a></td>
                  </tr>
                </table></td>
              </tr>
              <tr>
              ...
              <tr>
                <td class="fontetitulo4"><em><a href="principal.php" class="fontetitulo4"><span class="fontetabela">Data de Publicação:                        <?php echo $data.""; ?> | ( <?php echo $hora.""; ?> )<br />
                </span></a></em></td>
              </tr>
              <tr>
                <td><img src="imagens/branco.gif" width="1" height="6" /></td>
              ...
              <tr>
                <td>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="40%"><em class="fontetabela">( <?php echo $contador.""; ?> Visualizações )</em></td>
                      <td width="60%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="9%"><img src="imagens/image.png" width="16" height="16" /></td>
...
$sql_select_all = "SELECT * FROM cw_galeria WHERE local='galeria' ORDER BY id DESC";
