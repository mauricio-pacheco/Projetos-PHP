...
<?php include("cima.php"); ?>
    <table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td><img src="imagens/contatos.png" width="78" height="28" /></td>
      </tr>
    </table>
    <table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
    ...
    <table width="980" border="0" align="center" cellpadding="0" cellspacing="0" class="fonterodape">
      <tr>
        <td><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="fonterodape">
          <tr>
            <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td><table width="100%" border="0" align="center" class="fonterodape">
                  <tr>
                          ...
                          <tr>
                            <td><table width="100%" border="0">
                              <tr>
                                ...
                                <td width="16%" class="fontebaixo2">&nbsp;Telefone: 55 3746 1083 </td>
                                <td width="6%" class="fontebaixo2"><img src="imagens/carta.png" width="49" height="32" /></td>
                                <td width="74%" class="fontebaixo2">E-mail: <a href="mailto:comercial@postoseberi.com.br" class="fontetitulo">comercial@postoseberi.com.br</a></td>
                              </tr>
                              <tr>
                          ...
                          <tr>
                            <td><table width="100%" align="left" border="0">
                              <tbody>
                                ...
                                <tr>
                                  <td><input class="manchete_texto9" size="60" name="nome" />
                                    * </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td><input class="manchete_texto9" size="36" name="cidade" />
                                    <select class="manchete_texto9" 
                              name="estado">
                                ...
                                <tr>
                                  <td><input name="telefone" class="manchete_texto9" onKeyPress="Mascara('telefone', window.event.keyCode, 'document.cadastro.telefone');" size="14" maxlength="14"  />
                                    * </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td><input class="manchete_texto9" size="40" name="email2" />
                                    * </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  <td><textarea class="manchete_texto9" name="mensagem" rows="12" cols="80"></textarea></td>
                                </tr>
                                <tr>
                                  <td><input class="manchete_texto9" type="submit" value="ENVIAR DADOS" name="submit" /></td>
                                </tr>
                              </tbody>
                            </table></td>
                          </tr>
