...
echo 
"<a href='administrador/ups/fotosgaleria/g/".$linha['foto']."' rel='lightbox['roadtrip']' title='".$linha["comentario"]."'><img  width=80 height=60 alt='VISUALIZAR IMAGEM' border='0' src='administrador/ups/fotosgaleria/p/".$linha['fotomenor']."'></a>
";
   ...
   ?></td>
                            ...
                            <td width="68%" valign="top" align="left"><div align="justify"><span class="fontetabela"><?php echo $y["comentario"]; ?></span></div></td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr> </tr>
