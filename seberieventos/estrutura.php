...
<?php include("cima.php"); ?>
   <table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td><img src="imagens/estrutura.png" /></td>
      </tr>
    </table>
    <table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
...
$sql2="SELECT * FROM cw_publicidades WHERE local='estrutura'"; 
$resultado2=mysql_query($sql2);

while($linha2= mysql_fetch_array($resultado2))
{
	?>
         <img src="administrador/ups/publicidades/<?php echo $linha2['arquivo']; ?>" width="979" height="500" border="0" />
 <?php } ?> 
        </div>
        </div>
