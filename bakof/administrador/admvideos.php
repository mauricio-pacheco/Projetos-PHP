...
?>
                  ...
                  <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td align="left"><a href="edivideos.php?id=<?php echo $id.""; ?>" class="manchete_texto4"><b>EDITAR VIDEO</b></a> - <a href="delvideos.php?id=<?php echo $id.""; ?>&amp;foto=<?php echo $foto.""; ?>" onclick="return confirm('Tem certeza que deseja apagar o video <?php echo $nomegaleria.""; ?> ?')" class="manchete_texto6"><b>APAGAR VIDEO</b></a></td>
                    </tr>
                  </table>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
...
$sql_select_all = "SELECT * FROM cw_videos";
...
echo "<a class=manchete_texto href='admvideos.php?p=1' target='_self'><b>PRIMEIRA P&Aacute;GINA</b></a>&nbsp;&nbsp;";
...
echo "| <a class=manchete_texto href='admvideos.php?p=".$i."' target='_self'>".$i."</a> ";
}
}
...
echo "&nbsp;&nbsp;<a class=manchete_texto href='admvideos.php?p=".$pags."' target='_self'><b>&Uacute;LTIMA P&Aacute;GINA</b></a> ";
?></div></td>
              </tr>
            </table></td>
          </tr>
