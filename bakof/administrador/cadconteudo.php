...
$sql = "INSERT INTO cw_conteudo (titulo, idmenu, texto, data, hora) VALUES ('$titulo', '$idmenu', '$texto', '$data', '$hora')";
if(mysql_query($sql)) {
echo "<div align=center><br><img src=imagens/ok.png></div><div align=center class=manchete_texto><br>O CADASTRO DA PÁGINA FOI EFETUADO COM SUCESSO!!</div><br>";
}else{
