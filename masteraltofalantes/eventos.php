          ...
          <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="748" valign="top"><table width="99%" height="28" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="fontetitulo" align="right">Fotos&nbsp;</td>
                </tr>
              </table>
...
$sql_select = "SELECT * FROM cw_depprodgal ORDER BY nome ASC LIMIT $inicio, $qnt";
...
?>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><div align="center"><a href="eventosmais.php?localm=<?php echo $id; ?>" class="fonte"><img src="imagens/altopasta.png" border="0" /></a></div></td>
                      </tr>
                    <tr>
                      <td><div align="center"><img src="imagens/branco.gif" width="1" height="4" /></div></td>
                      </tr>
                    <tr>
                      <td><div align="center"><a href="eventosmais.php?localm=<?php echo $id; ?>" class="fonte"><?php echo $nome; ?></a></div></td>
                      </tr>
                  </table>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
