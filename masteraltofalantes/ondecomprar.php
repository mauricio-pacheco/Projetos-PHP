...
<table width="968" height="700" class="boxSombra" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
          ...
          <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="748" valign="top"><table width="99%" height="28" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="fontetitulo" align="right">Onde Comprar&nbsp;</td>
                </tr>
              </table>
    ...
    <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                   ...
                   <tr>
                    <td class="fonte">&nbsp;Selecione a Região para conferir nossas lojas:</td>
                  </tr>
                    <tr>
              ...
              <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="center"><SCRIPT src="classes/mapa2.js"></SCRIPT><SCRIPT language=javascript>
     carregaFlash("flash/mapa2.swf","560","480"); 
    </SCRIPT></td>
                </tr>
              </table>
                          </td>
