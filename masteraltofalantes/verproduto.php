          ...
          <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="748" valign="top"><table width="99%" height="28" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="fontetitulo" align="right"><span class="fontetitulo">
...
while($y = mysql_fetch_array($sql))
   {
   ?>
                    <strong><?php echo $y["nome"]; ?></strong></span>&nbsp;</td>
                </tr>
              </table>
              ...
              <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" class="fonte">
                <tr>
                  <td><table width="99%" border="0" align="center">
                    <tr>
                      <td valign="top"><table width="100%" border="0" align="center" class="manchete_texto9">
                        <tr>
					 ...
					 if ($branca == $testeb)
					 {
					  					  ?>
                                  <?php } else { ?>
                                  <img src="administrador/ups/produtos/<?php echo $y["foto"]; ?>" width="400" height="300"/>
                                  <?php } ?></td>
...
?>
                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                      <td align="left"><a href='administrador/ups/fotosprodutos/g/<?php echo $fotomaior.""; ?>' rel='lightbox['roadtrip="roadtrip"']' title='<?php echo $legenda.""; ?>'><img width="82" height="54" alt='<?php echo $legenda.""; ?>' title='<?php echo $legenda.""; ?>' border='0' src='administrador/ups/fotosprodutos/p/<?php echo $fotomenor.""; ?>' /></a></td>
                                    </tr>
                                  </table>
                                  <?php
$linhaco = $linha['id'];
...
?></td>
                        ...
                        <tr>
                          <td align="left" class="manchete_texto"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                              <td><strong>
                                <?php 	
   ...
   { echo $z["nomesub"];  }
	...
	?>
                            ...
                            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                              <tr>
                                <td class="manchete_texto9"><?php if ($y["valor"]=='') { } else { ?>
                                  Valor: <font color="#008000"><b>R$</b></font> <?php echo $y["valor"]; ?>
                                  <?php } ?></td>
                              </tr>
                            </table>
                            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                              <tr>
                                <td class="manchete_texto9"><?php if ($y["valorpx"]=='' and $y["valorp"]=='') { } else { ?>
                                  ou em <?php echo $y["valorpx"]; ?> X de <font color="#008000"><b>R$</b></font> <?php echo $y["valorp"]; ?>
                                  <?php } ?></td>
                              </tr>
                            </table>
                            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                              <tr>
                                <td class="manchete_texto9"><span class="manchete_texto96">
                                  <?php if ($y["valorpx"]!='' and $y["valorp"]!='' and $y["valor"]!='') { } else { ?>
                                  <b><?php echo $y["valortratar"]; ?></b>
                                  <?php } ?>
                                </span></td>
                              </tr>
                            </table>
                        ...
                        <tr>
                          <td align="left" width="14%"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                              <td>&nbsp;</td>
                            </tr>
                            <tr>
...
return false
		...
		return true;
                            ...
                            <form action="emailproduto.php" method="post" name="cadastro" onsubmit="return validar(this)">
                              <table width="99%" bgcolor="#E9E9E9" height="30" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                              ...
                              <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td><span class="manchete_texto96">Nome:
                                    <input name="nome" type="text" class="fonte" id="nome" style="width:280px"  />
                                    *</span></td>
                                </tr>
                              </table>
                              <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                              ...
                              <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td><span class="manchete_texto96">Telefone:
                                    <input name="fone" type="text" class="fonte" id="fone" style="width:150px" />
                                    *</span></td>
                                </tr>
                              </table>
                              <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                              ...
                              <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td><span class="manchete_texto96">E-mail:
                                    <input name="email2" type="text" class="fonte" id="email" style="width:190px" />
                                    *</span></td>
                                </tr>
                              </table>
                              <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                              ...
                              <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td><span class="manchete_texto96">Digite abaixo as informações que deseja sobre o produto:</span></td>
                                </tr>
                              </table>
                              <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                              ...
                              <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td><span class="manchete_texto96">
                                    <textarea name="descricao" cols="60" rows="10" class="fonte" id="descricao"></textarea>
                                  </span></td>
                                </tr>
                              </table>
                              <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                              ...
                              <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td><span class="manchete_texto96">
                                    <input name="button2" type="submit" value="ENVIAR DADOS" class="fontelink" id="button2"  />
                              ...
                              <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                                ...
                                <td valign="top"><script language="javascript" type="text/javascript">
function validar(cadastro2) { 

if (document.cadastro2.nome.value=="") {
alert("O Campo Nome não está preenchido!")
cadastro2.nome.focus();
return false
}

if (document.cadastro2.email2.value=="") {
alert("O Campo E-mail do seu Amigo não está preenchido!")
cadastro2.email2.focus();
return false
}
		...
		return true;
                            ...
                            <form action="emailamigo.php" method="post" name="cadastro2" onsubmit="return validar(this)">
                              <table bgcolor="#E9E9E9" width="99%" height="30" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td><strong>&nbsp;&nbsp;ENVIE ESSE PRODUTO AO SEU AMIGO:</strong></td>
                                </tr>
                              </table>
                              <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                              ...
                              <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td><span class="manchete_texto96">E-mail do seu Amigo:
                                      <input name="email2" type="text" class="fonte" id="email" style="width:190px" />
                                    *</span></td>
                                </tr>
                            </table>
                              ...
                              <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td><span class="manchete_texto96">Digite abaixo a mansagem para seu amigo:</span></td>
                                </tr>
                              </table>
                              <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                              ...
                              <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td><span class="manchete_texto96">
                                    <textarea name="descricao" cols="60" rows="12" class="fonte" style="height:169px"></textarea>
                                  </span></td>
                                </tr>
                              </table>
                              <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                             ...
                             <table width="100%" border="0" bgcolor="#E9E9E9" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td><img src="imagens/branco.gif" width="1" height="1" /></td>
        </tr>
      </table>
