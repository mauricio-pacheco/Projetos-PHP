          ...
          <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="748" valign="top"><table width="99%" height="28" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="fontetitulo" align="right">Representantes Região Sudeste&nbsp;</td>
                </tr>
              </table>
...
$sql_select = "SELECT * FROM cw_reps WHERE estado='SP - São Paulo' OR estado='RJ - Rio de Janeiro' OR estado='MG - Minas Gerais' OR estado='ES - Espírito Santo' ORDER BY id DESC LIMIT $inicio, $qnt";
