...
$sql_select_all = "SELECT * FROM cw_produtos";
...
echo "<a href='produtos.php?p=1' target='_self' class=fontesub><b>PRIMEIRA PÁGINA</b></a>&nbsp;&nbsp; ";
...
echo "| <a href='produtos.php?p=".$i."' target='_self' class=fontesub>".$i."</a> ";
}
}
...
echo "&nbsp;&nbsp;<a href='produtos.php?p=".$pags."' target='_self' class=fontesub><b>ÚLTIMA PÁGINA</b></a> ";
