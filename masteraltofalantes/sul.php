          ...
          <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="748" valign="top"><table width="99%" height="28" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="fontetitulo" align="right">Representantes Região Sul&nbsp;</td>
                </tr>
              </table>
...
$sql_select = "SELECT * FROM cw_reps WHERE estado='RS - Rio Grande do Sul' OR estado='PR - Paraná' OR estado='SC - Santa Catarina' ORDER BY id DESC LIMIT $inicio, $qnt";
