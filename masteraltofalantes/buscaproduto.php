...
$sql_select = "SELECT * FROM cw_produtos WHERE nome LIKE '%".$palavra."%' ORDER BY nome ASC LIMIT $inicio, $qnt";
...
echo "<a href='buscaprodutos.php?p=1' target='_self' class=fontesub><b>PRIMEIRA PÁGINA</b></a>&nbsp;&nbsp; ";
...
echo "| <a href='buscaprodutos.php?p=".$i."' target='_self' class=fontesub>".$i."</a> ";
}
}
...
echo "&nbsp;&nbsp;<a href='buscaprodutos.php?p=".$pags."' target='_self' class=fontesub><b>ÚLTIMA PÁGINA</b></a> ";
