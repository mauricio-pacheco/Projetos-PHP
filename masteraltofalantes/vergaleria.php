          ...
          <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="748" valign="top"><table width="99%" height="28" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="fontetitulo" align="right"><?php $obra = $_GET["galeria"]; echo $obra; ?>&nbsp;</td>
                </tr>
              </table>
                                ...
                                <table width="156" border="0" align="center" cellpadding="0" cellspacing="0">
                                  <tr>
                                    <td><table border="1" bordercolor="#FFFFFF" width="170" height="130" cellspacing="0" cellpadding="0">
                                      <tr>
                                        <td align="center" bordercolor="#EEEEEE" bgcolor="#2E2E2E"><a href='administrador/ups/fotosgaleria/g/<?php echo $foto.""; ?>' rel='lightbox['roadtrip="roadtrip"']' title='<?php echo $comentario.""; ?>'><img src="administrador/ups/fotosgaleria/p/<?php echo $fotomenor.""; ?>" width="160" height="120" border="0" /></a></td>
                                      </tr>
                                    </table></td>
                                  </tr>
                                  <tr>
