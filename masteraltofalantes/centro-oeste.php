          ...
          <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="748" valign="top"><table width="99%" height="28" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="fontetitulo" align="right">Representantes Região Centro Oeste&nbsp;</td>
                </tr>
              </table>
...
$sql_select = "SELECT * FROM cw_reps WHERE estado='MS - Mato Grosso do Sul' OR estado='MT - Mato Grosso' OR estado='DF - Distrito Federal' OR estado='GO - Goiás' ORDER BY id DESC LIMIT $inicio, $qnt";
