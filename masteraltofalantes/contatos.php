          ...
          <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="748" valign="top"><table width="99%" height="28" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="fontetitulo" align="right">Contatos&nbsp;</td>
                </tr>
              </table>
              ...
              <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td><table width="99%" border="0" align="center">
                    <tr>
                      <td><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="fonte">
                        <tr>
...
campo.value = campo.value + separador3;
                                        ...
                                        <tr>
                                          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                              ...
                                              <td width="39%" align="left" class="manchete_texto9">&nbsp;&nbsp;Telefone: 55 3744-6009</td>
                                              <td width="4%"><img src="imagens/email.png" /></td>
                                              <td width="53%" align="left">&nbsp;&nbsp; <a href="mailto:vendasmasterfw@bol.com.br" class="fonte">vendasmasterfw@bol.com.br</a></td>
                                            </tr>
                                          </table>
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                              <tr>
                              ...
                              name="estado">
                                ...
                                value='TO - Tocantins'>TO - Tocantins</option>
                                              ...
                                              <tr>
                                                <td><div align="left">
                                                  <input class="fontelink" type="submit" value="ENVIAR DADOS" name="submit" />
                                                </div></td>
                                              </tr>
                                            </tbody>
                                          </table></td>
