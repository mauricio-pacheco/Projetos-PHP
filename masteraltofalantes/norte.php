          ...
          <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="748" valign="top"><table width="99%" height="28" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="fontetitulo" align="right">Representantes Região Norte&nbsp;</td>
                </tr>
              </table>
...
$sql_select = "SELECT * FROM cw_reps WHERE estado='AC - Acre' OR estado='AM - Amazonas' OR estado='RO - Rondônia' OR estado='PA - Pará' OR estado='RR - Roraima' OR estado='AP - Amapá' ORDER BY id DESC LIMIT $inicio, $qnt";
...
?>
                            ...
                            <table width="200" border="0" align="center" cellpadding="0" cellspacing="0">
                              <tr>
                                <td><table border="0" bordercolor="#FFFFFF" width="170" height="130" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td align="center" bordercolor="#EEEEEE" bgcolor="#2E2E2E" background="imagens/ddd.png"><a href="<?php echo $link.""; ?>" target="_blank"><img src="administrador/ups/reps/<?php echo $foto.""; ?>" width="200" height="150" title="<?php echo $nome.""; ?>" alt="<?php echo $nome.""; ?>" border="0" /></a></td>
                                  </tr>
                                </table></td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                <td class="fonte"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                                  <tr>
                                    <td align="center"><a href="<?php echo $link.""; ?>" class="fonte" target="_blank"><em><b><?php echo $nome.""; ?></b></em></a></td>
                                  </tr>
                                  <tr>
                                    <td><img src="imagens/branco.gif" width="1" height="3" /></td>
                                  </tr>
...
$sql_select_all = "SELECT * FROM cw_reps ORDER BY id DESC";
