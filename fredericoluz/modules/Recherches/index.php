...
echo "<center><form action=\"modules.php?op=modload&amp;name=$nom&amp;file=index\" method=\"post\">"
."<table border=\"0\" align=\"center\"><tr><td valign=\"middle\"><input type=\"text\" name=\"query\" size=\"60\" ></td>"
."<td valign=\"middle\" align=\"left\"><input type=\"submit\" ></td>"
."</tr></table></form>"
...
global $screens;
OpenTable();
echo "<center>"._HAUTDEPAGE."</center><br><br></font><table width=\"100%\" border=\"0\"><tr><td align=\"left\"><b>[ "._VOTRERECHERCHE.":  $query ]</b></td><td align=\"right\"><b>[ <a href=\"modules.php?op=modload&name=$nom&file=stats\">"._STATS0."</a> ]</b></td></tr></table>";
if ($screens) {
} else {
