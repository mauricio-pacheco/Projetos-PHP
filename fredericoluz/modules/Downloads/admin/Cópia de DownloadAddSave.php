...
if ($numrows>0) {
  ...
  $db->sql_query("INSERT INTO ".$prefix."_nsngd_downloads VALUES (NULL, '$cat', '$perm', '$title', '$retarda', '$description', now(), '$sname', '$email', '$hits', '$submitter', '$sub_ip', '$tamanho', '$version', '$homepage', '1')");
