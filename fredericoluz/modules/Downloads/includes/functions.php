...
function dladminmain() {
    ...
    echo "<tr>\n";
    echo "<td align='center' width='25%'><b>Publicações</b></td>\n";
...
function menu($maindownload) {
    global $module_name;
    OpenTable();
    echo "<center><img src='publicacoes.jpg' border='0' alt='' title=''></center>\n";
    CloseTable();
    OpenTable();
    SearchForm();
    if ($maindownload>0) { echo ""; }
    echo "";
    echo "";
    echo "";
    echo " ";
    ...
    echo "<tr><td align='center' colspan='3'><img src=legendas.gif></td></tr>\n";
    echo "<tr>\n";
    $myimage = myimage("new_01.png");
    echo "<td align='left' width='33%'><img align='middle' src='$myimage' alt='' title=''> = "._NEWTODAY."</td>\n";
    $myimage = myimage("new_03.png");
    echo "<td align='left' width='34%'><img align='middle' src='$myimage' alt='' title=''> = "._NEWLAST3DAYS."</td>\n";
    echo "</tr>\n";
    echo "<tr>\n";
    $myimage = myimage("new_14.png");
    echo "<td align='left' width='33%'><img align='middle' src='$myimage' alt='' title=''> = "._NEWLAST2WEEKS."</td>\n";
    $myimage = myimage("new_07.png");
    echo "<td align='left' width='33%'><img align='middle' src='$myimage' alt='' title=''> = "._NEWTHISWEEK."</td>\n";
    $myimage = myimage("popular.png");
    echo "";
    echo "</tr>\n";
    echo "</table>\n";
...
function SearchForm() {
    ...
    echo "<tr><td><font class='content'>Pesquisar Publicações:&nbsp;<input type='text' size='40' name='query' value='$query'> <input type='submit' value='Buscar'></td></tr>\n";
    echo "</form>\n";
    echo "</table>\n";
}
...
function showlisting($lid) {
    ...
    if (($lidinfo['sid'] == 0) || ($lidinfo['sid'] == 1 AND is_user($user))  || ($lidinfo['sid'] == 2 AND is_admin($admin)) || ($lidinfo['sid'] > 2 AND in_group($priv)) || $dl_config['show_download'] == '1') {
        ...
        if (is_admin($admin)) {
            ...
            echo "<img align='middle' src='$myimage' border='0' alt='"._DL_EDIT."'>&nbsp;";
        } else {
        ...
        echo "<b>"._ADDEDON.":</b> ".CoolDate($lidinfo['date'])."<br><br>\n";
