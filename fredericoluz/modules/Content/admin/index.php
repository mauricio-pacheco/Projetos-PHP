...
function content() {
	...
	echo "<tr><td><a href=\"modules.php?name=Content&pa=showpage&pid=$mypid\">$mytitle</a></td><td align=\"center\">$status</td><td align=\"center\">$cat_title</td><td align=\"center\">[ <a href=\"admin.php?op=content_edit&pid=$mypid\">" . _EDIT . "</a> | <a href=\"admin.php?op=content_delete&pid=$mypid\">" . _DELETE . "</a> ]</td></tr>";
    }
    echo "</table>";
    CloseTable();
    echo "<br>";
...
#// Editor Ende
  ...
  ."<input type=\"hidden\" name=\"op\" value=\"add_category\">" 
	...
	."<b>" . _HEADERTEXT . ":</b><br>";
	echo "<br><iframe marginwidth=0 marginheight=0 src=enviafoto.php frameborder=0 width=520 scrolling=No height=30></iframe><br><br>";
// Editor Start
