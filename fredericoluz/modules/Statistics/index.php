...
function Stats_Main() {
    ...
    OpenTable();
    OpenTable();
    echo "<center>"._WERECEIVED." <b><font class=\"link1\">$total</font></b> "._PAGESVIEWS." $startdate<br><br>"
    ...
    OpenTable2();
    echo "<table bgcolor=\"#FFFFFF\" cellspacing=\"0\" cellpadding=\"2\" border=\"0\" align=\"center\"><tr><td colspan=\"2\">\n";
...
function Stats($total) {
    ...
    OpenTable();
    OpenTable();
    echo "<center>"._WERECEIVED." <b>$total</b> "._PAGESVIEWS." $startdate<br>"._TODAYIS.": $now[0]/$now[1]/$now[2]<br><br>";
...
function showYearStats($nowyear){
    ...
    echo "<tr><td width=\"25%\" bgcolor=\"#FFFFFF\">"._YEAR."</td><td bgcolor=\"#FFFFFF\">"._SPAGESVIEWS."</td></tr>";
    while($row = $db->sql_fetchrow($result)) {
...
function showMonthStats($nowyear,$nowmonth){
    ...
    echo "<table align=\"center\" bgcolor=\"#000000\" cellspacing=\"1\" cellpadding=\"3\" border=\"0\">";
    echo "<tr><td width=\"25%\" bgcolor=\"#FFFFFF\">"._UMONTH."</td><td bgcolor=\"#FFFFFF\">"._SPAGESVIEWS."</td></tr>";
    while($row = $db->sql_fetchrow($result)) {
...
function showDailyStats($year,$month,$nowdate){
    ...
    echo "<table align=\"center\" bgcolor=\"#000000\" cellspacing=\"1\" cellpadding=\"3\" border=\"0\">";
    echo "<tr><td width=\"25%\" bgcolor=\"#FFFFFF\">"._DATE."</td><td bgcolor=\"#FFFFFF\">"._SPAGESVIEWS."</td></tr>";
    while($row = $db->sql_fetchrow($result)) {
	$year = intval($row['year']);
	$month = intval($row['month']);
...
function showHourlyStats($year,$month,$date){
    ...
    echo "<table align=\"center\" bgcolor=\"#000000\" cellspacing=\"1\" cellpadding=\"3\" border=\"0\">";
    echo "<tr><td width=\"25%\" bgcolor=\"#FFFFFF\">"._HOUR."</td><td bgcolor=\"#FFFFFF\" width=\"70%\">"._SPAGESVIEWS."</td></tr>";
    for ($k = 0;$k<=23;$k++) {
