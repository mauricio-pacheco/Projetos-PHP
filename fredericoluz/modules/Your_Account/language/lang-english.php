...
define("_COOKIEPATHNOTE","Only if <i>Logout when windows close</i><br> is not selected");
...
define("_VALUECOMENT","**To create a list, separate the words with this symbol <b>::</b>");
