   ...
   #     echo "</table>";
    ...
    while ($row6 = $db->sql_fetchrow($result6)) {
		...
		echo "<tr><td align=\"right\"><b>$sid</b>"
		    ...
		    ."</td>"
		    ."<td align=\"right\">$topicname";
		if ($radminarticle == 1 OR $radminsuper == 1) {
		    if (($radminarticle==1) AND ($aid == $said) OR ($radminsuper==1)) {
				echo "</td><td align=\"right\" nowrap>(<a href=\"admin.php?op=FCKEditStory&amp;sid=$sid\">"._EDIT."</a>-<a href=\"admin.php?op=RemoveStory&amp;sid=$sid\">"._DELETE."</a>)"
			    	."</td></tr>";
		    } else {
