...
<tr>
	...
	<td width="100%" height="24" align="center" valign="middle" background="themes/Helius/forums/images/top_center.gif"><span class="cattitle">{L_VIEWING_PROFILE}</span></td>
	<td width="50" align="left" valign="bottom"><img src="themes/Helius/forums/images/esquerdo.gif"/></td>
</tr>
</table>
<table class="forumline" width="100%" cellspacing="1" cellpadding="3" border="0" align="center">
  <tr> 
	<th width="40%" height="28">{L_AVATAR}</th>
	<th width="60%">{L_ABOUT_USER}</td>
  </tr>
  <tr> 
  ...
  <tr> 
	<td class="th" height="28" align="center">{L_CONTACT} {USERNAME}</td>
  </tr>
  <tr> 
