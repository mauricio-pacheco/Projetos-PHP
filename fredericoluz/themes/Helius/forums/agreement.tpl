...
<tr>
	...
	<td width="100%" align="center" height="24" valign="middle" background="themes/Helius/forums/images/top_center.gif"><span class="cattitle">{SITENAME} - {REGISTRATION}</span></td>
