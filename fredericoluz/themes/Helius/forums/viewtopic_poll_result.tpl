...
<tr>
	...
	<td width="100%" height="24" align="center" valign="middle" background="themes/Helius/forums/images/top_center.gif"><span class="cattitle">{MESSAGE_TITLE}</span></td>
			...
			<tr> 
			  ...
			  <td> 
				<table cellspacing="0" cellpadding="0" border="0">
				  <tr> 
					<td><img src="themes/Helius/forums/images/vote_lcap.gif" width="4" alt="" height="12" /></td>
					<td><img src="themes/Helius/forums/images/voting_bar.gif" width="{poll_option.POLL_OPTION_IMG_WIDTH}" height="12" alt="{poll_option.POLL_OPTION_PERCENT}" /></td>
					<td><img src="themes/Helius/forums/images/vote_rcap.gif" width="10" alt="" height="12" /></td>
				  </tr>
				</table>
			  </td>
