...
<table width="960" bgcolor="#000000" border="0" height="30" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td class="fontetitulo">&nbsp;&nbsp;<strong>CONCURSOS</strong></td>
  </tr>
</table>
<table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
...
echo "<a href='galerias.php?p=1' target='_self' class=fonte>PRIMEIRA P&Aacute;GINA</a>&nbsp;&nbsp;";
...
echo "| <a href='galerias.php?p=".$i."' target='_self' class=fonte>".$i."</a> ";
}
}
...
{
echo " <a href='galerias.php?p=".$i."&id=$id' target='_self' class=fonte>".$i."</a> |";
}
}
// Exibe o link "&uacute;ltima p&aacute;gina"
echo "&nbsp;&nbsp;<a href='galerias.php?p=".$pags."&id=$id' target='_self' class=fonte>&Uacute;LTIMA P&Aacute;GINA</a> ";
