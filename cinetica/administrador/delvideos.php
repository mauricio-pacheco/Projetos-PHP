          ...
          <table width="100%" border="0" align="center">
            <tr>
              <td width="11%" height="30" bgcolor="#076CA0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="98%">&nbsp;&nbsp;<font color="#FFFFFF" class="fontetabela2"><b>APAGAR VIDEO</b></font></td>
                </tr>
              </table></td>
            </tr>
          </table>
...
$sql = "DELETE FROM cw_videos WHERE id='$id'";
unlink("ups/galeriavideo/$foto");
if(mysql_query($sql)) {
echo "<div align=center><br><font color='#000000' >O VIDEO FOI APAGADO COM SUCESSO!!</font></div>";
echo "<script>alert('VIDEO APAGADO COM SUCESSO!')</script>";
echo "<script>location.href='admvideos.php'</script>";
}else{
