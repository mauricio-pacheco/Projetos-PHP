...
$sql = "UPDATE cw_subsessoes SET subsessao = '$subsessao', idsessao = '$idsessao' WHERE id = '$id'";
if(mysql_query($sql)) {
echo "<div align=center><br><img src=imagens/ok.png></div><br><div align=center class=manchete_texto>A SUB-SESSÃO FOI EDITADA COM SUCESSO!!</div>";
}else{
echo "<div align=center>NÃO FOI POSSÍVEL EDITAR!</div>";
}

$sql2 = "UPDATE cw_pub SET idsubsessao = '$id', idsessao = '$idsessao' WHERE idsubsessao = '$id'";
if(mysql_query($sql2)) {
