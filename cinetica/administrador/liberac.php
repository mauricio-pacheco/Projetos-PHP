          ...
          <table width="100%" border="0" align="center">
            <tr>
              <td width="11%" height="30" bgcolor="#076CA0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="98%">&nbsp;&nbsp;<font color="#FFFFFF" class="fontetabela2"><b>LIBERAR COMENTÁRIO</b></font></td>
                </tr>
              </table></td>
            </tr>
          </table>
...
$sql = "UPDATE cw_comentarios SET status = '0' WHERE id = '$id'";
if(mysql_query($sql)) {
echo "<div align=center class=manchete_texto><br>O COMENTÁRIO FOI LIBERADO COM SUCESSO!!</div>";

echo "<script>alert('COMENTÁRIO LIBERADO COM SUCESSO!')</script>";
echo "<script>location.href='comentarios.php?id=$idnoticia'</script>";
}else{
