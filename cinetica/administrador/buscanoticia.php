          ...
          <table width="100%" border="0" align="center">
            <tr>
              <td width="11%" height="30" bgcolor="#076CA0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="98%">&nbsp;&nbsp;<font color="#FFFFFF" class="fontetabela2"><b>ADMINISTRAR NOTÍCIAS DO DEPARTAMENTO <?php
   ...
   { echo $z["departamento"];    }
          ...
          <tr>
            <td><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td>
                                <form name="formbusca" method="post" action="buscanoticia.php">
                  <label><span class="manchete_texto"><strong>Pesquisar Notícia:
<input name="palavra" type="text" value="Digite o Título da Notícia" onClick="this.value=''" class="manchete_texto" id="palavra" size="60" />
                  Departamento: </strong></span></label>
...
$sql_select = "SELECT * FROM cw_noticias WHERE titulo LIKE '%".$palavra."%' AND iddep='$iddep' ORDER BY id DESC LIMIT $inicio, $qnt";
// Executa o Query
                      ...
                      <td align="left" width="98%"><table width="100%" border="0">
                        <tr>
                          <td><table width="100%" border="0">
                            <tr>
                              <td width="4%"><img src="ups/capasnoticia/<?php echo $foto.""; ?>" width="150" height="112" /></td>
...
$sql_select_all = "SELECT * FROM cw_noticias WHERE titulo LIKE '%".$palavra."%' AND iddep='$iddep'";
...
echo "<a class=manchete_texto href='buscanoticia.php?p=1' target='_self'><b>PRIMEIRA P&Aacute;GINA</b></a>&nbsp;&nbsp;";
...
echo "| <a class=manchete_texto href='buscanoticia.php?p=".$i."' target='_self'>".$i."</a> ";
}
}
...
echo "&nbsp;&nbsp;<a class=manchete_texto href='buscanoticia.php?p=".$pags."' target='_self'><b>&Uacute;LTIMA P&Aacute;GINA</b></a> ";
?>
                  </div></td>
              </tr>
            </table></td>
