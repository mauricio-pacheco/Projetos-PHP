                    ...
                    <table width="99%" border="0" align="center">
                      ...
                      <tr>
                        ...
                        <?php if ($n["local"]=='cabecalho') { echo 'checked=checked'; } else { }?> />
                          Cabeçalho ( <em>571 px de largura X 299 px de altura</em> )
                          <input type="radio" name="local" value="rodape" <?php if ($n["local"]=='rodape') { echo 'checked=checked'; } else { }?> /> 
Rodapé ( <em>230 px de largura X 120 px de altura</em> ) </td>
                      </tr>
                      <tr>
...
Imagem ( .gif, .jpg e .png )</td>
                      ...
                      <tr>
                        <td class="manchete_texto" align="left"><?php
						  if ($n["tipo"]=='imagem') {
						  						  ?>
                          <img src="ups/publicidades/<?php echo $n["arquivo"]; ?>" width="400" height="150" />
                          <?php
						  } else {
						  ?>
