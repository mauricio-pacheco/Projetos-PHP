...
$sql = "INSERT INTO cw_videos (titulo, video, comentario, data, hora, foto) VALUES ('$titulo', '$video', '$comentario', '$data', '$hora', '$nome_foto')";
if(mysql_query($sql)) {
echo "<div align=center><br><img src=imagens/ok.png></div><div align=center class=manchete_texto><br>O VIDEO FOI CADASTRADO COM SUCESSO!!</div>";
}else{
