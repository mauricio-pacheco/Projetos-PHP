...
<table width="960" bgcolor="#000000" border="0" height="30" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td class="fontetitulo">&nbsp;&nbsp;<strong><?php echo $y["titulo"]; ?></strong></td>
  </tr>
</table>
<table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
...
// -->
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td>Faltam
              <input name="remLen" type="text" class="texto" value="255" size="3" maxlength="3" readonly="readonly" />
              caracteres.</td>
          </tr>
        </table>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><input name="button3" type="submit" class="texto" id="button3" value="Postar Coment&aacute;rio" /></td>
          </tr>
        </table>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
