...
//DO NOT EDIT THIS FILE... ONLY EDIT THE zpanel/database/db.php FILE!
...
/* $Id: config.inc.php,v 2.3 2003/12/02 21:59:24 lem9 Exp $ */
 ...
 */
$cfg['blowfish_secret'] = 'ijbqw0erib2klnasjbf349jj';
...
$cfg['Servers'][$i]['compress']      = FALSE;       // Use compressed protocol for the MySQL connection
                                                    // (requires PHP >= 4.3.0)
$cfg['Servers'][$i]['controluser']   = $db_user;          // MySQL control user settings
                                                    // (this user must have read-only
$cfg['Servers'][$i]['controlpass']   = $db_pass;          // access to the "mysql/user"
                                                    // and "mysql/db" tables).
