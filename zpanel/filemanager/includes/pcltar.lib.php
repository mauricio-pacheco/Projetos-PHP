...
$v_header[filename] = $zip_entry_tmp_name;
...
// - additional checks made by pcltar (file exists, newer file exists, etc) do not stop the extraction process
