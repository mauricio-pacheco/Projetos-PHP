...
// NET2FTP
// Force the extraction filename to the value given by net2ftp: $zip_entry_tmp_name
// This is a unique temporary filename which ensures that the file of one user would 
// not overwrite the file of another user

global $zip_entry_tmp_name;
$p_entry['filename'] = $zip_entry_tmp_name;

// NET2FTP
// The code below is put in comment so that:
// - no directories would be created on the web server (they are created on the FTP server instead)
// - no path would be removed/added from/to the filename
// - additional checks made by pclzip (file exists, newer file exists, etc) do not stop the extraction process
