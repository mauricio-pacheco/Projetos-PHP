...
$down_one = "yes";
 ...
 $updateSQL = sprintf("UPDATE `config` SET installed='1';");
    ...
    <tr> 
      <td height="241" align="left" valign="top" background="../images/templates/default_r3_c1.gif" bgcolor="#FFFFFF" style="background-repeat:no-repeat"><br>
        <br><ul>
          ...
          <li><strong><font color="#999999">Customize Packages</font></strong></li>
          <li><strong><font color="#FF0000">Finished!</font></strong></li>
        </ul>
        <strong>Step 6 of 6</strong><br>
        <table width="143" border="1" cellpadding="0" cellspacing="0" bordercolor="#000000" bgcolor="#F4F4F4">
          <tr> 
            <td height="25" align="left" valign="top"><font color="#0000FF"><strong><font color="#FF0000">|||</font></strong></font><font color="#FF0000"><strong>|||||||||||||||||||||||||||||||||||||||||||</strong></font></td>
          </tr>
        </table></td>
      <td colspan="2" align="left" valign="top" bgcolor="#FFFFFF"><p><font size="4"><strong>Setup 
          6: Finished!</strong></font></p>
        <blockquote> 
          <p></p>
          <p></p>
          <p></p>
          <p>It is now time for you to login to the Admin panel for the first 
            time! Click Finish below to move on.</p>
          <p>You will be redirected to the main login for your ZPanel. Once there, 
            login under your admin account and click the &quot;Administration&quot; 
            link located on the right, next to &quot;Home&quot; and &quot;Logout.&quot;</p>
          <p>&nbsp;</p>
          <form name="form1" method="post" action="javascript:document.location.href = '../index.php'">
            <div align="right">
              <input class="inputbox" type="submit" name="Submit" value="Finish">
            </div>
          </form>
        </blockquote></td>
    </tr>
