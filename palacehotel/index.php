...
$fp = fopen("palace/counterlog.txt", "w"); 
fwrite($fp, $count); 
                          ...
                          <TR>
                            <TD vAlign=top><!-- 
                              ...
                              cellPadding=1 width="100%" border=0>
                                <TBODY>
                                <TR>
                                <TD width="55%">&nbsp;&nbsp;<span class="TituloCapaG">&nbsp;Home</span></TD>
                                <TD width="30%">&nbsp;</TD>
                                <TD width="15%">&nbsp;</TD>
                                </TR>
                                <TR>
...
height=1></TD></TR>
                              ...
                              cellPadding=1 width="100%" border=0>
                                <TBODY>
                                <TR>
                                <TD vAlign=top><p align="justify" class="style7">&nbsp;</p>
                                  <p align="justify" class="style7">A empresa   inaugurada em outubro de 1994 est&aacute; instalada na Rua do Com&eacute;rcio, 789, Centro de   Frederico Westphalen - RS. O Hotel possui 2.250m2 de &aacute;rea constru&iacute;da, com 8   andares, sendo 5 andares com 10 apartamentos cada e os outros 3 andares onde   est&atilde;o localizadas a portaria no primeiro andar, a sala de jogos no segundo, a   sala de caf&eacute;s, cozinha. O Hotel possui hoje 50 apartamentos, 30 s&atilde;o de luxo e os   20 s&atilde;o stander. A capacidade m&aacute;xima de h&oacute;spedes gira   em torno de 125 pessoas. Um novo padr&atilde;o nos servi&ccedil;os de hotelaria, proporcionam a todos os h&oacute;spedes uma &oacute;tima   estadia.</p>
