                          ...
                          <TR>
                            <TD vAlign=top><!-- 
                              ...
                              cellPadding=1 width="100%" border=0>
                                <TBODY>
                                <TR>
                                <TD width="55%">&nbsp;&nbsp;<span class="TituloCapaG">&nbsp;Localiza&ccedil;&atilde;o </span></TD>
                                <TD width="30%">&nbsp;</TD>
                                <TD width="15%">&nbsp;</TD>
                                </TR>
                                <TR>
...
height=1></TD></TR>
                              ...
                              cellPadding=1 width="100%" border=0>
                                ...
                                <TR>
                                <TD vAlign=top>
                                  <div align="center"><SCRIPT src="prin5.js"></SCRIPT> <SCRIPT language=javascript>
     carregaFlash('mapars.swf','490','590'); // Depois só descrever o caminho, largura, altura do SWF.
    </SCRIPT></div>
                                  </TD>
                                </TR></TBODY></TABLE>
