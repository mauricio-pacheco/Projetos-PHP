                          ...
                          <TR>
                            <TD vAlign=top><!-- 
                              ...
                              cellPadding=1 width="100%" border=0>
                                <TBODY>
                                <TR>
                                <TD width="55%">&nbsp;&nbsp;<span class="TituloCapaG">&nbsp;Estacionamento </span></TD>
                                <TD width="30%">&nbsp;</TD>
                                <TD width="15%">&nbsp;</TD>
                                </TR>
                                <TR>
                              ...
                              cellPadding=1 width="100%" border=0>
                                ...
                                <TD vAlign=top>
                                  <p align="justify" class="style7">
                                    <iframe src="palace/est.php" name="centro" width="490" height="332" frameborder="0" marginheight="0" marginwidth="0" scrolling="no"></iframe>
                                  </p>
                                  </TD>
                                </TR></TBODY></TABLE>
