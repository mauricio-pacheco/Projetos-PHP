...
$sql = mysql_query("SELECT * FROM produtos WHERE cidade='palmera' ORDER BY id DESC");
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="34%"><div align="right"><a href="deletarmoto2.php?Id=<?php echo $n["Id"]; ?>&amp;fotomenor=<?php echo $n["fotomenor"]; ?>&amp;foto1=<?php echo $n["foto1"]; ?>&amp;foto2=<?php echo $n["foto2"]; ?>&amp;foto3=<?php echo $n["foto3"]; ?>&amp;foto4=<?php echo $n["foto4"]; ?>&amp;foto5=<?php echo $n["foto5"]; ?>&amp;foto6=<?php echo $n["foto6"]; ?>" onClick="return confirm('Tem certeza que deseja apagar a moto <?php echo $n["modelo"]; ?> ?')">APAGAR</a>&nbsp&nbsp</div></td>
      </tr>
    </table></td>
  </tr>
  <tr>
