...
if($arquivo0)
{
    ...
    if(is_uploaded_file($arquivo0['tmp_name']))
    {
        if(verifica_image0($arquivo0))
        {
            ...
            $nome_foto0  = ('imagemmenor_' . time() . '.' . verifica_extensao_image0($arquivo0));// nome Ãºnico para foto
...
if($arquivo1)
{
    ...
    if(is_uploaded_file($arquivo1['tmp_name']))
    {
        if(verifica_image1($arquivo1))
        {
            ...
            $nome_foto1  = ('imagem_' . time() . '.' . verifica_extensao_image1($arquivo1));// nome único para foto
...
if($arquivo2)
{
    ...
    if(is_uploaded_file($arquivo2['tmp_name']))
    {
        if(verifica_image2($arquivo2))
        {
            ...
            $nome_foto2  = ('imagem_' . time() . '.' . verifica_extensao_image2($arquivo2));// nome único para foto
...
if($arquivo3)
{
    ...
    if(is_uploaded_file($arquivo3['tmp_name']))
    {
        if(verifica_image3($arquivo3))
        {
            ...
            $nome_foto3  = ('imagem_' . time() . '.' . verifica_extensao_image3($arquivo3));// nome único para foto
...
if($arquivo4)
{
    ...
    if(is_uploaded_file($arquivo4['tmp_name']))
    {
        if(verifica_image4($arquivo4))
        {
            ...
            $nome_foto4  = ('imagem_' . time() . '.' . verifica_extensao_image4($arquivo4));// nome único para foto
...
if($arquivo5)
{
    ...
    if(is_uploaded_file($arquivo5['tmp_name']))
    {
        if(verifica_image5($arquivo5))
        {
            ...
            $nome_foto5  = ('imagem_' . time() . '.' . verifica_extensao_image5($arquivo5));// nome único para foto
...
if($arquivo6)
{
    ...
    if(is_uploaded_file($arquivo6['tmp_name']))
    {
        if(verifica_image6($arquivo6))
        {
            ...
            $nome_foto6  = ('imagem_' . time() . '.' . verifica_extensao_image6($arquivo6));// nome único para foto
...
$sql = "UPDATE produtos SET cidade = '$cidade', modelo = '$modelo', estado = '$estado', ano = '$ano', cor = '$cor', descricao = '$descricao', fotomenor = '$nome_foto0', foto1 = '$nome_foto1', foto2 = '$nome_foto2', foto3 = '$nome_foto3', foto4 = '$nome_foto4', foto5 = '$nome_foto5', foto6 = '$nome_foto6' WHERE Id = '$Id'";
if(mysql_query($sql)) {
echo "<div align=center><br><br><font color='#000000' size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">A sua moto foi editada com sucesso!!</font></div>";
}else{
echo "<div align=center><br><br><font color='#000000' size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\">Não foi possivel efetuar o cadastro da moto!</font></div>";
}
