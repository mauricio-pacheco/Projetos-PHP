...
<form name="form1" action="updatemoto.php" method="post" enctype="multipart/form-data"><table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
...
if ($contar < 1)  //Mostra se hÃƒÂ¡ algum registro na tabela, caso nÃƒÂ£o houver, ele mostrarÃƒÂ¡ a mensagem abaixo
   {echo "<div align=center><font color='#ffffff' size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\"><b>Não existe motos cadastradas!</b></font></div>"; 
   }
...
while($n = mysql_fetch_array($sql))
   {
   ?>
      <input name="Id" type="hidden" value="<?php echo $n["Id"]; ?>" /></td>
  </tr>
  <tr>
  ...
  <tr>
    <td><span class="style15">Modelo: 
        <input name="modelo" type="text" size="60" value="<?php echo $n["modelo"]; ?>" />
    </span></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    <td><span class="style15">Cor:
        <input name="cor" type="text" size="30" value="<?php echo $n["cor"]; ?>" />
    </span></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
