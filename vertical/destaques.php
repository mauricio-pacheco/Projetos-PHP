...
$sql_select = "SELECT * FROM cw_viajens WHERE sessao='Destaques' ORDER BY id ASC LIMIT $inicio, $qnt";
                    ...
                    <table width="100%" border="0">
                      <tr>
                        ...
                        <td width="98%" class="fontegrana"><table width="99%" border="0">
                         <tr>
                            <td class="fontetabela">A partir de <b><?php echo $valorvista.""; ?></b> ou em <b><?php echo $prazo.""; ?></b> X de <b><?php echo $valorprazo.""; ?></b></td>
                          </tr>
                        </table></td>
                        </tr>
                      </table>
