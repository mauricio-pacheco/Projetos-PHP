    ...
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="74%" valign="top">
          ...
          <tr>
            <td bgcolor="#f9f9f9"><img src="imagens/barra1.jpg" /></td>
          </tr></table>
...
$sql_select = "SELECT * FROM cw_viajens WHERE sessao='Pacotes Internacionais' ORDER BY rand() LIMIT $inicio, $qnt";
...
$sql_select_all = "SELECT * FROM cw_viajens WHERE sessao='Pacotes Internacionais'";
...
?></td>
          ...
          <tr>
            <td bgcolor="#f9f9f9" align="center"><a href="pacotes.php"><img src="imagens/barratodos1.png" border="0" /></a></td>
          </tr>
        </table>
          <table width="636" border="0" cellpadding="0" cellspacing="0" align="center">
            <tr>
              <td bgcolor="#f9f9f9"><img src="imagens/barra2.jpg" /></td>
            </tr>
          </table>
          <table width="636" height="2" align="center" cellspacing="0" cellpadding="0" border="0">
               <tr>
...
$sql_select = "SELECT * FROM cw_viajens WHERE sessao='Destaques' ORDER BY rand() LIMIT $inicio, $qnt";
...
// Faz uma nova sele&ccedil;&atilde;o no banco de dados, desta vez sem LIMIT, 
// para pegarmos o n&uacute;mero total de registros
$sql_select_all = "SELECT * FROM cw_viajens WHERE sessao='Destaques'";
// Executa o query da sele&ccedil;&atilde;o acimas
$sql_query_all = mysql_query($sql_select_all);
// Gera uma vari&aacute;vel com o n&uacute;mero total de registros no banco de dados
$total_registros = mysql_num_rows($sql_query_all);
...
?></td>
            ...
            <tr>
              <td bgcolor="#f9f9f9" align="center"><a href="destaques.php"><img src="imagens/barratodos2.png" border="0" /></a></td>
            </tr>
          </table>
          <table width="636" border="0" cellpadding="0" cellspacing="0" align="center">
            <tr>
...
$sql_select = "SELECT * FROM cw_viajens WHERE sessao='Agenda de Viajens' ORDER BY rand() LIMIT $inicio, $qnt";
...
?></td>
            ...
            <tr>
              <td bgcolor="#f9f9f9" align="center"><a href="agendas.php"><img src="imagens/barratodos3.png" border="0" /></a></td>
            </tr>
            <tr>
