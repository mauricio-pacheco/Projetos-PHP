...
<table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td valign="top"><table width="100%" border="0">
      <tr>
        <td class="fontetabela"><strong>QUER VENDER ?</strong></td>
      </tr>
    </table>
...
campo.value = campo.value + separador3;
                    ...
                    <form action="enviavenda.php" method="post" enctype="multipart/form-data" name="cadastro" id="cadastro" onSubmit="return validar(this)">
...
<select class="fontetabela2" 
                              ...
                              <tr>
                                <td class="manchete_texto" align="left"><strong><font color="#FFFF00">Veículo Para a Venda:</font></strong></td>
                              </tr>
                              <tr>
