...
$texto =  "<font face=tahoma size=2>$nome, acabou de enviar uma mensagem via Pedido QUER VENDER do site da Piaia Ve&iacute;culos:\n\n\n<br><br>"; 
...
$texto .= "E-mail: $email2\n\n<br><br>";  
$texto .= "<br>"; 
$texto .= "<b>Ve&iacute;culo Para a Venda:</b>\n\n<br><br>"; 
$texto .= "Tipo: $vtipo\n\n<br><br>"; 
$texto .= "Marca: $vmarca\n\n<br><br>"; 
...
$mensagem = $texto;
$assunto = utf8_decode("QUER VENDER - PIAIA VEÍCULOS");
