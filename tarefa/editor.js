...
function editor_action(button_id) {
  ...
  // help popup
  if (cmdID == 'showhelp') {
    window.open(_editor_url + "editor_help.html", 'EditorHelp');
    return;
  }
  ...
  // Custom2
    ...
    var myText = showModalDialog(_editor_url + "custom2.html",
  ...
  // fgColor and bgColor
    ...
    var newcolor = showModalDialog(_editor_url + "select_color.html", oldcolor, "resizable: no; help: no; status: no; scroll: no;");
