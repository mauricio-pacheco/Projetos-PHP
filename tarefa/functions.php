...
global $lang,$host,$user,$pass,$database,$table_prefix,$QUERY_STRING;
  ...
  <META HTTP-EQUIV="Cache-Control" CONTENT="no-cache">
  <META HTTP-EQUIV="PRAGMA" CONTENT="NO-CACHE">
  <META NAME="Description" CONTENT="Complexo Luz e Alegria">
  <META NAME="Author" CONTENT="http://www.luzealegria.com.br">
...
// - ------ LKG eid
			...
			<?
						...
						if ($e!="_new_" && CheckEntityAccess($e) == "ok") {
							...
							// PDF download icon
							print "<br><br><a href='javascript:popActivityGraph(" . $e .");' title='Mostrar Gráfico de Atividades'><img src='graph.gif' border=1></a>&nbsp;&nbsp;";
