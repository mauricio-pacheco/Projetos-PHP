   ...
   do while not rs.eof and contador < rs.pagesize
				  %>
                                        <tr class="Texto"> 
                                          ...
                                          <td width="16%" height="18"> <div align="right"><a href="radio_excluirSQL.asp?ID=<%=Rs("ID")%>" onClick="return confirm('Você deseja excluir esta Notícia?')"><img src="Imagens/excluir.gif" width="16" height="16" border="0"></a></div></td>
                                        </tr>
                                        <%
					contador = contador +1
   rs.movenext
