...
if rs.eof or rs.bof then
   ...
   do while not rs.eof and contador < rs.pagesize
				  %>
										  <tr class="Texto"> 
                                            <td width="84%" height="18"><div align="left"><%=Rs("Nome")%></div></td>
                                            
                                          <td width="16%" height="18"> <div align="right"><a href="radio_editar2.asp?ID=<%=Rs("ID")%>"><img src="Imagens/editar.gif" width="16" height="16" border="0"></a></div></td>
                                          </tr>
                                                        <%
					contador = contador +1
   rs.movenext
...
response.write "<a href='radio_editar.asp?pagina=1'><img src=""imagens/ico_i.gif""  border=""0""></a> "
response.write "<a href='radio_editar.asp?pagina="&pag - 1&"'><img src=""imagens/ico_menos.gif""  border=""0""></a> "
end if

if pag + 1 > rs.pagecount then
else
response.write "<a href='radio_editar.asp?pagina="&pag + 1&"'><img src=""imagens/ico_mais2.gif""  border=""0""></a> "
response.write "<a href='radio_editar.asp?pagina="&rs.pagecount&"'><img src=""imagens/ico_f.gif""  border=""0""></a> "
end if
%>
                                      <%
				end if
