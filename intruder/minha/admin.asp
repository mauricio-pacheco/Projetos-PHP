                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="5">
                        <tr>
                          <td><table width="100%" border="0" cellpadding="3" cellspacing="0">
                              ...
                              <tr> 
                                <td height="18" bgcolor="#FFFFFF" class="Texto" > 
                                  <div align="center" class="Menu"><a href="musica_nova.asp" class="Menu">Novo Audio</a></div></td>
                              </tr>
                              <tr> 
                        ...
                        <tr> 
                          <td><div align="center"> 
                              <table width="90%" height="18" border="0" cellpadding="0" cellspacing="0">
                                <tr> 
                                  <td height="20" bgcolor="#F5F5F5"> <div align="center"><span class="Texto"><strong>Admistra&ccedil;&atilde;o</strong></span></div></td>
                                </tr>
                                <tr> 
                                  <td height="7"></td>
                                </tr>
                                <tr> 
                                  <td><div align="center" class="Menu"><br>
                                      <a href="admin_novo.asp" class="Menu"><br>
                                      Novo Adminstrador</a> | <a href="admin_editar.asp" class="Menu">Editar 
                                      Adminstrador</a> | <a href="admin_excluir.asp" class="Menu">Excluir 
                                      Adminstrador<br>
                                      <br>
                                      <br>
                                      </a> </div></td>
                                ...
                                <tr> 
                                  <td height="20" bgcolor="#F5F5F5"> <div align="center"><span class="Texto"></span></div></td>
                                </tr>
                              </table>
                            </div></td>
                        </tr>
