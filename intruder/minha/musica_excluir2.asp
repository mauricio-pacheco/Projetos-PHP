...
alert("Audio excluido com Sucesso!")
</script>
<%
else
end if
...
sql = "SELECT * FROM radio_music WHERE IDRadio = "&Request.QueryString("ID_Radio")&" ORDER BY Autor ASC"
rs.open sql

if rs.eof or rs.bof then
   response.write "<font class='Menu'>Notícia sem audio!</font>"
else
   rs.absolutepage = pag
   contador = 0
   ...
   do while not rs.eof and contador < rs.pagesize
								  %>
                                        <tr class="Texto"> 
                                          <td width="84%" height="18"><div align="left"><%=Rs("Autor")%> - <%=Rs("Titulo")%></div></td>
                                          <td width="16%" height="18"> <div align="right"><a href="musica_excluirSQL.asp?ID=<%=Rs("ID")%>&ID_Radio=<%=Request.QueryString("ID_Radio")%>" onClick="return confirm('Você deseja excluir este Audio?')"><img src="Imagens/excluir.gif" width="16" height="16" border="0"></a></div></td>
                                        </tr>
                                        <%
					contador = contador +1
   rs.movenext
...
response.write "<a href='musica_excluir2.asp?pagina=1&ID_Radio="&Request.QueryString("ID_Radio")&"'><img src=""imagens/ico_i.gif""  border=""0""></a> "
response.write "<a href='musica_excluir2.asp?pagina="&pag - 1&"&ID_Radio="&Request.QueryString("ID_Radio")&"'><img src=""imagens/ico_menos.gif""  border=""0""></a> "
end if

if pag + 1 > rs.pagecount then
else
response.write "<a href='musica_excluir2.asp?pagina="&pag + 1&"&ID_Radio="&Request.QueryString("ID_Radio")&"'><img src=""imagens/ico_mais2.gif""  border=""0""></a> "
response.write "<a href='musica_excluir2.asp?pagina="&rs.pagecount&"&ID_Radio="&Request.QueryString("ID_Radio")&"'><img src=""imagens/ico_f.gif""  border=""0""></a> "
end if
%>
                                      <%
				end if
