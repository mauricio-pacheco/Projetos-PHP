...
<table width="400" cellpadding="6" cellspacing="0" align="center" style="border: 2px solid #0099cc;">
        <tr>
          <td rowspan="3" bordercolor="#0099CC" bgcolor="#0099CC">&nbsp;</td>
          <td bgcolor="#EAEDF4" width="100%" class="chatBorderText"> 
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td><div align="center"><img src="fmchat.gif" width="120" height="68"></div></td>
              </tr>
            </table>
            <p>&nbsp;</p><table width="100%">
              <tr> 
