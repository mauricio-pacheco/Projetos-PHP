...
function theindex($new_topic=0) {
	...
	if ($fullcount > 0 OR $c_count > 0 OR $articlecomm == 0 OR $acomm == 1) {
	    $morelink .= "$story_link<b><img src=\"http://www.luzealegria.com.br/leiamais.gif\" border=\"0\">&nbsp;"._READMORE."</b></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   ";
	} else {
	    $morelink .= "";
	}
	if ($fullcount > 0) { $morelink .= ""; }
	if ($articlecomm == 1 AND $acomm == 0) {
	    if ($c_count == 0) { $morelink .= "$story_link<img src=\"http://www.luzealegria.com.br/comente.gif\" border=\"0\">&nbsp;"._COMMENTSQ."</a>"; } elseif ($c_count == 1) { $morelink .= "$story_link$c_count "._COMMENT."</a>"; } elseif ($c_count > 1) { $morelink .= "$story_link$c_count "._COMMENTS."</a>"; }
	}
	$sid = intval($s_sid);
	if ($catid != 0) {
