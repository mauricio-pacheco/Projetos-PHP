...
<td class="row1" width="100%" onMouseOver=this.style.backgroundColor="#B7B8B2" onMouseOut=this.style.backgroundColor="#B7B8B2" onclick="window.location.href='{topicrow.U_VIEW_TOPIC}'"><span class="topictitle">{topicrow.NEWEST_POST_IMG}{topicrow.L_NEWS}{topicrow.TOPIC_TYPE}<a href="{topicrow.U_VIEW_TOPIC}" class="topictitle">{topicrow.TOPIC_TITLE}</a></span><span class="gensmall"><br />
