...
<table width="100%" cellspacing="2" cellpadding="2" border="0" align="center">
  ...
  <table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
	...
	<tr> 
	  ...
	  <td class="space" colspan="5" align="center"><span class="gensmall">{L_MOD_CP_EXPLAIN}</span></td>
	...
	<tr> 
	  ...
	  <th nowrap="nowrap" class="thLeft"> {L_TOPICS} </th>

	  <th width="8%" class="thLeft" nowrap="nowrap"> {L_REPLIES} </th>

	  <th width="17%" class="thLeft" nowrap="nowrap"> {L_LASTPOST} </th>
