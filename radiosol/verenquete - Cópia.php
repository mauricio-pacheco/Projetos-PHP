...
while($y = mysql_fetch_array($sql))
   {
   ?> <?php echo $y["pergunta"]; ?><strong></strong></td>
        </tr>
      </table>
      <table width="856" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
...
$totalop1 = mysql_result($sql, 0, 'Total');
					...
					?>
                                <b><i><font color="#083D21"><?php echo $totalop1; ?> votos</font></b></td>
...
$totalop2 = mysql_result($sql, 0, 'Total');
					...
					?>
                                <b><i><font color="#083D21"><?php echo $totalop2; ?> votos</font></i></b></td>
...
$totalop3 = mysql_result($sql, 0, 'Total');
					...
					?>
                                <b><i><font color="#083D21"><?php echo $totalop3; ?> votos</font></i></b></td>
...
$totalop4 = mysql_result($sql, 0, 'Total');
					...
					?>
                                <b><i><font color="#083D21"><?php echo $totalop4; ?> votos</font></i></b></td>
...
$totalop5 = mysql_result($sql, 0, 'Total');
					...
					?>
                                <b><i><font color="#083D21"><?php echo $totalop5; ?> votos</font></i></b></td>
...
$totalop6 = mysql_result($sql, 0, 'Total');
					...
					?>
                                <b><i><font color="#083D21"><?php echo $totalop6; ?> votos</font></i></b></td>
...
$totalop7 = mysql_result($sql, 0, 'Total');
					...
					?>
                                <b><i><font color="#083D21"><?php echo $totalop7; ?> votos</font></i></b></td>
...
$totalop8 = mysql_result($sql, 0, 'Total');
					...
					?>
                                <b><i><font color="#083D21"><?php echo $totalop8; ?> votos</font></i></b></td>
...
$totalop9 = mysql_result($sql, 0, 'Total');
					...
					?>
                                <b><i><font color="#083D21"><?php echo $totalop9; ?> votos</font></i></b></td>
...
$totalop10 = mysql_result($sql, 0, 'Total');
					...
					?>
                                <b><i><font color="#083D21"><?php echo $totalop10; ?> votos</font></i></b></td>
