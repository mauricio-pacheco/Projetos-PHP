...
<div id="menu" style="position:absolute; z-index:9999; VISIBILITY: s2; top: 20%; left: 30%;">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td valign="bottom">
    <a href="#" onClick="camada('menu');"> <img src="imagens/fechar-banner.png" border="0" /></a></td>
        <td valign="bottom">
</td>
  </tr>
</table>
  ...
  <tr>
    <td>
    <a href="imagens/docmaes.pdf" target="_blank"><img src="imagens/bannerdeferias.jpg" border="0" /></a>
    </td>
  </tr>
</table>
</div>
...
$sql = mysql_query("SELECT * FROM cw_noticias WHERE sessao='NOTÍCIAS' ORDER BY id DESC LIMIT 4");
...
$sql_select = "SELECT * FROM cw_noticias WHERE sessao='NOTÍCIAS' ORDER BY id DESC LIMIT 4 OFFSET 3";
...
// -->
                       ...
                       <span class="field"><textarea name="comentario" onclick="this.value=''"  onkeydown="textCounter(this.form.comentario,this.form.remLen,300);" onkeyup="textCounter(this.form.comentario,this.form.remLen,300);"  cols="46" rows="6" tabindex="4"></textarea></span>
                   </td>
                  </tr>
                </table>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td class="fonte">Faltam
                      <input name="remLen" type="text" class="manchete_texto" value="300" size="3" maxlength="3" readonly />
caracteres.</td>
                  </tr>
                </table>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
