...
echo "<br><br><p align='center'><font face='Verdana' size='1' color='$campo4[8]'>$campo2[1]</font></p><p align='center' style='word-spacing: 0; margin-top: 0; margin-bottom: 0'><img border='0' src='fotos/$campo2[3]' ></p><p align='center' style='word-spacing: 1; margin-top: 1; margin-bottom: 1'>";
if($campo4[15] == 'Ativo') {
...
"; } echo "</p>
<br><p align='left' style='word-spacing: 1; margin-top: 1; margin-bottom: 1'><font face='Verdana' size='1' color='$campo4[10]'>$comentario</font></p><br>";
...
<center><table border="0" cellpadding="0" width="270">
    ...
    <tr>
      ...
      <td width="137"><font face="Verdana" size="1" color="#<? echo $corcomentariopub; ?>"><input type="text" name="camposite" value="http://" size="10"></font></td>
    </tr>
    <tr>
