...
$sql = mysql_query("SELECT * FROM departamentos WHERE id='$depid' ORDER BY id DESC LIMIT 1");
$contar = mysql_num_rows($sql); 

while($n = mysql_fetch_array($sql))
   {
   ?>
          <b>ARQUIVOS - <?php echo $n["departamento"]; ?></b>
          <?php
 ...
 ?></td>
      ...
      <table width="96%" border="0" align="center">
        ...
        <tr>
          <td><div align="center"><em>SELECIONAR POR SUB-DEPARTAMENTOS</em></div></td>
        </tr>
        <tr>
          <td><span class="link3">
...
$sql = mysql_query("SELECT * FROM subdep WHERE depid='$depid' AND nomedep='$departamento' ORDER BY id DESC");
$contar = mysql_num_rows($sql); 

if ($contar < 1)  //Mostra se hÃƒÂ¡ algum registro na tabela, caso nÃƒÂ£o houver, ele mostrarÃƒÂ¡ a mensagem abaixo
   {echo "<div align=center><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\"><b>Não existe Sub-Departamentos cadastrados!</b></font></div>"; 
   }
          ...
          <table width="96%" border="0" align="center">
            <tr>
              <td><table width="100%" border="0">
                <tr>
                  <td width="2%"><a href="arqdeps.php?idsubdep=<?php echo $n["id"]; ?>&amp;depid=<?php echo $n["depid"]; ?>&amp;subdep=<?php echo $n["subdep"]; ?>"><img src="administrador/subdep.jpg" border="0" ></a></td>
                  <td width="98%"><a href="arqdeps.php?idsubdep=<?php echo $n["id"]; ?>&amp;depid=<?php echo $n["depid"]; ?>&amp;subdep=<?php echo $n["subdep"]; ?>"><?php echo $n["subdep"]; ?></a>
                    <!--/TITULO--></td>
                </tr>
              </table></td>
            </tr>
...
$sql_select = "SELECT * FROM licitacoes WHERE iddep = '$depid' AND idsubdep = 's' AND idano = 's' AND idtri = 's' ORDER BY id DESC LIMIT $inicio, $qnt";
// Executa o Query
...
$sql_select_all = "SELECT * FROM licitacoes WHERE iddep = '$depid' AND idsubdep = 's' AND idano = 's' AND idtri = 's' ";
...
echo "<a href='arqdeps.php?p=1&amp;id=$depid&departamento=$departamento' target='_self'><font size='1'>PRIMEIRA PÁGINA</font></a> <font color='#000000' size='1'>-</font> ";
...
echo "<a href='arqdeps.php?p=".$i."&amp;id=$depid&departamento=$departamento' target='_self'>".$i."</a> ";
}
}
...
echo " <font color='#000000' size='1'>-</font> <a href='arqdeps.php?p=".$pags."&amp;id=$depid&departamento=$departamento' target='_self'><font size='1'>ÚLTIMA PÁGINA</font></a> ";
?></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
