...
<table width="980" border="0" align="center">
  <tr>
    ...
    <td width="574" bgcolor="#FFFFFF" valign="top"><table width="98%" border="0" align="center">
      <tr>
        <td align="center"><br><b>ARQUIVO DE NOTÍCIAS DA PREFEITURA MUNICIPAL DE PALMITINHO</b></td>
      </tr>
    </table>
...
echo "<a href='home.php?p=1' target='_self'><font size='1'>Primeira p&aacute;gina</font></a> <font color='#000000' size='1'>-</font> ";
...
echo "<a href='home.php?p=".$i."' target='_self'>".$i."</a> ";
}
}
...
echo " <font color='#000000' size='1'>-</font> <a href='home.php?p=".$pags."' target='_self'><font size='1'>&Uacute;ltima p&aacute;gina</font></a> ";
?></td>
        </tr>
    </table>
