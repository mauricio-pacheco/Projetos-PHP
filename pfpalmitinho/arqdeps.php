...
$sql = mysql_query("SELECT * FROM anodep WHERE depid='$depid' AND idsubdep='$idsubdep' ORDER BY id DESC LIMIT 1");
$contar = mysql_num_rows($sql); 

while($n = mysql_fetch_array($sql))
   {
   ?><b>ARQUIVOS - <?php echo $n["nomedep"]; ?> - <?php echo $n["nomesubdep"]; ?></b><?php
 ...
 ?></td>
      ...
      <table width="96%" border="0" align="center">
        ...
        <tr>
          <td><div align="center"><em>SELECIONAR POR ANO</em></div></td>
        </tr>
        <tr>
          <td><span class="link3">
        <?php
...
$sql = mysql_query("SELECT * FROM anodep WHERE depid='$depid' AND idsubdep='$idsubdep' ORDER BY id DESC");
$contar = mysql_num_rows($sql); 

if ($contar < 1)  //Mostra se hÃƒÂ¡ algum registro na tabela, caso nÃƒÂ£o houver, ele mostrarÃƒÂ¡ a mensagem abaixo
   {echo "<div align=center><font size=\"2\" face=\"Verdana, Arial, Helvetica, sans-serif\"><b>Não existe anos cadastrados!</b></font></div>"; 
   }
          ...
          <table width="96%" border="0" align="center">
            <tr>
              <td><table width="100%" border="0">
                <tr>
                  <td width="2%"><a href="arqtrideps.php?id=<?php echo $n["id"]; ?>&amp;anodep=<?php echo $n["anodep"]; ?>&amp;depid=<?php echo $n["depid"]; ?>&amp;nomedep=<?php echo $n["nomedep"]; ?>&amp;nomesubdep=<?php echo $n["nomesubdep"]; ?>&amp;idsubdep=<?php echo $n["idsubdep"]; ?>"><img src="administrador/ano.jpg" border="0" ></a></td>
                  <td width="98%"><a href="arqtrideps.php?id=<?php echo $n["id"]; ?>&amp;anodep=<?php echo $n["anodep"]; ?>&amp;depid=<?php echo $n["depid"]; ?>&amp;nomedep=<?php echo $n["nomedep"]; ?>&amp;nomesubdep=<?php echo $n["nomesubdep"]; ?>&amp;idsubdep=<?php echo $n["idsubdep"]; ?>"><?php echo $n["anodep"]; ?></a>
                    <!--/TITULO--></td>
                </tr>
              </table></td>
            </tr>
...
while($n = mysql_fetch_array($sql))
   {
   ?>
            <b><?php echo $n["nomedep"]; ?> - <?php echo $n["nomesubdep"]; ?></b>
            <?php
...
$sql_select = "SELECT * FROM licitacoes WHERE iddep = '$depid' AND idsubdep = '$idsubdep' AND idano = 's' AND idtri = 's' ORDER BY id DESC LIMIT $inicio, $qnt";
// Executa o Query
...
$sql_select_all = "SELECT * FROM licitacoes WHERE iddep = '$depid' AND idsubdep = '$idsubdep' AND idano = 's' AND idtri = 's' ";
...
echo "<a href='arqdeps.php?p=1&amp;idsubdep=$idsubdep&depid=$depid&subdep=$subdep' target='_self'><font size='1'>PRIMEIRA PÁGINA</font></a> <font color='#000000' size='1'>-</font> ";
...
echo "<a href='arqdeps.php?p=".$i."&amp;idsubdep=$idsubdep&depid=$depid&subdep=$subdep' target='_self'>".$i."</a> ";
}
}
...
echo " <font color='#000000' size='1'>-</font> <a href='arqdeps.php?p=".$pags."&amp;idsubdep=$idsubdep&depid=$depid&subdep=$subdep' target='_self'><font size='1'>ÚLTIMA PÁGINA</font></a> ";
?></td>
        </tr>
    </table>
