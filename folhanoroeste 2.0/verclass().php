...
style="COLOR: #ffffff"><?php

include "administrador/conexao.php";

$id = $_GET['id'];

$sql = mysql_query("SELECT * FROM cw_depclass WHERE id='$id' ORDER BY id");

while($y = mysql_fetch_array($sql))
   {
   ?>
      <?php echo $y["departamento"]; ?><?php } ?></SPAN></span></DIV>
    <DIV class=content>
     <?php
include "administrador/conexao.php";
...
$sql_select = "SELECT * FROM cw_class WHERE iddep='$id' AND status='1' ORDER BY id DESC LIMIT $inicio, $qnt";
...
?>
     <table width="100%" border="0">
       <tr>
         <td align="center"><a 
                        href="vercc.php?id=<?php echo $id.""; ?>">
                        <?php if ($foto=='') { ?><img src="imagens/logomenor.png" border="0" ><?php } else { ?>
                        <img 
                        alt="<?php echo $titulo.""; ?>" 
                        src="administrador/ups/capasclass/<?php echo $foto.""; ?>" 
                        border=0 width="145" height="97">
                        <?php } ?>
       ...
       <tr>
         <td align="center"><a class=link_galeria_todas 
                        href="vercc.php?id=<?php echo $id.""; ?>"><b><?php echo $titulo.""; ?></b></a></td>
       </tr>
       <tr>
         <td>&nbsp;</td>
       </tr>
...
$sql_select_all = "SELECT * FROM cw_class WHERE iddep='$id' AND status='1' ORDER BY id DESC";
...
echo "<a href='verclass.php?p=1&amp;id=$id' target='_self' class=manchete_texto><b>PRIMEIRA PÁGINA</b></a>&nbsp;&nbsp; ";
...
echo "| <a href='vergalerias.php?p=".$i."&amp;id=$id' target='_self' class=manchete_texto>".$i."</a> ";
}
}
...
echo "&nbsp;&nbsp;<a href='vergalerias.php?p=".$pags."&amp;id=$id' target='_self' class=manchete_texto><b>ÚLTIMA PÁGINA</b></a> ";
