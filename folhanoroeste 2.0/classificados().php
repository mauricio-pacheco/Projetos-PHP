...
?>
     <table width="100%" border="0">
       <tr>
         <td align="center"><a 
                        href="verclass.php?id=<?php echo $id.""; ?>"><img 
                        alt="<?php echo $descricao.""; ?>" 
                        src="imagens/class.png" 
                        border=0 ></a></td>
       </tr>
       <tr>
         <td align="center"><a class=link_galeria_todas 
                        href="verclass.php?id=<?php echo $id.""; ?>"><b><?php echo $departamento.""; ?></b></a> ( <?php

$sql = mysql_query("SELECT COUNT(*) AS Total FROM cw_class WHERE iddep='$id'");
...
$sql_select_all = "SELECT * FROM cw_depclass ORDER BY id DESC";
