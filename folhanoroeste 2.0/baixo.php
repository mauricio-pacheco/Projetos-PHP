...
echo strftime("%Y");      
?>
       - Todos os direitos reservados - Jornal Folha do Noroeste - <b>
       <?php
...
class visita
{
    ...
    var $userdb = "noroeste_adelar";
    var $passdb = "noroad2011";
    var $namedb = "noroeste_folha";
...
?>
      ...
      <td width="18%" align="right">Desenvolvimento: <a href="http://www.casadaweb.net" target="_blank"><b>Casa da Web</b></a></td>
    </tr>
  </table>