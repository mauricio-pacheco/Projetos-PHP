...
$sql = "UPDATE cw_class SET status = '1' WHERE id = '$id'";
if(mysql_query($sql)) {
echo "<div align=center class=manchete_texto><br>O CLASSIFICADO FOI LIBERADO COM SUCESSO!!</div>";

echo "<script>alert('CLASSIFICADO LIBERADO COM SUCESSO!')</script>";
