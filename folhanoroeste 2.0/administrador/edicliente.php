   ...
   ?>
                        <table width="100%" border="0" align="center" class="fonteadm">
                          ...
                          <tr>
                            ...
                            <td><input name="senha" type="password" class="fonteadm" size="30"/>
                              *</td>
                          </tr>
                          <tr>
                            <td>&nbsp;</td>
                          ...
                          <tr>
                            ...
                            <td><input type="checkbox" name="impresso" value="JORNAL IMPRESSO" <?php if ($n["impresso"]=='JORNAL IMPRESSO') { echo 'checked=checked'; } else { }?> />
                              <strong>JORNAL IMPRESSO</strong>
                              <input name="online" type="checkbox" value="JORNAL ONLINE" <?php if ($n["online"]=='JORNAL ONLINE') { echo 'checked=checked'; } else { }?> />
