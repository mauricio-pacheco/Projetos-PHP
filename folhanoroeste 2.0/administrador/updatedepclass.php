...
$sql = "UPDATE cw_depclass SET departamento = '$departamento', descricao = '$descricao' WHERE id = '$id'";
if(mysql_query($sql)) {
echo "<div align=center><br><img src=imagens/ok.png></div><br><div align=center class=manchete_texto>A SESSÃO FOI EDITADA COM SUCESSO!!</div>";
}else{
