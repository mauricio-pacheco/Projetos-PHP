...
$sql = "UPDATE cw_conteudo SET titulo = '$titulo', idmenu = '$idmenu', data = '$data', hora = '$hora', texto = '$texto' WHERE id = '$id'";
if(mysql_query($sql)) {
echo "<div align=center><br><img src=imagens/ok.png></div><div align=center class=manchete_texto><br>A PÁGINA FOI EDITADA COM SUCESSO!!</div><br>";
}else{
echo "<div align=center class=manchete_texto><br>N&Atilde;O FOI POSS&Iacute;VEL EDITAR A PÁGINA!</div><br>";
}
