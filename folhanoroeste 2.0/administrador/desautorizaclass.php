          ...
          <table width="100%" border="0" align="center">
            <tr>
              <td width="11%" height="30" bgcolor="#076CA0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="98%">&nbsp;&nbsp;<font color="#FFFFFF" class="fontetabela2"><b>AUTORIZAR CLASSIFICADO</b></font></td>
                </tr>
              </table></td>
            </tr>
          </table>
...
$sql = "UPDATE cw_class SET status = '0' WHERE id = '$id'";
if(mysql_query($sql)) {
echo "<div align=center class=manchete_texto><br>O CLASSIFICADO FOI BLOQUEADO COM SUCESSO!!</div>";

echo "<script>alert('CLASSIFICADO BLOQUEADO COM SUCESSO!')</script>";
echo "<script>location.href='admclassificados.php?iddep=$iddep'</script>";
}else{
echo "<div align=center><br>N&Atilde;O FOI POSS&Iacute;VEL LIBERAR O COMENTÁRIO!</div>";
}
