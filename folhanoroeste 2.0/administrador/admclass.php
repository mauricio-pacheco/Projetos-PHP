      ...
      <tr>
        ...
        <td width="76%" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <table width="100%" border="0" align="center">
            <tr>
              <td width="11%" height="30" bgcolor="#076CA0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="98%">&nbsp;&nbsp;<font color="#FFFFFF" class="fontetabela2"><b>ADMINISTRAR CLASSIFICADOS - SELECIONE O DEPARTAMENTO</b></font></td>
                </tr>
              </table></td>
            </tr>
          </table>
          ...
          <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td>
                <form action="buscaclass.php" method="post" name="formbusca" id="formbusca">
                  <span class="manchete_texto"><strong>Pesquisar Classificados:
...
$sql_select = "SELECT * FROM cw_depclass ORDER BY departamento ASC LIMIT $inicio, $qnt";
// Executa o Query
...
?>
                  <table width="100%" border="0" align="center">
                    <tr>
                      <td width="2%"><img src="imagens/notdep.png" /></td>
                      <td align="left" width="98%" valign="top"><font color="#000000"><?php echo $departamento.""; ?><br />
                        <a href="admclassificados.php?iddep=<?php echo $id.""; ?>" class="manchete_texto4"><b>SELECIONAR DEPARTAMENTO</b></a></td>
                    </tr>
                  </table>
                  <div align="center">
                    <?php
...
$sql_select_all = "SELECT * FROM cw_depclass";
...
echo "<a href='admclass.php?p=1' target='_self' class=manchete_texto><b>PRIMEIRA P&Aacute;GINA</b></a>&nbsp;&nbsp;";
...
echo "| <a href='admclass.php?p=".$i."' target='_self' class=manchete_texto>".$i."</a> ";
}
}
...
echo "&nbsp;&nbsp;<a href='admclass.php?p=".$pags."' target='_self' class=manchete_texto><b>&Uacute;LTIMA P&Aacute;GINA</b></a> ";
?>
                    </div></td>
              </tr>
            </table></td>
