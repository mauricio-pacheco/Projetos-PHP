...
$sql = "INSERT INTO cw_class (nome, email, telefone, titulo, iddep, foto, foto2, foto3, texto, data, hora, status) VALUES ('$nome', '$email', '$telefone', '$titulo', '$iddep', '$nome_foto14', '$nome_foto15', '$nome_foto16', '$texto', '$data', '$hora', '1')";
if(mysql_query($sql)) {
echo "<div align=center><br><img src=imagens/ok.png></div><div align=center class=manchete_texto><br>O CADASTRO DO CLASSIFICADO FOI EFETUADO COM SUCESSO!!</div><br>";
}else{
