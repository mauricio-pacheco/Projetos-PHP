          ...
          <table width="100%" border="0" align="center">
            <tr>
              <td width="11%" height="30" bgcolor="#076CA0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="98%">&nbsp;&nbsp;<font color="#FFFFFF" class="fontetabela2"><b>EDITAR NOTÍCIA</b></font></td>
                </tr>
              </table></td>
            </tr>
          </table>
...
return false
                                ...
                                <form action="edinot.php" method="post" name="form1" enctype="multipart/form-data" id="form1" onSubmit="return validar(this)"><table width="98%" border="0" align="center">
             <tr>
...
while($y = mysql_fetch_array($sql))
 ...
 ?>
             ...
             <tr>
               <td class="manchete_texto" align="left">&nbsp;<?php if ($n["foto"]=='') { } else { ?><img src="ups/capasnoticia/<?php echo $n["foto"]; ?>" /><?php } ?></td>
             </tr>
             <tr>
             ...
             <tr>
               <td class="rodape"><span class="fontetabela">
                 <textarea name="legenda" cols="45" rows="5"><?php echo $n["titulo"]; ?></textarea>
               </span></td>
             </tr>
             <tr>
