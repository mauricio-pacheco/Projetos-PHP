...
$sql_select = "SELECT * FROM cw_class WHERE iddep = '$iddep' ORDER BY id DESC LIMIT $inicio, $qnt";
// Executa o Query
                  ...
                  <table width="100%" border="0" align="center">
                    <tr>
                      <td align="left" width="98%"><table width="100%" border="0">
                        ...
                        <tr>
                          <td>&nbsp;<a href="ediclass.php?id=<?php echo $id.""; ?>" class="manchete_texto4"><strong>EDITAR CLASSIFICADO</strong></a> - <a href="delclass.php?id=<?php echo $id.""; ?>&amp;foto=<?php echo $foto.""; ?>&amp;foto2=<?php echo $foto2.""; ?>&amp;foto3=<?php echo $foto3.""; ?>" class="manchete_texto6" onClick="return confirm('Tem certeza que deseja apagar o classificado <?php echo $titulo.""; ?> ?')"><b>APAGAR CLASSIFICADO </b></a> - <?php if ($status=='0') { ?><a href="autorizaclass.php?id=<?php echo $id.""; ?>&amp;iddep=<?php echo $iddep.""; ?>" class="manchete_texto4"><strong><font color="#003300"><b>AUTORIZAR CLASSIFICADO</b></font></a><?php } else { ?> <a href="desautorizaclass.php?id=<?php echo $id.""; ?>&amp;iddep=<?php echo $iddep.""; ?>" class="manchete_texto4"><strong><font color="#FF0000"><b>DESAUTORIZAR CLASSIFICADO</b></font></a> <?php } ?><br /></td>
                        </tr>
                      </table>
...
$sql_select_all = "SELECT * FROM cw_class WHERE iddep = '$iddep'";
...
echo "<a class=manchete_texto href='admclassificados.php?p=1&amp;iddep=$iddep' target='_self'><b>PRIMEIRA P&Aacute;GINA</b></a>&nbsp;&nbsp;";
...
echo "| <a class=manchete_texto href='admclassificados.php?p=".$i."&amp;iddep=$iddep' target='_self'>".$i."</a> ";
}
}
...
echo "&nbsp;&nbsp;<a class=manchete_texto href='admclassificados.php?p=".$pags."&amp;iddep=$iddep' target='_self'><b>&Uacute;LTIMA P&Aacute;GINA</b></a> ";
?>
                  </div></td>
              </tr>
            </table></td>
