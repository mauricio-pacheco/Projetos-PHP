          ...
          <table width="100%" border="0" align="center">
            <tr>
              <td width="11%" height="30" bgcolor="#076CA0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="98%">&nbsp;&nbsp;<font color="#FFFFFF" class="fontetabela2"><b>CANCELAR ASSINATURA</b></font></td>
                </tr>
              </table></td>
            </tr>
          </table>
...
$sql = "UPDATE cw_clientes SET assinatura = '' WHERE id = '$id'";
if(mysql_query($sql)) {
echo "<div align=center><br><img src=imagens/ok.png></div><br><div align=center class=manchete_texto>A ASSINATURA FOI CANCELADA COM SUCESSO!!</div>";
echo "<script>alert('A ASSINATURA FOI CANCELADA COM SUCESSO!!')</script>";
