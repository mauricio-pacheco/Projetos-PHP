...
$sql = mysql_query("SELECT * FROM cw_enquetes where id='$id'");
...
unlink("ups/fotosenquetes/$arquivoapaga1");
}
...
unlink("ups/fotosenquetes/$arquivoapaga2");
}
...
unlink("ups/fotosenquetes/$arquivoapaga3");
}
...
unlink("ups/fotosenquetes/$arquivoapaga4");
}
...
unlink("ups/fotosenquetes/$arquivoapaga5");
}
...
unlink("ups/fotosenquetes/$arquivoapaga6");
}
...
unlink("ups/fotosenquetes/$arquivoapaga7");
}
...
unlink("ups/fotosenquetes/$arquivoapaga8");
}
...
unlink("ups/fotosenquetes/$arquivoapaga9");
}
...
unlink("ups/fotosenquetes/$arquivoapaga10");
}
...
$sql = "UPDATE cw_enquetes SET pergunta = '$pergunta', op1 = '$op1', op2 = '$op2', op3 = '$op3', op4 = '$op4', op5 = '$op5', op6 = '$op6', op7 = '$op7', op8 = '$op8', op9 = '$op9', op10 = '$op10', foto1 = '$nome_foto1', foto2 = '$nome_foto2', foto3 = '$nome_foto3', foto4 = '$nome_foto4', foto5 = '$nome_foto5', foto6 = '$nome_foto6', foto7 = '$nome_foto7', foto8 = '$nome_foto8', foto9 = '$nome_foto9', foto10 = '$nome_foto10', data = '$data', hora = '$hora' WHERE id = '$id'";
if(mysql_query($sql)) {
echo "<div align=center><br><img src=imagens/ok.png></div><br><div align=center class=fontetabela>A ENQUETE FOI EDITADA COM SUCESSO!!</div>";
}else{
