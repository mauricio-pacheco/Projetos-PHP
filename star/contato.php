      ...
      <table width="100%" height="500" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td align="center"><img src="imagens/contatos.png" width="300" height="40" /></td>
            </tr>
          </table>
...
campo.value = campo.value + separador3;
                                    ...
                                    <table width="100%" border="0" align="center">
                                      <tr>
                                        <td><table width="100%" border="0">
                                          <tr>
                                            ...
                                            <td width="23%" class="fonteadm">&nbsp;Telefone: 55 3744-5056<br />&nbsp;Celular: 55 9964-8730 / 9695-5315</td>
                                            <td width="4%" class="fonteadm"><img src="imagens/email.png" /></td>
                                            <td width="69%" class="fonteadm">E-mail: <a href="mailto:starequipedegarcons@yahoo.com.br" class="fontetitulo">starequipedegarcons@yahoo.com.br</a></td>
                                          </tr>
                                          <tr>
                                            <td><img src="imagens/branco.gif" width="1" height="4" /></td>
                                            <td>&nbsp;</td>
                                      ...
                                      <tr>
                                        <td width="50%"><table width="100%" border="0">
                                          <tr>
                                            <td class="fonteadm">Preencha o formul&aacute;rio abaixo para entrar em contato conosco:</td>
                              ...
                              name="estado">
                                ...
                                value='TO - Tocantins'>TO - Tocantins</option>
                                            ...
                                            <tr>
                                              <td><input name="telefone" class="fontetabela" onKeyPress="Mascara('telefone', window.event.keyCode, 'document.cadastro.telefone');" size="14" maxlength="14"  />
                                                * </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                              <td class="fonteadm">Mensagem / Sugest&otilde;es:</td>
                                            </tr>
                                            <tr>
