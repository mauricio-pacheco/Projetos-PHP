        ...
        <tr>
          <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
           ...
           <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="center"><img src="imagens/agenda.png" /></td>
              </tr>
            </table>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
              ...
              <td><table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="604"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="18%"><img src="imagens/calendario.png" /></td>
                      <td width="82%"><img src="imagens/eventosr.png" /></td>
                    </tr>
                  </table></td>
                </tr>
                <tr>
		...
		startCalendar(0,0);
                          ...
                          <td width="74%" class="fonterodape" valign="top" style="background-image:url(imagens/fundoagenda.png); background-repeat:repeat-x"><br style="clear: both;" />
                            ...
                            <div style="display: none; margin-top: 10px;" id="addEventForm"> <b>Adicionar Evento</b> <br />
                              ...
                              <br />
                              <textarea name="evtBody" cols="46" rows="5" class="manchete_texto9" id="evtBody">00:00 ás 00:00 - </textarea>
                              <br />
                              <input type="button" value="Adicionar Evento" onClick="addEvent($F('evtDay'), $F('evtMonth'), $F('evtYear'), $F('evtBody'));" class="manchete_texto9" />
                              <a href="#" onClick="Element.hide('addEventForm');" class="manchete_texto9999">FECHAR FORMULÁRIO</a> - <a href="sair.php" class="manchete_texto9999">SAIR DO SISTEMA</a></div>
                            <div style="display: none; margin-top: 10px;" id="loginBox"> <br />
                              ...
                              <form action="agenda.php" method="post">
                                ...
                                <a href="#" onClick="Element.hide('loginBox');" class="manchete_texto9999">FECHAR FORMULÁRIO</a>
                              </form>
                            </div>
