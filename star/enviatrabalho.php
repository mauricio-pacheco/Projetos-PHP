...
$texto .=  "$nome, acabou de enviar uma mensagem pelo Trabalhe Conosco do site Star Equipe de Gar&ccedil;ons:\n\n\n<br><br>"; 
$texto .= "Nome: $nome\n\n<br><br>"; 
$texto .= "Idade: $idade\n\n<br><br>"; 
$texto .= "Cidade: $cidade\n\n<br><br>";  
$texto .= "Estado: $estado\n\n<br><br>";  
...
$mensagem = $texto;
$assunto = utf8_decode("TRABALHE CONOSCO DO SITE STAR EQUIPE DE GARÇONS");
