      ...
      <table width="100%" height="500" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td align="center"><img src="imagens/torcamento.png" width="300" height="40" /></td>
            </tr>
          </table>
            ...
            <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td><table width="980" border="0" align="center" cellpadding="0" cellspacing="0" class="fonterodape">
                  <tr>
                    <td></td>
                  </tr>
                </table></td>
...
campo.value = campo.value + separador3;
                                  ...
                                  <form action="enviaorc.php" method="post" enctype="multipart/form-data" name="cadastro" id="cadastro" onSubmit="return validar(this)">
                                    <table width="100%" border="0" align="center">
                                      <tr>
                                        <td width="50%"><table width="100%" border="0">
                                          <tr>
                                            <td class="fonteadm">Preencha o formul&aacute;rio abaixo para o orçamento:</td>
                                            <td class="fonteadm"><div align="right">* Campos Obrigat&oacute;rios</div></td>
                                            </tr>
                                          </table></td>
                                      </tr>
                                      <tr>
                                        <td><table width="100%" align="left" border="0">
                                          <tbody>
                                            <tr>
                                              <td width="68%" class="fonteadm">Nome Completo:</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                              <td class="fonteadm">Data do Evento</td>
                                            </tr>
                                            <tr>
                                              <td class="fonteadm"><input class="fontetabela" size="20" name="dataevento" /></td>
                                            </tr>
                                            <tr>
                                              <td class="fonteadm">Quantidade de Convidados:</td>
                                            </tr>
                                            <tr>
                                              <td class="fonteadm"><input class="fontetabela" size="4" name="convidados" /></td>
                                            </tr>
                                            <tr>
                                              <td class="fonteadm">Telefone:</td>
                                            </tr>
                                            <tr>
                                              <td class="fonteadm"><input name="telefone" class="fontetabela" onKeyPress="Mascara('telefone', window.event.keyCode, 'document.cadastro.telefone');" size="14" maxlength="14"  />
* </td>
                                            </tr>
                                            <tr>
                                              <td class="fonteadm">Tipo de Evento:</td>
                                            </tr>
                                            <tr>
                                              <td class="fonteadm"><select class="fontetabela" 
                              name="tipo">
                                              ...
                                              Outro: 
                                              <input name="tipo" class="fontetabela" size="20" maxlength="14"  /></td>
                                            </tr>
                                            <tr>
                                              <td class="fonteadm">Cidade:</td>
                                            </tr>
                                            <tr>
                              ...
                              name="estado">
                                ...
                                value='TO - Tocantins'>TO - Tocantins</option>
                                            ...
                                            <tr>
                                              <td class="fonteadm">Observações:</td>
                                            </tr>
                                            <tr>
