...
<tr>
<td class="nav"><a href="{U_INDEX}">{L_INDEX}</a> &raquo; <a href="{U_VIEW_FORUM}">{FORUM_NAME}</a> &raquo; {L_SPLIT_TOPIC}</td>
</tr>
</table>
...
<img src="themes/PH2RED/forums/images/spacer.gif" alt="" width="150" height="1" /></td>
<td width="100%" valign="top" class="{postrow.ROW_CLASS}">
<table width="100%" cellspacing="0" cellpadding="3" border="0">
<tr>
<td class="postdetails"><img src="themes/PH2RED/forums/images/icon_minipost.gif" alt="{L_POST}" title="{L_POST}" width="12" height="9" />{L_POSTED}: 
...
<tr>
<td colspan="3" height="1" class="spacerow"><img src="themes/PH2RED/forums/images/spacer.gif" width="1" height="1" alt="" /></td>
</tr>
<!-- END postrow -->
<tr>
