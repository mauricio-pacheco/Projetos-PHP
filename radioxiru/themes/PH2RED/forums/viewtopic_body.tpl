...
<img src="themes/PH2RED/forums/images/spacer.gif" alt="" width="150" height="1" />
</td>
...
<td align="right" valign="top" nowrap="nowrap">{postrow.IGNORE} {postrow.QUOTE_IMG} {postrow.EDIT_IMG} <a href="#top"><img src="themes/PH2RED/forums/images/icon_up.gif" alt="{L_BACK_TO_TOP}" title="{L_BACK_TO_TOP}"/></a> {postrow.DELETE_IMG} {postrow.IP_IMG}</td>
</tr>
</table>
...
<tr>
<td class="spacerow" colspan="2" height="1"><img src="themes/PH2RED/forums/images/spacer.gif" alt="" width="1" height="1" /></td>
</tr>
<!-- END postrow -->
<tr>
