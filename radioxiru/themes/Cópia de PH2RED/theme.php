...
/* Check if this impression is the last one and print the banner */
   ...
   if (($imptotal <= $impmade) AND ($imptotal != 0)) {
	...
	echo "<td width=\"100%\" align=\"center\"><embed src=\"bannercima.swf\" width=\"1002\" height=\"150\"></embed></td></tr></table>";
	echo "<table width=\"100%\" height=\"48\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\"><tr>";
	echo "<td style=\"padding-top:7px;\" align=\"right\" width=\"100%\" background=\"themes/PH2RED/images/spacer_bottom.jpg\">&nbsp;</td>";
	echo "</tr></table>";
	echo "<table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\"><tr>";
...
function themefooter() {
	...
	echo "</td></table>";
	echo "<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\" height=\"36\" background=\"themes/PH2RED/images/bottomline.jpg\">";
	echo "<tr><td width=\"103\"><a target=\"_blank\" href=\"http://phpnuke.org\" target=\"_blank\">";
	echo "<td class=\"cr\" align=\"center\" width=\"100%\"><font class=\"dcode\">Engine by PHP-Nuke - </font><a href=\"http://phpnuke.org/files/gpl.txt\" target=_blank><font class=\"dcode2\">GLP License</font></a><font class=\"dcode\"> - Designed by </a><a href=\"http://www.casadaweb.net\" target=_blank><font class=\"dcode2\">Casa da Web</font></a></b></td>";
	echo "<td width=\"103\"><a target=\"_blank\" href=\"http://pitcher.no\">";
...
function themeindex ($aid, $informant, $time, $title, $counter, $topic, $thetext, $notes, $morelink, $topicname, $topicimage, $topictext) {
	...
	echo "<tr><td class=\"newsbar\" width=\"100%\">$title</td></tr>";
...
function themearticle ($aid, $informant, $datetime, $title, $thetext, $topic, $topicname, $topicimage, $topictext) {
	...
	echo "<tr><td><table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"1\">";
	echo "<td bgcolor=\"#555D6A\"><table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"4\">";
	echo "<tr><td class=\"newsbar\">$title</td></tr>";
	echo "<tr><td bgcolor=\"#FFFFFD\"><a href=\"modules.php?name=News&new_topic=$topic\"><img src=\"$t_image\" alt=\"$topictext\" border=\"0\" align=\"right\" hspace=\"10\" vspace=\"10\"></a>";
		FormatStory($thetext, $notes, $aid, $informant);
	echo "</td></tr>";
	echo "<tr><td class=\"articles\" align=\"left\">"._POSTEDBY." ";
