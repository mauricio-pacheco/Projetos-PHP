...
function adminmenu2($url, $title, $image) {
    global $counter, $admingraphic, $Default_Theme;
    $ThemeSel = get_theme();
    if (file_exists("themes/$ThemeSel/images/admin/$image")) {
		$image = "themes/$ThemeSel/images/admin/$image";
    ...
    echo "<td align=\"center\" valign=\"top\" width=\"16%\"><font class=\"content\"><a href=\"$url\" target=\"_blank\">$img<b>$title</b>$close<br><br></font></td>";
    if ($counter == 5) {
		echo "</tr><tr>";
		$counter = 0;
    } else {
