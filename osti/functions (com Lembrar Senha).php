...
//							qlog("END");
	...
	//				print "Info on Cust#$ea[$GLOBALS[TBL_PREFIX]customer]";	
					...
					print "<div style='display:block' id='open$cust[id]'><a style='cursor:pointer' class='bigsort' OnClick=\"javascript:showLayer('rest$cust[id]');hideLayer('open$cust[id]');showLayer('close$cust[id]');\" title='Expand'>&nbsp;&nbsp;<img src='arrow.gif'> mais</a></div>";
					...
					if ((strtoupper($GLOBALS['HideCustomerTab'])<>'YES') || (is_administrator())) {
						...
						print "</td><td align='right'>&nbsp;<a href='javascript:popActivityCustomerGraph(" . $cust['id'] .");' title='Mostrar gráfico de ações'><img src='graph.gif' border=1></a>&nbsp;&nbsp;";
