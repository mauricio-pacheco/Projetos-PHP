...
// +----------------------------------------------------------------------+
//
// $Id: Server.php,v 1.13 2003/11/18 21:09:35 hholzgra Exp $
//
...
class HTTP_WebDAV_Server {
    ...
    var $path;
         ...
         * @var string 
         */
    var $http_auth_realm = "CRM PHP WebDAV";
...
//		system("echo 'in_get -- $options[path]'|logger");
...
// hack by hidde
               		$options["owner"] = $_SERVER['PHP_AUTH_USER'];
				}
