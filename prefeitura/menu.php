...
.nav2 {
	PADDING-RIGHT: 6px; PADDING-LEFT: 6px; FONT-SIZE: 11px; PADDING-BOTTOM: 2px; CURSOR: pointer; COLOR: #333333; LINE-HEIGHT: 18px; PADDING-TOP: 2px; BORDER-BOTTOM: #cccccc 1px solid; FONT-FAMILY: arial,helvetica,sanserif; WHITE-SPACE: nowrap; BACKGROUND-COLOR: #E7E4D3
}
A.nav:link {
...
#main {
	Z-INDEX: 20; VISIBILITY: visible; WIDTH: 780px; POSITION: relative
}
#domd {
	Z-INDEX: 100; LEFT: 0px; VISIBILITY: hidden; WIDTH: 124px; POSITION: absolute; TOP: 24px
}
#hostd {
	Z-INDEX: 100; LEFT: 123px; VISIBILITY: hidden; WIDTH: 140px; POSITION: absolute; TOP: 24px
}
#webd {
	Z-INDEX: 100; LEFT: 259px; VISIBILITY: hidden; WIDTH: 109px; POSITION: absolute; TOP: 24px
}
#ed {
	Z-INDEX: 100; LEFT: 300px; VISIBILITY: hidden; WIDTH: 64px; POSITION: absolute; TOP: 24px
}
#ssld {
	Z-INDEX: 100; LEFT: 389px; VISIBILITY: hidden; WIDTH: 130px; POSITION: absolute; TOP: 24px
}
#ecod {
	Z-INDEX: 100; LEFT: 402px; VISIBILITY: hidden; WIDTH: 102px; POSITION: absolute; TOP: 24px
}
#dad {
	Z-INDEX: 100; LEFT: 522px; VISIBILITY: hidden; WIDTH: 120px; POSITION: absolute; TOP: 24px
}
#wwdd {
	Z-INDEX: 100; LEFT: 650px; VISIBILITY: hidden; WIDTH: 120px; POSITION: absolute; TOP: 24px
}
</STYLE>
...
function getdropdowns(){
	var dn = 'domd';startdiv(dn,'128');
	bi('index.php',dn,'Perfil');
	bi('index.php',dn,'Informações');
	bi('index.php',dn,'Símbolos');
	bi('index.php',dn,'Eventos');
	bi('index.php',dn,'Guia Turístico');
	bi('index.php',dn,'Mapa de ruas');
	bi('index.php',dn,'Localização');
	bi('index.php',dn,'Transporte');
	bi('index.php',dn,'Rodoviária');
	bi('index.php',dn,'Como chegar?');
	enddiv(); 
	dn = 'hostd';startdiv(dn ,'134');
	bi('index.php',dn ,'Quem somos');
	bi('index.php',dn ,'Organização');
	bi('index.php',dn ,'Licitações');
	bi('index.php',dn ,'Concursos');
	bi('index.php',dn ,'Legislação');
	enddiv();
	dn = 'webd';startdiv(dn,'131');
	bi('index.php',dn,'Ouvidoria');
	bi('index.php',dn,'Contas Públicas');
	bi('index.php',dn,'Webmail');
	enddiv();
	dn = 'ssld';startdiv(dn,'134');
	bi('index.php',dn,'Governo');
	bi('index.php',dn,'Planejamento');
	bi('index.php',dn,'Cultura');
	bi('index.php',dn,'Saúde');
	bi('index.php',dn,'Defesa e Cidadania');
	bi('index.php',dn,'Assistência Social');
	bi('index.php',dn,'Finanças');
	bi('index.php',dn,'Infra-Estrutura');
	bi('index.php',dn,'Educação e Lazer');
	bi('index.php',dn,'Meio Ambiente');
	bi('index.php',dn,'Trabalho/Turismo');
	bi('index.php',dn,'Trânsito/Transportes');
	bi('index.php',dn,'Procuradoria Geral');
	enddiv();
	dn = 'ecod';startdiv(dn,'130');
	bi('index.php',dn,'Link 1');
	bi('index.php',dn,'Link 2');
	bi('index.php',dn,'Link 3');
	bi('index.php',dn,'Link 4');
	bi('index.php',dn,'Link 5');
	bi('index.php',dn,'Link 6');
	bi('index.php',dn,'Link 7');
	bi('index.php',dn,'Link 8');
	bi('index.php',dn,'Link 9');
	enddiv();
	dn = 'dad';
	startdiv(dn,'129');
	bi('index.php',dn,'Artigos');     
	bi('index.php',dn,'Leis Municípais');       
	bi('index.php',dn,'Decretos');     
	enddiv();
	dn = 'wwdd';
	startdiv(dn,'130');
...
function menuout(div, item){
	setDDTimeout(div);item.style.backgroundColor='#E7E4D3';
}
...
cellSpacing=0 cellPadding=0 width=780 background=menu_arquivos/bck_img_grey.gif 
border=0>
    <TBODY>
      <TR> 
        <TD class=menu onmouseover="mainovr('domd','Cidade')" 
     onclick="lnk('index.php');"
	 onmouseout="mainout('domd')" align=middle width=123 height=23><div align="center"><font color="#F5D300">Home</font></div></TD>
        ...
        <TD class=menu onmouseover="mainovr('hostd','Prefeitura')" 
     onmouseout="mainout('hostd')" align=middle width=123 height=23><div align="center">Prefeitura</div></TD>
        <TD width=20 height=8><img src="seta.gif" width="13" height="14"></TD>
        <TD width=2><IMG height=23 src="menu_arquivos/menu_div.png" width=2></TD>
        <TD class=menu onmouseover="mainovr('webd','O Governo')" 
    onmouseout="mainout('webd')" align=middle width=123 height=23><div align="center">O 
            Governo</div></TD>
        <TD width=20 height=8><img src="seta.gif" width="13" height="14"></TD>
        <TD width=2><IMG height=23 src="menu_arquivos/menu_div.png" width=2></TD>
        <TD class=menu onmouseover="mainovr('ssld','Secretarias')" 
    onmouseout="mainout('ssld')" align=middle width=123 height=23><div align="center">Secretarias</div></TD>
        <TD width=20 height=8><img src="seta.gif" width="13" height="14"></TD>
        <TD width=2><IMG height=23 src="menu_arquivos/menu_div.png" width=2></TD>
