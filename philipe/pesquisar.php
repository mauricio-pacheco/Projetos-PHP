...
if(!empty($HTTP_POST_VARS["palavra"])) {
      ...
      $qr = "SELECT * FROM telefones WHERE status = '0' AND nome LIKE '%".$palavra."%'";
        ...
        echo "<div align=\"center\"><font size='2'>Sua busca retornou <font color\"#2C9955\">' $total ' </font> resultados.</font></div><br>";
