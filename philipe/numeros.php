...
$letra = $_GET['letra'];
      ...
      $qr = "SELECT * FROM telefones WHERE status = '0' AND nome LIKE '0%' OR nome LIKE '1%' OR nome LIKE '2%' OR nome LIKE '3%' OR nome LIKE '4%' OR nome LIKE '5%' OR nome LIKE '6%' OR nome LIKE '7%' OR nome LIKE '8%' OR nome LIKE '9%' ORDER BY nome ASC";
        ...
        <table width="100%" border="0">
          <tr>
            <td><table width="100%" border="0">
              <tr>
                <td width="5%"><a href="perfil.php?&amp;id=<?php echo $r["id"]; ?>" class="link_normal" title="VER DETALHES DO CADASTRO"><img src="cliente.jpg" border="0"></a></td>
                <td width="90%"><a href="perfil.php?&amp;id=<?php echo $r["id"]; ?>" class="link_normal"  title="VER DETALHES DO CADASTRO"><?php echo $r["nome"]; ?></a></td>
                <td width="5%"><?php
                     $branca = $r["foto"];
					 $testeb = '';
					 if ($branca == $testeb)
					 {
					  					  ?><?php } else { ?><a href="administrador/fotos/<?php echo $r["foto"]; ?>" rel="lytebox" title="<?php echo $r["nome"]; ?>"><img src="camera.jpg" border="0" alt="VISUALIZAR FOTO"><?php } ?></a></td>
              </tr>
            </table></td>
          </tr>
          <tr>
            <td><table width="100%" border="0">
              <tr>
                ...
                <td width="95%"><font size="1"><?php echo $r["endereco"]; ?>, <?php echo $r["numero"]; ?>   <?php echo $r["complemento"]; ?> - Bairro: <?php echo $r["bairro"]; ?><br><?php echo $r["cidade"]; ?> - <?php echo $r["estado"]; ?> - CEP: <?php echo $r["cep"]; ?></font></td>
              </tr>
            </table></td>
          </tr>
          <tr>
            <td><table width="100%" border="0">
              <tr>
                ...
                <td width="96%"><font color="#006600"><?php echo $r["ddd1"]; ?>&nbsp;<?php echo $r["numero1"]; ?>&nbsp;&nbsp;<?php echo $r["numero2"]; ?>&nbsp;&nbsp;<?php echo $r["celular1"]; ?>&nbsp;&nbsp;<?php echo $r["celular2"]; ?></font></td>
              </tr>
            </table></td>
          </tr>
        </table>       <?php }
