...
$sql = mysql_query("SELECT * FROM cw_publicidades WHERE local='links'");
...
<table width="94%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td valign="top" class="fonte">Veja alguns links que poderão ajudar:<br /><br /><?php
...
while($m = mysql_fetch_array($sql2))
   ...
   ?><a href="<?php echo $m["link2"]; ?>" class="fonte" target="_blank"><?php echo $m["titulo"]; ?></a><br /><br /> <?php } } } } ?></td>
            <td>&nbsp;</td>
            <td class="fonte" valign="top">
</td>
          </tr>
        </table>
