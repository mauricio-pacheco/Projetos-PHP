...
$sql = mysql_query("SELECT * FROM cw_publicidades WHERE local='trabalho'");
...
<table width="94%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
            <td width="49%"><img src="imagens/tequipe2.png" /></td>
            <td width="2%">&nbsp;</td>
            <td width="49%">&nbsp;</td>
          </tr>
          <tr>
...
$sql = mysql_query("SELECT * FROM cw_galeria WHERE nomegaleria='EQUIPE DE TRABALHO'");
...
$sql_select = "SELECT * FROM cw_fotos WHERE idgaleria='70' LIMIT $inicio, $qnt";
...
?>
                          <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                              <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td width="31%"><table border="0" width="127" height="74" cellspacing="0" cellpadding="0">
                                    <tr>
                                      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                          <tr>
                                            ...
                                            <td><img src="administrador/ups/fotosgaleria/p/<?php echo $fotomenor.""; ?>" width="120" height="120" border="0" /></td>
                                          </tr>
                                        </table></td>
                                    </tr>
                                  </table></td>
                                  <td width="69%" valign="top"><?php echo $comentario.""; ?></td>
                                </tr>
                              </table></td>
                            </tr>
                            <tr>
