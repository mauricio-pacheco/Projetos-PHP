...
$subject = utf8_decode("Contato do Site - V-Mat Imagem");
...
$texto =  utf8_decode("<font face=verdana size=2 color=#C60000><b>CONTATO DO VAT IMAGEM:</b></font>\n\n\n<br><br>"); 
$texto .=  utf8_decode("<font face=verdana size=2><b>$nome</b>, acabou de enviar uma mensagem via Formul&aacute;rio do site V-Mat Imagem:</font>\n\n\n<br><br>"); 
