                        ...
                        <table width="100%" border="0">
                          <tr>
                            <td width="25%" align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td align="center"><a href="verpubli.php?iddep=<?php echo $iddep.""; ?>&amp;idpublic=<?php echo $id.""; ?>"><img alt="<?php echo $subsessao.""; ?>" title="<?php echo $subsessao.""; ?>" src="imagens/pasta.png" border="0" /></a></td>
                              </tr>
                            </table>
