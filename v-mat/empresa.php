...
$sql = mysql_query("SELECT * FROM cw_publicidades WHERE local='empresa'");
...
$sql = mysql_query("SELECT * FROM cw_galeria WHERE nomegaleria='EMPRESA'");
...
$sql_select = "SELECT * FROM cw_fotos WHERE idgaleria='69' LIMIT $inicio, $qnt";
