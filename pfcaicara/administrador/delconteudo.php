          ...
          <table width="100%" border="0" align="center">
            <tr>
              <td width="11%" height="30" bgcolor="#076CA0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="98%">&nbsp;&nbsp;<font color="#FFFFFF" class="fontetabela2"><b>APAGAR PÁGINA</b></font></td>
                </tr>
              </table></td>
            </tr>
          </table>
...
$sql = "DELETE FROM cw_conteudo WHERE id='$id'";
if(mysql_query($sql)) {
echo "<div align=center class=manchete_texto><br>A PÁGINA FOI APAGADA COM SUCESSO!!</div>";
echo "<script>alert('PÁGINA APAGADA COM SUCESSO!')</script>";
echo "<script>location.href='admconteudo.php'</script>";
}else{
echo "<div align=center><br>N&Atilde;O FOI POSS&Iacute;VEL APAGAR A PÁGINA!</div>";
}
