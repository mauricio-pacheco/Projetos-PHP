          ...
          <table width="100%" border="0" align="center">
            <tr>
              <td width="11%" height="30" bgcolor="#076CA0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="98%">&nbsp;&nbsp;<font color="#FFFFFF" class="fontetabela2"><b>APAGAR CLIENTE</b></font></td>
                </tr>
              </table></td>
            </tr>
          </table>
...
$sql = "DELETE FROM cw_clientes WHERE id='$id'";


if ($foto = 'semfoto.jpg') {
}
else {
unlink("ups/clientes/$foto");
}

if(mysql_query($sql)) {
echo "<div align=center><br><img src=imagens/ok.png></div><div align=center><br>O CLIENTE FOI APAGADO COM SUCESSO!!</div>";
