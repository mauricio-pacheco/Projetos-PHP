          ...
          <table width="100%" border="0" align="center">
            <tr>
              <td width="11%" height="30" bgcolor="#076CA0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="98%">&nbsp;&nbsp;<font color="#FFFFFF" class="fontetabela2"><b>CADASTRAR SUB-DEPARTAMENTO DOS PRODUTOS</b></font></td>
                </tr>
              </table></td>
            </tr>
          </table>
...
$sql = "INSERT INTO cw_subdepprod (nomesub, iddep) VALUES ('$nomesub', '$iddep')";
if(mysql_query($sql)) {
echo "<div align=center><br><img src=imagens/ok.png></div><div align=center class=manchete_texto><br>O CADASTRO DO SUB-DEPARTAMENTO FOI EFETUADO COM SUCESSO!!</div><br>";
}else{
