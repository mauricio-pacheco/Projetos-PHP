          ...
          <table width="100%" border="0" align="center">
            <tr>
              <td width="11%" height="30" bgcolor="#076CA0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="98%">&nbsp;&nbsp;<font color="#FFFFFF" class="fontetabela2"><b>CADASTRAR SESSÃO</b></font></td>
                </tr>
              </table></td>
            </tr>
          </table>
...
return false
                  ...
                  <form action="cadsessao.php" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return validar(this)">
                    <table width="100%" border="0" align="center">
                      <tr>
                        <td class="manchete_texto" align="left">T&iacute;tulo da Sessão (Ex: Licitações): <span class="style15">
                          <input name="nome" type="text" class="fontetabela" size="60" />
                        </span> *</td>
                      </tr>
                      <tr>
                        <td class="manchete_texto" align="left"><span style="MARGIN: 0px">
                          <input name="submit" class="fontetabela" type="submit" style="FONT-SIZE: 10px" value="CADASTRAR SESSÃO" />
                        </span></td>
                      </tr>
                    </table>
                  </form></td>
