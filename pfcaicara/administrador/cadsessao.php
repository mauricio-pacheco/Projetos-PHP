...
$sql = "INSERT INTO cw_sessoes (nome) VALUES ('$nome')";
if(mysql_query($sql)) {
echo "<div align=center><br><img src=imagens/ok.png></div><div align=center class=manchete_texto><br>A SESSÃO FOI CADASTRADA COM SUCESSO!!</div>";
}else{
