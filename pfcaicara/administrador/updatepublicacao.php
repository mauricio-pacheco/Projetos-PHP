          ...
          <table width="100%" border="0" align="center">
            <tr>
              <td width="11%" height="30" bgcolor="#076CA0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="98%">&nbsp;&nbsp;<font color="#FFFFFF" class="fontetabela2"><b>EDITAR PUBLICAÇÃO</b></font></td>
                </tr>
              </table></td>
            </tr>
          </table>
...
$sql = mysql_query("SELECT * FROM cw_pub WHERE id='$id'");
...
$idsubsessao = $_POST["idsubsessao"];
$data = $_POST["data"];
$hora = $_POST["hora"];


$sql = "UPDATE cw_pub SET titulo = '$titulo', idsessao = '$idsessao', idsubsessao = '$idsubsessao', data = '$data', hora = '$hora', arquivo = '$arquivo_nome' WHERE id = '$id'";
if(mysql_query($sql)) {
echo "<div align=center><br><img src=imagens/ok.png></div><br><div align=center class=manchete_texto>A PUBLICAÇÃO FOI EDITADA COM SUCESSO!!</div>";
}else{
