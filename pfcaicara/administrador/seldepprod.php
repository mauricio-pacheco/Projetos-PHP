          ...
          <table width="100%" border="0" align="center">
            <tr>
              <td width="11%" height="30" bgcolor="#076CA0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="98%">&nbsp;&nbsp;<font color="#FFFFFF" class="fontetabela2"><b>ADMINISTRAR SUB-DEPARTAMENTOS DO DEPARTAMENTO 
                                  <?php
...
$sql_select = "SELECT * FROM cw_subdepprod WHERE iddep='$iddepnovo' ORDER BY nomesub ASC LIMIT $inicio, $qnt";
// Executa o Query
...
?>
                  <table width="100%" border="0" align="center">
                    <tr>
                      ...
                      <td align="left" width="98%" valign="top"><font color="#000000"><?php echo $nomesub.""; ?><br />
                        <a href="edisubprod.php?id=<?php echo $id.""; ?>" class="manchete_texto4"><b>EDITAR SUB-DEPARTAMENTO</b></a> - <a href="delsubprod.php?id=<?php echo $id.""; ?>&amp;iddep=<?php echo $iddep.""; ?>" onclick="return confirm('Tem certeza que deseja apagar o sub-departamento <?php echo $nomesub.""; ?> ?')" class="manchete_texto6"><b>APAGAR SUB-DEPARTAMENTO</b></a></td>
                    </tr>
                  </table>
                  <div align="center">
				  <?php
...
$sql_select_all = "SELECT * FROM cw_subdepprod WHERE iddep='iddepnovo'";
...
echo "<a href='seldepprod.php?p=1&amp;id=$iddepnovo' target='_self' class=manchete_texto><b>PRIMEIRA P&Aacute;GINA</b></a>&nbsp;&nbsp;";
...
echo "| <a href='seldepprod.php?p=".$i."&amp;id=$iddepnovo' target='_self' class=manchete_texto>".$i."</a> ";
}
}
...
echo "&nbsp;&nbsp;<a href='seldepprod.php?p=".$pags."&amp;id=$ideponovo' target='_self' class=manchete_texto><b>&Uacute;LTIMA P&Aacute;GINA</b></a> ";
?></div></td>
              </tr>
            </table></td>
          </tr>
