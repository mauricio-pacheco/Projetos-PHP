          ...
          <table width="100%" border="0" align="center">
            <tr>
              <td width="11%" height="30" bgcolor="#076CA0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="98%">&nbsp;&nbsp;<font color="#FFFFFF" class="fontetabela2"><b>ADMINISTRAR EVENTOS</b></font></td>
                </tr>
              </table></td>
            </tr>
          </table>
              ...
              <tr>
                <td>
                  <form name="formbusca" method="post" action="buscaevento.php">
                    <label><span class="manchete_texto"><strong>Pesquisar Evento:</strong></span>
                      <input name="palavra" type="text" value="Digite o Título do Evento" onclick="this.value=''" class="manchete_texto" id="palavra" size="102" />
                    </label>
...
?>
                  ...
                  <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td align="left"><a href="edigalerias.php?id=<?php echo $id.""; ?>" class="manchete_texto4"><b>EDITAR EVENTO</b></a> - <a href="delgalerias.php?id=<?php echo $id.""; ?>&amp;foto=<?php echo $foto.""; ?>" onclick="return confirm('Tem certeza que deseja apagar o evento <?php echo $nomegaleria.""; ?> ?')" class="manchete_texto6"><b>APAGAR EVENTO</b></a> - <a href="enviafotos.php?id=<?php echo $id.""; ?>" class="manchete_textof6"><b>ENVIAR IMAGENS AO EVENTO</b></a> - <a href="comenadmfotos.php?id=<?php echo $id.""; ?>" class="manchete_textof8"><b>ADMINISTRAR IMAGENS DO EVENTO</b></a></td>
                    </tr>
                  </table>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
...
$sql_select_all = "SELECT * FROM cw_galeria";
...
echo "<a class=manchete_texto href='admeventos.php?p=1' target='_self'><b>PRIMEIRA P&Aacute;GINA</b></a>&nbsp;&nbsp;";
...
echo "| <a class=manchete_texto href='admeventos.php?p=".$i."' target='_self'>".$i."</a> ";
}
}
...
echo "&nbsp;&nbsp;<a class=manchete_texto href='admeventos.php?p=".$pags."' target='_self'><b>&Uacute;LTIMA P&Aacute;GINA</b></a> ";
?></div></td>
              </tr>
            </table></td>
          </tr>
