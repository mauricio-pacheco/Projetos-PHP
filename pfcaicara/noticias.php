          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td valign="top"><table width="702" height="42" background="imagens/barramenu.png" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="fontetitulo">&nbsp;&nbsp;<font color="#FFFFFF">Notícias</font></td>
                </tr>
              </table></td>
              <td valign="top">&nbsp;</td>
            </tr>
                            ...
                            <table width="100%" border="0">
                              <tr>
                                <td width="25%" align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td align="center"><a href="nots.php?iddep=<?php echo $id.""; ?>"><img alt="<?php echo $departamento.""; ?>" title="<?php echo $departamento.""; ?>" src="imagens/nota.png" border="0" /></a></td>
                                  </tr>
                                </table>
                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
