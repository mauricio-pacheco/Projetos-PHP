          ...
          <table width="100%" border="0" align="center">
            <tr>
              <td width="11%" height="30" bgcolor="#076CA0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="98%">&nbsp;&nbsp;<font color="#FFFFFF" class="fontetabela2"><b>APAGAR PUBLICAÇÃO</b></font></td>
                </tr>
              </table></td>
            </tr>
          </table>
...
$sql = "DELETE FROM cw_pub WHERE id='$id'";
unlink("ups/publicacoes/$arquivo");
if(mysql_query($sql)) {
echo "<script>alert('PUBLICAÇÃO APAGADA COM SUCESSO!')</script>";
echo "<script>location.href='admpublicacao.php?idsessao=$idsessao&idsubsessao=$idsubsessao'</script>";
}else{
