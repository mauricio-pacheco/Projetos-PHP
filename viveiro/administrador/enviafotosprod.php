          ...
          <table width="100%" border="0" align="center">
            <tr>
              <td width="11%" height="30" bgcolor="#076CA0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="98%">&nbsp;&nbsp;<font color="#FFFFFF" class="fontetabela2"><b>ENVIAR IMAGENS AO PRODUTO</b></font></td>
                </tr>
              </table></td>
            </tr>
          </table>
...
if ($contar < 1)  
   {echo "<div align=center><b>Não existe produtos cadastrados!</b></div>"; 
   }
else 
   {
            ...
            <td><table width="100%" border="0" align="center">
              <tr>
                <td><table width="100%" border="0" align="center">
                    ...
                    <td class="manchete_texto" align="left"><table width="100%" border="0" align="center">
                      <tr>
                        ...
                        <td align="left" width="98%" valign="top" class="manchete_texto3"><table width="100%" border="0">
                          <tr>
                            <td class="manchete_texto"><?php echo $n["nome"]; ?></td>
                          </tr>
                        </table>
                          <table width="100%" border="0">
                            <tr>
                              <td class="manchete_texto"><b>Preço:&nbsp;</b><font color="#009900">R$</font> <?php echo $n["valor"]; ?></td>
                            </tr>
                          </table></td>
                      </tr>
                    </table></td>
                  ...
                  <tr>
                    <td class="manchete_texto" align="center"><!-- dynamic assets -->
                     <style type="text/css">
#status
{
	padding:				10px 15px;
...
window.addEvent('load', function() {
	...
	$('upload-images').addEvent('click', function() {
		...
		return false;
                      ...
                      <div>
                        <form action="funcoesupload/script3.php?id=<?php echo $n["id"]; ?>" method="post" enctype="multipart/form-data" id="form_imagens">
