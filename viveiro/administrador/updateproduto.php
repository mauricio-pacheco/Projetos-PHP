...
$sql = "UPDATE cw_produtos SET nome = '$nome', departamento = '$departamento', subdep = '$subdep', tipo = '$tipo', foto = '$nome_foto0', peso = '$peso', valor = '$valor', valorpx = '$valorpx', valorp = '$valorp', valortratar = '$valortratar', descricao = '$descricao' WHERE id = '$id'";
if(mysql_query($sql)) {
