...
return false
                ...
                <form id="formbusca" name="formbusca" method="post" action="buscaconteudo.php">
...
while($y = mysql_fetch_array($sql))
 ...
 ?>
                  ...
                  <input name="button" type="submit" class="manchete_texto" id="button" value="PESQUISAR" />
                </form></td>
              </tr>
            </table>
             <table width="100%" border="0" cellspacing="0" cellpadding="0">
...
$sql_select = "SELECT * FROM cw_conteudo WHERE idmenu='$id' ORDER BY id DESC LIMIT $inicio, $qnt";
// Executa o Query
...
$sql_select_all = "SELECT * FROM cw_conteudo WHERE idmenu='$id'";
...
echo "<a class=manchete_texto href='editarcont.php?p=1&amp;id=$idmenu' target='_self'>PRIMEIRA P&Aacute;GINA</a>&nbsp;&nbsp;";
...
echo "| <a class=manchete_texto href='editarcont.php?p=".$i."&amp;id=$idmenu' target='_self'>".$i."</a> ";
}
}
...
echo "&nbsp;&nbsp;<a class=manchete_texto href='editarcont.php?p=".$pags."&amp;id=$idmenu' target='_self'>&Uacute;LTIMA P&Aacute;GINA</a> ";
?></div></td>
              </tr>
            </table></td>
          </tr>
