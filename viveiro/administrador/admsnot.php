          ...
          <table width="100%" border="0" align="center">
            <tr>
              <td width="11%" height="30" bgcolor="#076CA0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="98%">&nbsp;&nbsp;<font color="#FFFFFF" class="fontetabela2"><b>ADMINISTRAR NOTÍCIAS DOS SLIDES</b></font></td>
                </tr>
              </table></td>
            </tr>
          </table>
...
$sql_select = "SELECT * FROM cw_noticias WHERE iddep = '0' ORDER BY id DESC LIMIT $inicio, $qnt";
// Executa o Query
                          ...
                          <td><table width="100%" border="0">
                            <tr>
                              <td width="96%" class="manchete_texto5" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td><img src="ups/capasnoticia/<?php echo $foto.""; ?>" /></td>
                                </tr>
                                <tr>
...
$sql_select_all = "SELECT * FROM cw_noticias WHERE iddep = '0'";
...
echo "<a class=manchete_texto href='admsnot.php?p=1' target='_self'><b>PRIMEIRA P&Aacute;GINA</b></a>&nbsp;&nbsp;";
...
echo "| <a class=manchete_texto href='admsnot.php?p=".$i."' target='_self'>".$i."</a> ";
}
}
...
echo "&nbsp;&nbsp;<a class=manchete_texto href='admsnot.php?p=".$pags."' target='_self'><b>&Uacute;LTIMA P&Aacute;GINA</b></a> ";
?>
                  </div></td>
              </tr>
            </table></td>
