...
$sql = "INSERT INTO cw_menus (departamento) VALUES ('$departamento')";
if(mysql_query($sql)) {
echo "<div align=center><br><img src=imagens/ok.png></div><div align=center class=manchete_texto><br>O MENU FOI CADASTRADO COM SUCESSO!!</div>";
}else{
