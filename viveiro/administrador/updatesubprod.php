...
$sql = "UPDATE cw_subdepprod SET nomesub = '$nomesub', iddep = '$iddep' WHERE id = '$id'";
if(mysql_query($sql)) {
echo "<div align=center><br><img src=imagens/ok.png></div><br><div align=center class=manchete_texto>O SUB-DEPARTAMENTO FOI EDITADO COM SUCESSO!!</div>";
}else{
