              ...
              <tr>
                <td class="fonteadm"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="31%" align="right" class="fontetabela">Compras do Dia: <b><?php $data = date ("j/m/Y"); echo $data; ?></b>&nbsp;</td>
                  </tr>
                </table>                  </td>
              </tr>
            </table></form></td>
...
$sql_select = "SELECT * FROM cw_compras WHERE data='$data' ORDER BY id DESC LIMIT $inicio, $qnt";
	...
	echo $y["cliente"];
              ...
              <td width="24%" class="fontemenu2"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="86%" class="manchete_texto4"><strong>&nbsp;<a href="detalhecompra.php?id=<?php echo $id.""; ?>&amp;idcliente=<?php echo $idcliente.""; ?>&amp;data=<?php echo $data.""; ?>&amp;hora=<?php echo $hora.""; ?>" class="manchete_texto4"><b>DETALHES DA COMPRA</b></a></strong></td>
                </tr>
              </table></td>
...
$sql_select_all = "SELECT * FROM cw_compras WHERE data='$data' ORDER BY id DESC";
