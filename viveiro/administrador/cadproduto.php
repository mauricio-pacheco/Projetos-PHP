...
$sql = "INSERT INTO cw_produtos (nome, departamento, subdep, tipo, foto, peso, valor, valorpx, valorp, valortratar, descricao) VALUES ('$nome', '$departamento', '$subdep', '$tipo', '$nome_foto', '$peso', '$valor', '$valorpx', '$valorp', '$valortratar', '$descricao')";
if(mysql_query($sql)) {
