...
<div id="list_Templates" style="display:none;">
	<div style="position:absolute; top:0; left:0; overflow:scroll; overflow-x:hidden;width:100%;height:200px">
		<div onmouseover="this.style.filter='progid:DXImageTransform.Microsoft.Gradient(GradientType=0, StartColorStr=#99ccff, EndColorStr=#FFFFFF)';"
			...
			<span onclick="parent.selectTemplate(1)"><img style="vertical-align:middle" src="../Images/One-Column-Table.gif" alt="<?php echo GetString("1ColumnTable") ; ?>" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
		...
		<div onmouseover="this.style.filter='progid:DXImageTransform.Microsoft.Gradient(GradientType=0, StartColorStr=yellowgreen, EndColorStr=#FFFFFF)';"
			...
			<span onclick="parent.selectTemplate(2)"><img style="vertical-align:middle" src="../Images/Two-Column-Table.gif" alt="<?php echo GetString("2ColumnTable") ; ?>" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
		...
		<div onmouseover="this.style.filter='progid:DXImageTransform.Microsoft.Gradient(GradientType=0, StartColorStr=gold, EndColorStr=#FFFFFF)';"
			onmouseout="this.style.filter='';" style="font:normal 11px Tahoma; height:25px; background:#ffffff; border:1px solid black; padding:3px; padding-left:20px; cursor:hand; border-top:0px solid black">
			<span onclick="parent.selectTemplate(3)"><img style="vertical-align:middle" src="../Images/Three-Column-Table.gif" alt="<?php echo GetString("3ColumnTable") ; ?>"
		...
		<div onmouseover="this.style.filter='progid:DXImageTransform.Microsoft.Gradient(GradientType=0, StartColorStr=violet, EndColorStr=#FFFFFF)';"
			onmouseout="this.style.filter='';" style="font:normal 11px Tahoma; height:25px; background:#ffffff; border:1px solid black; padding:3px; padding-left:20px; cursor:hand; border-top:0px solid black">
			<span onclick="parent.selectTemplate(4)"><img style="vertical-align:middle" src="../Images/h-R-t-Body.gif" alt="<?php echo GetString("Header-Right-TopLeft-Body") ; ?>"
					/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php echo GetString("Header-Right-TopLeft-Body") ; ?></span>
		</div>
		<div onmouseover="this.style.filter='progid:DXImageTransform.Microsoft.Gradient(GradientType=0, StartColorStr=#99ccff, EndColorStr=#FFFFFF)';"
			onmouseout="this.style.filter='';" style="font:normal 11px Tahoma; height:25px; background:#ffffff; border:1px solid black; padding:3px; padding-left:20px; cursor:hand; border-top:0px solid black">
			<span onclick="parent.selectTemplate(5)"><img style="vertical-align:middle" src="../Images/h-l-tr-Body.gif" alt="<?php echo GetString("Header-Left-TopRight-Body") ; ?>"
					/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php echo GetString("Header-Left-TopRight-Body") ; ?></span>
		</div>
		<div onmouseover="this.style.filter='progid:DXImageTransform.Microsoft.Gradient(GradientType=0, StartColorStr=#99ccff, EndColorStr=#FFFFFF)';"
			onmouseout="this.style.filter='';" style="font:normal 11px Tahoma; height:25px; background:#ffffff; border:1px solid black; padding:3px; padding-left:20px;  cursor:hand; border-top:0px solid black;">
			<span onclick="parent.selectTemplate(6)"><img style="vertical-align:middle" src="../Images/h-f-3Columns-Body.gif" alt="<?php echo GetString("Header-Footer-3-Columns") ; ?>"
