          ...
          <table width="100%" border="0" align="center">
            <tr>
              <td width="11%" height="30" bgcolor="#076CA0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="98%">&nbsp;&nbsp;<font color="#FFFFFF" class="fontetabela2"><b>APAGAR COMPRA</b></font></td>
                </tr>
              </table></td>
            </tr>
          </table>
...
$sql = "DELETE FROM cw_compras WHERE id='$id'";
mysql_query($sql);

$sql4 = "DELETE FROM cw_produtoscomprados WHERE carrinho='$carrinho'";
mysql_query($sql4);


echo "<script>alert('A COMPRA FOI APAGADA COM SUCESSO!')</script>";
