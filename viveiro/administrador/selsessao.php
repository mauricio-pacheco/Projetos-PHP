...
echo "<a href='selsessao.php?p=1&amp;id=$idsessaonovo' target='_self' class=manchete_texto><b>PRIMEIRA P&Aacute;GINA</b></a>&nbsp;&nbsp;";
...
echo "| <a href='selsessao.php?p=".$i."&amp;id=$idsessaonovo' target='_self' class=manchete_texto>".$i."</a> ";
}
}
...
echo "&nbsp;&nbsp;<a href='selsessao.php?p=".$pags."&amp;id=$idsessaonovo' target='_self' class=manchete_texto><b>&Uacute;LTIMA P&Aacute;GINA</b></a> ";
?></div></td>
              </tr>
            </table></td>
          </tr>
