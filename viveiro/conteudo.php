...
while($y = mysql_fetch_array($sql))
   {
   ?>
              <table height="30" bgcolor="#000000" width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td class="fontetabela5" align="right"><strong><?php echo $y["titulo"]; ?></strong>&nbsp;&nbsp;</td>
              </tr>
            </table>
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
