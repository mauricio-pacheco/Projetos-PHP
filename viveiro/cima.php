          ...
          <form action="autoriza.php" method="post" name="formlogin" onsubmit="return validarlogin(this)"><table width="98%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="323"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="6%"><img src="imagens/ajuda.png"  /></td>
                    <td width="47%" class="manchete_texto9"><a href="atendimento.php" class="manchete_texto9">Atendimento Online</a></td>
                    <td width="9%"><img src="imagens/login.png" /></td>
                    <td width="38%" class="manchete_texto9"s><a href="cadastro.php" class="manchete_texto9">Efetuar Cadastro</a></td>
                  </tr>
                </table></td>
