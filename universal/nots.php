        ...
        <table width="494" height="29" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#026DA2" style="margin-bottom:4px">
                <tr>
                  <td height="24" background="imagens/b5.png"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="90%" class="manchete_texto" align="center"><font color="#FFFFFF"><b>ÚLTIMAS NOTÍCIAS -
                ...
                <td width="77%" valign="top"><table width="100%" border="0">
                  ...
                  <tr>
                    <td><table width="100%" border="0">
                      <tr>
                        <td width="3%"><a style="cursor:hand;" onClick="toggle('maisinfo<?php echo $id.""; ?>');" class="manchete_texto9"><img border="0" src="imagens/mais.png" /></a></td>
                        <td width="97%" class="manchete_texto9">&nbsp;<a style="cursor:hand;" onClick="toggle('maisinfo<?php echo $id.""; ?>');" class="manchete_texto9">Leia mais...</a></td>
                      </tr>
                    </table></td>
                  </tr>
                </table></td>
