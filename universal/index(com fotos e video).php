...
<table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <SCRIPT language=javascript>
     carregaFlash('flash/index.swf','980','240'); 
    </SCRIPT></td>
  </tr>
</table>
<table width="980" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td bgcolor="#FFFFFF" valign="top">
      ...
      <tr>
        ...
        <td width="59%" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#026DA2" style="margin-bottom:4px">
                <tr>
                  <td height="24" bordercolor="#A7D2EF" bgcolor="#026DA2"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
...
while($y = mysql_fetch_array($sql))
 ...
 ?>
          ...
          <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#026DA2" style="margin-bottom:4px">
            <tr>
              <td height="24" bordercolor="#A7D2EF" bgcolor="#E08842"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="5%"><img src="imagens/antena.png" /></td>
                  <td width="90%" class="manchete_texto" align="center"><font color="#FFFFFF"><b>GALERIA DE VIDEOS</b></font></td>
                  <td width="5%" class="manchete_texto"><img src="imagens/antena2.png" /></td>
                </tr>
              </table></td>
            </tr>
...
?></td>
        ...
        <td width="19%" valign="top"><?php include("direito.php"); ?></td>
          </tr>
        </table></td>
      </tr>
    </table>
