      ...
      <tr>
        ...
        <td width="78%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td width="97%" class="manchete_texto9m">&nbsp;<strong><em>Serviços</em></strong></td>
          </tr>
        </table>
          ...
          <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td><p align="center" class="manchete_texto9">&nbsp;</p>
                <p align="center" class="manchete_texto9"><img src="imagens/constru07.gif" width="40" height="40" /></p>
                <p align="center" class="manchete_texto9">Em construção...</p>
                <p align="center" class="manchete_texto9">&nbsp;</p></td>
            </tr>
          </table>
          <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
