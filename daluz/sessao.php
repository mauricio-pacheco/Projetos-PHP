...
echo "| <a href='sessao.php?p=".$i."&amp;iddep=$iddep' target='_self' class=manchete_texto9>".$i."</a> ";
}
}
...
echo "&nbsp;&nbsp;<a href='sessao.php?p=".$pags."&amp;iddep=$iddep' target='_self' class=manchete_texto9><b>ÚLTIMA PÁGINA</b></a> ";
