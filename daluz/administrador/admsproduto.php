                  ...
                  <table width="99%" border="0" align="center">
                    <tr>
                      ...
                      <td align="left" width="98%" class="manchete_texto5" valign="top"><table width="99%" border="0" align="right" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          <td><div align="justify"><b>Tipo:</b> <?php if ($tipo=='Venda') { ?><font color="#EC1D25"><?php } else { ?><font color="#0364FF"><?php } ?><?php echo $tipo.""; ?></font></div></td>
                        </tr>
                          <tr>
                          <td><img src="imagens/branco.gif" width="1" height="3" /></td>
                        </tr>
...
echo "<a class=manchete_texto href='admsproduto.php?p=1&id=$idsubnovo&iddep=$iddepnovo' target='_self'><b>PRIMEIRA P&Aacute;GINA</b></a>&nbsp;&nbsp;";
...
echo "| <a class=manchete_texto href='admsproduto.php?p=".$i."&id=$idsubnovo&iddep=$iddepnovo' target='_self'>".$i."</a> ";
}
}
...
echo "&nbsp;&nbsp;<a class=manchete_texto href='admsproduto.php?p=".$pags."&id=$idsubnovo&iddep=$iddepnovo' target='_self'><b>&Uacute;LTIMA P&Aacute;GINA</b></a> ";
?></div></td>
              </tr>
            </table></td>
          </tr>
