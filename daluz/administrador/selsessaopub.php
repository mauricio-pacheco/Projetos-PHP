          ...
          <table width="100%" border="0" align="center">
            <tr>
              <td width="11%" height="30" bgcolor="#076CA0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="98%">&nbsp;&nbsp;<font color="#FFFFFF" class="fontetabela2"><b>CADASTRAR PUBLICAÇÃO - SELECIONE A SUB-SESSÃO</b></font></td>
                </tr>
              </table></td>
            </tr>
          </table>
                  ...
                  <table width="100%" border="0" align="center">
                    <tr>
                      ...
                      <td align="left" width="98%" valign="top"><font color="#000000"><?php echo $subsessao.""; ?><br />
                        <a href="publicacao.php?idsessao=<?php echo $idsessao.""; ?>&amp;idsubsessao=<?php echo $id.""; ?>" class="manchete_texto4"><b>SELECIONAR SUB-SESSÃO</b></a></td>
                    </tr>
                  </table>
                  <div align="center">
				  <?php
