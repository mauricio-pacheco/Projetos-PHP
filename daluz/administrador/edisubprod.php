          ...
          <table width="100%" border="0" align="center">
            <tr>
              <td width="11%" height="30" bgcolor="#076CA0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="98%">&nbsp;&nbsp;<font color="#FFFFFF" class="fontetabela2"><b>EDITAR SUB-DEPARTAMENTO</b></font></td>
                </tr>
              </table></td>
            </tr>
          </table>
...
return false
                  ...
                  <form action="updatesubprod.php" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return validar(this)">
                    <?php

include "conexao.php";

$idnovato = $_GET['id'];
$sql = mysql_query("SELECT * FROM cw_subdepprod WHERE id='$idnovato' ORDER BY id");
$contar = mysql_num_rows($sql); 

if ($contar < 1)  
   {echo "<div align=center><b>N&Atilde;O EXISTE SUB-DEPARTAMENTO CADASTRADO!</b></div>"; 
   }
else 
   {
                    ...
                    <table width="100%" border="0" align="center">
                      <tr>
                        <td class="manchete_texto" align="left">T&iacute;tulo do Sub-Departamento: <span class="style15">
                          <input name="nomesub" type="text"  value="<?php echo $n["nomesub"]; ?>" class="fontetabela" size="60" />
...
$sql2 = mysql_query("SELECT * FROM cw_depprod WHERE id='$idnovato2' ORDER BY nome ASC");
...
$sql3 = mysql_query("SELECT * FROM cw_depprod WHERE id!='$idnovato2' ORDER BY nome ASC");
 ...
 ?>
                      ...
                      <tr>
                        <td class="manchete_texto" align="left"><span style="MARGIN: 0px">
                          <input name="submit" class="fontetabela" type="submit" style="FONT-SIZE: 10px" value="EDITAR SUB-DEPARTAMENTO" />
                        </span></td>
                      </tr>
                    </table>
