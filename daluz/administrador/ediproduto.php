          ...
          <table width="100%" border="0" align="center">
            <tr>
              <td width="11%" height="30" bgcolor="#076CA0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="98%">&nbsp;&nbsp;<font color="#FFFFFF" class="fontetabela2"><b>EDITAR IMÓVEL
                  </b></font></td>
                </tr>
              </table></td>
            </tr>
...
while($n = mysql_fetch_array($sql))
   ...
   ?>
             ...
             <tr>
               <td class="manchete_texto" align="left"><span class="fontetabela">&nbsp;Nome do Imóvel:
   ...
   { echo $z["nomesub"];    }
             ...
             <tr>
               <td class="manchete_texto" align="left">&nbsp;Tipo:
                 <select name="tipo" class="manchete_texto">
                   <option value="Venda"  <?php if ($n["tipo"]=='Venda') { echo 'selected'; } else { }?> >Venda</option>
                   <option value="Locação"  <?php if ($n["tipo"]=='Locação') { echo 'selected'; } else { }?>>Locação</option>
                 </select></td>
             </tr>
             <tr>
             ...
             <tr>
               <td class="manchete_texto" align="left"><span class="fontetabela">&nbsp;Imagem do Imóvel: 
             ...
             <tr>
               ...
               <input class="fontetabela" name="valorpx" size="6" value="<?php echo $n["valorpx"]; ?>" />
               </span>X de <font color="#009900">R$</font> <span class="fontetabela">
               <input class="fontetabela" name="valorp" value="<?php echo $n["valorp"]; ?>" />
               </span></td>
             </tr>
             <tr>
               <td class="manchete_texto" align="left">&nbsp;Valor a tratar:<span class="fontetabela">
               <input class="fontetabela" name="valortratar" size="100" value="<?php echo $n["valortratar"]; ?>" />
               </span></td>
             </tr>
             <tr>
            ...
            ?>               
             ...
             <tr>
               <td align="left"><p style="MARGIN: 0px"> 
                 ...
                 <input name="submit" type="submit" style="FONT-SIZE: 10px" value="EDITAR IMÓVEL" />
                 </span></p></td>
             </tr>
           </table><?php
  }
