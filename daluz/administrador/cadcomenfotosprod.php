          ...
          <table width="100%" border="0" align="center">
            <tr>
              <td width="11%" height="30" bgcolor="#076CA0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="98%">&nbsp;&nbsp;<font color="#FFFFFF" class="fontetabela2"><b>ADMINISTRAR COMENTÁRIOS DAS IMAGENS</b></font></td>
                </tr>
              </table></td>
            </tr>
          </table>
...
$sql = "UPDATE cw_anexosprod SET legenda = '$legenda' WHERE id = '$idanexo'";
if(mysql_query($sql)) {
echo "<div align=center><br><img src=ok.png></div><br><div align=center>A LEGENDA FOI POSTADA COM SUCESSO!!</div>";
echo "<script>location.href='comenadmfotosprod.php?id=$id'</script>";
}else{
