          ...
          <table width="100%" border="0" align="center">
            <tr>
              <td width="11%" height="30" bgcolor="#076CA0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="98%">&nbsp;&nbsp;<font color="#FFFFFF" class="fontetabela2"><b>SLIDES
                        <?php
                  ...
                  <table width="100%" border="0" align="center">
                    <tr>
                      <td align="left" width="98%"><table width="100%" border="0">
                        ...
                        <tr>
                          <td><a href="anexanoticias.php?id=<?php echo $id.""; ?>" class="manchete_textof6"><strong>ANEXAR IMAGENS NO SLIDE</strong></a> - <a href="admanexanoticia.php?id=<?php echo $id.""; ?>" class="manchete_textof8"><strong>ADMINISTRAR SLIDES</strong></a></td>
                        </tr>
                      </table>
