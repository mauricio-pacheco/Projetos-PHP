          ...
          <table width="100%" border="0" align="center">
            <tr>
              <td width="11%" height="30" bgcolor="#076CA0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="98%">&nbsp;&nbsp;<font color="#FFFFFF" class="fontetabela2"><b>EDITAR IMÓVEL</b></font></td>
                </tr>
              </table></td>
            </tr>
          </table>
...
$sql = "UPDATE cw_produtos SET nome = '$nome', departamento = '$departamento', subdep = '$subdep', tipo = '$tipo', foto = '$nome_foto0', valor = '$valor', valorpx = '$valorpx', valorp = '$valorp', valortratar = '$valortratar', descricao = '$descricao' WHERE id = '$id'";
if(mysql_query($sql)) {
echo "<div align=center><br><img src=imagens/ok.png></div><div align=center class=manchete_texto><br>O IMÓVEL FOI EDITADO COM SUCESSO!!</div><br>";
}else{
