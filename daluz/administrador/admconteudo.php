          ...
          <table width="100%" border="0" align="center">
            <tr>
              <td width="11%" height="30" bgcolor="#076CA0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="98%">&nbsp;&nbsp;<font color="#FFFFFF" class="fontetabela2"><b>ADMINISTRAR PÁGINAS - SELECIONE O DEPARTAMENTO</b></font></td>
                </tr>
              </table></td>
            </tr>
          </table>
 ...
 ?>
          ...
          <tr>
            <td><table width="100%" border="0" align="center">
              <tr>
                <td class="manchete_texto"><table width="100%" border="0" align="center">
                  <tr>
                    <td width="2%"><img src="imagens/menutab.png" /></td>
                    <td align="left" width="98%" valign="top"><font color="#000000"><strong>Menu Principal</strong><br />
                      <a href="editarcont.php?idmenu=0&amp;id=0" class="manchete_texto4"><b>SELECIONAR DEPARTAMENTO</b></a></td>
                  </tr>
                </table>
                  <?php
include "conexao.php";
...
$sql_select = "SELECT * FROM cw_menus ORDER BY id DESC LIMIT $inicio, $qnt";
// Executa o Query
                  ...
                  <table width="100%" border="0" align="center">
                    <tr>
                      ...
                      <td align="left" width="98%" valign="top"><font color="#000000"><?php echo $departamento.""; ?><br />
                        <a href="editarcont.php?idmenu=<?php echo $id.""; ?>&amp;id=<?php echo $id.""; ?>" class="manchete_texto4"><b>SELECIONAR DEPARTAMENTO</b></a></td>
                    </tr>
                  </table>
                  <div align="center">
				  <?php
...
$sql_select_all = "SELECT * FROM cw_menus";
...
echo "<a href='admconteudo.php?p=1' target='_self' class=manchete_texto><b>PRIMEIRA P&Aacute;GINA</b></a>&nbsp;&nbsp;";
...
echo "| <a href='admconteudo.php?p=".$i."' target='_self' class=manchete_texto>".$i."</a> ";
}
}
...
echo "&nbsp;&nbsp;<a href='admconteudo.php?p=".$pags."' target='_self' class=manchete_texto><b>&Uacute;LTIMA P&Aacute;GINA</b></a> ";
?></div></td>
              </tr>
            </table></td>
          </tr>
