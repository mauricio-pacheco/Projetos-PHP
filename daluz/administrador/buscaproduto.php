          ...
          <table width="100%" border="0" align="center">
            <tr>
              <td width="11%" height="30" bgcolor="#076CA0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="98%">&nbsp;&nbsp;<font color="#FFFFFF" class="fontetabela2"><b>ADMINISTRAR IMÓVEIS EM 
                    <?php
									
									$iddepnovo = $_POST["iddepnovo"];
                                    $idsubnovo = $_POST["idsubnovo"];
									include "conexao.php";
              ...
              <tr>
                <td>
                  <form name="formbusca" method="post" action="buscaproduto.php">
                    <label><span class="manchete_texto"><strong>Pesquisar Imóvel:</strong></span>
                      <input name="palavra" type="text" value="Digite o Nome do Imóvel" onclick="this.value=''" class="manchete_texto" id="palavra" size="98" />
...
$sql_select = "SELECT * FROM cw_produtos WHERE departamento='$iddepnovo' AND subdep='$idsubnovo' AND nome LIKE '%".$palavra."%' ORDER BY id DESC LIMIT $inicio, $qnt";
// Executa o Query
...
?>
                  <table width="99%" border="0" align="center">
                    <tr>
                      ...
                      <td align="left" width="98%" class="manchete_texto5" valign="top"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                        ...
                        <tr>
                          <td><div align="justify"><b>Tipo:</b>
                              <?php if ($tipo=='Venda') { ?>
                              <font color="#EC1D25">
                              <?php } else { ?>
                              <font color="#0364FF">
                              <?php } ?>
                              <?php echo $tipo.""; ?></font></div></td>
                        </tr>
                        <tr>
                          <td><img src="imagens/branco.gif" width="1" height="3" /></td>
                        </tr>
                        ...
                        <tr>
                          <td><div align="justify">Valor a Prazo: <?php echo $valorpx.""; ?> X de <font color="#009900">R$</font> <font color="#000000"><?php echo $valorp.""; ?></font></div></td>
                        </tr>
                        <tr>
                  ...
                  <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td align="left"><a href="ediproduto.php?id=<?php echo $id.""; ?>" class="manchete_texto4"><b>EDITAR IMÓVEL</b></a> - <a href="delproduto.php?id=<?php echo $id.""; ?>&amp;foto=<?php echo $foto.""; ?>&amp;iddepnovo=<?php echo $iddepnovo; ?>&amp;idsubnovo=<?php echo $idsubnovo; ?>" onclick="return confirm('Tem certeza que deseja apagar o produto <?php echo $nome.""; ?> ?')" class="manchete_texto6"><b>APAGAR IMÓVEL</b></a> - <a href="enviafotosprod.php?id=<?php echo $id.""; ?>" class="manchete_textof6"><b>ENVIAR IMAGENS AO IMÓVEL</b></a> - <a href="comenadmfotosprod.php?id=<?php echo $id.""; ?>" class="manchete_textof8"><b>ADMINISTRAR IMAGENS DO IMÓVEL</b></a></td>
                    </tr>
                  </table>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
...
$sql_select_all = "SELECT * FROM cw_produtos WHERE departamento='$iddepnovo' AND subdep='$idsubnovo' AND nome LIKE '%".$palavra."%'";
