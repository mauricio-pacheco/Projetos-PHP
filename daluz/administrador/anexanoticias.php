          ...
          <table width="100%" border="0" align="center">
            <tr>
              <td width="11%" height="30" bgcolor="#076CA0"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="98%">&nbsp;&nbsp;<font color="#FFFFFF" class="fontetabela2"><b>ANEXAR IMAGENS NOS SLIDES</b></font></td>
                </tr>
              </table></td>
            </tr>
          </table>
                        ...
                        <tr>
                          <td width="96%" class="manchete_texto5" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                              ...
                              <tr>
                              <td><font color="#000000"><b>TAMANHO DAS IMAGENS:</b>&nbsp; Largura: 980 px - Altura: 270 px ( Tipo PNG )</font></td>
                              </tr>
                          </table></td>
                        </tr>
                      </table></td>
