...
return false
                                ...
                                <form action="cadsnot.php" method="post" name="form1" enctype="multipart/form-data" id="form1" onSubmit="return validar(this)"><table width="98%" border="0" align="center">
             <tr>
             ...
             <tr>
               <td class="manchete_texto" align="left"><span class="fontetabela">&nbsp;Imagem da Legenda: 
                 ...
                 ( <em>Largura: 642 px X Altura: 240 px</em> )</span></td>
             </tr>
             <tr>
            ...
            ?>               
             ...
             <tr>
               <td align="left"><p style="MARGIN: 0px"> 
                 ...
                 <input name="submit" type="submit" style="FONT-SIZE: 10px" value="CADASTRAR NOTÍCIA NO SLIDE" />
                 </span></p></td>
             </tr>
           </table></form></td>
          </tr>
