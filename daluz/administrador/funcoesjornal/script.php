<style type="text/css">
.manchete {
	FONT-FAMILY: Tahoma, "Trebuchet MS", Verdana, Arial; COLOR: #ffffff; FONT-SIZE: 11px; TEXT-DECORATION: none
}
a {
	font-size: 11px;
	font-color: #FFFFFF;
...
{	$file = $_FILES['photoupload']['tmp_name'];
	...
	if (!is_uploaded_file($file) || ($_FILES['photoupload']['size'] > 50 * 1024 * 1024) )
	{
	  echo "Faça upload de arquivos menores que 50Mb!!!";
	  $error = 'Faça upload de arquivos menores que 50Mb!!!';
...
echo "<font color=#ffffff class=manchete>";			
