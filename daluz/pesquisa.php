...
$tipo = $_POST["tipo"];
	...
	?>
            Resultados da Pesquisa</strong></i></span></em></strong></em></strong></td>
          </tr>
        </table>
...
$sql_select = "SELECT * FROM cw_produtos WHERE departamento='$departamento' AND subdep='$subdep' AND tipo='$tipo' ORDER BY id DESC LIMIT $inicio, $qnt";
...
$sql_select_all = "SELECT * FROM cw_produtos WHERE departamento='$departamento' AND subdep='$subdep' AND tipo='$tipo'";
...
echo "<a href='pesquisa.php?p=1&amp;idsub=$idsub&iddep=$iddep' target='_self' class=manchete_texto9><b>PRIMEIRA PÁGINA</b></a>&nbsp;&nbsp; ";
...
echo "| <a href='pesquisa.php?p=".$i."&amp;idsub=$idsub&iddep=$iddep' target='_self' class=manchete_texto9>".$i."</a> ";
}
}
...
echo "&nbsp;&nbsp;<a href='pesquisa.php?p=".$pags."&amp;idsub=$idsub&iddep=$iddep' target='_self' class=manchete_texto9><b>ÚLTIMA PÁGINA</b></a> ";
