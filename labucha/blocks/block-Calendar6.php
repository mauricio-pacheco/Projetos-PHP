...
$todaycolor = "#778899";
$daycolor = "#ffffff";
$daybackground = "#212121";
$todaybackground = "#cccccc";
...
$content .= "<center><b>PRÓXIMAS BALADAS</b></center><br>";
$content .= "<MARQUEE behavior= \"scroll\" align= \"center\" direction= \"up\" height=\"116\" scrollamount= \"1\" scrolldelay= \"80\" onmouseover='this.stop()' onmouseout='this.start()'>";
...
$content .= "<br><center><a href=\"modules.php?name=$module_name&op=modload&file=submit\">•<FONT FACE=verdana size=\"1\"> Enviar uma nova balada </font>•</a><BR><a href=\"modules.php?name=Calendar&op=modload&file=index&type=month&Date=$Date\">•<FONT FACE=verdana size=\"1\"> Visualização mensal </font>•</a><BR><a href=\"modules.php?name=Calendar&op=modload&file=index&type=year&Date=$Date\">•<FONT FACE=verdana size=\"1\"> Visualização anual </font>•</a></center>";
...
$content .= "\n<TR>\n\t<Td colspan=7><FONT class=\"tiny\">";
$content .="<B><center><SELECT Name = \"calsetmonth\" onChange=\"javascript:document.selectcalendar.submit()\">
<OPTION $selmon[1] VALUE='01'>Janeiro</OPTION>
<OPTION $selmon[2] VALUE='02'>Fevereiro</OPTION>
<OPTION $selmon[3] VALUE='03'>Março</OPTION>
<OPTION $selmon[4] VALUE='04'>Abril</OPTION>
<OPTION $selmon[5] VALUE='05'>Maio</OPTION>
<OPTION $selmon[6] VALUE='06'>Junho</OPTION>
<OPTION $selmon[7] VALUE='07'>Julho</OPTION>
<OPTION $selmon[8] VALUE='08'>Agosto</OPTION>
<OPTION $selmon[9] VALUE='09'>Setembro</OPTION>
<OPTION $selmon[10] VALUE='10'>Outubro</OPTION>
<OPTION $selmon[11] VALUE='11'>Novembro</OPTION>
<OPTION $selmon[12] VALUE='12'>Dezembro</OPTION>
</SELECT>
