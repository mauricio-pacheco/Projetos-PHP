...
function Stats($total) {
    ...
    include ("header.php");
    title(""._STATS."<br><br>$sitename ");
    $total++;
    OpenTable();
    OpenTable();
    echo "<center><font class=\"option\"><b>"._STATS."</b><br><br>$sitename</font><br><br>"._WERECEIVED." <b>$total</b> "._PAGESVIEWS." $startdate<br>"._TODAYIS.": $now[0]/$now[1]/$now[2]<br><br>";
