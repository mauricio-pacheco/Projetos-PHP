...
$lang['Forum_Index'] = '';  // eg. sitename Forum Index, %s can be removed if you prefer
...
$lang['Admin_panel'] = 'Vá ao Painel de Administração';
...
$lang['Newest_user'] = 'Nosso mais novo usuário: <b>%s%s%s</b>'; // a href, username, /a
...
$lang['Reached_on_error'] = 'Você chegou a esta página por erro';
...
$lang['No_post_mode'] = 'Não foi especificada a ação para esta mensagem'; // If posting.php is called without a mode (newtopic/reply/delete/etc, shouldn't be shown normaly)
...
$lang['Flood_Error'] = 'Você não pode colocar uma nova mensagem tão rapidamente, por favor tente novamente daqui a pouco';
...
$lang['More_emoticons'] = 'Ver mais ícones de emoções (emoticons)';
...
$lang['Cannot_send_privmsg'] = 'O administrador suspendeu a sua permissão de envio de Mensagens Particulares';
...
$lang['No_user_id_specified'] = 'Este Usuário não existe';
...
$lang['Popup_on_privmsg_explain'] = 'Surgirá uma pequena janela avisando-o caso uma Mensagem Particular seja enviada.';
...
$lang['Account_inactive'] = 'O seu registro foi criado. Este fórum requer que o seu registro seja ativado, portanto uma senha foi enviada para o endereço de email fornecido. Por favor verifique o seu email para mais informações';
...
$lang['Not_logged_in'] = 'Você deve estar online para entrar no grupo.';
$lang['Remove_selected'] = 'Remover Selecionados';
$lang['Add_member'] = 'Adicionar um Membro';
$lang['Not_group_moderator'] = 'Você não é moderador deste Grupo e como tal não pode efetuar esta função.';

$lang['Login_to_join'] = 'Logue-se para entrar ou dar manutenção à lista de membros do Grupo';
...
$lang['No_searchable_forums'] = 'Você não possui autorização para fazer pesquisa nestas páginas';
...
$lang['You_been_banned'] = 'Você foi expulso deste fórum<br/>Contacte o webmaster ou o administrador para mais informações';
...
$lang['Hidden_users_online'] = '%d usuários online em modo invisível'; // 6 Hidden users online
$lang['Hidden_user_online'] = '%d usuário online em modo invisível'; // 6 Hidden users online
...
$lang['Mod_CP_explain'] = 'Usando o formulário abaixo você pode efetuar operações de moderação em massa neste fórum. Pode bloquear, desbloquear, mover ou excluir qualquer quantidade de tópicos.';
...
$lang['Confirm_lock_topic'] = 'Deseja realmente bloquear o(s) tópico(s) selecionado(s)?';
$lang['Confirm_unlock_topic'] = 'Deseja realmente desbloquear o(s) tópico(s) selecionado(s)?';
...
$lang['None_selected'] = 'Você não selecionou nenhum tópico para efetuar esta operação. Por favor volte atrás e escolha pelo menos um.';
...
$lang['Users_this_IP'] = 'Usuários que colocam mensagens a partir deste IP';
...
$lang['user_no_email'] = 'O usuário não possui nenhum email, conseqüentemente nenhuma mensagem sobre essa ação foi enviada, você deveria enviar-lhe uma mensagem particular';
$lang['user_already_banned'] = 'O usuário selecionado já está expulso';
$lang['Ban_no_admin'] ='Esse Usuário é um ADMINISTRADOR e conseqüentemente não pode ser nem avisado nem expulso';
