...
function theindex($new_topic=0) {
	...
	if ($numrows_a == 0) {
	    ...
	    echo "<center><font class=\"title\">$topic_title<br><br>$sitename</font><br><br>"
		."<form action=\"modules.php?name=Search\" method=\"post\">"
		."<input type=\"hidden\" name=\"topic\" value=\"$new_topic\">"
		."Buscar baladas cadastradas:<br> <br><input type=\"name\" name=\"query\" size=\"30\">&nbsp;&nbsp;"
		."<input type=\"submit\" value=\""._SEARCH."\">"
		."</form>"
		."[ <a href=\"index.php\">"._GOTOHOME."</a> ]</center>";
	}
	CloseTable();
	echo "<br>";
    }
...
function rate_article($sid, $score) {
	...
	include("header.php");
	title(""._ARTICLERATING."<br><br>$sitename");
	OpenTable();
