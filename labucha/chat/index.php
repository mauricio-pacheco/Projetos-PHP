...
<html>
<head>
<title>Bate Papo - Fred Balada</title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1"></head>
<LINK href="../index_arquivos/hdnew.css" type=text/css rel=stylesheet>
<body bgcolor="#151515">
<div align="center">
...
?> 
	<param name="pixx:helppage" value="http://www.fredbalada.com.br">
	<param name="command1" value="/j #fred">
	<param name="alternatenick" value="Visitante">
    <param name="name" value="Usuário">
    <param name="host" value="200.180.201.226">
    ...
    <param name="style:backgroundimage1" value="all all 0 img/bira.gif">
