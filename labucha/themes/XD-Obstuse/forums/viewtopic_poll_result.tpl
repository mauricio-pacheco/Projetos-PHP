			...
			<tr> 
			  ...
			  <td> 
				<table cellspacing="0" cellpadding="0" border="0">
				  <tr> 
					<td><img src="themes/XD-Obstuse/images/leftbar.gif" alt="" /></td>
					<td><img src="{poll_option.POLL_OPTION_IMG}" alt="{poll_option.POLL_OPTION_PERCENT}" width="{poll_option.POLL_OPTION_IMG_WIDTH}" height="11" /></td>
					<td><img src="themes/XD-Obstuse/images/rightbar.gif" alt="" /></td>
				  </tr>
				</table>
			  </td>
