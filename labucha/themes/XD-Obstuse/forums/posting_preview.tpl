...
<table width="100%" cellspacing="1" cellpadding="4" border="0">
	...
	<tr> 
		<td class="row1"><img src="themes/XD-Obstuse/forums/images/icon_minipost.gif" alt="{L_POST}" /><span class="postdetails">{L_POSTED}: {POST_DATE} &nbsp;&nbsp;&nbsp; {L_POST_SUBJECT}: {POST_SUBJECT}</span></td>
	</tr>
	<tr> 
	...
	<tr> 
		<td class="spaceRow" height="1"><img src="themes/XD-Obstuse/forums/images/spacer.gif" width="1" height="1" /></td>
	</tr>
</table>
</td>
