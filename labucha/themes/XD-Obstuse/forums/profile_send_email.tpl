...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	...
	<tr> 
		<td class="row2" width="22%"><span class="gen"><b>{L_RECIPIENT}</b></span></td>
	...
	<tr> 
		<td class="row2" valign="top"><span class="gen"><b>{L_MESSAGE_BODY}</b></span><br /><span class="gensmall">{L_MESSAGE_BODY_DESC}</span></td>
	...
	<tr> 
		<td class="row2" valign="top"><span class="gen"><b>{L_OPTIONS}</b></span></td>
