...
<script language='JavaScript'>
        function openAllSmiles(){
                smiles = window.open('modules.php?name=Forums&file=quick_reply&mode=smilies', '_phpbbsmilies', 'HEIGHT=300,resizable=yes,scrollbars=yes,WIDTH=250');
                smiles.focus();
                return false;
        }
...
<center><form action='{quick_reply.POST_ACTION}' method='post' name='post' onsubmit='return checkForm(this)'>
