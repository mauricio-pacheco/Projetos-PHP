    ...
    <td width="80%" height="80%" valign="top">
      <blockquote>
        ...
        <p><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><b>Manuten&ccedil;&atilde;o
          geral dos clientes do site.</b></font></p>
...
include ("paginacao.php");
/// Termina paginação
$sql = mysql_query("SELECT * FROM clientes ORDER BY nome_cliente ASC LIMIT $inicio,$max");
while($ressql = mysql_fetch_array($sql)){
print "<a class=link_verde href=\"javascript:alteraproduto('al_cliente_form.php?id=$ressql[0]');\">$ressql[1]</a><br>";
}
?></font></p>
