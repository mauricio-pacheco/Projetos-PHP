CREATE TABLE `boletim` (  `id` int(10) NOT NULL auto_increment,  `nome` varchar(70) NOT NULL default '',  `email` varchar(70) NOT NULL default '',  PRIMARY KEY  (`id`),  KEY `id` (`id`)) TYPE=MyISAM
...
CREATE TABLE `carrinho` (  `id_cliente` int(10) NOT NULL default '0',  `id_produto` int(10) NOT NULL default '0',  `quantidade` int(10) NOT NULL default '0',  `descricao_produto` varchar(255) NOT NULL default '',  `valor_produto` int(10) NOT NULL default '0',  KEY `id_cliente` (`id_cliente`)) TYPE=MyISAM
INSERT INTO carrinho VALUES (9,36,1,'Cartucho de tinta p/ HP 695',7500)
CREATE TABLE `categorias` (  `cod_categoria` int(10) NOT NULL auto_increment,  `descri_categoria` varchar(50) NOT NULL default '',  `pertence_categoria` int(10) NOT NULL default '0',  `gif` varchar(50) NOT NULL default '',  PRIMARY KEY  (`cod_categoria`)) TYPE=MyISAM
...
CREATE TABLE `clientes` (  `id` int(10) NOT NULL auto_increment,  `nome_cliente` varchar(255) NOT NULL default '',  `email_cliente` varchar(150) NOT NULL default '',  `senha_cliente` varchar(30) NOT NULL default '',  `fone_cliente` varchar(20) NOT NULL default '',  `endereco_cliente` varchar(255) NOT NULL default '',  `cidade_cliente` varchar(100) NOT NULL default '',  `estado_cliente` varchar(50) NOT NULL default '',  `cep_cliente` varchar(10) NOT NULL default '',  `cpf_cliente` varchar(50) NOT NULL default '',  `rg_cliente` varchar(50) NOT NULL default '',  PRIMARY KEY  (`id`),  KEY `id` (`id`)) TYPE=MyISAM
...
CREATE TABLE `enquete` (  `id` int(10) NOT NULL auto_increment,  `descricao` varchar(255) NOT NULL default '0',  `qtdcampos` int(10) unsigned default '0',  `campos` text NOT NULL,  `valorcampos` varchar(100) default '0',  `ativa` tinyint(1) unsigned default '0',  PRIMARY KEY  (`id`),  KEY `id` (`id`)) TYPE=MyISAM
INSERT INTO enquete VALUES (1,'Qual sua opniao sobre nosso site?',3,'Maravilhoso|Ótimo|Lindooooo','3|1|2',1)
CREATE TABLE `pedidos` (  `id` int(10) NOT NULL auto_increment,  `id_cliente` int(10) NOT NULL default '0',  `nome_cliente` varchar(100) NOT NULL default '',  `endereco_entrega` varchar(255) NOT NULL default '',  `cidade_entrega` varchar(100) NOT NULL default '',  `estado_entrega` varchar(50) NOT NULL default '',  `cep_entrega` varchar(9) NOT NULL default '',  `produtos` text NOT NULL,  `quantidades` text NOT NULL,  `valores` text NOT NULL,  `ativo` tinyint(1) NOT NULL default '1',  `frete` varchar(255) NOT NULL default '0',  `pagamento` varchar(255) NOT NULL default '',  `mensagem` text NOT NULL,  PRIMARY KEY  (`id`),  KEY `id` (`id`)) TYPE=MyISAM
...
CREATE TABLE `produto` (  `id` int(11) NOT NULL auto_increment,  `cod_produto` int(11) NOT NULL default '0',  `nome_produto` varchar(50) NOT NULL default '',  `descri_produto` text,  `valor_produto` int(11) NOT NULL default '0',  `foto_produto` varchar(50) NOT NULL default '',  `promo` tinyint(1) NOT NULL default '0',  `peso_produto` int(10) NOT NULL default '0',  `icone_produto` varchar(50) NOT NULL default '',  PRIMARY KEY  (`id`),  KEY `id` (`id`)) TYPE=MyISAM
...
CREATE TABLE `produto_categoria` (  `cod_produto` int(10) NOT NULL default '0',  `cod_categoria` int(10) NOT NULL default '0') TYPE=MyISAM
