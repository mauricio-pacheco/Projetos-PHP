          ...
          <tr> 
            <td width="780"><div align="center">
                <p><font color="#000000" size="1" face="Verdana">Administra&ccedil;&atilde;o 
                  dos pedidos de m&uacute;sicas da R&aacute;dio Frequ&ecirc;ncia.</font></p>
                <p>&nbsp;</p>
              </div></td>
          </tr>
          <%
   ...
   %>
          <tr> 
            <td width="780" bgcolor="#FFFFFF"> <p><font color="#000000" size="1"> 
                ...
                <% =nome2%>
                </font></strong><font face="Verdana"> - Cidade:</font><font color="#000000" size="1"><strong><font face="Verdana"> 
                <% =cidade2%>
                </font></strong></font><font face="Verdana"> - Estado:</font><font color="#000000" size="1"><font color="#000000" size="1"><strong><font face="Verdana"> 
                <% =estado2%>
                </font></strong></font></font> <font face="Verdana">-- M&uacute;sica: 
                <% =description%>
                - </font><font color="#000000" size="1"><font face="Verdana">Endere&ccedil;o:<font color="#000000" size="1"><font color="#000000" size="1"><strong> 
                <% =endereco2%>
                </strong></font></font></font> <font face="Verdana">-- Bairro: 
                <% =bairro2%>
                </font></font></font></p>
